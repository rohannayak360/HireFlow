...
<!-- Mirrored from coderthemes.com/paces/bootstrap/layouts-compact.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:59:07 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Compact Layout | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
...
<!-- Sidenav Menu End -->
            ...
            <div class="content-page">
                <div class="container-fluid"><div class="page-title-head d-flex align-items-center">
    <div class="flex-grow-1">
        <h4 class="page-main-title m-0">Compact</h4>
    </div>
    ...
    <div class="text-end">
        <ol class="breadcrumb m-0 py-0">
            ...
            <li class="breadcrumb-item active">Compact</li>
        </ol>
    </div>
</div>
</div>
