...
<!-- Mirrored from coderthemes.com/paces/bootstrap/ui-colors.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:59:10 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Colors | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Colors</h4>
                        </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered align-middle table-striped mb-0">
                                            <thead>
                                                <tr class="text-center">
                                                    <th scope="col" class="align-middle">Name</th>
                                                    <th scope="col" colspan="2" class="align-middle">Text Color</th>
                                                    <th scope="col" colspan="2" class="align-middle">Text Emphasis</th>
                                                    <th scope="col" colspan="2" class="align-middle">Text Opacity</th>
                                                    <th scope="col" colspan="2" class="align-middle">Link Color</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr>
