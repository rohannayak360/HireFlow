...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-crm-contacts.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:25 GMT -->
<head>
        <meta charset="utf-8" />
        <title>CRM Contacts | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-xxl-4">
                            <div class="card">
                                <div class="card-body d-flex align-items-start">
                                    <!-- Avatar -->
                                    <img src="{{ asset('admin/assets/images/users/user-10.jpg') }}" alt="avatar" class="rounded-circle me-3" width="64" height="64" />

                                    <div class="flex-grow-1">
                                        <!-- Name & Role -->
                                        <div class="d-flex justify-content-between align-items-center">
                                            <h5 class="mb-0">
                                                <a href="#!" class="link-reset">Emily Ross</a>
                                            </h5>
                                        ...
                                        <div class="mb-2">
                                            <div class="d-flex align-items-center gap-2 mb-1">
                                                ...
                                                <p class="fs-base mb-0 fw-medium">
                                                    <a href="#" class="link-reset">emily.ross&#64;greentech.com</a>
                                                </p>
                                            </div>
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="avatar-xs avatar-img-size fs-24">
                                                ...
                                                <p class="fs-base mb-0 fw-medium">
                                                    <a href="#" class="link-reset">+44 7911 112233</a>
                                                </p>
                                            </div>
                                        </div>
                        ...
                        <div class="col-md-6 col-xxl-4">
                            <div class="card">
                                <div class="card-body d-flex align-items-start">
                                    <!-- Avatar -->
                                    <img src="{{ asset('admin/assets/images/users/user-9.jpg') }}" alt="avatar" class="rounded-circle me-3" width="64" height="64" />

                                    <div class="flex-grow-1">
                                        <!-- Name & Role -->
                                        <div class="d-flex justify-content-between align-items-center">
                                            <h5 class="mb-0">
                                                <a href="#!" class="link-reset">Ava Mitchell</a>
                                            </h5>
                                        ...
                                        <div class="mb-2">
                                            <div class="d-flex align-items-center gap-2 mb-1">
                                                ...
                                                <p class="fs-base mb-0 fw-medium">
                                                    <a href="#" class="link-reset">ava.mitchell&#64;novaxlabs.com</a>
                                                </p>
                                            </div>
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="avatar-xs avatar-img-size fs-24">
                                                ...
                                                <p class="fs-base mb-0 fw-medium">
                                                    <a href="#" class="link-reset">+1 347 445 8890</a>
                                                </p>
                                            </div>
                                        </div>
                        ...
                        <div class="col-md-6 col-xxl-4">
                            <div class="card">
                                <div class="card-body d-flex align-items-start">
                                    <!-- Avatar -->
                                    <img src="{{ asset('admin/assets/images/users/user-8.jpg') }}" alt="avatar" class="rounded-circle me-3" width="64" height="64" />

                                    <div class="flex-grow-1">
                                        <!-- Name & Role -->
                                        <div class="d-flex justify-content-between align-items-center">
                                            <h5 class="mb-0">
                                                <a href="#!" class="link-reset">Lucas Grant</a>
                                            </h5>
                                        ...
                                        <div class="mb-2">
                                            <div class="d-flex align-items-center gap-2 mb-1">
                                                ...
                                                <p class="fs-base mb-0 fw-medium">
                                                    <a href="#" class="link-reset">lucas.grant&#64;metricone.com</a>
                                                </p>
                                            </div>
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="avatar-xs avatar-img-size fs-24">
                                                ...
                                                <p class="fs-base mb-0 fw-medium">
                                                    <a href="#" class="link-reset">+1 646 901 2200</a>
                                                </p>
                                            </div>
                                        </div>
                        ...
                        <div class="col-md-6 col-xxl-4">
                            <div class="card">
                                <div class="card-body d-flex align-items-start">
                                    <!-- Avatar -->
                                    <img src="{{ asset('admin/assets/images/users/user-7.jpg') }}" alt="avatar" class="rounded-circle me-3" width="64" height="64" />

                                    <div class="flex-grow-1">
                                        <!-- Name & Role -->
                                        <div class="d-flex justify-content-between align-items-center">
                                            <h5 class="mb-0">
                                                <a href="#!" class="link-reset">Sophie Nguyen</a>
                                            </h5>
                        ...
                        <div class="col-md-6 col-xxl-4">
                            <div class="card">
                                <div class="card-body d-flex align-items-start">
                                    <!-- Avatar -->
                                    <img src="{{ asset('admin/assets/images/users/user-6.jpg') }}" alt="avatar" class="rounded-circle me-3" width="64" height="64" />

                                    <div class="flex-grow-1">
                                        <!-- Name & Role -->
                                        <div class="d-flex justify-content-between align-items-center">
                                            <h5 class="mb-0">
                                                <a href="#!" class="link-reset">Rajiv Mehra</a>
                                            </h5>
                                            <span class="badge badge-label bg-info">Cold Lead</span>
                                        </div>
                            ...
                            <div class="card">
                                <div class="card-body d-flex align-items-start">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            <h5 class="mb-0">
                                                <a href="#!" class="link-reset">Isabella Stone</a>
                                            </h5>
                        ...
                        <div class="col-md-6 col-xxl-4">
                            <div class="card">
                                <div class="card-body d-flex align-items-start">
                                    <!-- Avatar -->
                                    <img src="{{ asset('admin/assets/images/users/user-5.jpg') }}" alt="avatar" class="rounded-circle me-3" width="64" height="64" />

                                    <div class="flex-grow-1">
                                        <!-- Name & Role -->
                                        <div class="d-flex justify-content-between align-items-center">
                                            <h5 class="mb-0">
                                                <a href="#!" class="link-reset">Carlos Jiménez</a>
                                            </h5>
                        ...
                        <div class="col-md-6 col-xxl-4">
                            <div class="card">
                                <div class="card-body d-flex align-items-start">
                                    <!-- Avatar -->
                                    <img src="{{ asset('admin/assets/images/users/user-4.jpg') }}" alt="avatar" class="rounded-circle me-3" width="64" height="64" />

                                    <div class="flex-grow-1">
                                        <!-- Name & Role -->
                                        <div class="d-flex justify-content-between align-items-center">
                                            <h5 class="mb-0">
                                                <a href="#!" class="link-reset">Nina Patel</a>
                                            </h5>
                        ...
                        <div class="col-md-6 col-xxl-4">
                            <div class="card">
                                <div class="card-body d-flex align-items-start">
                                    <!-- Avatar -->
                                    <img src="{{ asset('admin/assets/images/users/user-3.jpg') }}" alt="avatar" class="rounded-circle me-3" width="64" height="64" />

                                    <div class="flex-grow-1">
                                        <!-- Name & Role -->
                                        <div class="d-flex justify-content-between align-items-center">
                                            <h5 class="mb-0">
                                                <a href="#!" class="link-reset">Elena Moretti</a>
                                            </h5>
                        ...
                        <div class="col-md-6 col-xxl-4">
                            <div class="card">
                                <div class="card-body d-flex align-items-start">
                                    <!-- Avatar -->
                                    <img src="{{ asset('admin/assets/images/users/user-2.jpg') }}" alt="avatar" class="rounded-circle me-3" width="64" height="64" />

                                    <div class="flex-grow-1">
                                        <!-- Name & Role -->
                                        <div class="d-flex justify-content-between align-items-center">
                                            <h5 class="mb-0">
                                                <a href="#!" class="link-reset">Jason Lee</a>
                                            </h5>
                        ...
                        <div class="col-md-6 col-xxl-4">
                            <div class="card">
                                <div class="card-body d-flex align-items-start">
                                    <!-- Avatar -->
                                    <img src="{{ asset('admin/assets/images/users/user-1.jpg') }}" alt="avatar" class="rounded-circle me-3" width="64" height="64" />

                                    <div class="flex-grow-1">
                                        <!-- Name & Role -->
                                        <div class="d-flex justify-content-between align-items-center">
                                            <h5 class="mb-0">
                                                <a href="#!" class="link-reset">Fatima Al-Mansoori</a>
                                            </h5>
                            ...
                            <div class="card">
                                <div class="card-body d-flex align-items-start">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            <h5 class="mb-0">
                                                <a href="#!" class="link-reset">Markus Hoffmann</a>
                                            </h5>
