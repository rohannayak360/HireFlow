...
<!-- Mirrored from coderthemes.com/paces/bootstrap/pages-search-results.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:56 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Search Results | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Search Results</h4>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-header border-light justify-content-between">
                                    ...
                                    <div class="d-flex flex-wrap align-items-center gap-3">
                                        ...
                                        <div class="app-search">
                                            ...
                                            <i class="ti ti-cpu app-search-icon text-muted"></i>
                                        </div>
                                        ...
                                        <div class="app-search">
                                            ...
                                            <i class="ti ti-wallet app-search-icon text-muted"></i>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-body p-0">
                                    <div class="border-bottom border-dashed px-4 py-3">
                                        <h4 class="fs-md mb-1">
                                            <a href="#!" target="_blank" class="text-reset">NeuroVision AI – Smart Analytics Dashboard</a>
                                        </h4>
                                        ...
                                        <p class="d-flex flex-wrap gap-3 text-muted mb-1 align-items-center fs-base">
                                            <span class="d-flex align-items-center gap-1">
                                                ...
                                                <a href="#!" class="link-reset fw-semibold">Alex Johnson</a>
                                            </span>
                                            <span>
                                            ...
                                            <span>
                                                ...
                                                <a href="#!" class="link-reset">Feedback: 145</a>
                                            </span>
                                            <span>
                                    ...
                                    <div class="border-bottom border-dashed px-4 py-3">
                                        <h4 class="fs-md mb-1">
                                            <a href="#!" target="_blank" class="text-reset">SynthChat – AI Conversational Assistant</a>
                                        </h4>
                                        ...
                                        <p class="d-flex flex-wrap gap-3 text-muted mb-1 align-items-center fs-base">
                                            <span class="d-flex align-items-center gap-1">
                                                <img src="{{ asset('admin/assets/images/users/user-5.jpg') }}" alt="avatar-5" class="img-fluid avatar-xs rounded-circle" />
                                                <a href="#!" class="link-reset fw-semibold">Maria Lopez</a>
                                            </span>
                                            <span>
                                                <i class="ti ti-calendar"></i>
                                            ...
                                            <span>
                                                <i class="ti ti-message-circle"></i>
                                                <a href="#!" class="link-reset">Feedback: 89</a>
                                            </span>
                                            <span>
                                                <i class="ti ti-star"></i>
                                                Rating: 4.7
                                    ...
                                    <div class="border-bottom border-dashed px-4 py-3">
                                        <h4 class="fs-md mb-1">
                                            <a href="#!" target="_blank" class="text-reset">VisionaryGen – AI Image Creator</a>
                                        </h4>
                                        ...
                                        <p class="d-flex flex-wrap gap-3 text-muted mb-1 align-items-center fs-base">
                                            <span class="d-flex align-items-center gap-1">
                                                ...
                                                <a href="#!" class="link-reset fw-semibold">James Carter</a>
                                            </span>
                                            <span>
                                                <i class="ti ti-calendar"></i>
                                            ...
                                            <span>
                                                <i class="ti ti-message-circle"></i>
                                                <a href="#!" class="link-reset">Feedback: 67</a>
                                            </span>
                                            <span>
                                                <i class="ti ti-star"></i>
                                                Rating: 4.8
                                    ...
                                    <div class="border-bottom border-dashed px-4 py-3">
                                        ...
                                        <div class="d-flex gap-2">
                                            <div class="avatar">
                                                <img src="{{ asset('admin/assets/images/users/user-4.jpg') }}" alt="" class="rounded avatar-xl" />
                                            </div>
                                            <div class="avatar">
                                                <img src="{{ asset('admin/assets/images/users/user-5.jpg') }}" alt="" class="rounded avatar-xl" />
                                            </div>
                                            <div class="avatar">
                                                <img src="{{ asset('admin/assets/images/users/user-3.jpg') }}" alt="" class="rounded avatar-xl" />
                                            </div>
                                            <div class="avatar">
                                                <img src="{{ asset('admin/assets/images/users/user-8.jpg') }}" alt="" class="rounded avatar-xl" />
                                            </div>
                                            <div class="avatar">
                                                <img src="{{ asset('admin/assets/images/users/user-2.jpg') }}" alt="" class="rounded avatar-xl" />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="border-bottom border-dashed px-4 py-3">
                                        <h4 class="fs-md mb-1">
                                            <a href="#!" target="_blank" class="text-reset">EchoAI – Voice & Speech Recognition</a>
                                        </h4>
                                        ...
                                        <p class="d-flex flex-wrap gap-3 text-muted mb-1 align-items-center fs-base">
                                            <span class="d-flex align-items-center gap-1">
                                                <img src="{{ asset('admin/assets/images/users/user-5.jpg') }}" alt="avatar-5" class="img-fluid avatar-xs rounded-circle" />
                                                <a href="#!" class="link-reset fw-semibold">Daniel Kim</a>
                                            </span>
                                            <span>
                                                <i class="ti ti-calendar"></i>
                                            ...
                                            <span>
                                                <i class="ti ti-message-circle"></i>
                                                <a href="#!" class="link-reset">Feedback: 54</a>
                                            </span>
                                            <span>
                                                <i class="ti ti-star"></i>
                                                Rating: 4.6
                                    ...
                                    <div class="border-bottom border-dashed px-4 py-3">
                                        ...
                                        <div class="d-flex gap-2 flex-wrap">
                                            <div class="px-3 py-2 bg-light bg-opacity-50 rounded">
                                                <a href="#!" class="text-reset fs-md fw-semibold">
                                                    AI SaaS Platforms
                                                    <i class="ti ti-search ms-2 align-middle"></i>
                                                </a>
                                            </div>
                                            <div class="px-3 py-2 bg-light bg-opacity-50 rounded">
                                                <a href="#!" class="text-reset fs-md fw-semibold">
