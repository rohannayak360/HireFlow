...
<!-- Mirrored from coderthemes.com/paces/bootstrap/dashboard-crm.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:57:56 GMT -->
<head>
        <meta charset="utf-8" />
        <title>CRM Dashboard | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                                    ...
                                    <table class="table table-custom table-nowrap table-centered table-select table-hover w-100 mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>30 Sep, 2024</td>
                                                <td>
                                                    <img src="{{ asset('admin/assets/images/users/user-10.jpg') }}" alt="" class="avatar-xs rounded-circle me-1" />
                                            ...
                                            <tr>
                                                ...
                                                <td>12 Jan, 2025</td>
                                                <td>
                                                    <img src="{{ asset('admin/assets/images/users/user-3.jpg') }}" class="avatar-xs rounded-circle me-1" />
                                                    <a href="#" class="text-body fw-medium">Chris Nolan</a>
                                                </td>
                                                <td><div class="text-nowrap">USD $78.3K</div></td>
                                                <td><span class="badge bg-info-subtle text-info p-1">Paused</span></td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>08 Mar, 2025</td>
                                                <td>
                                                    <img src="{{ asset('admin/assets/images/users/user-4.jpg') }}" class="avatar-xs rounded-circle me-1" />
                                                    <a href="#" class="text-body fw-medium">Karen Miles</a>
                                                </td>
                                                <td><div class="text-nowrap">EUR €120.4K</div></td>
                                                <td><span class="badge text-bg-light p-1">New</span></td>
                                                <td>
                                                    <a href="#" class="text-muted fs-20"><i class="ti ti-edit"></i></a>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>15 Jul, 2025</td>
                                                <td>
                                                    <img src="{{ asset('admin/assets/images/users/user-6.jpg') }}" class="avatar-xs rounded-circle me-1" />
                                                    <a href="#" class="text-body fw-medium">Oscar Brent</a>
                                                </td>
                                                <td><div class="text-nowrap">GBP £58.7K</div></td>
                                                <td><span class="badge bg-warning-subtle text-warning p-1">Cold Lead</span></td>
                                                <td>
                                                    <a href="#" class="text-muted fs-20"><i class="ti ti-edit"></i></a>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>21 Feb, 2025</td>
                                                <td>
                                                    <img src="{{ asset('admin/assets/images/users/user-8.jpg') }}" class="avatar-xs rounded-circle me-1" />
                                                    <a href="#" class="text-body fw-medium">Maria Jensen</a>
                                                </td>
                                                <td><div class="text-nowrap">USD $42.3K</div></td>
                                                <td><span class="badge bg-danger-subtle text-danger p-1">Canceled</span></td>
                                                <td>
                                                    <a href="#" class="text-muted fs-20"><i class="ti ti-edit"></i></a>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>10 Oct, 2024</td>
                                                <td>
                                                    <img src="{{ asset('admin/assets/images/users/user-9.jpg') }}" class="avatar-xs rounded-circle me-1" />
                                                    <a href="#" class="text-body fw-medium">Daniel Cook</a>
                                                </td>
                                                <td><div class="text-nowrap">USD $310.2K</div></td>
                                                <td><span class="badge bg-success-subtle text-success p-1">Deal Won</span></td>
                                                <td>
                                                    <a href="#" class="text-muted fs-20"><i class="ti ti-edit"></i></a>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>28 May, 2025</td>
                                                <td>
                                                    <img src="{{ asset('admin/assets/images/users/user-5.jpg') }}" class="avatar-xs rounded-circle me-1" />
                                                    <a href="#" class="text-body fw-medium">Emily Grace</a>
                                                </td>
                                                <td><div class="text-nowrap">USD $54.1K</div></td>
                                                <td><span class="badge bg-info-subtle text-info p-1">Paused</span></td>
                                                <td>
                                                    <a href="#" class="text-muted fs-20"><i class="ti ti-edit"></i></a>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>02 Feb, 2025</td>
                                                <td>
                                                    <img src="{{ asset('admin/assets/images/users/user-7.jpg') }}" class="avatar-xs rounded-circle me-1" />
                                                    <a href="#" class="text-body fw-medium">Nathan Cole</a>
                                                </td>
                                                <td><div class="text-nowrap">USD $19.8K</div></td>
                                                <td><span class="badge bg-danger-subtle text-danger p-1">Canceled</span></td>
                                                <td>
                                                    <a href="#" class="text-muted fs-20"><i class="ti ti-edit"></i></a>
                                                </td>
                                    ...
                                    <div class="mt-3">
                                        <div class="table-responsive mb-n1">
                                            <table class="table table-nowrap table-borderless table-centered mb-0">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td><img src="{{ asset('admin/assets/images/flags/us.svg') }}" alt="user-image" class="me-1 rounded-circle" height="18" /> <span class="align-middle">United States</span></td>
                                                        <td>196,584</td>
                                                        <td>187,232</td>
                                                        <td>48.63%</td>
                                                    </tr>
                                                    <tr>
                                                        <td><img src="{{ asset('admin/assets/images/flags/in.svg') }}" alt="user-image" class="me-1 rounded-circle" height="18" /> <span class="align-middle">India</span></td>
                                                        <td>145,845</td>
                                                        <td>126,874</td>
                                                        <td>36.08%</td>
                                                    </tr>
                                                    <tr>
                                                        <td><img src="{{ asset('admin/assets/images/flags/au.svg') }}" alt="user-image" class="me-1 rounded-circle" height="18" /> <span class="align-middle">Australia</span></td>
                                                        <td>95,845</td>
                                                        <td>90,127</td>
                                                        <td>23.41%</td>
                                                    </tr>
...
<!-- Mirrored from coderthemes.com/paces/bootstrap/dashboard-crm.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:57:58 GMT -->
</html>
