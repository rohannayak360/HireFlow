...
<!-- Mirrored from coderthemes.com/paces/bootstrap/icons-flags.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 10:00:05 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Flags | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
...
<script src="{{ asset('admin/assets/js/app.js') }}"></script>
        ...
        <!-- Page only -->
        <script src="{{ asset('admin/assets/js/pages/flags-listing.js') }}"></script>
    </body>

<!-- Mirrored from coderthemes.com/paces/bootstrap/icons-flags.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 10:00:06 GMT -->
</html>
