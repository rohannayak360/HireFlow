...
<!-- Mirrored from coderthemes.com/paces/bootstrap/dashboard-finance.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:57:58 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Finance Dashboard | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
            ...
            <div class="content-page">
                <div class="container-fluid">
                            ...
                            <div class="card card-h-100">
                                <div class="card-header border-0 justify-content-between">
                                    ...
                                    <div class="dropdown ms-auto">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            <li>
                                                <a class="dropdown-item" href="#"> <i class="ti ti-wallet me-2"></i> Add Funds </a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item" href="#"> <i class="ti ti-cash-banknote-move-back me-2"></i> Withdraw Funds </a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item" href="#"> <i class="ti ti-transaction-dollar me-2"></i> Transaction History </a>
                                            </li>
                                            <li>
                                                <hr class="dropdown-divider" />
                                            </li>
                                            <li>
                                                <a class="dropdown-item text-danger" href="#"> <i class="ti ti-lock me-2"></i> Freeze Account </a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <div class="p-2 bg-light bg-opacity-50 rounded mt-3 gap-2 d-flex align-items-center">
                                        <img src="{{ asset('admin/assets/images/debit-card.png') }}" alt="" height="36" class="rounded me-1" />
                                        <div>
                                ...
                                <div class="card-header border-0 justify-content-between">
                                    ...
                                    <div class="dropdown ms-auto">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            ...
                                            <li>
                                                <a class="dropdown-item" href="#"> <i class="ti ti-chart-bar me-2"></i> View Analytics </a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item" href="#"> <i class="ti ti-filter-2 me-2"></i> Filter Report </a>
                                            </li>
                                            <li>
                                                <hr class="dropdown-divider" />
                                            </li>
                                            <li>
                                                <a class="dropdown-item text-danger" href="#"> <i class="ti ti-download me-2"></i> Export Data </a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="col-xl-4">
                            ...
                            <div class="card">
                                <div class="card-header justify-content-between">
                                    <h4 class="card-title">
                                        Quick Transfer
                                        <i class="ti ti-info-octagon text-muted ms-1" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Quickly send money to your saved contacts."></i>
                                    </h4>
                                    <div class="dropdown ms-auto">
                                        <a href="#" class="btn btn-sm btn-default btn-icon" data-bs-toggle="dropdown">
                                            <i class="ti ti-dots-vertical fs-lg"></i>
                                ...
                                <div class="card-body">
                                    <div class="d-flex gap-2 justify-content-center">
                                        ...
                                        <label class="avatar-label" for="rec1" data-bs-toggle="tooltip" data-bs-title="Alexa Newsome">
                                            <img src="{{ asset('admin/assets/images/users/user-4.jpg') }}" alt="" class="rounded-circle img-thumbnail avatar-lg" />
                                        </label>
                                        ...
                                        <label class="avatar-label" for="rec2" data-bs-toggle="tooltip" data-bs-title="Shelly Dorey">
                                            <img src="{{ asset('admin/assets/images/users/user-5.jpg') }}" alt="" class="rounded-circle img-thumbnail avatar-lg" />
                                        </label>
                                        ...
                                        <label class="avatar-label" for="rec3" data-bs-toggle="tooltip" data-bs-title="Fredrick Arnett">
                                            <img src="{{ asset('admin/assets/images/users/user-3.jpg') }}" alt="" class="rounded-circle img-thumbnail avatar-lg" />
                                        </label>
                                        ...
                                        <label class="avatar-label" for="rec4" data-bs-toggle="tooltip" data-bs-title="Barbara Frink">
                                            <img src="{{ asset('admin/assets/images/users/user-8.jpg') }}" alt="" class="rounded-circle img-thumbnail avatar-lg" />
                                        </label>
                                        ...
                                        <label class="avatar-label" for="rec5" data-bs-toggle="tooltip" data-bs-title="Adam M">
                                            <img src="{{ asset('admin/assets/images/users/user-2.jpg') }}" alt="" class="rounded-circle img-thumbnail avatar-lg" />
                                        </label>
                                    </div>
                        ...
                        <div class="col-12">
                            <div data-table data-table-rows-per-page="8" class="card">
                                <div class="card-header border-light justify-content-between">
                                    <h4 class="card-title">Recent Transactions <span class="text-muted fw-normal fs-14">(95.6k+ Transactions)</span></h4>
                                    ...
                                    <table class="table table-custom table-nowrap table-centered table-select table-hover w-100 mb-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="{{ asset('admin/assets/images/users/user-5.jpg') }}" alt="" class="avatar-xs rounded-circle me-1" />
                                                ...
                                                <td>Credit</td>
                                                <td><img src="{{ asset('admin/assets/images/cards/visa.svg') }}" height="24" class="me-1" /> *4321</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="{{ asset('admin/assets/images/users/user-2.jpg') }}" alt="" class="avatar-xs rounded-circle me-1" />
                                                ...
                                                <td>Debit</td>
                                                <td><img src="{{ asset('admin/assets/images/cards/mastercard.svg') }}" height="24" class="me-1" /> *9333</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>Credit</td>
                                                <td><img src="{{ asset('admin/assets/images/cards/paypal.svg') }}" height="24" class="me-1" /> PayPal</td>
                                                <td><span class="badge bg-success-subtle text-success p-1">Success</span></td>
                                                <td>
                                                    <a href="#!" class="text-muted fs-20"><i class="ti ti-eye"></i></a>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="{{ asset('admin/assets/images/users/user-3.jpg') }}" alt="" class="avatar-xs rounded-circle me-1" />
                                                ...
                                                <td>Debit</td>
                                                <td><img src="{{ asset('admin/assets/images/cards/stripe.svg') }}" height="24" class="me-1" /> Stripe</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="{{ asset('admin/assets/images/users/user-4.jpg') }}" alt="" class="avatar-xs rounded-circle me-1" />
                                                ...
                                                <td>Credit</td>
                                                <td><img src="{{ asset('admin/assets/images/cards/mastercard.svg') }}" height="24" class="me-1" /> *2112</td>
                                                <td><span class="badge bg-success-subtle text-success p-1">Success</span></td>
                                                <td>
                                                    <a href="#!" class="text-muted fs-20"><i class="ti ti-eye"></i></a>
                                                </td>
                                            ...
                                            <tr>
                                                <td><a href="#!" class="fw-medium text-reset">#TX896</a></td>
                                                <td>
                                                    <div class="avatar-xs d-inline-block me-1">
                                                ...
                                                <td>17 Nov,25 <small class="text-muted">02:10 pm</small></td>
                                                <td>Debit</td>
                                                <td><img src="{{ asset('admin/assets/images/cards/unionpay.svg') }}" height="24" class="me-1" /> *5510</td>
                                                <td><span class="badge bg-success-subtle text-success p-1">Success</span></td>
                                                <td>
                                                    <a href="#!" class="text-muted fs-20"><i class="ti ti-eye"></i></a>
                                                </td>
                                            ...
                                            <tr>
                                                <td><a href="#!" class="fw-medium text-reset">#TX895</a></td>
                                                <td>
                                                    <img src="{{ asset('admin/assets/images/users/user-8.jpg') }}" alt="" class="avatar-xs rounded-circle me-1" />
                                                    <span class="align-middle">Olivia Brown</span>
                                                </td>
                                                <td>Personal Transfer</td>
                                                <td class="text-success">USD $250.00</td>
                                                <td>16 Nov,25 <small class="text-muted">07:48 am</small></td>
                                                <td>Credit</td>
                                                <td><img src="{{ asset('admin/assets/images/cards/visa.svg') }}" height="24" class="me-1" /> *0244</td>
                                                <td><span class="badge bg-success-subtle text-success p-1">Success</span></td>
                                                <td>
                                                    <a href="#!" class="text-muted fs-20"><i class="ti ti-eye"></i></a>
                                                </td>
                                            ...
                                            <tr>
                                                <td><a href="#!" class="fw-medium text-reset">#TX894</a></td>
                                                <td>
                                                    <img src="{{ asset('admin/assets/images/users/user-1.jpg') }}" alt="" class="avatar-xs rounded-circle me-1" />
                                                    <span class="align-middle">David Chen</span>
                                                </td>
                                                <td>ATM Withdrawal</td>
                                                <td class="text-danger">-USD $180.00</td>
                                                <td>15 Nov,25 <small class="text-muted">04:33 pm</small></td>
                                                <td>Debit</td>
                                                <td><img src="{{ asset('admin/assets/images/cards/mastercard.svg') }}" height="24" class="me-1" /> *7780</td>
                                            ...
                                            <tr>
                                                <td><a href="#!" class="fw-medium text-reset">#TX893</a></td>
                                                <td>
                                                    <img src="{{ asset('admin/assets/images/users/user-6.jpg') }}" alt="" class="avatar-xs rounded-circle me-1" />
                                                    <span class="align-middle">Marcus Lee</span>
                                                </td>
                                                <td>Online Purchase</td>
                                                <td class="text-danger">-USD $65.49</td>
                                                <td>14 Nov,24 <small class="text-muted">02:09 pm</small></td>
                                                <td>Debit</td>
                                                <td><img src="{{ asset('admin/assets/images/cards/stripe.svg') }}" height="24" class="me-1" /> Stripe</td>
                                                <td><span class="badge bg-success-subtle text-success p-1">Success</span></td>
                                                <td>
                                            ...
                                            <tr>
                                                <td><a href="#!" class="fw-medium text-reset">#TX892</a></td>
                                                <td>
                                                    <div class="avatar-xs d-inline-block me-1">
                                                ...
                                                <td>12 Nov,24 <small class="text-muted">09:30 am</small></td>
                                                <td>Debit</td>
                                                <td><img src="{{ asset('admin/assets/images/cards/visa.svg') }}" height="24" class="me-1" /> *1188</td>
                                                <td><span class="badge bg-success-subtle text-success p-1">Success</span></td>
                                                <td>
                                                    <a href="#!" class="text-muted fs-20"><i class="ti ti-eye"></i></a>
                                                </td>
                                            ...
                                            <tr>
                                                <td><a href="#!" class="fw-medium text-reset">#TX891</a></td>
                                                <td>
                                                    <img src="{{ asset('admin/assets/images/users/user-7.jpg') }}" alt="" class="avatar-xs rounded-circle me-1" />
                                                    <span class="align-middle">Henry Walker</span>
                                                </td>
                                                <td>Loan EMI Payment</td>
                                                <td class="text-danger">-USD $320.00</td>
                                                <td>11 Nov,24 <small class="text-muted">04:55 pm</small></td>
                                                <td>Debit</td>
                                                <td><img src="{{ asset('admin/assets/images/cards/mastercard.svg') }}" height="24" class="me-1" /> *9982</td>
                                                <td><span class="badge bg-success-subtle text-success p-1">Success</span></td>
                                                <td>
                                                    <a href="#!" class="text-muted fs-20"><i class="ti ti-eye"></i></a>
                                                </td>
                                            ...
                                            <tr>
                                                <td><a href="#!" class="fw-medium text-reset">#TX890</a></td>
                                                <td>
                                                    <div class="avatar-xs d-inline-block me-1">
                                                ...
                                                <td>10 Nov,24 <small class="text-muted">08:12 am</small></td>
                                                <td>Debit</td>
                                                <td><img src="{{ asset('admin/assets/images/cards/stripe.svg') }}" height="24" class="me-1" /> Stripe</td>
                                                <td><span class="badge bg-warning-subtle text-warning p-1">Pending</span></td>
                                                <td>
                    ...
                    <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-3 row-cols-xxl-5">
                        <div class="col">
                            <div class="card border-0 rounded-3 text-white" style="background-image: url({{ asset('admin/assets/images/stock/small-1.jpg') }}); background-size: cover">
                        ...
                        <div class="col">
                            <div class="card border-0 rounded-3 text-white" style="background-image: url({{ asset('admin/assets/images/stock/small-2.jpg') }}); background-size: cover">
                        ...
                        <div class="col">
                            <div class="card border-0 rounded-3 text-white" style="background-image: url({{ asset('admin/assets/images/stock/small-3.jpg') }}); background-size: cover">
                        ...
                        <div class="col">
                            <div class="card border-0 rounded-3 text-white" style="background-image: url({{ asset('admin/assets/images/stock/small-4.jpg') }}); background-size: cover">
                        ...
                        <div class="col">
                            <div class="card border-0 rounded-3 text-white" style="background-image: url({{ asset('admin/assets/images/stock/small-5.jpg') }}); background-size: cover">
...
<script src="{{ asset('admin/assets/js/app.js') }}"></script>
        ...
        <!-- Dashboard js -->
        <script src="{{ asset('admin/assets/js/pages/dashboard-finance.js') }}"></script>
    </body>

<!-- Mirrored from coderthemes.com/paces/bootstrap/dashboard-finance.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:03 GMT -->
</html>
