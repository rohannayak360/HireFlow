...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-issue-tracker.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:45 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Issue List | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Issue List</h4>
                        </div>
                            ...
                            <div data-table data-table-rows-per-page="8" class="card">
                                <div class="card-header border-light justify-content-between">
                                    <div class="app-search">
                                        <input data-table-search type="search" class="form-control" placeholder="Search issues..." />
                                        <i class="ti ti-search app-search-icon text-muted"></i>
                                    </div>
                                            ...
                                            <table class="table table-custom table-centered table-hover w-100 mb-0">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <!-- Issue ID and Title -->
                                                        <td>
                                                            <a href="#!" data-bs-toggle="modal" data-bs-target="#issueDetailsModal" class="link-reset text-uppercase fw-semibold">ISSUE-104</a>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="#!" data-bs-toggle="modal" data-bs-target="#issueDetailsModal" class="link-reset text-uppercase fw-semibold">ISSUE-105</a>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="#!" data-bs-toggle="modal" data-bs-target="#issueDetailsModal" class="link-reset text-uppercase fw-semibold">ISSUE-106</a>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="#!" data-bs-toggle="modal" data-bs-target="#issueDetailsModal" class="link-reset text-uppercase fw-semibold">ISSUE-107</a>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="#!" data-bs-toggle="modal" data-bs-target="#issueDetailsModal" class="link-reset text-uppercase fw-semibold">ISSUE-108</a>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="#!" data-bs-toggle="modal" data-bs-target="#issueDetailsModal" class="link-reset text-uppercase fw-semibold">ISSUE-109</a>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="#!" data-bs-toggle="modal" data-bs-target="#issueDetailsModal" class="link-reset text-uppercase fw-semibold">ISSUE-110</a>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="#!" data-bs-toggle="modal" data-bs-target="#issueDetailsModal" class="link-reset text-uppercase fw-semibold">ISSUE-111</a>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="#!" data-bs-toggle="modal" data-bs-target="#issueDetailsModal" class="link-reset text-uppercase fw-semibold">ISSUE-112</a>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="#!" data-bs-toggle="modal" data-bs-target="#issueDetailsModal" class="link-reset text-uppercase fw-semibold">ISSUE-113</a>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="d-flex align-items-center mb-3">
                                        <img src="{{ asset('admin/assets/images/users/user-1.jpg') }}" class="rounded-circle me-2" width="40" height="40" alt="User" />
                                        <div>
