...
<!-- Mirrored from coderthemes.com/paces/bootstrap/tables-datatables-scroll.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:59:59 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Scroll Datatables | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Scroll</h4>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <table id="vertical-scroll" class="table table-striped w-100 align-middle mb-0">
                            ...
                            <div class="card">
                                <div class="card-header justify-content-between">
                                    ...
                                    <a href="https://datatables.net/examples/basic_init/scroll_x.html" target="_blank" class="icon-link icon-link-hover link-primary fw-semibold">
                                        View Docs
                                        <i class="ti ti-arrow-right bi align-middle fs-lg"></i>
                                    </a>
                                </div>
                                ...
                                <div class="card-body">
                                    <table id="horizontal-scroll" class="table table-striped align-middle mb-0">
                                        <thead class="thead-sm text-uppercase fs-xxs">
                                            <tr>
                                                <th>Company</th>
                                                <th>Symbol</th>
...
<script src="{{ asset('admin/assets/js/app.js') }}"></script>
        ...
        <!-- Page js -->
        <script src="{{ asset('admin/assets/js/pages/datatables-scroll.js') }}"></script>
    </body>

<!-- Mirrored from coderthemes.com/paces/bootstrap/tables-datatables-scroll.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 10:00:00 GMT -->
</html>
