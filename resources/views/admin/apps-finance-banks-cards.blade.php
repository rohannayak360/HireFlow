...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-finance-banks-cards.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:33 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Banks & cards | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Banks & cards</h4>
                        </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-12 d-flex justify-content-between align-items-center mb-3">
                                            ...
                                            <button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#addBankModal"><i class="ti ti-plus me-1"></i> Add Bank</button>
                                        </div>
                                                    ...
                                                    <div class="d-flex gap-3">
                                                        ...
                                                        <div>
                                                            ...
                                                            <ul class="list-unstyled mb-0">
                                                                <li><strong class="text-muted">Account Holder:</strong> John Doe</li>
                                                                <li><strong class="text-muted">Account No:</strong> 1234 5678 2045</li>
                                                                <li><strong class="text-muted">Account Type:</strong> Checking</li>
                                                                <li><strong class="text-muted">Branch:</strong> New York Downtown</li>
                                                            </ul>
                                                            <div class="mt-3">
                                                ...
                                                <div class="card-body d-flex justify-content-between">
                                                    <div class="d-flex gap-3">
                                                        ...
                                                        <div>
                                                            ...
                                                            <ul class="list-unstyled mb-0">
                                                                <li><strong class="text-muted">Account Holder:</strong> Emily Smith</li>
                                                                <li><strong class="text-muted">Account No:</strong> 9876 5432 1089</li>
                                                                <li><strong class="text-muted">Account Type:</strong> Savings</li>
                                                                <li><strong class="text-muted">Branch:</strong> Los Angeles Central</li>
                                                            </ul>
                                                            <div class="mt-3">
                                                                <button class="btn btn-sm btn-default">Edit</button>
                                                                <button class="btn btn-sm btn-default">Delete</button>
                                                ...
                                                <div class="card-body d-flex justify-content-between">
                                                    <div class="d-flex gap-3">
                                                        ...
                                                        <div>
                                                            ...
                                                            <ul class="list-unstyled mb-0">
                                                                <li><strong class="text-muted">Account Holder:</strong> Michael Johnson</li>
                                                                <li><strong class="text-muted">Account No:</strong> 4455 2299 6574</li>
                                                                <li><strong class="text-muted">Account Type:</strong> Business</li>
                                                                <li><strong class="text-muted">Branch:</strong> Chicago West Loop</li>
                                                            </ul>
                                                            <div class="mt-3">
                                                                <button class="btn btn-sm btn-default">Edit</button>
                                                                <button class="btn btn-sm btn-default">Delete</button>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 d-flex justify-content-between align-items-center mb-3">
                                            ...
                                            <button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#addCardModal"><i class="ti ti-plus me-1"></i> Add Card</button>
                                        </div>
                                            ...
                                            <div class="card border border-dashed shadow-none">
                                                <div class="card-body">
                                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                                        <img src="{{ asset('admin/assets/images/cards/visa.svg') }}" alt="Visa" height="36" />
                                        ...
                                        <div class="col-md-6 col-xxl-3">
                                            <div class="card border border-dashed shadow-none">
                                                <div class="card-body">
                                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                                        <img src="{{ asset('admin/assets/images/cards/mastercard.svg') }}" alt="MasterCard" height="36" />
                                                        <span class="badge bg-success-subtle text-success">Active</span>
                                                    </div>
                                        ...
                                        <div class="col-md-6 col-xxl-3">
                                            <div class="card border border-dashed shadow-none">
                                                <div class="card-body">
                                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                                        <img src="{{ asset('admin/assets/images/cards/american-express.svg') }}" alt="American Express" height="36" />
                                        ...
                                        <div class="col-md-6 col-xxl-3">
                                            <div class="card border border-dashed shadow-none">
                                                <div class="card-body">
                                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                                        <img src="{{ asset('admin/assets/images/cards/discover-card.svg') }}" alt="Discover" height="36" />
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form id="bankForm">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" placeholder="Enter balance amount" required />
                                        </div>
                                ...
                                <div class="modal-footer border-0 pt-0">
                                    ...
                                    <button type="submit" form="bankForm" class="btn btn-primary">Save Bank</button>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="modal-body">
                                    <form id="cardForm">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" placeholder="Enter card holder name" required />
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" data-provider="flatpickr" data-date-format="M, Y" class="form-control" required />
                                        </div>
