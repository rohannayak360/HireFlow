...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-invoice-create.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:24 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Create Invoice | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Create Invoice</h4>
                        </div>
                                            ...
                                            <div class="card-body p-4">
                                                ...
                                                <div class="d-flex justify-content-between align-items-center mb-4">
                                                    ...
                                                    <div class="border rounded position-relative d-flex text-center align-items-center justify-content-between px-2" style="height: 60px; width: 260px">
                                                        ...
                                                        <img id="preview" src="{{ asset('admin/assets/images/logo-black.png') }}" alt="Company Logo" height="28" />
                                                        <i class="ti ti-cloud-upload fs-xxl text-muted" role="button"></i>
                                                    </div>
                                                ...
                                                <div class="table-responsive mt-4">
                                                    ...
                                                    <button type="button" class="btn btn-primary mt-2"><i class="ti ti-plus me-1"></i> Add Item</button>
                                                </div>
...
<script src="{{ asset('admin/assets/js/app.js') }}"></script>
        ...
        <script src="{{ asset('admin/assets/js/pages/apps-create-invoice.js') }}"></script>
    </body>

<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-invoice-create.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:25 GMT -->
</html>
