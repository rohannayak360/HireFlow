...
<!-- Mirrored from coderthemes.com/paces/bootstrap/charts-chartjs-other.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:59:38 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Other Charts | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Other Charts</h4>
                        </div>
...
<script src="{{ asset('admin/assets/js/app.js') }}"></script>
        ...
        <!-- Area chart Demo js -->
        <script src="{{ asset('admin/assets/js/pages/chartjs-other.js') }}"></script>
    </body>

<!-- Mirrored from coderthemes.com/paces/bootstrap/charts-chartjs-other.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:59:39 GMT -->
</html>
