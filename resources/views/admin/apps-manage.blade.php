...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-manage.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:46 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Manage Apps | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Manage Apps</h4>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <p class="text-muted">
                                ...
                                <a href="#" class="text-decoration-underline">PRO</a>
                                ...
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-start mb-3">
                                        ...
                                        <div class="d-flex align-items-center gap-3">
                                            <img src="{{ asset('admin/assets/images/logos/google.svg') }}" alt="Google Analytics Logo" width="48" height="48" class="rounded" />
                                            <div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-start mb-3">
                                        <!-- Logo + Title -->
                                        <div class="d-flex align-items-center gap-3">
                                            <img src="{{ asset('admin/assets/images/logos/asana.svg') }}" alt="Asana Logo" width="48" height="48" class="rounded" />
                                            <div>
                                        ...
                                        <!-- Toggle Switch -->
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" id="asanaToggle" checked />
                                        </div>
                                    </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-start mb-3">
                                        <!-- Logo + Title -->
                                        <div class="d-flex align-items-center gap-3">
                                            <img src="{{ asset('admin/assets/images/logos/dropbox.svg') }}" alt="Dropbox Logo" width="48" height="48" class="rounded" />
                                            <div>
                                        ...
                                        <!-- Toggle Switch -->
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" id="dropboxToggle" checked />
                                        </div>
                                    </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        <span class="avatar-xl d-block mb-1">
                                            <span class="avatar-title bg-light bg-opacity-75 rounded">
                                                <img src="{{ asset('admin/assets/images/logos/amazon.svg') }}" alt="Amazon Logo" height="30" />
                                            </span>
                                        </span>
                                    ...
                                    <div class="mb-3 d-flex align-items-center gap-1">
                                        ...
                                        <a href="#!" class="link-reset">www.amazon.com</a>
                                    </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        <span class="avatar-xl d-block mb-1">
                                            <span class="avatar-title bg-light bg-opacity-75 rounded">
                                                <img src="{{ asset('admin/assets/images/logos/figma.svg') }}" alt="Figma Logo" height="30" />
                                            </span>
                                        </span>
                                    ...
                                    <div class="mb-3 d-flex align-items-center gap-1">
                                        <i class="ti ti-world"></i>
                                        <a href="#!" class="link-reset">www.figma.com</a>
                                    </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        <span class="avatar-xl d-block mb-1">
                                            <span class="avatar-title bg-light bg-opacity-75 rounded">
                                                <img src="{{ asset('admin/assets/images/logos/microsoft.svg') }}" alt="Microsoft Logo" height="30" />
                                            </span>
                                        </span>
                                        <span class="badge badge-label text-bg-warning">
                                            <i class="ti ti-medal"></i>
                                    ...
                                    <div class="mb-3 d-flex align-items-center gap-1">
                                        <i class="ti ti-world"></i>
                                        <a href="#!" class="link-reset">www.microsoft.com</a>
                                    </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        <span class="avatar-xl d-block mb-1">
                                            <span class="avatar-title bg-light bg-opacity-75 rounded">
                                                <img src="{{ asset('admin/assets/images/logos/openai.svg') }}" alt="OpenAI Logo" height="30" />
                                            </span>
                                        </span>
                                        <span class="badge badge-label text-bg-light">Free</span>
                                    </div>
                                    ...
                                    <div class="mb-3 d-flex align-items-center gap-1">
                                        <i class="ti ti-world"></i>
                                        <a href="#!" class="link-reset">www.openai.com</a>
                                    </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        <span class="avatar-xl d-block mb-1">
                                            <span class="avatar-title bg-light bg-opacity-75 rounded">
                                                <img src="{{ asset('admin/assets/images/logos/slack.svg') }}" alt="Slack Logo" height="30" />
                                            </span>
                                        </span>
                                        <span class="badge badge-label text-bg-warning">
                                            <i class="ti ti-medal"></i>
                                    ...
                                    <div class="mb-3 d-flex align-items-center gap-1">
                                        <i class="ti ti-world"></i>
                                        <a href="#!" class="link-reset">www.slack.com</a>
                                    </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        <span class="avatar-xl d-block mb-1">
                                            <span class="avatar-title bg-light bg-opacity-75 rounded">
                                                <img src="{{ asset('admin/assets/images/logos/spotify.svg') }}" alt="Spotify Logo" height="30" />
                                            </span>
                                        </span>
                                        <span class="badge badge-label text-bg-light">Free</span>
                                    </div>
                                    ...
                                    <div class="mb-3 d-flex align-items-center gap-1">
                                        <i class="ti ti-world"></i>
                                        <a href="#!" class="link-reset">www.spotify.com</a>
                                    </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        <span class="avatar-xl d-block mb-1">
                                            <span class="avatar-title bg-light bg-opacity-75 rounded">
                                                <img src="{{ asset('admin/assets/images/logos/meta.svg') }}" alt="Meta Logo" height="24" />
                                            </span>
                                        </span>
                                        <span class="badge badge-label text-bg-warning">
                                            <i class="ti ti-medal"></i>
                                    ...
                                    <div class="mb-3 d-flex align-items-center gap-1">
                                        <i class="ti ti-world"></i>
                                        <a href="#!" class="link-reset">www.meta.com</a>
                                    </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        <span class="avatar-xl d-block mb-1">
                                            <span class="avatar-title bg-light bg-opacity-75 rounded">
                                                <img src="{{ asset('admin/assets/images/logos/apple.svg') }}" alt="Apple Logo" height="30" />
                                            </span>
                                        </span>
                                        <span class="badge badge-label text-bg-light">Free</span>
                                    </div>
                                    ...
                                    <div class="mb-3 d-flex align-items-center gap-1">
                                        <i class="ti ti-world"></i>
                                        <a href="#!" class="link-reset">www.apple.com</a>
                                    </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        <span class="avatar-xl d-block mb-1">
                                            <span class="avatar-title bg-light bg-opacity-75 rounded">
                                                <img src="{{ asset('admin/assets/images/logos/airbnb.svg') }}" alt="Airbnb Logo" height="30" />
                                            </span>
                                        </span>
                                        <span class="badge badge-label text-bg-warning">
                                            <i class="ti ti-medal"></i>
                                    ...
                                    <div class="mb-3 d-flex align-items-center gap-1">
                                        <i class="ti ti-world"></i>
                                        <a href="#!" class="link-reset">www.airbnb.com</a>
                                    </div>
