...
<!-- Mirrored from coderthemes.com/paces/bootstrap/ui-scrollspy.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:59:14 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Scrollspy | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Scrollspy</h4>
                        </div>
                                    ...
                                    <nav id="navbar-example2" class="navbar navbar-light bg-light px-3">
                                        ...
                                        <ul class="nav nav-pills">
                                            ...
                                            <li class="nav-item dropdown">
                                                <a class="nav-link dropdown-toggle drop-arrow-none" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                                                    Dropdown
                                                    <i class="ti ti-chevron-down align-middle"></i>
                                                </a>
                                                <div class="dropdown-menu dropdown-menu-end">
