...
<!-- Mirrored from coderthemes.com/paces/bootstrap/ui-carousel.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:59:11 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Carousel | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Carousel</h4>
                        </div>
                                    ...
                                    <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                                        <div class="carousel-inner" role="listbox">
                                            <div class="carousel-item active">
                                                <!-- First slide -->
                                                <img class="d-block img-fluid" src="{{ asset('admin/assets/images/stock/small-1.jpg') }}" alt="First slide" />
                                            </div>
                                            <div class="carousel-item">
                                                <!-- Second slide -->
                                                <img class="d-block img-fluid" src="{{ asset('admin/assets/images/stock/small-2.jpg') }}" alt="Second slide" />
                                            </div>
                                            <div class="carousel-item">
                                                <!-- Third slide -->
                                                <img class="d-block img-fluid" src="{{ asset('admin/assets/images/stock/small-3.jpg') }}" alt="Third slide" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                                        <div class="carousel-inner" role="listbox">
                                            <div class="carousel-item active">
                                                <!-- First slide -->
                                                <img class="d-block img-fluid" src="{{ asset('admin/assets/images/stock/small-4.jpg') }}" alt="First slide" />
                                            </div>
                                            <div class="carousel-item">
                                                <!-- Second slide -->
                                                <img class="d-block img-fluid" src="{{ asset('admin/assets/images/stock/small-1.jpg') }}" alt="Second slide" />
                                            </div>
                                            <div class="carousel-item">
                                                <!-- Third slide -->
                                                <img class="d-block img-fluid" src="{{ asset('admin/assets/images/stock/small-2.jpg') }}" alt="Third slide" />
                                            </div>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                                        ...
                                        <div class="carousel-inner" role="listbox">
                                            <div class="carousel-item active">
                                                <!-- First slide -->
                                                <img class="d-block img-fluid" src="{{ asset('admin/assets/images/stock/small-3.jpg') }}" alt="First slide" />
                                            </div>
                                            <div class="carousel-item">
                                                <!-- Second slide -->
                                                <img class="d-block img-fluid" src="{{ asset('admin/assets/images/stock/small-2.jpg') }}" alt="Second slide" />
                                            ...
                                            <div class="carousel-item">
                                                <!-- Third slide -->
                                                <img class="d-block img-fluid" src="{{ asset('admin/assets/images/stock/small-1.jpg') }}" alt="Third slide" />
                                            </div>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div id="carouselExampleCaption" class="carousel slide" data-bs-ride="carousel">
                                        <div class="carousel-inner" role="listbox">
                                            <div class="carousel-item active">
                                                <!-- first slide  -->
                                                <img src="{{ asset('admin/assets/images/stock/small-1.jpg') }}" alt="..." class="d-block img-fluid" />
                                            ...
                                            <div class="carousel-item">
                                                <!-- secound slide  -->
                                                <img src="{{ asset('admin/assets/images/stock/small-3.jpg') }}" alt="..." class="d-block img-fluid" />
                                                <div class="carousel-caption d-none d-md-block">
                                            ...
                                            <div class="carousel-item">
                                                <!-- third slide  -->
                                                <img src="{{ asset('admin/assets/images/stock/small-2.jpg') }}" alt="..." class="d-block img-fluid" />
                                                <div class="carousel-caption d-none d-md-block">
                                    ...
                                    <div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel">
                                        <div class="carousel-inner">
                                            <div class="carousel-item active" data-bs-interval="1000">
                                                <!-- First slide -->
                                                <img src="{{ asset('admin/assets/images/stock/small-4.jpg') }}" class="img-fluid d-block w-100" alt="First slide" />
                                            </div>
                                            <div class="carousel-item" data-bs-interval="2000">
                                                <!-- Second slide -->
                                                <img src="{{ asset('admin/assets/images/stock/small-2.jpg') }}" class="img-fluid d-block w-100" alt="Second slide" />
                                            </div>
                                            <div class="carousel-item">
                                                <!-- Third slide -->
                                                <img src="{{ asset('admin/assets/images/stock/small-1.jpg') }}" class="img-fluid d-block w-100" alt="Third slide" />
                                            </div>
                                        </div>
                                    ...
                                    <div id="carouselExampleDark" class="carousel carousel-dark slide">
                                        ...
                                        <div class="carousel-inner">
                                            <div class="carousel-item active" data-bs-interval="10000">
                                                <!-- first slide  -->
                                                <img src="{{ asset('admin/assets/images/stock/small-8.jpg') }}" class="img-fluid" alt="Images" />
                                                <div class="carousel-caption d-none d-md-block">
                                            ...
                                            <div class="carousel-item" data-bs-interval="2000">
                                                <!-- secound slide  -->
                                                <img src="{{ asset('admin/assets/images/stock/small-9.jpg') }}" class="img-fluid" alt="Images" />
                                                <div class="carousel-caption d-none d-md-block">
                                            ...
                                            <div class="carousel-item">
                                                <!-- third slide  -->
                                                <img src="{{ asset('admin/assets/images/stock/small-10.jpg') }}" class="img-fluid" alt="Images" />
                                                <div class="carousel-caption d-none d-md-block">
...
<!-- Mirrored from coderthemes.com/paces/bootstrap/ui-carousel.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:59:12 GMT -->
</html>
