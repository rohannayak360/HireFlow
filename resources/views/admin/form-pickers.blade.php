...
<!-- Mirrored from coderthemes.com/paces/bootstrap/form-pickers.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:59:41 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Form Picker | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
        ...
        <link rel="stylesheet" href="{{ asset('admin/assets/plugins/pickr/classic.min.css') }}" />
        <!-- 'classic' theme -->
        <link rel="stylesheet" href="{{ asset('admin/assets/plugins/pickr/monolith.min.css') }}" />
        <!-- 'monolith' theme -->
        <link rel="stylesheet" href="{{ asset('admin/assets/plugins/pickr/nano.min.css') }}" />
        <!-- 'nano' theme -->
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Pickers</h4>
                        </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="position-relative">
                                                <div id="reportrange" class="form-control" data-toggle="date-picker-range" data-target-display="#selectedValue" data-cancel-class="btn-light">
                                                    <i class="ti ti-calendar me-2 align-middle fs-16"></i>
...
<script src="{{ asset('admin/assets/js/app.js') }}"></script>
        ...
        <script src="{{ asset('admin/assets/js/pages/form-date-range-picker.js') }}"></script>

        <!-- Colorpicker Plugin Js -->
        <script src="{{ asset('admin/assets/plugins/pickr/pickr.min.js') }}"></script>

        <!-- Color Picker Demo Js -->
        <script src="{{ asset('admin/assets/js/pages/form-colorpickr.js') }}"></script>
    </body>

<!-- Mirrored from coderthemes.com/paces/bootstrap/form-pickers.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:59:43 GMT -->
</html>
