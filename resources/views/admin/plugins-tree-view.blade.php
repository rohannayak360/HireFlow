...
<!-- Mirrored from coderthemes.com/paces/bootstrap/plugins-tree-view.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:59 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Treeview | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
        ...
        <!-- Treeview css-->
        <link href="{{ asset('admin/assets/plugins/jstree/style.min.css') }}" rel="stylesheet" type="text/css" />
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Treeview</h4>
                        </div>
...
<script src="{{ asset('admin/assets/js/app.js') }}"></script>
        ...
        <!-- Jquery Required for Treeview plugin-->
        ...
        <!-- Treeviw Page Js -->
        <script src="{{ asset('admin/assets/js/pages/plugins-treeview.js') }}"></script>
    </body>

<!-- Mirrored from coderthemes.com/paces/bootstrap/plugins-tree-view.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:59:01 GMT -->
</html>
