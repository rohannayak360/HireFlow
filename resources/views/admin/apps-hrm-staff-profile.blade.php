...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-hrm-staff-profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:35 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Staff Profile | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Staff Profile</h4>
                        </div>
                        ...
                        <div class="row">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-center gap-2 mb-2">
                                            ...
                                            <p class="mb-0 fs-sm">
                                                Email
                                                <a href="mailto:yogesh&#64;company.com" class="text-primary fw-semibold">emp2045&#64;company.com</a>
                                            </p>
                                        </div>
                                        <div class="d-flex align-items-center gap-2 mb-2">
                                            <div class="avatar-sm bg-light d-flex align-items-center justify-content-center rounded">
                            ...
                            <div class="col-xl-8">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <p class="m-0">
                                            <strong>Alex Johnson</strong> is a passionate and results-driven <span class="text-primary fw-semibold">Project Manager</span> with over 6 years of experience in managing cross-functional teams and delivering projects on time and within
                                            budget. Alex specializes in planning, process optimization, and team leadership across multiple domains.
                                        </p>
                                        <p class="mt-3 mb-0">
