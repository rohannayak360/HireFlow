...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-ticket-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:37 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Support Tickets | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Tickets</h4>
                        </div>
                        ...
                        <div class="col">
                            <div class="card mb-2">
                                <div class="card-body">
                                    <div class="d-flex gap-3">
                                        <div class="avatar-lg rounded-circle bg-primary-subtle text-primary d-flex align-items-center justify-content-center">
                                            <i class="ti ti-alert-circle fs-xxl"></i>
                                        </div>
                                        <div class="flex-grow-1">
                                            <div class="mb-2 d-flex justify-content-between align-items-center">
                            ...
                            <div data-table data-table-rows-per-page="8" class="card">
                                <div class="card-header border-light justify-content-between">
                                    <div class="d-flex gap-2">
                                        ...
                                        <a href="{{ url('admin/apps-ticket-create') }}" class="btn btn-primary"> <i class="ti ti-plus me-1"></i> New Ticket </a>
                                        ...
                                        <table class="table table-custom table-centered table-select table-hover w-100 mb-0">
                                            ...
                                            <tbody class="text-nowrap">
                                                <tr>
                                                    ...
                                                    <td><a href="{{ url('admin/apps-ticket-details') }}" class="fw-semibold link-reset">#SUP-2451</a></td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <div class="d-flex gap-2 align-items-center">
                                                            <img src="{{ asset('admin/assets/images/users/user-2.jpg') }}" alt="Agent" class="avatar-xs rounded-circle" />
                                                    ...
                                                    <td>
                                                        <div class="d-flex justify-content-center gap-1">
                                                            <a href="{{ url('admin/apps-ticket-details') }}" class="btn btn-default btn-icon btn-sm"><i class="ti ti-eye fs-lg"></i></a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="{{ url('admin/apps-ticket-details') }}" class="fw-semibold link-reset">#SUP-2517</a></td>
                                                    <td>
                                                        <div class="d-flex gap-2 align-items-center">
                                                            <img src="{{ asset('admin/assets/images/users/user-9.jpg') }}" alt="Lucas Graham" class="avatar-xs rounded-circle" />
                                                    ...
                                                    <td>
                                                        <div class="d-flex gap-2 align-items-center">
                                                            <img src="{{ asset('admin/assets/images/users/user-1.jpg') }}" alt="Agent" class="avatar-xs rounded-circle" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="{{ url('admin/apps-ticket-details') }}" class="fw-semibold link-reset">#SUP-2518</a></td>
                                                    <td>
                                                        <div class="d-flex gap-2 align-items-center">
                                                            <img src="{{ asset('admin/assets/images/users/user-4.jpg') }}" alt="Nina Patel" class="avatar-xs rounded-circle" />
                                                    ...
                                                    <td>
                                                        <div class="d-flex gap-2 align-items-center">
                                                            <img src="{{ asset('admin/assets/images/users/user-8.jpg') }}" alt="Agent" class="avatar-xs rounded-circle" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="{{ url('admin/apps-ticket-details') }}" class="fw-semibold link-reset">#SUP-2519</a></td>
                                                    <td>
                                                        <div class="d-flex gap-2 align-items-center">
                                                            <img src="{{ asset('admin/assets/images/users/user-6.jpg') }}" alt="Michael Foster" class="avatar-xs rounded-circle" />
                                                    ...
                                                    <td>
                                                        <div class="d-flex gap-2 align-items-center">
                                                            <img src="{{ asset('admin/assets/images/users/user-5.jpg') }}" alt="Agent" class="avatar-xs rounded-circle" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="{{ url('admin/apps-ticket-details') }}" class="fw-semibold link-reset">#SUP-2520</a></td>
                                                    <td>
                                                        <div class="d-flex gap-2 align-items-center">
                                                            <img src="{{ asset('admin/assets/images/users/user-7.jpg') }}" alt="Isabella Reed" class="avatar-xs rounded-circle" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="{{ url('admin/apps-ticket-details') }}" class="fw-semibold link-reset">#SUP-2521</a></td>
                                                    <td>
                                                        <div class="d-flex gap-2 align-items-center">
                                                            <img src="{{ asset('admin/assets/images/users/user-1.jpg') }}" alt="Olivia White" class="avatar-xs rounded-circle" />
                                                    ...
                                                    <td>
                                                        <div class="d-flex gap-2 align-items-center">
                                                            <img src="{{ asset('admin/assets/images/users/user-9.jpg') }}" alt="Agent" class="avatar-xs rounded-circle" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="{{ url('admin/apps-ticket-details') }}" class="fw-semibold link-reset">#SUP-2522</a></td>
                                                    <td>
                                                        <div class="d-flex gap-2 align-items-center">
                                                            <img src="{{ asset('admin/assets/images/users/user-10.jpg') }}" alt="Emma King" class="avatar-xs rounded-circle" />
                                                            <span>Emma King</span>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <div class="d-flex gap-2 align-items-center">
                                                            <img src="{{ asset('admin/assets/images/users/user-3.jpg') }}" alt="Agent" class="avatar-xs rounded-circle" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="{{ url('admin/apps-ticket-details') }}" class="fw-semibold link-reset">#SUP-2523</a></td>
                                                    <td>
                                                        <div class="d-flex gap-2 align-items-center">
                                                            <img src="{{ asset('admin/assets/images/users/user-1.jpg') }}" alt="Ava Sullivan" class="avatar-xs rounded-circle" />
                                                    ...
                                                    <td>
                                                        <div class="d-flex gap-2 align-items-center">
                                                            <img src="{{ asset('admin/assets/images/users/user-4.jpg') }}" alt="Agent" class="avatar-xs rounded-circle" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="{{ url('admin/apps-ticket-details') }}" class="fw-semibold link-reset">#SUP-2524</a></td>
                                                    <td>
                                                        <div class="d-flex gap-2 align-items-center">
                                                            <img src="{{ asset('admin/assets/images/users/user-3.jpg') }}" alt="Sophie Bennett" class="avatar-xs rounded-circle" />
                                                    ...
                                                    <td>
                                                        <div class="d-flex gap-2 align-items-center">
                                                            <img src="{{ asset('admin/assets/images/users/user-6.jpg') }}" alt="Agent" class="avatar-xs rounded-circle" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="{{ url('admin/apps-ticket-details') }}" class="fw-semibold link-reset">#SUP-2525</a></td>
                                                    <td>
                                                        <div class="d-flex gap-2 align-items-center">
                                                            <img src="{{ asset('admin/assets/images/users/user-4.jpg') }}" alt="Noah Allen" class="avatar-xs rounded-circle" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="{{ url('admin/apps-ticket-details') }}" class="fw-semibold link-reset">#SUP-2526</a></td>
                                                    <td>
                                                        <div class="d-flex gap-2 align-items-center">
                                                            <img src="{{ asset('admin/assets/images/users/user-5.jpg') }}" alt="Ethan James" class="avatar-xs rounded-circle" />
                                                    ...
                                                    <td>
                                                        <div class="d-flex gap-2 align-items-center">
                                                            <img src="{{ asset('admin/assets/images/users/user-7.jpg') }}" alt="Agent" class="avatar-xs rounded-circle" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="{{ url('admin/apps-ticket-details') }}" class="fw-semibold link-reset">#SUP-2527</a></td>
                                                    <td>
                                                        <div class="d-flex gap-2 align-items-center">
                                                            <img src="{{ asset('admin/assets/images/users/user-8.jpg') }}" alt="Grace Carter" class="avatar-xs rounded-circle" />
...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-ticket-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:38 GMT -->
</html>
