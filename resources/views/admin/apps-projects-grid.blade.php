...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-projects-grid.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:21 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Projects | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                                ...
                                <div class="row gap-3">
                                    ...
                                    <div class="col-auto">
                                        <div class="d-flex gap-1">
                                            <a href="{{ url('admin/apps-projects-grid') }}" class="btn btn-primary btn-icon">
                                                <i class="ti ti-category fs-lg"></i>
                                            </a>
                                            <a href="{{ url('admin/apps-projects-list') }}" class="btn btn-soft-primary btn-icon">
                                ...
                                <div class="card-body d-flex flex-column">
                                        ...
                                        <div class="flex-grow-1">
                                            <div class="d-flex align-items-start gap-2">
                                                <h5 class="mb-1 lh-sm flex-grow-1">
                                                    <a href="{{ url('admin/apps-projects-details') }}" class="link-reset">AI Analytics Dashboard</a>
                                                </h5>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="avatar-group avatar-group-xs">
                                            <div class="avatar"><img src="{{ asset('admin/assets/images/users/user-2.jpg') }}" alt="" class="rounded-circle avatar-xs" /></div>
                                            <div class="avatar"><img src="{{ asset('admin/assets/images/users/user-3.jpg') }}" alt="" class="rounded-circle avatar-xs" /></div>
                                            <div class="avatar"><img src="{{ asset('admin/assets/images/users/user-5.jpg') }}" alt="" class="rounded-circle avatar-xs" /></div>
                                            <div class="avatar"><img src="{{ asset('admin/assets/images/users/user-1.jpg') }}" alt="" class="rounded-circle avatar-xs" /></div>
                                        </div>
                                    </div>
                                ...
                                <div class="card-body d-flex flex-column">
                                    ...
                                    <div class="d-flex align-items-start border-bottom border-dashed pb-3 mb-3">
                                        ...
                                        <div class="flex-grow-1">
                                            <div class="d-flex align-items-start gap-2">
                                                <h5 class="mb-1 lh-sm flex-grow-1">
                                                    <a href="{{ url('admin/apps-projects-details') }}" class="link-reset">CRM Web Platform for Club</a>
                                                </h5>
                                    ...
                                    <div class="mb-3">
                                        <p class="my-2 text-muted fw-semibold fs-xs">Team Members</p>
                                        <div class="avatar-group avatar-group-xs">
                                            <div class="avatar"><img src="{{ asset('admin/assets/images/users/user-4.jpg') }}" class="rounded-circle avatar-xs" /></div>
                                            <div class="avatar"><img src="{{ asset('admin/assets/images/users/user-6.jpg') }}" class="rounded-circle avatar-xs" /></div>
                                            <div class="avatar"><img src="{{ asset('admin/assets/images/users/user-8.jpg') }}" class="rounded-circle avatar-xs" /></div>
                                        </div>
                                    </div>
                                ...
                                <div class="card-body d-flex flex-column">
                                    <div class="d-flex align-items-start border-bottom border-dashed pb-3 mb-3">
                                        ...
                                        <div class="flex-grow-1">
                                            <div class="d-flex align-items-start gap-2">
                                                <h5 class="mb-1 lh-sm flex-grow-1">
                                                    <a href="{{ url('admin/apps-projects-details') }}" class="link-reset">E-Commerce Mobile App</a>
                                                </h5>
                                        ...
                                        <div class="ms-2">
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li>
                                                        <a class="dropdown-item"><i class="ti ti-share me-2"></i>Share</a>
                                                    </li>
                                                    <li>
                                                        <a class="dropdown-item"><i class="ti ti-edit me-2"></i>Edit</a>
                                                    </li>
                                                    <li>
                                                        <a class="dropdown-item"><i class="ti ti-ban me-2"></i>Block</a>
                                                    </li>
                                                    <li>
                                                        <a class="dropdown-item text-danger"><i class="ti ti-trash me-2"></i>Delete</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <div class="mb-3">
                                        <p class="my-2 text-muted fw-semibold fs-xs">Team Members</p>
                                        <div class="avatar-group avatar-group-xs">
                                            <div class="avatar"><img src="{{ asset('admin/assets/images/users/user-9.jpg') }}" class="rounded-circle avatar-xs" /></div>
                                            <div class="avatar"><img src="{{ asset('admin/assets/images/users/user-7.jpg') }}" class="rounded-circle avatar-xs" /></div>
                                            <div class="avatar"><img src="{{ asset('admin/assets/images/users/user-10.jpg') }}" class="rounded-circle avatar-xs" /></div>
                                        </div>
                                    </div>
                                ...
                                <div class="card-body d-flex flex-column">
                                    <div class="d-flex align-items-start border-bottom border-dashed pb-3 mb-3">
                                        ...
                                        <div class="flex-grow-1">
                                            <div class="d-flex align-items-start gap-2">
                                                <h5 class="mb-1 lh-sm flex-grow-1">
                                                    <a href="{{ url('admin/apps-projects-details') }}" class="link-reset">HR Employee Portal - Web & Mobile</a>
                                                </h5>
                                    ...
                                    <div class="mb-3">
                                        <p class="my-2 text-muted fw-semibold fs-xs">Team Members</p>
                                        <div class="avatar-group avatar-group-xs">
                                            <div class="avatar"><img src="{{ asset('admin/assets/images/users/user-1.jpg') }}" class="rounded-circle avatar-xs" /></div>
                                            <div class="avatar"><img src="{{ asset('admin/assets/images/users/user-4.jpg') }}" class="rounded-circle avatar-xs" /></div>
                                            <div class="avatar"><img src="{{ asset('admin/assets/images/users/user-9.jpg') }}" class="rounded-circle avatar-xs" /></div>
                                        </div>
                                    </div>
                                ...
                                <div class="card-body d-flex flex-column">
                                    <div class="d-flex align-items-start border-bottom border-dashed pb-3 mb-3">
                                        ...
                                        <div class="flex-grow-1">
                                            <div class="d-flex align-items-start gap-2">
                                                <h5 class="mb-1 lh-sm flex-grow-1">
                                                    <a href="{{ url('admin/apps-projects-details') }}" class="link-reset">SaaS Billing System - Starbucks</a>
                                                </h5>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="avatar-group avatar-group-xs">
                                            <div class="avatar"><img src="{{ asset('admin/assets/images/users/user-6.jpg') }}" class="rounded-circle avatar-xs" /></div>
                                            <div class="avatar"><img src="{{ asset('admin/assets/images/users/user-3.jpg') }}" class="rounded-circle avatar-xs" /></div>
                                            <div class="avatar"><img src="{{ asset('admin/assets/images/users/user-7.jpg') }}" class="rounded-circle avatar-xs" /></div>
                                            <div class="avatar"><img src="{{ asset('admin/assets/images/users/user-2.jpg') }}" class="rounded-circle avatar-xs" /></div>
                                        </div>
                                    </div>
                            ...
                            <div class="card">
                                <div class="card-body d-flex flex-column">
                                    <div class="d-flex align-items-start border-bottom border-dashed pb-3 mb-3">
                                        ...
                                        <div class="flex-grow-1">
                                            <div class="d-flex align-items-start gap-2">
                                                <h5 class="mb-1 lh-sm flex-grow-1"><a href="#" class="link-reset">Learning Management System</a></h5>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="avatar-group avatar-group-xs">
                                            <div class="avatar"><img src="{{ asset('admin/assets/images/users/user-3.jpg') }}" class="rounded-circle avatar-xs" /></div>
                                            <div class="avatar"><img src="{{ asset('admin/assets/images/users/user-8.jpg') }}" class="rounded-circle avatar-xs" /></div>
                                            <div class="avatar"><img src="{{ asset('admin/assets/images/users/user-5.jpg') }}" class="rounded-circle avatar-xs" /></div>
                                        </div>
                                    </div>
                                ...
                                <div class="card-body d-flex flex-column">
                                    <div class="d-flex align-items-start border-bottom border-dashed pb-3 mb-3">
                                        ...
                                        <div class="flex-grow-1">
                                            <div class="d-flex align-items-start gap-2">
                                                <h5 class="mb-1 lh-sm flex-grow-1">
                                                    <a href="{{ url('admin/apps-projects-details') }}" class="link-reset">Warehouse Inventory System</a>
                                                </h5>
                                ...
                                <div class="card-body d-flex flex-column">
                                    <div class="d-flex align-items-start border-bottom border-dashed pb-3 mb-3">
                                        ...
                                        <div class="flex-grow-1">
                                            <div class="d-flex align-items-start gap-2">
                                                <h5 class="mb-1 lh-sm flex-grow-1">
                                                    <a href="{{ url('admin/apps-projects-details') }}" class="link-reset">Fitness Tracker App - Tracky</a>
                                                </h5>
