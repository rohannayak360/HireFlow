...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-crm-activities.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:30 GMT -->
<head>
        <meta charset="utf-8" />
        <title>CRM Activities | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Activities</h4>
                        </div>
                                    ...
                                    <div class="timeline timeline-icon-bordered">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="timeline-item d-flex align-items-start">
                                                ...
                                                <div class="timeline-dot">
                                                    <i class="ti ti-phone-call fs-xl text-success"></i>
                                                </div>
                                                <div class="timeline-content ps-3 pb-4">
                                                    <p class="mb-1">
