...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-crm-opportunities.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:25 GMT -->
<head>
        <meta charset="utf-8" />
        <title>CRM Opportunities | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Opportunities</h4>
                        </div>
                                ...
                                <div class="card-header border-light justify-content-between">
                                    ...
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <div class="app-search">
                                            ...
                                            <i class="ti ti-alert-circle app-search-icon text-muted"></i>
                                        </div>
                                            ...
                                            <tbody class="text-nowrap">
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar-sm me-2">
                                                                <img src="{{ asset('admin/assets/images/users/user-1.jpg') }}" alt="Product" class="img-fluid rounded-circle" />
                                                            </div>
                                                            <div>
                                                                <p class="mb-0 fw-medium">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar-sm flex-shrink-0 border border-dashed rounded me-2 justify-content-center d-flex align-items-center">
                                                                <img src="{{ asset('admin/assets/images/logos/microsoft.svg') }}" alt="Product" height="20" />
                                                            </div>
                                                            <div>
                                                                <p class="mb-0 fw-medium">
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar-sm me-2">
                                                                <img src="{{ asset('admin/assets/images/users/user-2.jpg') }}" alt="Product" class="img-fluid rounded-circle" />
                                                            </div>
                                                            <div>
                                                                <p class="mb-0 fw-medium">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar-sm me-2">
                                                                <img src="{{ asset('admin/assets/images/users/user-5.jpg') }}" alt="Product" class="img-fluid rounded-circle" />
                                                            </div>
                                                            <div>
                                                                <p class="mb-0 fw-medium">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div>
                                                                <p class="mb-0 fw-medium">
                                                                    <a href="#!" class="link-reset">Retail Insights Pro</a>
                                                                </p>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar-sm me-2">
                                                                <img src="{{ asset('admin/assets/images/users/user-3.jpg') }}" alt="User" class="img-fluid rounded-circle" />
                                                            </div>
                                                            <div>
                                                                <p class="mb-0 fw-medium">
                                                                    <a href="#!" class="link-reset">Meena Roy</a>
                                                                </p>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div>
                                                                <p class="mb-0 fw-medium">
                                                                    <a href="#!" class="link-reset">AI Compute Suite</a>
                                                                </p>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar-sm me-2">
                                                                <img src="{{ asset('admin/assets/images/users/user-7.jpg') }}" alt="User" class="img-fluid rounded-circle" />
                                                            </div>
                                                            <div>
                                                                <p class="mb-0 fw-medium">
                                                                    <a href="#!" class="link-reset">Kabir Shah</a>
                                                                </p>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div>
                                                                <p class="mb-0 fw-medium">
                                                                    <a href="#!" class="link-reset">Ad Manager Pro</a>
                                                                </p>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar-sm me-2">
                                                                <img src="{{ asset('admin/assets/images/users/user-4.jpg') }}" alt="User" class="img-fluid rounded-circle" />
                                                            </div>
                                                            <div>
                                                                <p class="mb-0 fw-medium">
                                                                    <a href="#!" class="link-reset">Sana Iqbal</a>
                                                                </p>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div>
                                                                <p class="mb-0 fw-medium">
                                                                    <a href="#!" class="link-reset">TeamCollab Enterprise</a>
                                                                </p>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar-sm me-2">
                                                                <img src="{{ asset('admin/assets/images/users/user-6.jpg') }}" alt="User" class="img-fluid rounded-circle" />
                                                            </div>
                                                            <div>
                                                                <p class="mb-0 fw-medium">
                                                                    <a href="#!" class="link-reset">Jatin Desai</a>
                                                                </p>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div>
                                                                <p class="mb-0 fw-medium">
                                                                    <a href="#!" class="link-reset">Virtual Events Suite</a>
                                                                </p>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar-sm me-2">
                                                                <img src="{{ asset('admin/assets/images/users/user-8.jpg') }}" alt="User" class="img-fluid rounded-circle" />
                                                            </div>
                                                            <div>
                                                                <p class="mb-0 fw-medium">
                                                                    <a href="#!" class="link-reset">Lina George</a>
                                                                </p>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar-sm flex-shrink-0 border border-dashed rounded me-2 justify-content-center d-flex align-items-center">
                                                                <img src="{{ asset('admin/assets/images/logos/starbucks.svg') }}" alt="Product" height="20" />
                                                            </div>
                                                            <div>
                                                                <p class="mb-0 fw-medium">
                                                                    <a href="#!" class="link-reset">Streamlytics Dashboard</a>
                                                                </p>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar-sm me-2">
                                                                <img src="{{ asset('admin/assets/images/users/user-10.jpg') }}" alt="User" class="img-fluid rounded-circle" />
                                                            </div>
                                                            <div>
                                                                <p class="mb-0 fw-medium">
                                                                    <a href="#!" class="link-reset">Ravi Khanna</a>
                                                                </p>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div>
                                                                <p class="mb-0 fw-medium">
                                                                    <a href="#!" class="link-reset">Hospitality CRM Suite</a>
                                                                </p>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar-sm me-2">
                                                                <img src="{{ asset('admin/assets/images/users/user-9.jpg') }}" alt="User" class="img-fluid rounded-circle" />
                                                            </div>
                                                            <div>
                                                                <p class="mb-0 fw-medium">
                                                                    <a href="#!" class="link-reset">Isabella Wang</a>
                                                                </p>
...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-crm-opportunities.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:27 GMT -->
</html>
