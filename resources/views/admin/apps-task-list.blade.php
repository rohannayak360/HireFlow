...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-task-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:23 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Tasks | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Tasks</h4>
                        </div>
                            ...
                            <div data-table data-table-rows-per-page="8" class="card">
                                <div class="card-header border-light justify-content-between">
                                    ...
                                    <div class="d-flex gap-1">
                                        <a href="{{ url('admin/apps-task-create') }}" class="btn btn-primary ms-1"> <i class="ti ti-plus fs-sm me-2"></i> Add Task </a>
                                    </div>
                                </div>
                                    ...
                                    <table class="table table-custom table-centered table-select table-hover w-100 mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="fs-base mb-0">
                                                        <a href="{{ url('admin/apps-task-details') }}" class="link-reset"> Complete Presentation Slides for Meeting </a>
                                                    </h5>
                                                    <p class="text-muted fs-xs mb-0">Created: 9 May, 2025 <small class="text-muted">10:10 AM</small></p>
                                                </td>

                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="avatar avatar-sm">
                                                            <img src="{{ asset('admin/assets/images/users/user-2.jpg') }}" alt="Cruise ⚒️" class="img-fluid rounded-circle" />
                                                        </div>
                                                        <div>
                                                ...
                                                <td><i class="ti ti-calendar text-muted me-1"></i> Today</td>

                                                <td><i class="ti ti-list-details text-muted me-1"></i> 0/7</td>
                                                ...
                                                <td><i class="ti ti-messages text-muted fs-sm me-1"></i> 1</td>

                                                <td>
                                                    <div class="d-flex justify-content-center gap-1">
                                                        <a href="{{ url('admin/apps-task-details') }}" class="btn btn-default btn-icon btn-sm">
                                                            <i class="ti ti-eye fs-lg"></i>
                                                        </a>
                                                        <a href="#" class="btn btn-default btn-icon btn-sm">
                                                            <i class="ti ti-edit fs-lg"></i>
                                                        </a>
                                                        <a href="#" data-table-delete-row class="btn btn-default btn-icon btn-sm">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="fs-base mb-0">
                                                        <a href="{{ url('admin/apps-task-details') }}" class="link-reset"> Finalize Product Roadmap for Launch </a>
                                                    </h5>
                                                    <p class="text-muted fs-xs mb-0">Created: 8 Oct, 2025 <small class="text-muted">2:30 PM</small></p>
                                                </td>

                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="avatar avatar-sm">
                                                            <img src="{{ asset('admin/assets/images/users/user-5.jpg') }}" alt="Maria 💻" class="img-fluid rounded-circle" />
                                                        </div>
                                                        <div>
                                                ...
                                                <td><i class="ti ti-calendar text-muted me-1"></i> 29 Oct, 2025</td>
                                                <td><i class="ti ti-list-details text-muted me-1"></i> 5/10</td>
                                                ...
                                                <td><i class="ti ti-messages text-muted me-1"></i> 14</td>
                                                <td>
                                                    <div class="d-flex justify-content-center gap-1">
                                                        <a href="{{ url('admin/apps-task-details') }}" class="btn btn-default btn-icon btn-sm">
                                                            <i class="ti ti-eye fs-lg"></i>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="fs-base mb-0">
                                                        <a href="{{ url('admin/apps-task-details') }}" class="link-reset"> Design Marketing Campaign Assets </a>
                                                    </h5>
                                                    <p class="text-muted fs-xs mb-0">Created: 6 Oct, 2025 <small class="text-muted">5:45 PM</small></p>
                                                </td>

                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="avatar avatar-sm">
                                                            <img src="{{ asset('admin/assets/images/users/user-3.jpg') }}" alt="Kevin" class="img-fluid rounded-circle" />
                                                        </div>
                                                        <div>
                                                ...
                                                <td><i class="ti ti-calendar text-muted me-1"></i> 29 Oct, 2025</td>
                                                <td><i class="ti ti-list-details text-muted me-1"></i> 6/8</td>
                                                <td><span class="badge badge-outline-success fs-xxs">In Progress</span></td>
                                                <td><span class="badge badge-soft-danger fs-xxs">High</span></td>
                                                <td><i class="ti ti-messages text-muted me-1"></i> 9</td>
                                                <td>
                                                    <div class="d-flex justify-content-center gap-1">
                                                        <a href="{{ url('admin/apps-task-details') }}" class="btn btn-default btn-icon btn-sm">
                                                            <i class="ti ti-eye fs-lg"></i>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="fs-base mb-0">
                                                        <a href="{{ url('admin/apps-task-details') }}" class="link-reset"> Prepare Monthly Financial Report </a>
                                                    </h5>
                                                    <p class="text-muted fs-xs mb-0">Created: 4 Oct, 2025 <small class="text-muted">11:00 AM</small></p>
                                                </td>

                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="avatar avatar-sm">
                                                            <img src="{{ asset('admin/assets/images/users/user-4.jpg') }}" alt="Thomas 🏠" class="img-fluid rounded-circle" />
                                                        </div>
                                                        <div>
                                                ...
                                                <td><i class="ti ti-calendar text-danger me-1"></i> 20 Sep, 2025</td>
                                                <td><i class="ti ti-list-details text-muted me-1"></i> 2/5</td>
                                                <td><span class="badge badge-outline-success fs-xxs">In Progress</span></td>
                                                <td><span class="badge badge-soft-warning fs-xxs">Medium</span></td>
                                                <td><i class="ti ti-messages text-muted me-1"></i> 6</td>
                                                <td>
                                                    <div class="d-flex justify-content-center gap-1">
                                                        <a href="{{ url('admin/apps-task-details') }}" class="btn btn-default btn-icon btn-sm">
                                                            <i class="ti ti-eye fs-lg"></i>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="fs-base mb-0">
                                                        <a href="{{ url('admin/apps-task-details') }}" class="link-reset"> Conduct Team Retrospective Meeting </a>
                                                    </h5>
                                                    <p class="text-muted fs-xs mb-0">Created: 2 Oct, 2025 <small class="text-muted">4:00 PM</small></p>
                                                </td>

                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="avatar avatar-sm">
                                                            <img src="{{ asset('admin/assets/images/users/user-6.jpg') }}" alt="James" class="img-fluid rounded-circle" />
                                                        </div>
                                                        <div>
                                                ...
                                                <td><i class="ti ti-calendar text-muted me-1"></i> Yesterday</td>
                                                <td><i class="ti ti-list-details text-muted me-1"></i> 4/4</td>
                                                ...
                                                <td><i class="ti ti-messages text-muted me-1"></i> 2</td>
                                                <td>
                                                    <div class="d-flex justify-content-center gap-1">
                                                        <a href="{{ url('admin/apps-task-details') }}" class="btn btn-default btn-icon btn-sm">
                                                            <i class="ti ti-eye fs-lg"></i>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="fs-base mb-0">
                                                        <a href="{{ url('admin/apps-task-details') }}" class="link-reset"> Review UI/UX Prototype for Dashboard </a>
                                                    </h5>
                                                    <p class="text-muted fs-xs mb-0">Created: 1 Oct, 2025 <small class="text-muted">9:45 AM</small></p>
                                                </td>

                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="avatar avatar-sm">
                                                            <img src="{{ asset('admin/assets/images/users/user-7.jpg') }}" alt="Sophia 🚀" class="img-fluid rounded-circle" />
                                                        </div>
                                                        <div>
                                                ...
                                                <td><i class="ti ti-calendar text-muted me-1"></i> 22 Oct, 2025</td>
                                                <td><i class="ti ti-list-details text-muted me-1"></i> 1/6</td>
                                                <td><span class="badge badge-outline-warning fs-xxs">New</span></td>
                                                <td><span class="badge badge-soft-danger fs-xxs">High</span></td>
                                                <td><i class="ti ti-messages text-muted me-1"></i> 11</td>
                                                <td>
                                                    <div class="d-flex justify-content-center gap-1">
                                                        <a href="{{ url('admin/apps-task-details') }}" class="btn btn-default btn-icon btn-sm">
                                                            <i class="ti ti-eye fs-lg"></i>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="fs-base mb-0">
                                                        <a href="{{ url('admin/apps-task-details') }}" class="link-reset"> Update Documentation and API References </a>
                                                    </h5>
                                                    <p class="text-muted fs-xs mb-0">Created: 28 Sep, 2025 <small class="text-muted">1:20 PM</small></p>
                                                </td>

                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="avatar avatar-sm">
                                                            <img src="{{ asset('admin/assets/images/users/user-8.jpg') }}" alt="Liam" class="img-fluid rounded-circle" />
                                                        </div>
                                                        <div>
                                                ...
                                                <td><i class="ti ti-calendar text-danger me-1"></i> 19 Sep, 2025</td>
                                                <td><i class="ti ti-list-details text-muted me-1"></i> 7/8</td>
                                                <td><span class="badge badge-outline-danger fs-xxs">Cancelled</span></td>
                                                <td><span class="badge badge-soft-warning fs-xxs">Medium</span></td>
                                                <td><i class="ti ti-messages text-muted me-1"></i> 5</td>
                                                <td>
                                                    <div class="d-flex justify-content-center gap-1">
                                                        <a href="{{ url('admin/apps-task-details') }}" class="btn btn-default btn-icon btn-sm">
                                                            <i class="ti ti-eye fs-lg"></i>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="fs-base mb-0">
                                                        <a href="{{ url('admin/apps-task-details') }}" class="link-reset"> Implement User Authentication Module </a>
                                                    </h5>
                                                    <p class="text-muted fs-xs mb-0">Created: 10 Oct, 2025 <small class="text-muted">9:00 AM</small></p>
                                                </td>

                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="avatar avatar-sm">
                                                            <img src="{{ asset('admin/assets/images/users/user-9.jpg') }}" alt="Olivia" class="img-fluid rounded-circle" />
                                                        </div>
                                                        <div>
                                                ...
                                                <td><i class="ti ti-calendar text-muted me-1"></i> Tomorrow</td>
                                                <td><i class="ti ti-list-details text-muted me-1"></i> 3/10</td>
                                                <td><span class="badge badge-outline-warning fs-xxs">New</span></td>
                                                <td><span class="badge badge-soft-danger fs-xxs">High</span></td>
                                                <td><i class="ti ti-messages text-muted me-1"></i> 8</td>
                                                <td>
                                                    <div class="d-flex justify-content-center gap-1">
                                                        <a href="{{ url('admin/apps-task-details') }}" class="btn btn-default btn-icon btn-sm">
                                                            <i class="ti ti-eye fs-lg"></i>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="fs-base mb-0">
                                                        <a href="{{ url('admin/apps-task-details') }}" class="link-reset"> Write Test Cases for API Endpoints </a>
                                                    </h5>
                                                    <p class="text-muted fs-xs mb-0">Created: 9 Oct, 2025 <small class="text-muted">10:45 AM</small></p>
                                                </td>

                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="avatar avatar-sm">
                                                            <img src="{{ asset('admin/assets/images/users/user-10.jpg') }}" alt="Ethan" class="img-fluid rounded-circle" />
                                                        </div>
                                                        <div>
                                                ...
                                                <td><i class="ti ti-calendar text-muted me-1"></i> 12 Nov, 2025</td>
                                                <td><i class="ti ti-list-details text-muted me-1"></i> 1/8</td>
                                                <td><span class="badge badge-outline-warning fs-xxs">In Review</span></td>
                                                <td><span class="badge badge-soft-warning fs-xxs">Medium</span></td>
                                                <td><i class="ti ti-messages text-muted me-1"></i> 3</td>
                                                <td>
                                                    <div class="d-flex justify-content-center gap-1">
                                                        <a href="{{ url('admin/apps-task-details') }}" class="btn btn-default btn-icon btn-sm">
                                                            <i class="ti ti-eye fs-lg"></i>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="fs-base mb-0">
                                                        <a href="{{ url('admin/apps-task-details') }}" class="link-reset"> Migrate Legacy Data to New Database </a>
                                                    </h5>
                                                    <p class="text-muted fs-xs mb-0">Created: 5 Oct, 2025 <small class="text-muted">8:00 PM</small></p>
                                                </td>

                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="avatar avatar-sm">
                                                            <img src="{{ asset('admin/assets/images/users/user-4.jpg') }}" alt="Charlotte" class="img-fluid rounded-circle" />
                                                        </div>
                                                        <div>
                                                ...
                                                <td><i class="ti ti-calendar text-muted me-1"></i> Next Week</td>
                                                <td><i class="ti ti-list-details text-muted me-1"></i> 2/12</td>
                                                <td><span class="badge badge-outline-success fs-xxs">In Progress</span></td>
                                                <td><span class="badge badge-soft-warning fs-xxs">Medium</span></td>
                                                <td><i class="ti ti-messages text-muted me-1"></i> 10</td>
                                                <td>
                                                    <div class="d-flex justify-content-center gap-1">
                                                        <a href="{{ url('admin/apps-task-details') }}" class="btn btn-default btn-icon btn-sm">
                                                            <i class="ti ti-eye fs-lg"></i>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="fs-base mb-0">
                                                        <a href="{{ url('admin/apps-task-details') }}" class="link-reset"> QA Review and Regression Testing </a>
                                                    </h5>
                                                    <p class="text-muted fs-xs mb-0">Created: 3 Oct, 2025 <small class="text-muted">3:10 PM</small></p>
                                                </td>

                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="avatar avatar-sm">
                                                            <img src="{{ asset('admin/assets/images/users/user-2.jpg') }}" alt="Grace" class="img-fluid rounded-circle" />
                                                        </div>
                                                        <div>
                                                ...
                                                <td><i class="ti ti-calendar text-danger me-1"></i> 12 Sep, 2025</td>
                                                <td><i class="ti ti-list-details text-muted me-1"></i> 9/10</td>
                                                <td><span class="badge badge-outline-danger fs-xxs">Cancelled</span></td>
                                                <td><span class="badge badge-soft-danger fs-xxs">High</span></td>
                                                <td><i class="ti ti-messages text-muted me-1"></i> 17</td>
                                                <td>
                                                    <div class="d-flex justify-content-center gap-1">
                                                        <a href="{{ url('admin/apps-task-details') }}" class="btn btn-default btn-icon btn-sm">
                                                            <i class="ti ti-eye fs-lg"></i>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="fs-base mb-0">
                                                        <a href="{{ url('admin/apps-task-details') }}" class="link-reset"> Optimize Application Performance Metrics </a>
                                                    </h5>
                                                    <p class="text-muted fs-xs mb-0">Created: 1 Oct, 2025 <small class="text-muted">12:05 PM</small></p>
                                                </td>

                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="avatar avatar-sm">
                                                            <img src="{{ asset('admin/assets/images/users/user-6.jpg') }}" alt="Noah" class="img-fluid rounded-circle" />
                                                        </div>
                                                        <div>
                                                ...
                                                <td><i class="ti ti-calendar text-muted me-1"></i> 18 Oct, 2025</td>
                                                <td><i class="ti ti-list-details text-muted me-1"></i> 2/7</td>
                                                <td><span class="badge badge-outline-success fs-xxs">In Progress</span></td>
                                                <td><span class="badge badge-soft-warning fs-xxs">Medium</span></td>
                                                <td><i class="ti ti-messages text-muted me-1"></i> 6</td>
                                                <td>
