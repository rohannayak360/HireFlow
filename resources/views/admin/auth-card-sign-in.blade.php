...
<!-- Mirrored from coderthemes.com/paces/bootstrap/auth-card-sign-in.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:59:05 GMT -->
<head>
        <meta charset="utf-8" />
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form>
                                            ...
                                            <div class="d-flex justify-content-between align-items-center mb-3">
                                                ...
                                                <a href="{{ url('admin/auth-card-reset-pass') }}" class="text-decoration-underline link-offset-3 text-muted">Forgot Password?</a>
                                            </div>
                                        ...
                                        <p class="text-muted text-center mt-4 mb-0">
                                            New here?
                                            <a href="{{ url('admin/auth-card-sign-up') }}" class="text-decoration-underline link-offset-3 fw-semibold">Create an account</a>
                                        </p>
