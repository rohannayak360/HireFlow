...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-email-inbox.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:36 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Inbox (77) | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Email</h4>
                        </div>
                    ...
                    <div class="outlook-box gap-1 email-app">
                        <div class="offcanvas-lg offcanvas-start outlook-left-menu outlook-left-menu-sm" tabindex="-1" id="emailSidebaroffcanvas">
                            <div class="card h-100 mb-0 rounded-end-0" data-simplebar>
                                <div class="card-body">
                                    <a href="{{ url('admin/apps-email-compose') }}" class="btn btn-danger fw-medium w-100">Compose</a>
                        ...
                        <div data-table data-table-rows-per-page="15" class="card h-100 mb-0 rounded-start-0 flex-grow-1 border-start-0">
                            ...
                            <div class="card-header card-bg justify-content-between">
                                <div class="d-flex flex-wrap align-items-center gap-1">
                                    <input class="form-check-input form-check-input-light fs-14 mt-0 me-3" type="checkbox" id="select-all-email" />
                                    ...
                                    <!-- Tag -->
                                    <button type="button" class="btn btn-default btn-icon btn-sm" data-bs-toggle="tooltip" title="Tag">
                                    ...
                                    <!-- Forward -->
                                    <button type="button" class="btn btn-default btn-icon btn-sm" data-bs-toggle="tooltip" title="Forward">
                                        <i class="ti ti-mail-forward fs-lg"></i>
                                    </button>

                                    <!-- Snooze -->
                                    <button type="button" class="btn btn-default btn-icon btn-sm" data-bs-toggle="tooltip" title="Snooze">
                                        <i class="ti ti-clock-pause fs-lg"></i>
                                    </button>

                                    <!-- Important -->
                                    <button type="button" class="btn btn-default btn-icon btn-sm" data-bs-toggle="tooltip" title="Mark as Important">
                                    ...
                                    <table class="table table-hover table-select mb-0">
                                        <tbody>
                                            <tr class="position-relative">
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <img src="{{ asset('admin/assets/images/users/user-5.jpg') }}" alt="user avatar" class="avatar-xs rounded-circle" />
                                                        <h5 class="fs-base mb-0 fw-medium">Amanda Reyes</h5>
                                                    </div>
                                                </td>

                                                <td>
                                                    <a href="{{ url('admin/apps-email-details') }}" class="link-reset fs-base fw-medium stretched-link">Design Review & Feedback</a>
                                            ...
                                            <tr class="position-relative">
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <img src="{{ asset('admin/assets/images/users/user-2.jpg') }}" alt="user avatar" class="avatar-xs rounded-circle" />
                                                        <h5 class="fs-base mb-0 fw-medium">George Thomas</h5>
                                                    </div>
                                                </td>
                                                <td>
                                                    <a href="{{ url('admin/apps-email-details') }}" class="link-reset fs-base fw-medium stretched-link">Request for Meeting</a>
                                                    <span class="d-xl-inline-block d-none">—</span>
                                            ...
                                            <tr class="position-relative mark-as-read">
                                                ...
                                                <td>
                                                    <a href="{{ url('admin/apps-email-details') }}" class="link-reset fs-base fw-medium stretched-link">Q2 Marketing Strategy</a>
                                                    <span class="d-xl-inline-block d-none">—</span>
                                            ...
                                            <tr class="position-relative mark-as-read">
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <img src="{{ asset('admin/assets/images/users/user-6.jpg') }}" alt="user avatar" class="avatar-xs rounded-circle" />
                                                        <h5 class="fs-base mb-0 fw-medium">Sophia Lee</h5>
                                                    </div>
                                                </td>
                                                <td>
                                                    <a href="{{ url('admin/apps-email-details') }}" class="link-reset fs-base fw-medium stretched-link">Final Invoice Attached</a>
                                                    <span class="d-xl-inline-block d-none">—</span>
                                            ...
                                            <tr class="position-relative mark-as-read">
                                                ...
                                                <td>
                                                    <a href="{{ url('admin/apps-email-details') }}" class="link-reset fs-base fw-medium stretched-link">Team Offsite Agenda</a>
                                                    <span class="d-xl-inline-block d-none">—</span>
                                            ...
                                            <tr class="position-relative mark-as-read">
                                                ...
                                                <td>
                                                    <a href="{{ url('admin/apps-email-details') }}" class="link-reset fs-base fw-medium stretched-link">Welcome to the Project!</a>
                                                    <span class="d-xl-inline-block d-none">—</span>
                                            ...
                                            <tr class="position-relative">
                                                ...
                                                <td>
                                                    <a href="{{ url('admin/apps-email-details') }}" class="link-reset fs-base fw-medium stretched-link">Meeting Follow-up Notes</a>
                                                    <span class="d-xl-inline-block d-none">—</span>
                                            ...
                                            <tr class="position-relative mark-as-read">
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <img src="{{ asset('admin/assets/images/users/user-7.jpg') }}" alt="user avatar" class="avatar-xs rounded-circle" />
                                                        <h5 class="fs-base mb-0 fw-medium">Sophia Allen</h5>
                                                    </div>
                                                </td>
                                                <td>
                                                    <a href="{{ url('admin/apps-email-details') }}" class="link-reset fs-base fw-medium stretched-link">Project Files Delivered</a>
                                                    <span class="d-xl-inline-block d-none">—</span>
                                            ...
                                            <tr class="position-relative">
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <img src="{{ asset('admin/assets/images/users/user-8.jpg') }}" alt="user avatar" class="avatar-xs rounded-circle" />
                                                        <h5 class="fs-base mb-0 fw-medium">Michael Chen</h5>
                                                    </div>
                                                </td>
                                                <td>
                                                    <a href="{{ url('admin/apps-email-details') }}" class="link-reset fs-base fw-medium stretched-link">Re: Budget Estimate</a>
                                                    <span class="d-xl-inline-block d-none">—</span>
                                            ...
                                            <tr class="position-relative mark-as-read">
                                                ...
                                                <td>
                                                    <a href="{{ url('admin/apps-email-details') }}" class="link-reset fs-base fw-medium stretched-link">Collaboration Opportunity</a>
                                                    <span class="d-xl-inline-block d-none">—</span>
                                            ...
                                            <tr class="position-relative mark-as-read">
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <img src="{{ asset('admin/assets/images/users/user-10.jpg') }}" alt="user avatar" class="avatar-xs rounded-circle" />
                                                        <h5 class="fs-base mb-0 fw-medium">Daniel White</h5>
                                                    </div>
                                                </td>
                                                <td>
                                                    <a href="{{ url('admin/apps-email-details') }}" class="link-reset fs-base fw-medium stretched-link">Reschedule Request</a>
                                                    <span class="d-xl-inline-block d-none">—</span>
                                            ...
                                            <tr class="position-relative mark-as-read">
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <img src="{{ asset('admin/assets/images/users/user-3.jpg') }}" alt="user avatar" class="avatar-xs rounded-circle" />
                                                        <h5 class="fs-base mb-0 fw-medium">James Walker</h5>
                                                    </div>
                                                </td>
                                                <td>
                                                    <a href="{{ url('admin/apps-email-details') }}" class="link-reset fs-base fw-medium stretched-link">Monthly Report Submission</a>
                                                    <span class="d-xl-inline-block d-none">—</span>
                                            ...
                                            <tr class="position-relative">
                                                ...
                                                <td>
                                                    <a href="{{ url('admin/apps-email-details') }}" class="link-reset fs-base fw-medium stretched-link">Design Assets Update</a>
                                                    <span class="d-xl-inline-block d-none">—</span>
                                            ...
                                            <tr class="position-relative mark-as-read">
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <img src="{{ asset('admin/assets/images/users/user-9.jpg') }}" alt="user avatar" class="avatar-xs rounded-circle" />
                                                        <h5 class="fs-base mb-0 fw-medium">Noah Patel</h5>
                                                    </div>
                                                </td>
                                                <td>
                                                    <a href="{{ url('admin/apps-email-details') }}" class="link-reset fs-base fw-medium stretched-link">Updated Meeting Schedule</a>
                                                    <span class="d-xl-inline-block d-none">—</span>
                                            ...
                                            <tr class="position-relative mark-as-read">
                                                ...
                                                <td>
                                                    <a href="{{ url('admin/apps-email-details') }}" class="link-reset fs-base fw-medium stretched-link">Client Feedback Notes</a>
                                                    <span class="d-xl-inline-block d-none">—</span>
                                            ...
                                            <tr class="position-relative mark-as-read">
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <img src="{{ asset('admin/assets/images/users/user-1.jpg') }}" alt="user avatar" class="avatar-xs rounded-circle" />
                                                        <h5 class="fs-base mb-0 fw-medium">Liam Garcia</h5>
                                                    </div>
                                                </td>
                                                <td>
                                                    <a href="{{ url('admin/apps-email-details') }}" class="link-reset fs-base fw-medium stretched-link">Weekly Sync Meeting</a>
                                                    <span class="d-xl-inline-block d-none">—</span>
...
<script src="{{ asset('admin/assets/js/app.js') }}"></script>
        ...
        <!-- Email Init Js -->
        <script src="{{ asset('admin/assets/js/pages/apps-email.js') }}"></script>
    </body>

<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-email-inbox.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:37 GMT -->
</html>
