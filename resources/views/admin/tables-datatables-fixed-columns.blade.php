...
<!-- Mirrored from coderthemes.com/paces/bootstrap/tables-datatables-fixed-columns.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 10:00:00 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Basic Datatables | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
        ...
        <!-- Datatables css -->
        <link href="{{ asset('admin/assets/plugins/datatables/fixedColumns.bootstrap5.min.css') }}" rel="stylesheet" type="text/css" />
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Fixed Columns</h4>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header justify-content-between">
                                    ...
                                    <a href="https://datatables.net/extensions/fixedcolumns/examples/initialisation/left_right_columns.html" target="_blank" class="icon-link icon-link-hover link-primary fw-semibold">
                                        View Docs
...
<script src="{{ asset('admin/assets/js/app.js') }}"></script>
        ...
        <script src="{{ asset('admin/assets/plugins/datatables/fixedColumns.bootstrap5.min.js') }}"></script>

        <!-- Page js -->
        <script src="{{ asset('admin/assets/js/pages/datatables-fixed-columns.js') }}"></script>
    </body>

<!-- Mirrored from coderthemes.com/paces/bootstrap/tables-datatables-fixed-columns.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 10:00:01 GMT -->
</html>
