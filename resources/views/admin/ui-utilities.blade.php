...
<!-- Mirrored from coderthemes.com/paces/bootstrap/ui-utilities.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:59:15 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Utilities | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Utilities</h4>
                        </div>
                        ...
                        <div class="col-xl-4">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-start flex-wrap gap-2">
                                        <img src="{{ asset('admin/assets/images/users/user-2.jpg') }}" class="avatar-lg rounded" alt="rounded" />
                                        <img src="{{ asset('admin/assets/images/users/user-2.jpg') }}" class="avatar-lg rounded-top" alt="rounded-top" />
                                        <img src="{{ asset('admin/assets/images/users/user-2.jpg') }}" class="avatar-lg rounded-end" alt="rounded-end" />
                                        <img src="{{ asset('admin/assets/images/users/user-2.jpg') }}" class="avatar-lg rounded-bottom" alt="rounded-bottom" />
                                        <img src="{{ asset('admin/assets/images/users/user-2.jpg') }}" class="avatar-lg rounded-start" alt="rounded-start" />
                                        <img src="{{ asset('admin/assets/images/users/user-2.jpg') }}" class="avatar-lg rounded-circle" alt="rounded-circle" />
                                        <img src="{{ asset('admin/assets/images/stock/small-3.jpg') }}" class="w-auto rounded-pill" alt="rounded-pill" width="80" />
                                    </div>
                                </div>
                                <!-- end card body-->
                            </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <p>
                                        <a href="#" class="pe-none" tabindex="-1">This link</a>
                                        can not be clicked.
                                    </p>
                                    <p>
                        ...
                        <div class="col-xl-4">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-start flex-wrap gap-2">
                                        <img src="{{ asset('admin/assets/images/users/user-4.jpg') }}" class="avatar-lg rounded-0" alt="rounded-0" />
                                        <img src="{{ asset('admin/assets/images/users/user-4.jpg') }}" class="avatar-lg rounded-1" alt="rounded-1" />
                                        <img src="{{ asset('admin/assets/images/users/user-4.jpg') }}" class="avatar-lg rounded-2" alt="rounded-2" />
                                        <img src="{{ asset('admin/assets/images/users/user-4.jpg') }}" class="avatar-lg rounded-3" alt="rounded-3" />
                                        <img src="{{ asset('admin/assets/images/users/user-4.jpg') }}" class="avatar-lg rounded-4" alt="rounded-4" />
                                        <img src="{{ asset('admin/assets/images/users/user-4.jpg') }}" class="avatar-lg rounded-5" alt="rounded-5" />
                                    </div>
                                </div>
                                <!--end card body-->
                            </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-start flex-wrap gap-3 text-center">
                                        <div>
                                            <img src="{{ asset('admin/assets/images/stock/small-1.jpg') }}" class="object-fit-contain border rounded avatar-xl" alt="..." />
                                            <p class="mt-1 mb-0">
                                                <code class="user-select-all">.object-fit-contain</code>
                                            </p>
                                        </div>
                                        <div>
                                            <img src="{{ asset('admin/assets/images/stock/small-1.jpg') }}" class="object-fit-cover border rounded avatar-xl" alt="..." />
                                            <p class="mt-1 mb-0">
                                                <code class="user-select-all">.object-fit-cover</code>
                                            </p>
                                        </div>
                                        <div>
                                            <img src="{{ asset('admin/assets/images/stock/small-1.jpg') }}" class="object-fit-fill border rounded avatar-xl" alt="..." />
                                            <p class="mt-1 mb-0">
                                                <code class="user-select-all">.object-fit-fill</code>
                                            </p>
                                        </div>
                                        <div>
                                            <img src="{{ asset('admin/assets/images/stock/small-1.jpg') }}" class="object-fit-scale border rounded avatar-xl" alt="..." />
                                            <p class="mt-1 mb-0">
                                                <code class="user-select-all">.object-fit-scale</code>
                                            </p>
                                        </div>
                                        <div>
                                            <img src="{{ asset('admin/assets/images/stock/small-1.jpg') }}" class="object-fit-none border rounded avatar-xl" alt="..." />
                                            <p class="mt-1 mb-0">
