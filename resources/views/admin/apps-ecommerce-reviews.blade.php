...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-ecommerce-reviews.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:19 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Reviews | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                                            ...
                                            <div class="row align-items-center g-0">
                                                <div class="col-xl-7">
                                                    <div class="d-flex align-items-center gap-4 p-4">
                                                        <img src="{{ asset('admin/assets/images/ratings.svg') }}" alt="Product" height="80" />
                                                        <div>
                                                            <h3 class="d-flex align-items-center gap-2 mb-2 fw-bold">4.92 <i class="ti ti-star-filled text-warning"></i></h3>
                                ...
                                <div class="card-header border-light d-flex align-items-center justify-content-between flex-wrap gap-2">
                                    <div class="d-flex gap-2">
                                        <div class="app-search">
                                            <input data-table-search type="search" class="form-control" placeholder="Search reviews..." />
                                            <i class="ti ti-search app-search-icon text-muted"></i>
                                        </div>
                                    ...
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <!-- View All Dropdown -->
                                        <div class="dropdown">
                                            <button class="btn btn-default dropdown-toggle drop-arrow-none" type="button" data-bs-toggle="dropdown" aria-expanded="false">View All <i class="ti ti-chevron-down align-middle ms-1"></i></button>
                                            <ul class="dropdown-menu dropdown-menu-end">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-0">
                                                                <a data-sort="product" href="{{ url('admin/apps-ecommerce-product-details') }}" class="link-reset">Smart Watch</a>
                                                            </h5>
                                                        </div>
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-0">
                                                                <a data-sort="product" href="{{ url('admin/apps-ecommerce-product-details') }}" class="link-reset">4K Ultra HD TV</a>
                                                            </h5>
                                                        </div>
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-0">
                                                                <a data-sort="product" href="{{ url('admin/apps-ecommerce-product-details') }}" class="link-reset">Smartphone X</a>
                                                            </h5>
                                                        </div>
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-0">
                                                                <a data-sort="product" href="{{ url('admin/apps-ecommerce-product-details') }}" class="link-reset">Gaming Laptop</a>
                                                            </h5>
                                                        </div>
                                                    </div>
                                                </td>
...
<script src="{{ asset('admin/assets/js/app.js') }}"></script>
        ...
        <script src="{{ asset('admin/assets/js/pages/ecommerce-reviews.js') }}"></script>
    </body>
