...
<!-- Mirrored from coderthemes.com/paces/bootstrap/charts-chartjs-area.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:59:37 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Area Charts | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Area Charts</h4>
                        </div>
...
<script src="{{ asset('admin/assets/js/app.js') }}"></script>
        ...
        <!-- Area chart Demo js -->
        <script src="{{ asset('admin/assets/js/pages/chartjs-area.js') }}"></script>
    </body>
