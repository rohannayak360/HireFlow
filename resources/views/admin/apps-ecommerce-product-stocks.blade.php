...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-ecommerce-product-stocks.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:19 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Product Stocks | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Stocks</h4>
                        </div>
                                ...
                                <div class="card-header border-light justify-content-between">
                                    <div class="d-flex gap-2">
                                        <div class="app-search">
                                            <input data-table-search type="search" class="form-control" placeholder="Search product name or SKU..." />
                                            <i class="ti ti-search app-search-icon text-muted"></i>
                                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-1">
                                                                <a data-sort="product" href="{{ url('admin/apps-ecommerce-product-details') }}" class="link-reset">Smart LED TV 55"</a>
                                                            </h5>
                                                ...
                                                <td>08 Oct, 2025 <small class="text-muted">10:30 AM</small></td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-1">
                                                                <a href="{{ url('admin/apps-ecommerce-product-details') }}" class="link-reset">Wireless Noise Cancel Headphones</a>
                                                            </h5>
                                                ...
                                                <td>07 Oct, 2025 <small class="text-muted">02:45 PM</small></td>
                                                <td>
                                                    <div class="d-flex justify-content-center gap-1">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-1">
                                                                <a href="{{ url('admin/apps-ecommerce-product-details') }}" class="link-reset">Ergonomic Office Chair</a>
                                                            </h5>
                                                ...
                                                <td>06 Oct, 2025 <small class="text-muted">09:10 AM</small></td>
                                                <td>
                                                    <div class="d-flex justify-content-center gap-1">
                                                        <a href="#" class="btn btn-default btn-icon btn-sm"><i class="ti ti-eye fs-lg"></i></a>
                                                        <a href="#" class="btn btn-default btn-icon btn-sm"><i class="ti ti-edit fs-lg"></i></a>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-1">
                                                                <a href="{{ url('admin/apps-ecommerce-product-details') }}" class="link-reset">Smartphone 12 Pro</a>
                                                            </h5>
                                                ...
                                                <td>$999.00</td>
                                                <td><span class="badge badge-label badge-soft-success fs-xxs">In Stock</span></td>
                                                <td>05 Oct, 2025 <small class="text-muted">04:00 PM</small></td>
                                                <td>
                                                    <div class="d-flex justify-content-center gap-1">
                                                        <a href="#" class="btn btn-default btn-icon btn-sm"><i class="ti ti-eye fs-lg"></i></a>
                                                        <a href="#" class="btn btn-default btn-icon btn-sm"><i class="ti ti-edit fs-lg"></i></a>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-1">
                                                                <a href="{{ url('admin/apps-ecommerce-product-details') }}" class="link-reset">Bluetooth Speaker Mini</a>
                                                            </h5>
                                                ...
                                                <td>$79.00</td>
                                                <td><span class="badge badge-label badge-soft-success fs-xxs">In Stock</span></td>
                                                <td>04 Oct, 2025 <small class="text-muted">01:20 PM</small></td>
                                                <td>
                                                    <div class="d-flex justify-content-center gap-1">
                                                        <a href="#" class="btn btn-default btn-icon btn-sm"><i class="ti ti-eye fs-lg"></i></a>
                                                        <a href="#" class="btn btn-default btn-icon btn-sm"><i class="ti ti-edit fs-lg"></i></a>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-1">
                                                                <a href="{{ url('admin/apps-ecommerce-product-details') }}" class="link-reset">Portable Air Cooler</a>
                                                            </h5>
                                                ...
                                                <td>03 Oct, 2025 <small class="text-muted">11:05 AM</small></td>
                                                <td>
                                                    <div class="d-flex justify-content-center gap-1">
                                                        <a href="#" class="btn btn-default btn-icon btn-sm"><i class="ti ti-eye fs-lg"></i></a>
                                                        <a href="#" class="btn btn-default btn-icon btn-sm"><i class="ti ti-edit fs-lg"></i></a>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-1">
                                                                <a href="{{ url('admin/apps-ecommerce-product-details') }}" class="link-reset">Gaming Laptop GTX 4070</a>
                                                            </h5>
                                                ...
                                                <td>$1,899.00</td>
                                                <td><span class="badge badge-label badge-soft-success fs-xxs">In Stock</span></td>
                                                <td>02 Oct, 2025 <small class="text-muted">05:15 PM</small></td>
                                                <td>
                                                    <div class="d-flex justify-content-center gap-1">
                                                        <a href="#" class="btn btn-default btn-icon btn-sm"><i class="ti ti-eye fs-lg"></i></a>
                                                        <a href="#" class="btn btn-default btn-icon btn-sm"><i class="ti ti-edit fs-lg"></i></a>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-1">
                                                                <a href="{{ url('admin/apps-ecommerce-product-details') }}" class="link-reset">Wireless Mouse Pro</a>
                                                            </h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-1">
                                                                <a href="{{ url('admin/apps-ecommerce-product-details') }}" class="link-reset">4K Action Camera</a>
                                                            </h5>
                                                ...
                                                <td>30 Sep, 2025 <small class="text-muted">01:20 PM</small></td>
                                                <td>
                                                    <div class="d-flex justify-content-center gap-1">
                                                        <a href="#" class="btn btn-default btn-icon btn-sm"><i class="ti ti-eye fs-lg"></i></a>
                                                        <a href="#" class="btn btn-default btn-icon btn-sm"><i class="ti ti-edit fs-lg"></i></a>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-1">
                                                                <a href="{{ url('admin/apps-ecommerce-product-details') }}" class="link-reset">Smart Fitness Watch</a>
                                                            </h5>
                                                ...
                                                <td>$149.00</td>
                                                <td><span class="badge badge-label badge-soft-success fs-xxs">In Stock</span></td>
                                                <td>29 Sep, 2025 <small class="text-muted">10:45 AM</small></td>
                                                <td>
                                                    <div class="d-flex justify-content-center gap-1">
                                                        <a href="#" class="btn btn-default btn-icon btn-sm"><i class="ti ti-eye fs-lg"></i></a>
                                                        <a href="#" class="btn btn-default btn-icon btn-sm"><i class="ti ti-edit fs-lg"></i></a>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-1">
                                                                <a href="{{ url('admin/apps-ecommerce-product-details') }}" class="link-reset">Cordless Vacuum Cleaner</a>
                                                            </h5>
                                                ...
                                                <td>$249.00</td>
                                                <td><span class="badge badge-label badge-soft-warning fs-xxs">Low Stock</span></td>
                                                <td>28 Sep, 2025 <small class="text-muted">09:30 AM</small></td>
                                                <td>
                                                    <div class="d-flex justify-content-center gap-1">
                                                        <a href="#" class="btn btn-default btn-icon btn-sm"><i class="ti ti-eye fs-lg"></i></a>
                                                        <a href="#" class="btn btn-default btn-icon btn-sm"><i class="ti ti-edit fs-lg"></i></a>
