...
<!-- Mirrored from coderthemes.com/paces/bootstrap/ui-placeholders.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:59:13 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Placeholders | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Placeholders</h4>
                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="card border shadow-none mb-md-0">
                                                <!-- card-img-top -->
                                                <img src="{{ asset('admin/assets/images/stock/small-1.jpg') }}" class="card-img-top" alt="..." />
