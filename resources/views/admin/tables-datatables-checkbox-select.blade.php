...
<!-- Mirrored from coderthemes.com/paces/bootstrap/tables-datatables-checkbox-select.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 10:00:04 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Checkbox Select Datatables | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Checkbox Select</h4>
                        </div>
                        ...
                        <div class="text-end">
                            <ol class="breadcrumb m-0 py-0">
                                ...
                                <li class="breadcrumb-item active">Checkbox Select</li>
                            </ol>
                        </div>
                    </div>
...
<script src="{{ asset('admin/assets/js/app.js') }}"></script>
        ...
        <!-- Page js -->
        <script src="{{ asset('admin/assets/js/pages/datatables-checkbox-select.js') }}"></script>
    </body>

<!-- Mirrored from coderthemes.com/paces/bootstrap/tables-datatables-checkbox-select.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 10:00:05 GMT -->
</html>
