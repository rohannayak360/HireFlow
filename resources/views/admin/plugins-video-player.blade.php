...
<!-- Mirrored from coderthemes.com/paces/bootstrap/plugins-video-player.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:59:02 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Video Player | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
        ...
        <!-- Plyr style -->
        <link href="{{ asset('admin/assets/plugins/plyr/plyr.css') }}" rel="stylesheet" />
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-xl-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <video id="player1" class="plyr w-100" playsinline controls poster="../../../media.w3.org/2010/05/sintel/poster.png" style="--plyr-color-main: #1ac266">
                        ...
                        <div class="col-12 col-xl-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <video id="player3" class="plyr w-100" playsinline controls muted autoplay loop poster="../../../media.w3.org/2010/05/sintel/poster.png" style="--plyr-color-main: #1c84c6">
                                        <source src="https://media.w3.org/2010/05/sintel/trailer_hd.mp4" type="video/mp4" />
                                    </video>
                                </div>
                            </div>
...
<script src="{{ asset('admin/assets/js/app.js') }}"></script>
        ...
        <!-- Plyr Plugin Js-->
        <script src="{{ asset('admin/assets/plugins/plyr/plyr.min.js') }}"></script>

        <!-- Plyr Page Js-->
        <script src="{{ asset('admin/assets/js/pages/plugins-plyr.js') }}"></script>
    </body>

<!-- Mirrored from coderthemes.com/paces/bootstrap/plugins-video-player.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:59:04 GMT -->
</html>
