...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-hrm-attendance.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:36 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Attendance | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Attendance</h4>
                        </div>
                                ...
                                <div class="card-header border-light justify-content-between">
                                    <div class="d-flex gap-2">
                                        ...
                                        <div class="app-search">
                                            <input data-table-search type="search" class="form-control" placeholder="Search records..." />
                                            <i class="ti ti-search app-search-icon text-muted"></i>
                                        </div>
                                    ...
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <!-- Shift Type Filter -->
                                        <div class="app-search">
                                            <select data-table-filter="shift" class="form-select form-control my-1 my-md-0">
                                        ...
                                        <table class="table table-custom table-centered table-hover w-100 mb-0">
                                            <thead class="bg-light align-middle bg-opacity-25 thead-sm text-nowrap">
                                                <tr class="text-uppercase fs-xxs">
                                                    ...
                                                    <th data-table-sort data-column="shift">Shift Type</th>
                                    ...
                                    <div class="modal-body">
                                        <div class="row g-3">
                                            <div class="col-md-4">
                                                ...
                                                <input type="date" class="form-control" data-provider="flatpickr" data-date-format="d M, Y" id="attendance-date" required />
                                            </div>

                                            <div class="col-md-4">
                                                <label for="shift-type" class="form-label">Shift Type</label>
                                                <select id="shift-type" class="form-select" required>
                                            ...
                                            <div class="col-md-4">
                                                <label for="atte-status" class="form-label">Status</label>
                                                <select id="atte-status" class="form-select" required>
                                            ...
                                            <div class="col-md-4">
                                                <label for="clock-in" class="form-label">Clock In</label>
                                                <input type="time" id="clock-in" data-provider="timepickr" data-time-basic="true" class="form-control" />
                                            </div>

                                            <div class="col-md-4">
                                                <label for="clock-out" class="form-label">Clock Out</label>
                                                <input type="time" id="clock-out" data-provider="timepickr" data-time-basic="true" class="form-control" />
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                <label for="approval-by" class="form-label">Approved By</label>
                                                <input type="text" id="approval-by" class="form-control" placeholder="e.g. Maria Smith" />
                                            </div>
