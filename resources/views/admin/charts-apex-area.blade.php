...
<!-- Mirrored from coderthemes.com/paces/bootstrap/charts-apex-area.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:59:18 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Apex Area Charts | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Area Apexchart</h4>
                        </div>
                        ...
                        <div class="text-end">
                            <ol class="breadcrumb m-0 py-0">
                                ...
                                <li class="breadcrumb-item active">Area Apexchart</li>
                            </ol>
                        </div>
                    </div>
                                    ...
                                    <div dir="ltr">
                                        ...
                                        <div class="pt-2 pb-1">
                                            <div class="d-flex justify-content-center align-items-center gap-2">
                                                <img src="{{ asset('admin/assets/images/logo-sm.png') }}" class="avatar-sm rounded" alt="file-image" />
                                                <a href="javascript:void(0);" class="text-muted fw-bold fs-md">Paces</a>
                                            </div>
                                        </div>
...
<script src="{{ asset('admin/assets/js/app.js') }}"></script>
        ...
        <script src="{{ asset('admin/assets/js/pages/chart-apex-area.js') }}"></script>
    </body>

<!-- Mirrored from coderthemes.com/paces/bootstrap/charts-apex-area.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:59:21 GMT -->
</html>
