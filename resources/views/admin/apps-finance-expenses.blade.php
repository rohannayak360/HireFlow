...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-finance-expenses.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:32 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Expenses | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Expenses</h4>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="text-end">
                                            <h3 class="mb-2 fw-normal">$<span data-target="15240">0</span></h3>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="text-end">
                                            <h3 class="mb-2 fw-normal">$<span data-target="10780">0</span></h3>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="text-end">
                                            <h3 class="mb-2 fw-normal">$<span data-target="2940">0</span></h3>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="text-end">
                                            <h3 class="mb-2 fw-normal">$<span data-target="1520">0</span></h3>
                                ...
                                <div class="card-header border-light justify-content-between">
                                    <div class="d-flex gap-2">
                                        ...
                                        <div class="app-search">
                                            <input data-table-search type="search" class="form-control" placeholder="Search expenses..." />
                                            <i class="ti ti-search app-search-icon text-muted"></i>
                                        </div>

                                        <!-- Add New Expense -->
                                        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addExpenseModal"><i class="ti ti-plus me-1"></i> Add Expense</button>
                                    ...
                                    <div class="d-flex align-items-center gap-2 flex-wrap">
                                        ...
                                        <!-- Category Filter -->
                                        <div class="app-search">
                                            <select data-table-filter="expense-category" class="form-select form-control my-1 my-md-0">
                                        ...
                                        <table class="table table-custom table-centered table-select table-hover w-100 mb-0">
                                            <thead class="bg-light align-middle bg-opacity-25 thead-sm text-nowrap">
                                                <tr class="text-uppercase fs-xxs">
                                                    ...
                                                    <th>Expense Title</th>
                                                    <th data-table-sort data-column="expense-category">Category</th>
                                            ...
                                            <tbody class="text-nowrap">
                                                <tr>
                                                    ...
                                                    <td><a href="#!" class="fw-semibold link-reset">#EXP-1023</a></td>
                                                    ...
                                                    <td>02 Oct, 2025 <small class="text-muted">09:45 AM</small></td>
                                                    <td>
                                                        <div class="d-flex gap-2 align-items-center">
                                                            <img src="{{ asset('admin/assets/images/users/user-5.jpg') }}" alt="John Miller" class="avatar-xs rounded-circle" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="#!" class="fw-semibold link-reset">#EXP-1024</a></td>
                                                    ...
                                                    <td>04 Oct, 2025 <small class="text-muted">02:10 PM</small></td>
                                                    <td>
                                                        <div class="d-flex gap-2 align-items-center">
                                                            <img src="{{ asset('admin/assets/images/users/user-7.jpg') }}" alt="Sarah Lee" class="avatar-xs rounded-circle" />
                                                            <span>Sarah Lee</span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="#!" class="fw-semibold link-reset">#EXP-1025</a></td>
                                                    <td>Team Dinner</td>
                                                    ...
                                                    <td>$185.75</td>
                                                    <td><span class="badge bg-success-subtle text-success badge-label">Approved</span></td>
                                                    <td>03 Oct, 2025 <small class="text-muted">08:00 PM</small></td>
                                                    <td>
                                                        <div class="d-flex gap-2 align-items-center">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="#!" class="fw-semibold link-reset">#EXP-1026</a></td>
                                                    ...
                                                    <td>01 Oct, 2025 <small class="text-muted">03:40 PM</small></td>
                                                    <td>
                                                        <div class="d-flex gap-2 align-items-center">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="#!" class="fw-semibold link-reset">#EXP-1027</a></td>
                                                    ...
                                                    <td>30 Sep, 2025 <small class="text-muted">11:20 AM</small></td>
                                                    <td>
                                                        <div class="d-flex gap-2 align-items-center">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="#!" class="fw-semibold link-reset">#EXP-1028</a></td>
                                                    ...
                                                    <td>$342.60</td>
                                                    <td><span class="badge bg-warning-subtle text-warning badge-label">Pending</span></td>
                                                    <td>28 Sep, 2025 <small class="text-muted">09:05 AM</small></td>
                                                    <td>
                                                        <div class="d-flex gap-2 align-items-center">
                                                            <img src="{{ asset('admin/assets/images/users/user-1.jpg') }}" alt="Liam Davis" class="avatar-xs rounded-circle" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="#!" class="fw-semibold link-reset">#EXP-1029</a></td>
                                                    ...
                                                    <td>$129.00</td>
                                                    <td><span class="badge bg-success-subtle text-success badge-label">Approved</span></td>
                                                    <td>27 Sep, 2025 <small class="text-muted">01:25 PM</small></td>
                                                    <td>
                                                        <div class="d-flex gap-2 align-items-center">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="#!" class="fw-semibold link-reset">#EXP-1030</a></td>
                                                    ...
                                                    <td>$298.40</td>
                                                    <td><span class="badge bg-warning-subtle text-warning badge-label">Pending</span></td>
                                                    <td>25 Sep, 2025 <small class="text-muted">07:55 PM</small></td>
                                                    <td>
                                                        <div class="d-flex gap-2 align-items-center">
                                                            <img src="{{ asset('admin/assets/images/users/user-2.jpg') }}" alt="Daniel Ray" class="avatar-xs rounded-circle" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="#!" class="fw-semibold link-reset">#EXP-1031</a></td>
                                                    ...
                                                    <td>$560.00</td>
                                                    <td><span class="badge bg-success-subtle text-success badge-label">Approved</span></td>
                                                    <td>24 Sep, 2025 <small class="text-muted">09:20 AM</small></td>
                                                    <td>
                                                        <div class="d-flex gap-2 align-items-center">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="#!" class="fw-semibold link-reset">#EXP-1032</a></td>
                                                    ...
                                                    <td>$1,125.00</td>
                                                    <td><span class="badge bg-success-subtle text-success badge-label">Reimbursed</span></td>
                                                    <td>22 Sep, 2025 <small class="text-muted">04:50 PM</small></td>
                                                    <td>
                                                        <div class="d-flex gap-2 align-items-center">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="#!" class="fw-semibold link-reset">#EXP-1033</a></td>
                                                    ...
                                                    <td>$42.50</td>
                                                    <td><span class="badge bg-danger-subtle text-danger badge-label">Rejected</span></td>
                                                    <td>20 Sep, 2025 <small class="text-muted">05:35 PM</small></td>
                                                    <td>
                                                        <div class="d-flex gap-2 align-items-center">
                                                            <img src="{{ asset('admin/assets/images/users/user-7.jpg') }}" alt="Sophia Turner" class="avatar-xs rounded-circle" />
                            ...
                            <div class="modal-content border-0 shadow-sm">
                                ...
                                <form id="addExpenseForm">
                                    <div class="modal-body">
                                        <div class="row g-3">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" id="expenseTitle" class="form-control" placeholder="Enter expense title" required />
                                            </div>

                                            <!-- Amount -->
                                            <div class="col-md-6">
                                                <label for="expenseAmount" class="form-label">Amount ($) <span class="text-danger">*</span></label>
                                                <input type="number" step="0.01" id="expenseAmount" class="form-control" placeholder="Enter amount" required />
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <select id="expensePayment" class="form-select">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" data-provider="flatpickr" data-date-format="d M, Y" id="expenseDate" class="form-control" />
                                            </div>

                                            <!-- Description -->
                                            <div class="col-12">
                                                <label for="expenseDesc" class="form-label">Description</label>
                                                <textarea id="expenseDesc" class="form-control" rows="3" placeholder="Optional notes or description"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="modal-footer border-top">
                                        ...
                                        <button type="submit" class="btn btn-primary"><i class="ti ti-device-floppy me-1"></i> Save Expense</button>
                                    </div>
                                </form>
                            </div>
                            <!-- end modal content-->
