...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-hrm-holidays.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:36 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Holidays | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Holidays</h4>
                        </div>
                                ...
                                <div class="card-header border-light justify-content-between">
                                    <div class="d-flex gap-2">
                                        ...
                                        <div class="app-search">
                                            <input data-table-search type="search" class="form-control" placeholder="Search holidays..." />
                                            <i class="ti ti-search app-search-icon text-muted"></i>
                                        </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="d-flex align-items-center justify-content-center gap-1">
                                                            <a href="#" class="btn btn-default btn-icon btn-sm" title="Edit">
                                                                <i class="ti ti-edit fs-lg"></i>
                                                            </a>
                                                            <a href="#" class="btn btn-default btn-icon btn-sm" data-table-delete-row title="Delete">
                                    ...
                                    <div class="modal-body">
                                        <div class="row g-3">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="date" data-provider="flatpickr" data-date-format="d M, Y" id="holidayDate" class="form-control" required />
                                            </div>

                                            <!-- Day -->
                                            <div class="col-md-6">
                                                <label for="holidayDay" class="form-label"> Day <span class="text-danger">*</span> </label>
                                                <select id="holidayDay" class="form-select" required>
                                            ...
                                            <!-- Optional Holiday -->
                                            <div class="col-md-6">
                                                <label for="optionalHoliday" class="form-label"> Optional Holiday <span class="text-danger">*</span> </label>
                                                <select id="optionalHoliday" class="form-select" required>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <textarea id="holidayDescription" class="form-control" rows="3" placeholder="Enter holiday description" required></textarea>
                                            </div>

                                            <!-- Added By -->
                                            <div class="col-md-6">
                                                <label for="holidayAddedBy" class="form-label"> Added By <span class="text-danger">*</span> </label>
                                                <input type="text" id="holidayAddedBy" class="form-control" placeholder="Enter admin name" required />
                                            </div>

                                            <!-- Status -->
                                            <div class="col-md-6">
                                                <label for="holidayStatus" class="form-label"> Status <span class="text-danger">*</span> </label>
                                                <select id="holidayStatus" class="form-select" required>
