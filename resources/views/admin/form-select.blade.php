...
<!-- Mirrored from coderthemes.com/paces/bootstrap/form-select.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:59:40 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Form Select | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
...
<script src="{{ asset('admin/assets/js/app.js') }}"></script>
        ...
        <!-- Choices Demo Js-->
        <script src="{{ asset('admin/assets/js/pages/form-choice.js') }}"></script>

        <!--Select 2 Demo js-->
        <script src="{{ asset('admin/assets/js/pages/form-select2.js') }}"></script>
    </body>

<!-- Mirrored from coderthemes.com/paces/bootstrap/form-select.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:59:41 GMT -->
</html>
