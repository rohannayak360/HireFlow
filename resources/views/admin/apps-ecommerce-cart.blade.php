...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-ecommerce-cart.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:12 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Shopping Cart | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                        ...
                        <div class="col-lg-8">
                            <div class="card">
                                ...
                                <div class="card-body">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td class="d-flex align-items-center">
                                                        <img src="{{ asset('admin/assets/images/products/1.png') }}" class="me-3 rounded" width="60" alt="iPhone" />
                                                        <div>
                                                ...
                                                <tr>
                                                    <td class="d-flex align-items-center">
                                                        <img src="{{ asset('admin/assets/images/products/2.png') }}" class="me-3 rounded" width="60" alt="iPad" />
                                                        <div>
                                                ...
                                                <tr>
                                                    <td class="d-flex align-items-center">
                                                        <img src="{{ asset('admin/assets/images/products/3.png') }}" class="me-3 rounded" width="60" alt="Watch" />
                                                        <div>
                                    ...
                                    <!-- Continue Shopping -->
                                    <div class="mt-4">
                                        <a href="{{ url('admin/apps-ecommerce-products-grid') }}" class="fw-medium d-inline-flex align-items-center gap-1"> <i class="ti ti-arrow-left"></i> Continue Shopping </a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="{{ url('admin/apps-ecommerce-checkout') }}" class="btn btn-lg btn-danger w-100 mb-3"> Proceed to Checkout </a>
