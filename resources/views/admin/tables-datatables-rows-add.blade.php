...
<!-- Mirrored from coderthemes.com/paces/bootstrap/tables-datatables-rows-add.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 10:00:04 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Add New Row Datatables | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Add Rows</h4>
                        </div>
                        ...
                        <div class="text-end">
                            <ol class="breadcrumb m-0 py-0">
                                ...
                                <li class="breadcrumb-item active">Add Rows</li>
                            </ol>
                        </div>
                    </div>
...
<script src="{{ asset('admin/assets/js/app.js') }}"></script>
        ...
        <!-- Page js -->
        <script src="{{ asset('admin/assets/js/pages/datatables-rows-add.js') }}"></script>
    </body>
