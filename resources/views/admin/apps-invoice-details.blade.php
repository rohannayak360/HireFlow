...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-invoice-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:23 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Invoice Details | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Invoice Details</h4>
                        </div>
                                        ...
                                        <div class="card-body px-4">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-4 text-end">
                                                    <img src="{{ asset('admin/assets/images/qr.png') }}" alt="Barcode" class="img-fluid" style="max-height: 80px" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="mt-lg-4 mt-2 bg-light bg-opacity-50 rounded px-3 py-2">
                                                <p class="mb-0 text-muted"><strong>Note:</strong> Please make payment within 10 days. For any billing inquiries, contact <a href="mailto:billing&#64;alinadesignco.com" class="fw-medium">billing&#64;alinadesignco.com</a>.</p>
                                            </div>
                                            ...
                                            <div class="mt-4">
                                                ...
                                                <img src="{{ asset('admin/assets/images/sign.png') }}" alt="Company Logo" height="42" />
                                    ...
                                    <div class="card card-top-sticky">
                                        <div class="card-body">
                                            <div class="justify-content-center d-flex flex-column gap-2">
                                                ...
                                                <a href="javascript: void(0);" class="btn btn-danger btn-lg"><i class="ti ti-send-2 me-1"></i> Send</a>
                                            </div>
                                        </div>
                                        <!-- end card-body-->
                                    </div>
...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-invoice-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:24 GMT -->
</html>
