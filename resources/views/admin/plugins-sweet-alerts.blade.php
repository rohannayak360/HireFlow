...
<!-- Mirrored from coderthemes.com/paces/bootstrap/plugins-sweet-alerts.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:57 GMT -->
<head>
        <meta charset="utf-8" />
        <title>SweetAlert2 | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">SweetAlert2</h4>
                        </div>
...
<script src="{{ asset('admin/assets/js/app.js') }}"></script>
        ...
        <!-- Sweet alert demo js-->
        <script src="{{ asset('admin/assets/js/pages/plugins-sweetalerts.js') }}"></script>
    </body>

<!-- Mirrored from coderthemes.com/paces/bootstrap/plugins-sweet-alerts.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:58 GMT -->
</html>
