...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-ticket-create.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:38 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Create New Ticket | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Create New Ticket</h4>
                        </div>
                                ...
                                <form action="#" method="post">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex gap-2 justify-content-center">
                                            ...
                                            <button type="reset" class="btn btn-outline-secondary"><i class="ti ti-refresh me-1"></i>Reset</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
