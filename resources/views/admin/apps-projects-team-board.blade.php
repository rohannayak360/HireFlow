...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-projects-team-board.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:22 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Team Board | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                    ...
                    <div class="row">
                        <div class="col-xxl-12">
                            <div class="d-flex align-items-sm-center flex-sm-row flex-column my-3">
                                ...
                                <div class="text-end">
                                    <a href="javascript:void(0);" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#addTeamModal">
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="card card-h-100">
                                        <div class="card-header d-flex align-items-center">
                                            ...
                                            <div class="dropdown ms-auto">
                                                <a href="#" class="text-muted fs-xl" data-bs-toggle="dropdown"><i class="ti ti-dots-vertical"></i></a>
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li>
                                        ...
                                        <div class="card-body d-flex flex-column justify-content-between">
                                            <div class="row g-3">
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="avatar-group avatar-group-sm mb-3">
                                                        <div class="avatar"><img src="{{ asset('admin/assets/images/users/user-1.jpg') }}" class="rounded-circle avatar-sm" /></div>
                                                        <div class="avatar"><img src="{{ asset('admin/assets/images/users/user-2.jpg') }}" class="rounded-circle avatar-sm" /></div>
                                                        <div class="avatar"><img src="{{ asset('admin/assets/images/users/user-3.jpg') }}" class="rounded-circle avatar-sm" /></div>
                                                        <div class="avatar"><img src="{{ asset('admin/assets/images/users/user-4.jpg') }}" class="rounded-circle avatar-sm" /></div>
                                                        <div class="avatar"><img src="{{ asset('admin/assets/images/users/user-5.jpg') }}" class="rounded-circle avatar-sm" /></div>
                                    ...
                                    <div class="card card-h-100">
                                        <div class="card-header d-flex align-items-center">
                                            ...
                                            <div class="dropdown ms-auto">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li>
                                                        <a class="dropdown-item"><i class="ti ti-eye me-2"></i>View</a>
                                                    </li>
                                                    <li>
                                                        <a class="dropdown-item"><i class="ti ti-edit me-2"></i>Edit</a>
                                                    </li>
                                                    <li>
                                                        <a class="dropdown-item text-danger"><i class="ti ti-trash me-2"></i>Remove</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card-body d-flex flex-column justify-content-between">
                                            <div class="row g-3">
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="avatar-group avatar-group-sm mb-3">
                                                        <div class="avatar"><img src="{{ asset('admin/assets/images/users/user-10.jpg') }}" class="rounded-circle avatar-sm" /></div>
                                                        <div class="avatar"><img src="{{ asset('admin/assets/images/users/user-9.jpg') }}" class="rounded-circle avatar-sm" /></div>
                                                        <div class="avatar"><img src="{{ asset('admin/assets/images/users/user-8.jpg') }}" class="rounded-circle avatar-sm" /></div>
                                                        <div class="avatar"><img src="{{ asset('admin/assets/images/users/user-7.jpg') }}" class="rounded-circle avatar-sm" /></div>
                                                        <div class="avatar"><img src="{{ asset('admin/assets/images/users/user-6.jpg') }}" class="rounded-circle avatar-sm" /></div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="d-flex gap-2">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center">
                                                <span class="text-muted fs-xs"><i class="ti ti-clock me-1"></i> Updated yesterday</span><a href="#" class="btn btn-sm btn-primary rounded-pill">Details</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card card-h-100">
                                        ...
                                        <div class="card-body d-flex flex-column justify-content-between">
                                            ...
                                            <div class="d-flex justify-content-between">
                                                <span class="text-muted fs-xs"><i class="ti ti-clock"></i> Updated 5 hours ago</span><a href="#" class="btn btn-sm btn-primary rounded-pill">Details</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="card card-h-100">
                                        ...
                                        <div class="card-body d-flex flex-column justify-content-between">
                                            ...
                                            <div class="d-flex justify-content-between">
                                                <span class="text-muted fs-xs"><i class="ti ti-clock"></i> Updated 2 days ago</span><a href="#" class="btn btn-sm btn-primary rounded-pill">Details</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="card card-h-100">
                                        ...
                                        <div class="card-body d-flex flex-column justify-content-between">
                                            ...
                                            <div class="d-flex justify-content-between">
                                                <span class="text-muted fs-xs"><i class="ti ti-clock"></i> Updated 4 hours ago</span><a href="#" class="btn btn-sm btn-primary rounded-pill">Details</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="modal-body">
                                    <form id="teamForm">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" placeholder="e.g., Creative Design Team" required />
                                        </div>

                                        <!-- Team Code / Short Label -->
                                        <div class="mb-3">
                                            <label class="form-label">Team Code</label>
                                            <input type="text" class="form-control" placeholder="e.g., IT-01" required />
                                        </div>
                                        ...
                                        <div class="mb-0">
                                            ...
                                            <textarea class="form-control" rows="3" placeholder="Brief team responsibilities..."></textarea>
                                        </div>
                                    </form>
                                </div>
