...
<!-- Mirrored from coderthemes.com/paces/bootstrap/charts-apex-bubble.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:59:21 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Apex Bubble Charts | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
...
<script src="{{ asset('admin/assets/js/app.js') }}"></script>
        ...
        <script src="{{ asset('admin/assets/js/pages/chart-apex-bubble.js') }}"></script>
    </body>

<!-- Mirrored from coderthemes.com/paces/bootstrap/charts-apex-bubble.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:59:22 GMT -->
</html>
