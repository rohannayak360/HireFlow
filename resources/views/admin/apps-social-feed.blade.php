...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-social-feed.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:39 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Social Feed | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Social Feed</h4>
                        </div>
                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-center mb-3">
                                        <div class="me-2 position-relative">
                                            <img src="{{ asset('admin/assets/images/users/user-3.jpg') }}" alt="avatar" class="rounded" width="42" height="42" />
                                        </div>
                                        <div>
                            ...
                            <div class="card">
                                <div class="card-body pb-2">
                                    <div class="d-flex align-items-center mb-2">
                                        ...
                                        <div class="w-100">
                                            <h5 class="m-0">
                                                <a href="#!" class="link-reset">Jeremy Tomlinson</a>
                                            </h5>
                                ...
                                <div class="card-body pb-2">
                                    ...
                                    <div class="bg-light-subtle mx-n3 p-3 border-top border-bottom border-dashed">
                                        <div class="d-flex align-items-start">
                                            <img class="me-2 avatar-sm rounded-circle" src="{{ asset('admin/assets/images/users/user-1.jpg') }}" alt="Generic placeholder image" />
                                            <div class="w-100">
                                                <h5 class="mt-0 mb-1">
                                                    <a href="#!" class="link-reset">Liam Johnson</a>
                                                ...
                                                <div class="d-flex align-items-start mt-3">
                                                    <a class="pe-2" href="#">
                                                        <img src="{{ asset('admin/assets/images/users/user-2.jpg') }}" class="avatar-sm rounded-circle" alt="Generic placeholder image" />
                                                    </a>
                                                    <div class="w-100">
                                                        <h5 class="mt-0 mb-1">
                                                            <a href="#!" class="link-reset">Olivia Carter</a>
                        ...
                        <div class="col-xl-3 col-lg-6 order-lg-1 order-xl-2">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="d-flex align-items-center mt-2">
                                            <img src="{{ asset('admin/assets/images/users/user-7.jpg') }}" class="rounded-circle me-2" width="32" height="32" alt="mention" />
                                            <div>
                                    ...
                                    <ul class="list-unstyled mt-2 mb-0">
                                        <li class="d-flex align-items-center py-1">
                                            <img src="{{ asset('admin/assets/images/users/user-8.jpg') }}" class="rounded-circle me-2" width="36" height="36" alt="jenny.w" />
                                            <div class="flex-grow-1">
                                        ...
                                        <li class="d-flex align-items-center py-1">
                                            <img src="{{ asset('admin/assets/images/users/user-9.jpg') }}" class="rounded-circle me-2" width="36" height="36" alt="daniel92" />
                                            <div class="flex-grow-1">
                                            ...
                                            <div>
                                                <img src="{{ asset('admin/assets/images/gallery/1.jpg') }}" class="rounded" width="32" height="32" alt="commented" />
                                            </div>
                                        </li>

                                        <li class="d-flex align-items-center py-1">
                                            <img src="{{ asset('admin/assets/images/users/user-10.jpg') }}" class="rounded-circle me-2" width="36" height="36" alt="amelie.design" />
                                            <div class="flex-grow-1">
                                            ...
                                            <div>
                                                <img src="{{ asset('admin/assets/images/gallery/2.jpg') }}" class="rounded" width="32" height="32" alt="liked" />
                                            </div>
                                        </li>

                                        <li class="d-flex align-items-center py-1">
                                            <img src="{{ asset('admin/assets/images/users/user-5.jpg') }}" class="rounded-circle me-2" width="36" height="36" alt="johnny_dev" />
                                            <div class="flex-grow-1">
                                        ...
                                        <li class="d-flex align-items-center py-1">
                                            <img src="{{ asset('admin/assets/images/users/user-6.jpg') }}" class="rounded-circle me-2" width="36" height="36" alt="art.gal" />
                                            <div class="flex-grow-1">
                                            ...
                                            <div>
                                                <img src="{{ asset('admin/assets/images/gallery/3.jpg') }}" class="rounded" width="32" height="32" alt="liked" />
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        <div class="d-flex align-items-start">
                                            <img src="{{ asset('admin/assets/images/users/user-3.jpg') }}" alt="Emily Zhang" class="avatar-xs rounded-circle me-2" />
                                            <div>
                                                <p class="mb-1">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        <div class="d-flex align-items-start">
                                            <img src="{{ asset('admin/assets/images/users/user-6.jpg') }}" alt="John Doe" class="avatar-xs rounded-circle me-2" />
                                            <div>
                                                <p class="mb-1">
...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-social-feed.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:42 GMT -->
</html>
