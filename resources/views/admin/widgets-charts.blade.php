...
<!-- Mirrored from coderthemes.com/paces/bootstrap/widgets-charts.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:59:15 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Chart Widgets | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Charts</h4>
                        </div>
                        ...
                        <div class="col-xxl-3 col-xl-6 order-xxl-1">
                            <div class="card card-h-100">
                                <div class="card-header justify-content-between">
                                    ...
                                    <div>
                                        <a href="#" class="btn btn-sm btn-default"><i class="ti ti-refresh me-1"></i> Refresh</a>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <div dir="ltr">
                                    ...
                                    <div class="text-center">
                                        <span class="badge badge-outline-light text-dark p-1 px-2 rounded-pill fs-12"><i class="ti ti-star-filled text-success me-1"></i> GOOD SALES</span>
                                    </div>
...
<script src="{{ asset('admin/assets/js/app.js') }}"></script>
        ...
        <!-- Chart Widgets js -->
        <script src="{{ asset('admin/assets/js/pages/widgets-charts.js') }}"></script>
    </body>
