...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-users-role-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:31 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Role Details | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                        ...
                        <div class="col-12">
                            <div class="d-flex align-items-sm-center flex-sm-row flex-column my-3">
                                ...
                                <div class="text-end mt-3 mt-sm-0">
                                    <a href="javascript:void(0);" class="btn btn-success"> <i class="ti ti-plus me-1"></i> Add New Role </a>
                                </div>
                            </div>
                                                ...
                                                <div class="ms-auto">
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-end">
                                                            ...
                                                            <li>
                                                                <a class="dropdown-item text-danger" href="#"><i class="ti ti-trash me-2"></i>Remove</a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            ...
                                            <table class="table table-custom table-centered table-select table-hover w-100 mb-0">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <h5 class="m-0"><a href="{{ url('admin/apps-users-profile') }}" class="link-reset">#USR76129</a></h5>
                                                        </td>
                                                        <td>
                                                            <div class="d-flex align-items-center gap-2">
                                                                <div class="avatar avatar-sm"><img src="{{ asset('admin/assets/images/users/user-1.jpg') }}" class="img-fluid rounded-circle" alt="Elena Carter" /></div>
                                                                <div>
                                                                    <h5 class="fs-base mb-0"><a href="{{ url('admin/apps-users-profile') }}" class="link-reset">Elena Carter</a></h5>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <h5 class="m-0"><a href="{{ url('admin/apps-users-profile') }}" class="link-reset">#USR58647</a></h5>
                                                        </td>
                                                        <td>
                                                            <div class="d-flex align-items-center gap-2">
                                                                <div class="avatar avatar-sm"><img src="{{ asset('admin/assets/images/users/user-2.jpg') }}" class="img-fluid rounded-circle" alt="Jordan Smith" /></div>
                                                                <div>
                                                                    <h5 class="fs-base mb-0"><a href="{{ url('admin/apps-users-profile') }}" class="link-reset">Jordan Smith</a></h5>
                                                    ...
                                                    <tr>
                                                        <td class="ps-3"><input class="form-check-input form-check-input-light fs-14 file-item-check mt-0" type="checkbox" /></td>
                                                        <td>
                                                            <h5 class="m-0"><a href="{{ url('admin/apps-users-profile') }}" class="link-reset">#USR94715</a></h5>
                                                        </td>
                                                        <td>
                                                            <div class="d-flex align-items-center gap-2">
                                                                <div class="avatar avatar-sm"><img src="{{ asset('admin/assets/images/users/user-3.jpg') }}" class="img-fluid rounded-circle" alt="Lucas Brown" /></div>
                                                                <div>
                                                                    <h5 class="fs-base mb-0"><a href="{{ url('admin/apps-users-profile') }}" class="link-reset">Lucas Brown</a></h5>
                                                    ...
                                                    <tr>
                                                        <td class="ps-3"><input class="form-check-input form-check-input-light fs-14 file-item-check mt-0" type="checkbox" /></td>
                                                        <td>
                                                            <h5 class="m-0"><a href="{{ url('admin/apps-users-profile') }}" class="link-reset">#USR40289</a></h5>
                                                        </td>
                                                        <td>
                                                            <div class="d-flex align-items-center gap-2">
                                                                <div class="avatar avatar-sm"><img src="{{ asset('admin/assets/images/users/user-4.jpg') }}" class="img-fluid rounded-circle" alt="Sophia Green" /></div>
                                                                <div>
                                                                    <h5 class="fs-base mb-0"><a href="{{ url('admin/apps-users-profile') }}" class="link-reset">Sophia Green</a></h5>
                                                    ...
                                                    <tr>
                                                        <td class="ps-3"><input class="form-check-input form-check-input-light fs-14 file-item-check mt-0" type="checkbox" /></td>
                                                        <td>
                                                            <h5 class="m-0"><a href="{{ url('admin/apps-users-profile') }}" class="link-reset">#USR23981</a></h5>
                                                        </td>
                                                        <td>
                                                            <div class="d-flex align-items-center gap-2">
                                                                <div class="avatar avatar-sm"><img src="{{ asset('admin/assets/images/users/user-5.jpg') }}" class="img-fluid rounded-circle" alt="Ethan Ross" /></div>
                                                                <div>
                                                                    <h5 class="fs-base mb-0"><a href="{{ url('admin/apps-users-profile') }}" class="link-reset">Ethan Ross</a></h5>
                                                    ...
                                                    <tr>
                                                        <td class="ps-3"><input class="form-check-input form-check-input-light fs-14 file-item-check mt-0" type="checkbox" /></td>
                                                        <td>
                                                            <h5 class="m-0"><a href="{{ url('admin/apps-users-profile') }}" class="link-reset">#USR83742</a></h5>
                                                        </td>
                                                        <td>
                                                            <div class="d-flex align-items-center gap-2">
                                                                <div class="avatar avatar-sm"><img src="{{ asset('admin/assets/images/users/user-6.jpg') }}" class="img-fluid rounded-circle" alt="Zara Mitchell" /></div>
                                                                <div>
                                                                    <h5 class="fs-base mb-0"><a href="{{ url('admin/apps-users-profile') }}" class="link-reset">Zara Mitchell</a></h5>
                                                    ...
                                                    <tr>
                                                        <td class="ps-3"><input class="form-check-input form-check-input-light fs-14 file-item-check mt-0" type="checkbox" /></td>
                                                        <td>
                                                            <h5 class="m-0"><a href="{{ url('admin/apps-users-profile') }}" class="link-reset">#USR51268</a></h5>
                                                        </td>
                                                        <td>
                                                            <div class="d-flex align-items-center gap-2">
                                                                <div class="avatar avatar-sm"><img src="{{ asset('admin/assets/images/users/user-7.jpg') }}" class="img-fluid rounded-circle" alt="Benjamin Gray" /></div>
                                                                <div>
                                                                    <h5 class="fs-base mb-0"><a href="{{ url('admin/apps-users-profile') }}" class="link-reset">Benjamin Gray</a></h5>
                                                    ...
                                                    <tr>
                                                        <td class="ps-3"><input class="form-check-input form-check-input-light fs-14 file-item-check mt-0" type="checkbox" /></td>
                                                        <td>
                                                            <h5 class="m-0"><a href="{{ url('admin/apps-users-profile') }}" class="link-reset">#USR17456</a></h5>
                                                        </td>
                                                        <td>
                                                            <div class="d-flex align-items-center gap-2">
                                                                <div class="avatar avatar-sm"><img src="{{ asset('admin/assets/images/users/user-8.jpg') }}" class="img-fluid rounded-circle" alt="Ava Patel" /></div>
                                                                <div>
                                                                    <h5 class="fs-base mb-0"><a href="{{ url('admin/apps-users-profile') }}" class="link-reset">Ava Patel</a></h5>
                                                    ...
                                                    <tr>
                                                        <td class="ps-3"><input class="form-check-input form-check-input-light fs-14 file-item-check mt-0" type="checkbox" /></td>
                                                        <td>
                                                            <h5 class="m-0"><a href="{{ url('admin/apps-users-profile') }}" class="link-reset">#USR96421</a></h5>
                                                        </td>
                                                        <td>
                                                            <div class="d-flex align-items-center gap-2">
                                                                <div class="avatar avatar-sm"><img src="{{ asset('admin/assets/images/users/user-9.jpg') }}" class="img-fluid rounded-circle" alt="Mason Rivera" /></div>
                                                                <div>
                                                                    <h5 class="fs-base mb-0"><a href="{{ url('admin/apps-users-profile') }}" class="link-reset">Mason Rivera</a></h5>
                                                    ...
                                                    <tr>
                                                        <td class="ps-3"><input class="form-check-input form-check-input-light fs-14 file-item-check mt-0" type="checkbox" /></td>
                                                        <td>
                                                            <h5 class="m-0"><a href="{{ url('admin/apps-users-profile') }}" class="link-reset">#USR71539</a></h5>
                                                        </td>
                                                        <td>
                                                            <div class="d-flex align-items-center gap-2">
                                                                <div class="avatar avatar-sm"><img src="{{ asset('admin/assets/images/users/user-10.jpg') }}" class="img-fluid rounded-circle" alt="Chloe Walker" /></div>
                                                                <div>
                                                                    <h5 class="fs-base mb-0"><a href="{{ url('admin/apps-users-profile') }}" class="link-reset">Chloe Walker</a></h5>
...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-users-role-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:32 GMT -->
</html>
