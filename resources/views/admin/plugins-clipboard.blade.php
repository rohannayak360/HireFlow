...
<!-- Mirrored from coderthemes.com/paces/bootstrap/plugins-clipboard.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:59 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Clipboard | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Clipboard</h4>
                        </div>
...
<script src="{{ asset('admin/assets/js/app.js') }}"></script>
        ...
        <!-- Clipboard Page js -->
        <script src="{{ asset('admin/assets/js/pages/plugins-clipboard.js') }}"></script>
    </body>
