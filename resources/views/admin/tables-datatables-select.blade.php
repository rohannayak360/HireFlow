...
<!-- Mirrored from coderthemes.com/paces/bootstrap/tables-datatables-select.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:59:57 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Select Datatables | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
        ...
        <link href="{{ asset('admin/assets/plugins/datatables/select.bootstrap5.min.css') }}" rel="stylesheet" type="text/css" />
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Select</h4>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <table id="single-select" class="table dt-responsive align-middle mb-0">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table id="multi-select" class="table dt-responsive align-middle mb-0">
                                        <thead class="thead-sm text-uppercase fs-xxs">
                                            <tr>
                                                <th>Company</th>
                                                <th>Symbol</th>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table id="cell-select" class="table dt-responsive align-middle mb-0">
                                        <thead class="thead-sm text-uppercase fs-xxs">
                                            <tr>
                                                <th>Company</th>
                                                <th>Symbol</th>
...
<script src="{{ asset('admin/assets/js/app.js') }}"></script>
        ...
        <script src="{{ asset('admin/assets/plugins/datatables/select.bootstrap5.min.js') }}"></script>

        <!-- Page js -->
        <script src="{{ asset('admin/assets/js/pages/datatables-select.js') }}"></script>
    </body>

<!-- Mirrored from coderthemes.com/paces/bootstrap/tables-datatables-select.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:59:58 GMT -->
</html>
