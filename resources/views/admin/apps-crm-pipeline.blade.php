...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-crm-pipeline.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:28 GMT -->
<head>
        <meta charset="utf-8" />
        <title>CRM Pipeline | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Pipeline</h4>
                        </div>
                                                        ...
                                                        <div class="card-body p-3">
                                                            ...
                                                            <div class="d-flex justify-content-between align-items-center">
                                                                <div class="d-flex align-items-center gap-1">
                                                                    <img src="{{ asset('admin/assets/images/users/user-4.jpg') }}" class="rounded-circle avatar-xs" alt="Mark Allen" />
                                                ...
                                                <li class="kanban-item">
                                                    <div class="card shadow mb-2">
                                                        <div class="card-body p-3">
                                                            ...
                                                            <div class="d-flex justify-content-between align-items-center">
                                                                <div class="d-flex align-items-center gap-1">
                                                                    <img src="{{ asset('admin/assets/images/users/user-2.jpg') }}" class="rounded-circle avatar-xs" alt="Alex Carter" />
                                                ...
                                                <li class="kanban-item">
                                                    <div class="card shadow mb-2">
                                                        <div class="card-body p-3">
                                                            ...
                                                            <div class="d-flex justify-content-between align-items-center">
                                                                <div class="d-flex align-items-center gap-1">
                                                                    <img src="{{ asset('admin/assets/images/users/user-5.jpg') }}" class="rounded-circle avatar-xs" alt="Emily Rose" />
                                                ...
                                                <li class="kanban-item">
                                                    <div class="card shadow mb-2">
                                                        <div class="card-body p-3">
                                                            ...
                                                            <div class="d-flex justify-content-between align-items-center">
                                                                <div class="d-flex align-items-center gap-1">
                                                                    <img src="{{ asset('admin/assets/images/users/user-6.jpg') }}" class="rounded-circle avatar-xs" alt="Ryan King" />
                                                ...
                                                <li class="kanban-item">
                                                    <div class="card shadow mb-2">
                                                        <div class="card-body p-3">
                                                            ...
                                                            <div class="d-flex justify-content-between align-items-center">
                                                                <div class="d-flex align-items-center gap-1">
                                                                    <img src="{{ asset('admin/assets/images/users/user-8.jpg') }}" class="rounded-circle avatar-xs" alt="Nina White" />
                                                ...
                                                <li class="kanban-item">
                                                    <div class="card shadow mb-2">
                                                        <div class="card-body p-3">
                                                            ...
                                                            <div class="d-flex justify-content-between align-items-center">
                                                                <div class="d-flex align-items-center gap-1">
                                                                    <img src="{{ asset('admin/assets/images/users/user-9.jpg') }}" class="rounded-circle avatar-xs" alt="Amit Rao" />
                                                    ...
                                                    <div class="card shadow mb-2">
                                                        <div class="card-body p-3">
                                                            <div class="d-flex align-items-start mb-2">
                                                                <div>
                                                                    <h5 class="mb-0 fw-semibold">
                                                                        <a href="#!" class="link-reset">Enterprise License Upgrade</a>
                                                                    </h5>
                                                            ...
                                                            <div class="d-flex justify-content-between align-items-center">
                                                                <div class="d-flex align-items-center gap-1">
                                                                    <img src="{{ asset('admin/assets/images/users/user-1.jpg') }}" class="rounded-circle avatar-xs" alt="Sophia Lee" />
                                                                    <span class="fw-medium text-muted fs-sm">Sophia Lee</span>
                                                                </div>
                                                                <div class="d-flex align-items-center gap-1">
                                                                    <i class="ti ti-calendar-clock text-success"></i>
                                                            ...
                                                            <div class="mt-2">
                                                                <div class="d-flex justify-content-between align-items-center">
                                                                    <div class="d-flex align-items-center gap-2 fs-sm">
                                                                        <i class="ti ti-medal text-success fs-lg"></i>
                                                                        Won
                                                                    </div>
                                                    ...
                                                    <div class="card shadow mb-2">
                                                        <div class="card-body p-3">
                                                            <div class="d-flex align-items-start mb-2">
                                                                <div>
                                                                    <h5 class="mb-0 fw-semibold">
                                                                        <a href="#!" class="link-reset">Custom CRM Implementation</a>
                                                                    </h5>
                                                            ...
                                                            <div class="d-flex justify-content-between align-items-center">
                                                                <div class="d-flex align-items-center gap-1">
                                                                    <img src="{{ asset('admin/assets/images/users/user-2.jpg') }}" class="rounded-circle avatar-xs" alt="Mark J." />
                                                    ...
                                                    <div class="card shadow mb-2">
                                                        <div class="card-body p-3">
                                                            <div class="d-flex align-items-start mb-2">
                                                                <div>
                                                                    <h5 class="mb-0 fw-semibold">
                                                                        <a href="#!" class="link-reset">API Subscription Expansion</a>
                                                                    </h5>
                                                            ...
                                                            <div class="d-flex justify-content-between align-items-center">
                                                                <div class="d-flex align-items-center gap-1">
                                                                    <img src="{{ asset('admin/assets/images/users/user-3.jpg') }}" class="rounded-circle avatar-xs" alt="Raj Patel" />
                                                    ...
                                                    <div class="card shadow mb-2">
                                                        <div class="card-body p-3">
                                                            <div class="d-flex align-items-start mb-2">
                                                                <div>
                                                                    <h5 class="mb-0 fw-semibold">
                                                                        <a href="#!" class="link-reset">Annual Cloud Retainer</a>
                                                                    </h5>
                                                            ...
                                                            <div class="d-flex justify-content-between align-items-center">
                                                                <div class="d-flex align-items-center gap-1">
                                                                    <img src="{{ asset('admin/assets/images/users/user-5.jpg') }}" class="rounded-circle avatar-xs" alt="Tina Ray" />
                                                    ...
                                                    <div class="card shadow mb-2">
                                                        <div class="card-body p-3">
                                                            <div class="d-flex align-items-start mb-2">
                                                                <div>
                                                                    <h5 class="mb-0 fw-semibold">
                                                                        <a href="#!" class="link-reset">Marketing Automation Deal</a>
                                                                    </h5>
                                                            ...
                                                            <div class="d-flex justify-content-between align-items-center">
                                                                <div class="d-flex align-items-center gap-1">
                                                                    <img src="{{ asset('admin/assets/images/users/user-6.jpg') }}" class="rounded-circle avatar-xs" alt="Mohit Chauhan" />
                                                ...
                                                <li class="kanban-item">
                                                    <div class="card shadow mb-2 border-danger-subtle">
                                                        <div class="card-body p-3">
                                                            ...
                                                            <div class="d-flex justify-content-between align-items-center">
                                                                <div class="d-flex align-items-center gap-1">
                                                                    <img src="{{ asset('admin/assets/images/users/user-7.jpg') }}" class="rounded-circle avatar-xs" alt="Julia Mason" />
                                                                    <span class="fw-medium text-muted fs-sm">Julia Mason</span>
                                                                </div>
                                                                <div class="d-flex align-items-center gap-1">
                                                                    <i class="ti ti-calendar text-danger fs-lg"></i>
                                                            ...
                                                            <div class="mt-2">
                                                                <div class="d-flex justify-content-between align-items-center">
                                                                    <div class="d-flex align-items-center gap-2 fs-sm">
                                                                        <i class="ti ti-x text-danger fs-lg"></i>
                                                                        Lost
                                                                    </div>
                                                ...
                                                <li class="kanban-item">
                                                    <div class="card shadow mb-2 border-danger-subtle">
                                                        <div class="card-body p-3">
                                                            ...
                                                            <div class="d-flex justify-content-between align-items-center">
                                                                <div class="d-flex align-items-center gap-1">
                                                                    <img src="{{ asset('admin/assets/images/users/user-8.jpg') }}" class="rounded-circle avatar-xs" alt="Ethan Cruz" />
...
<script src="{{ asset('admin/assets/js/app.js') }}"></script>
        ...
        <!-- Dashboard App js -->
        <script src="{{ asset('admin/assets/js/pages/apps-crm-pipeline.js') }}"></script>
    </body>
