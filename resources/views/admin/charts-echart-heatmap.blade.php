...
<!-- Mirrored from coderthemes.com/paces/bootstrap/charts-echart-heatmap.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:59:36 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Echart Heatmap Chart | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
...
<script src="{{ asset('admin/assets/js/app.js') }}"></script>
        ...
        <!-- E Charts Demo js -->
        <script src="{{ asset('admin/assets/js/pages/chart-echart-heatmap.js') }}"></script>
    </body>
