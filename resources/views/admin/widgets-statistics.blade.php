...
<!-- Mirrored from coderthemes.com/paces/bootstrap/widgets-statistics.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:59:16 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Statistics Widgets | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Statistics</h4>
                        </div>
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <div>
                                            ...
                                            <p class="mb-0 text-muted">
                                                <span class="text-success me-2"><i class="ti ti-arrow-up"></i> 3.2%</span>
                                                Since last month
                                            </p>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="d-flex justify-content-between">
                                        <div>
                                            ...
                                            <p class="mb-0 text-muted">
                                                <span class="text-success me-2"><i class="ti ti-arrow-up"></i> 6.1%</span>
                                                Since last month
                                            </p>
                                        </div>
                                        <div class="avatar-lg flex-shrink-0">
                                ...
                                <div class="card-body">
                                    <div class="d-flex justify-content-between">
                                        <div>
                                            ...
                                            <h3 class="my-2 py-1 fw-semibold text-white">$<span data-target="98.40">0</span>k</h3>
                                            <p class="mb-0 text-white-50">
                                                <span class="text-white me-2"><i class="ti ti-arrow-down"></i> 2.9%</span>
                                                Since last month
                                            </p>
                                        </div>
                                        <div class="avatar-lg flex-shrink-0">
                                ...
                                <div class="card-body">
                                    <div class="d-flex justify-content-between">
                                        <div>
                                            ...
                                            <h3 class="my-2 py-1 fw-semibold"><span data-target="4.76">0</span>%</h3>
                                            <p class="mb-0 text-muted">
                                                <span class="text-success me-2"><i class="ti ti-arrow-up"></i> 1.4%</span>
                                                Since last month
                                            </p>
                                        </div>
                                        <div class="avatar-lg flex-shrink-0">
                                        ...
                                        <div class="col">
                                            <div class="mt-3 mt-md-0 p-3">
                                                ...
                                                <div class="d-flex align-items-center justify-content-center gap-2 my-3">
                                                    ...
                                                    <h3 class="mb-0 fw-bold"><span data-target="72.40">0</span>%</h3>
                                                </div>
                                                <p class="mb-0 text-muted">
                                                    <span class="text-success me-2"><i class="ti ti-arrow-up"></i> 3.47%</span>
                                                    <span class="text-nowrap">Since last month</span>
                                                </p>
                                            </div>
                                        </div>
                                    ...
                                    <div class="d-flex gap-3">
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <div class="progress bg-secondary bg-opacity-25 progress-sm mb-0">
                                                <div class="progress-bar bg-secondary" role="progressbar" style="width: 15.1%" aria-valuenow="15.1" aria-valuemin="0" aria-valuemax="100"></div>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- end .d-flex-->
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-6">
                                            ...
                                            <div class="d-flex align-items-center gap-2 my-3">
                                                ...
                                                <h3 class="mb-0 fw-bold"><span data-target="78.4">0</span>k</h3>
                                            </div>
                                            <p class="mb-0 text-muted">
                                                <span class="text-success me-2">+6.8% <i class="ti ti-trending-up ms-1"></i></span>
                                        ...
                                        <div class="col-6 text-end">
                                            ...
                                            <span class="badge bg-success-subtle text-success">On Track <i class="ti ti-circle-check ms-1"></i></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-6">
                                            ...
                                            <div class="d-flex align-items-center gap-2 my-3">
                                                ...
                                                <h3 class="mb-0 fw-bold"><span data-target="95.3">0</span>%</h3>
                                            </div>
                                            <p class="mb-0 text-muted">
                                                <span class="text-danger me-2">-1.2% <i class="ti ti-trending-down ms-1"></i></span>
                                        ...
                                        <div class="col-6 text-end">
                                            ...
                                            <span class="badge bg-warning-subtle text-warning">Monitor <i class="ti ti-alert-circle ms-1"></i></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-6">
                                            ...
                                            <div class="d-flex align-items-center gap-2 my-3">
                                                ...
                                                <h3 class="mb-0 fw-bold"><span data-target="185">0</span>ms</h3>
                                            </div>
                                            <p class="mb-0 text-muted">
                                                <span class="text-success me-2">+3.4% <i class="ti ti-trending-up ms-1"></i></span>
                                        ...
                                        <div class="col-6 text-end">
                                            ...
                                            <span class="badge bg-success-subtle text-success">Great <i class="ti ti-thumb-up ms-1"></i></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-6">
                                            ...
                                            <div class="d-flex align-items-center gap-2 my-3">
                                                ...
                                                <h3 class="mb-0 fw-bold">$<span data-target="2.84">0</span>M</h3>
                                            </div>
                                            <p class="mb-0 text-muted">
                                                <span class="text-success me-2">+8.9% <i class="ti ti-trending-up ms-1"></i></span>
                                        ...
                                        <div class="col-6 text-end">
                                            ...
                                            <span class="badge bg-success-subtle text-success">Ahead <i class="ti ti-circle-check ms-1"></i></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-xl-4 row-cols-xxl-6">
                        ...
                        <div class="col">
                            <div class="card">
                                <div class="card-body text-center">
                                    <iconify-icon icon="solar:cpu-bolt-bold-duotone" class="fs-36 text-primary"></iconify-icon>
                                    <h3 class="fw-bold mt-3 mb-1"><span data-target="12.5">0</span>M</h3>
                                    <p class="text-muted">Tokens Processed</p>
                                    <span class="badge fs-12 badge-soft-success"><i class="ti ti-arrow-badge-up"></i> 6.4%</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="card">
                                <div class="card-body text-center">
                                    <iconify-icon icon="solar:cloud-plus-bold-duotone" class="fs-36 text-info"></iconify-icon>
                                    <h3 class="fw-bold mt-3 mb-1"><span data-target="284">0</span>k</h3>
                                    <p class="text-muted">API Requests</p>
                                    <span class="badge fs-12 badge-soft-success"><i class="ti ti-arrow-badge-up"></i> 4.8%</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="card">
                                <div class="card-body text-center">
                                    <iconify-icon icon="solar:target-bold-duotone" class="fs-36 text-warning"></iconify-icon>
                                    <h3 class="fw-bold mt-3 mb-1"><span data-target="98.6">0</span>%</h3>
                                    <p class="text-muted">Model Accuracy</p>
                                    <span class="badge fs-12 badge-soft-success"><i class="ti ti-arrow-badge-up"></i> 1.2%</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="card">
                                <div class="card-body text-center">
                                    <iconify-icon icon="solar:clock-circle-bold-duotone" class="fs-36 text-secondary"></iconify-icon>
                                    <h3 class="fw-bold mt-3 mb-1"><span data-target="210">0</span>ms</h3>
                                    <p class="text-muted">Response Time</p>
                                    <span class="badge fs-12 badge-soft-danger"><i class="ti ti-arrow-badge-down"></i> 3.1%</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="card">
                                <div class="card-body text-center">
                                    <iconify-icon icon="solar:hand-money-bold-duotone" class="fs-36 text-success"></iconify-icon>
                                    <h3 class="fw-bold mt-3 mb-1">$<span data-target="76.4">0</span>k</h3>
                                    <p class="text-muted">Cost Savings</p>
                                    <span class="badge fs-12 badge-soft-success"><i class="ti ti-arrow-badge-up"></i> 9.5%</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="card">
                                <div class="card-body text-center">
                                    <iconify-icon icon="solar:server-square-cloud-bold-duotone" class="fs-36 text-danger"></iconify-icon>
                                    <h3 class="fw-bold mt-3 mb-1"><span data-target="62.3">0</span>%</h3>
                                    <p class="text-muted">GPU Utilization</p>
                                    <span class="badge fs-12 badge-soft-warning"><i class="ti ti-arrow-badge-up"></i> 2.7%</span>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="text-end">
                                            <h3 class="mb-2 fw-normal">$<span data-target="245.6">245.6</span>K</h3>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="text-end">
                                            <h3 class="mb-2 fw-normal"><span data-target="3.25">3.25</span>%</h3>
