...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-companies.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:43 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Companies | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                                ...
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-start mb-3">
                                        ...
                                        <div class="d-flex align-items-center gap-3">
                                            <img src="{{ asset('admin/assets/images/logos/amazon.svg') }}" alt="Amazon Logo" width="50" height="50" class="rounded" />
                                            <div>
                                                <h4 class="mb-1 fw-bold">Amazon Inc.</h4>
                                                <a href="https://www.amazon.com/" class="text-muted small" target="_blank">www.amazon.com</a>
                                            </div>
                                        </div>
                                        <!-- Follow Button -->
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <a href="#" class="btn btn-primary btn-sm">Visit Company Profile</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-start mb-3">
                                        <!-- Logo -->
                                        <div class="d-flex align-items-center gap-3">
                                            <img src="{{ asset('admin/assets/images/logos/apple.svg') }}" alt="Apple Logo" width="50" height="50" class="rounded" />
                                            <div>
                                                <h4 class="mb-1 fw-bold">Apple Inc.</h4>
                                                <a href="https://www.apple.com/" class="text-muted small" target="_blank">www.apple.com</a>
                                            </div>
                                        </div>
                                        <!-- Follow Button -->
                                        <button class="btn btn-outline-danger btn-sm">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-start mb-3">
                                        <!-- Logo -->
                                        <div class="d-flex align-items-center gap-3">
                                            <img src="{{ asset('admin/assets/images/logos/starbucks.svg') }}" alt="Starbucks Logo" width="50" height="50" class="rounded" />
                                            <div>
                                                <h4 class="mb-1 fw-bold">Starbucks Corporation</h4>
                                                <a href="https://www.starbucks.com/" class="text-muted small" target="_blank">www.starbucks.com</a>
                                            </div>
                                        </div>
                                        <!-- Follow Button -->
                                        <button class="btn btn-outline-danger btn-sm">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-start mb-3">
                                        <!-- Logo -->
                                        <div class="d-flex align-items-center gap-3">
                                            <img src="{{ asset('admin/assets/images/logos/meta.svg') }}" alt="Meta Logo" width="50" height="50" class="rounded" />
                                            <div>
                                                <h4 class="mb-1 fw-bold">Meta Platforms, Inc.</h4>
                                                <a href="https://www.meta.com/" class="text-muted small" target="_blank">www.meta.com</a>
                                            </div>
                                        </div>
                                        <!-- Follow Button -->
                                        <button class="btn btn-outline-danger btn-sm">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-start mb-3">
                                        <!-- Logo -->
                                        <div class="d-flex align-items-center gap-3">
                                            <img src="{{ asset('admin/assets/images/logos/spotify.svg') }}" alt="Spotify Logo" width="50" height="50" class="rounded" />
                                            <div>
                                                <h4 class="mb-1 fw-bold">Spotify Technology S.A.</h4>
                                                <a href="https://www.spotify.com/" class="text-muted small" target="_blank">www.spotify.com</a>
                                            </div>
                                        </div>
                                        <!-- Follow Button -->
                                        <button class="btn btn-outline-danger btn-sm">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-start mb-3">
                                        <!-- Logo -->
                                        <div class="d-flex align-items-center gap-3">
                                            <img src="{{ asset('admin/assets/images/logos/google.svg') }}" alt="Google Logo" width="50" height="50" class="rounded" />
                                            <div>
                                                <h4 class="mb-1 fw-bold">Google LLC</h4>
                                                <a href="https://www.google.com/" class="text-muted small" target="_blank">www.google.com</a>
                                            </div>
                                        </div>
                                        <!-- Follow Button -->
                                        <button class="btn btn-outline-danger btn-sm">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-start mb-3">
                                        <!-- Logo -->
                                        <div class="d-flex align-items-center gap-3">
                                            <img src="{{ asset('admin/assets/images/logos/airbnb.svg') }}" alt="Airbnb Logo" width="50" height="50" class="rounded" />
                                            <div>
                                                <h4 class="mb-1 fw-bold">Airbnb, Inc.</h4>
                                                <a href="https://www.airbnb.com/" class="text-muted small" target="_blank">www.airbnb.com</a>
                                            </div>
                                        </div>
                                        <!-- Follow Button -->
                                        <button class="btn btn-outline-danger btn-sm">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-start mb-3">
                                        <!-- Logo -->
                                        <div class="d-flex align-items-center gap-3">
                                            <img src="{{ asset('admin/assets/images/logos/shell.svg') }}" alt="Shell Logo" width="50" height="50" class="rounded" />
                                            <div>
                                                <h4 class="mb-1 fw-bold">Shell plc</h4>
                                                <a href="https://www.shell.com/" class="text-muted small" target="_blank">www.shell.com</a>
                                            </div>
                                        </div>
                                        <!-- Follow Button -->
                                        <button class="btn btn-outline-danger btn-sm">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-start mb-3">
                                        <!-- Logo -->
                                        <div class="d-flex align-items-center gap-3">
                                            <img src="{{ asset('admin/assets/images/logos/asana.svg') }}" alt="Asana Logo" width="50" height="50" class="rounded" />
                                            <div>
                                                <h4 class="mb-1 fw-bold">Asana, Inc.</h4>
                                                <a href="https://www.asana.com/" class="text-muted small" target="_blank">www.asana.com</a>
                                            </div>
                                        </div>
                                        <!-- Follow Button -->
                                        <button class="btn btn-outline-danger btn-sm">
...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-companies.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:44 GMT -->
</html>
