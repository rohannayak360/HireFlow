...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-projects-kanban.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:21 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Kanban Board | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Kanban Board</h4>
                        </div>
                        ...
                        <div class="card h-100 mb-0 flex-grow-1">
                            <div class="card-header border-light align-items-center gap-2">
                                ...
                                <div class="app-search">
                                    <input type="search" class="form-control" placeholder="Search by task name, assignee..." />
                                    <i class="ti ti-search app-search-icon text-muted"></i>
                                </div>
                                ...
                                <!-- Add New Card Button -->
                                <button type="button" class="btn btn-primary ms-lg-auto" data-bs-toggle="modal" data-bs-target="#addTaskModal">
                                ...
                                <div class="kanban-content bg-light bg-opacity-40">
                                    ...
                                    <div class="kanban-board">
                                        <div class="kanban-item py-2 px-3 d-flex align-items-center">
                                            ...
                                            <a href="#!" class="ms-auto btn btn-sm btn-icon rounded-circle btn-primary">
                                                ...
                                                <li class="kanban-item">
                                                    <div class="card mb-2 border border-light">
                                                        <div class="card-body">
                                                            ...
                                                            <h5 class="mb-2">
                                                                <a href="#!" class="link-reset">Design onboarding flow for new user sign-up journey.</a>
                                                            </h5>

                                                            <div class="d-flex align-items-center mb-2">
                                                                <img src="{{ asset('admin/assets/images/users/user-5.jpg') }}" class="rounded-circle me-2" width="28" height="28" alt="" />
                                                            ...
                                                            <div class="d-flex justify-content-between align-items-center mb-n1 text-muted">
                                                                <span>4 Days</span>
                                                                <span><i class="ti ti-list-check"></i> 3</span>
                                                                <span><i class="ti ti-link"></i> 2</span>
                                                                <span><i class="ti ti-messages"></i> 9</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </li>
                                                ...
                                                <li class="kanban-item">
                                                    <div class="card mb-2 border border-light">
                                                        <div class="card-body">
                                                            ...
                                                            <h5 class="mb-2"><a href="#!" class="link-reset">Create dark/light theme switcher with local storage.</a></h5>

                                                            <div class="d-flex align-items-center mb-2">
                                                                <img src="{{ asset('admin/assets/images/users/user-8.jpg') }}" width="28" height="28" class="rounded-circle me-2" />
                                                                <span class="text-muted fw-medium">Mia Johnson</span>
                                                            </div>

                                                            <div class="d-flex justify-content-between align-items-center mb-n1 text-muted">
                                                                <span>2 Days</span>
                                                                <span><i class="ti ti-list-check"></i> 4</span>
                                                                <span><i class="ti ti-link"></i> 1</span>
                                                                <span><i class="ti ti-messages"></i> 6</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </li>
                                                ...
                                                <li class="kanban-item">
                                                    <div class="card mb-2 border border-light">
                                                        <div class="card-body">
                                                            ...
                                                            <h5 class="mb-2"><a href="#!" class="link-reset">Write documentation for project setup and deployment.</a></h5>

                                                            <div class="d-flex align-items-center mb-2">
                                                                <img src="{{ asset('admin/assets/images/users/user-9.jpg') }}" width="28" height="28" class="rounded-circle me-2" />
                                                            ...
                                                            <div class="d-flex justify-content-between align-items-center mb-n1 text-muted">
                                                                ...
                                                                <span><i class="ti ti-list-check"></i> 3</span>
                                                                <span><i class="ti ti-link"></i> 1</span>
                                                                <span><i class="ti ti-messages"></i> 10</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </li>
                                                ...
                                                <li class="kanban-item">
                                                    <div class="card mb-2 border border-light">
                                                        <div class="card-body">
                                                            ...
                                                            <h5 class="mb-2"><a href="#!" class="link-reset">Fix payment failed callback issue in checkout API.</a></h5>

                                                            <div class="d-flex align-items-center mb-2">
                                                                <img src="{{ asset('admin/assets/images/users/user-3.jpg') }}" width="28" height="28" class="rounded-circle me-2" />
                                                                <span class="text-muted fw-medium">Noah Parker</span>
                                                            </div>

                                                            <div class="d-flex justify-content-between align-items-center mb-n1 text-muted">
                                                                <span>1 Day</span>
                                                                <span><i class="ti ti-list-check"></i> 5</span>
                                                                <span><i class="ti ti-link"></i> 2</span>
                                                                <span><i class="ti ti-messages"></i> 14</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </li>
                                                ...
                                                <li class="kanban-item">
                                                    <div class="card mb-2 border border-light">
                                                        <div class="card-body">
                                                            ...
                                                            <h5 class="mb-2"><a href="#!" class="link-reset">Resolve server downtime and restore access logs.</a></h5>

                                                            <div class="d-flex align-items-center mb-2">
                                                                <img src="{{ asset('admin/assets/images/users/user-7.jpg') }}" width="28" height="28" class="rounded-circle me-2" />
                                                                <span class="text-muted fw-medium">Lucas Martin</span>
                                                            </div>

                                                            <div class="d-flex justify-content-between align-items-center mb-n1 text-muted">
                                                                <span>8 Hours</span>
                                                                <span><i class="ti ti-list-check"></i> 7</span>
                                                                <span><i class="ti ti-link"></i> 3</span>
                                                                <span><i class="ti ti-messages"></i> 18</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </li>
                                                ...
                                                <li class="kanban-item">
                                                    <div class="card mb-2 border border-light">
                                                        <div class="card-body">
                                                            ...
                                                            <h5 class="mb-2"><a href="#!" class="link-reset">Implement role-based access control for admin panel.</a></h5>

                                                            <div class="d-flex align-items-center mb-2">
                                                                <img src="{{ asset('admin/assets/images/users/user-4.jpg') }}" class="rounded-circle me-2" width="28" height="28" />
                                                            ...
                                                            <div class="d-flex justify-content-between align-items-center mb-n1 text-muted">
                                                                <span>3 Days</span>
                                                                <span><i class="ti ti-list-check"></i> 5</span>
                                                                <span><i class="ti ti-link"></i> 4</span>
                                                                <span><i class="ti ti-messages"></i> 11</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </li>
                                                ...
                                                <li class="kanban-item">
                                                    <div class="card mb-2 border border-light">
                                                        <div class="card-body">
                                                            ...
                                                            <h5 class="mb-2"><a href="#!" class="link-reset">Refactor project directory structure for clarity.</a></h5>

                                                            <div class="d-flex align-items-center mb-2">
                                                                <img src="{{ asset('admin/assets/images/users/user-7.jpg') }}" class="rounded-circle me-2" width="28" height="28" />
                                                            ...
                                                            <div class="d-flex justify-content-between align-items-center mb-n1 text-muted">
                                                                ...
                                                                <span><i class="ti ti-list-check"></i> 3</span>
                                                                <span><i class="ti ti-link"></i> 1</span>
                                                                <span><i class="ti ti-messages"></i> 7</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </li>
                                                ...
                                                <li class="kanban-item">
                                                    <div class="card mb-2 border border-light">
                                                        <div class="card-body">
                                                            ...
                                                            <h5 class="mb-2"><a href="#!" class="link-reset">Resolve 500 errors occurring on user authentication.</a></h5>

                                                            <div class="d-flex align-items-center mb-2">
                                                                <img src="{{ asset('admin/assets/images/users/user-9.jpg') }}" class="rounded-circle me-2" width="28" height="28" />
                                                                <span class="text-muted fw-medium">Evelyn Clark</span>
                                                            </div>

                                                            <div class="d-flex justify-content-between align-items-center mb-n1 text-muted">
                                                                <span>6 Hours</span>
                                                                <span><i class="ti ti-list-check"></i> 8</span>
                                                                <span><i class="ti ti-link"></i> 5</span>
                                                                <span><i class="ti ti-messages"></i> 21</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </li>
                                                ...
                                                <li class="kanban-item">
                                                    <div class="card mb-2 border border-light">
                                                        <div class="card-body">
                                                            ...
                                                            <h5 class="mb-2"><a href="#!" class="link-reset">Add placeholder loading animations (skeleton screens).</a></h5>

                                                            <div class="d-flex align-items-center mb-2">
                                                                <img src="{{ asset('admin/assets/images/users/user-10.jpg') }}" class="rounded-circle me-2" width="28" height="28" />
                                                            ...
                                                            <div class="d-flex justify-content-between align-items-center mb-n1 text-muted">
                                                                <span>4 Days</span>
                                                                <span><i class="ti ti-list-check"></i> 4</span>
                                                                <span><i class="ti ti-link"></i> 0</span>
                                                                <span><i class="ti ti-messages"></i> 8</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </li>
                                                ...
                                                <li class="kanban-item">
                                                    <div class="card mb-2 border border-light">
                                                        <div class="card-body">
                                                            ...
                                                            <h5 class="mb-2"><a href="#!" class="link-reset">Improve success/error toast notification styles.</a></h5>

                                                            <div class="d-flex align-items-center mb-2">
                                                                <img src="{{ asset('admin/assets/images/users/user-6.jpg') }}" class="rounded-circle me-2" width="28" height="28" />
                                                                <span class="text-muted fw-medium">Andrew Carter</span>
                                                            </div>

                                                            <div class="d-flex justify-content-between align-items-center mb-n1 text-muted">
                                                                <span>5 Days</span>
                                                                <span><i class="ti ti-list-check"></i> 1</span>
                                                                <span><i class="ti ti-link"></i> 0</span>
                                                                <span><i class="ti ti-messages"></i> 3</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </li>
                                                ...
                                                <li class="kanban-item">
                                                    <div class="card mb-2 border border-light">
                                                        <div class="card-body">
                                                            ...
                                                            <h5 class="mb-2"><a href="#!" class="link-reset">Integrate analytics dashboard with real-time API data.</a></h5>
                                                            ...
                                                            <div class="d-flex justify-content-between align-items-center mb-n1 text-muted">
                                                                <span>3 Days</span>
                                                                <span><i class="ti ti-list-check"></i> 6</span>
                                                                <span><i class="ti ti-link"></i> 3</span>
                                                                <span><i class="ti ti-messages"></i> 12</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </li>
                                                <li class="kanban-item">
                                                    <div class="card mb-2 border border-light">
                                                        <div class="card-body">
                                                            ...
                                                            <h5 class="mb-2"><a href="#!" class="link-reset">Add pagination support to activity feed list.</a></h5>

                                                            <div class="d-flex align-items-center mb-2">
                                                                <img src="{{ asset('admin/assets/images/users/user-1.jpg') }}" width="28" height="28" class="rounded-circle me-2" />
                                                            ...
                                                            <div class="d-flex justify-content-between text-muted">
                                                                ...
                                                                <span><i class="ti ti-list-check"></i> 3</span>
                                                                <span><i class="ti ti-link"></i> 1</span>
                                                                <span><i class="ti ti-messages"></i> 5</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </li>
                                                ...
                                                <li class="kanban-item">
                                                    <div class="card mb-2 border border-light">
                                                        <div class="card-body">
                                                            ...
                                                            <h5 class="mb-2"><a href="#!" class="link-reset">Completed UI redesign for profile settings page.</a></h5>

                                                            <div class="d-flex align-items-center mb-2">
                                                                <img src="{{ asset('admin/assets/images/users/user-3.jpg') }}" class="rounded-circle me-2" width="28" height="28" />
                                                ...
                                                <li class="kanban-item">
                                                    <div class="card mb-2 border border-light">
                                                        <div class="card-body">
                                                            ...
                                                            <h5 class="mb-2"><a href="#!" class="link-reset">Launched new email notification templating system.</a></h5>

                                                            <div class="d-flex align-items-center mb-2">
                                                                <img src="{{ asset('admin/assets/images/users/user-5.jpg') }}" class="rounded-circle me-2" width="28" height="28" />
                                                            ...
                                                            <div class="d-flex justify-content-between align-items-center text-muted">
                                                                ...
                                                                <span><i class="ti ti-list-check"></i> 5</span>
                                                                <span><i class="ti ti-link"></i> 0</span>
                                                                <span><i class="ti ti-messages"></i> 2</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </li>
                                ...
                                <div class="modal-body">
                                    <form id="taskForm">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" rows="3" placeholder="Brief details..."></textarea>
                                        </div>
                                    </form>
                                </div>
...
<script src="{{ asset('admin/assets/js/app.js') }}"></script>
        ...
        <!-- Kanban Page js -->
        <script src="{{ asset('admin/assets/js/pages/apps-kanban.js') }}"></script>
    </body>

<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-projects-kanban.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:22 GMT -->
</html>
