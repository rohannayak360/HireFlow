...
<!-- Mirrored from coderthemes.com/paces/bootstrap/ui-alerts.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:59:09 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Alerts | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Alerts</h4>
                        </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="alert alert-primary" role="alert">
                                        ...
                                        <a href="#" class="alert-link">this primary link</a>
                                        for important details.
                                    </div>

                                    <div class="alert alert-secondary" role="alert">
                                        Here's a secondary message with
                                        <a href="#" class="alert-link">a helpful link</a>
                                        for additional context.
                                    </div>

                                    <div class="alert alert-success" role="alert">
                                        Operation successful! View the results
                                        <a href="#" class="alert-link">by clicking here</a>
                                        .
                                    </div>

                                    <div class="alert alert-danger" role="alert">
                                        Something went wrong. Learn more
                                        <a href="#" class="alert-link">through this alert link</a>
                                        .
                                    </div>

                                    <div class="alert alert-warning" role="alert">
                                        Heads up! You might want to check
                                        <a href="#" class="alert-link">this warning link</a>
                                        .
                                    </div>

                                    <div class="alert alert-info" role="alert">
                                        Here’s some information that may help—click
                                        <a href="#" class="alert-link">this link</a>
                                        to read more.
                                    </div>

                                    <div class="alert alert-light" role="alert">
                                        Just a light reminder with
                                        <a href="#" class="alert-link">a gentle link</a>
                                        to explore.
                                    </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="alert alert-secondary p-3 d-flex" role="alert">
                                        <i class="ti ti-alarm-snooze fs-1 me-2"></i>
                                        <div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="alert alert-info alert-dismissible d-flex align-items-center gap-2" role="alert">
                                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                        <i class="ti ti-alert-octagon fs-xl"></i>
...
<script src="{{ asset('admin/assets/js/app.js') }}"></script>
        ...
        <!-- Page js -->
        <script src="{{ asset('admin/assets/js/pages/ui-alerts.js') }}"></script>
    </body>
