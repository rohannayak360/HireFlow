...
<!-- Mirrored from coderthemes.com/paces/bootstrap/ui-spinners.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:59:14 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Spinners | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
        ...
        <link rel="stylesheet" href="{{ asset('admin/assets/plugins/spinkit/spinkit.min.css') }}" />
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Spinners</h4>
                        </div>
