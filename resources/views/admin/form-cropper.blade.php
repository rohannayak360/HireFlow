...
<!-- Mirrored from coderthemes.com/paces/bootstrap/form-cropper.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:59:48 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Image Cropper | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
        ...
        <!-- Cropper Plugin CSS -->
        <link rel="stylesheet" href="{{ asset('admin/assets/plugins/cropperjs/cropper.min.css') }}" type="text/css" />
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Image Cropper</h4>
                        </div>
                                ...
                                <div class="card-body">
                                    <div class="row g-3 align-items-end">
                                        ...
                                        <div class="col-lg-4 d-grid gap-2">
                                            <button id="useDemoBtn" class="btn btn-outline-secondary">Use Demo Image</button>
                                            <button id="clearInputBtn" class="btn btn-outline-light border">Clear File Input</button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row g-4 mt-1">
                                        <div class="col-lg-8">
                                            <div class="ratio ratio-4x3 bg-white border rounded">
                                                <!-- Default demo image -->
                                                <img id="image" src="{{ asset('admin/assets/images/stock/small-1.jpg') }}" alt="Upload to crop" />
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="d-flex flex-wrap gap-2">
                                                ...
                                                <div class="ms-auto d-flex align-items-center gap-2">
                                                    <label for="aspect" class="form-label mb-0">Aspect:</label>
                                                    <select id="aspect" class="form-select form-select-sm" style="width: auto">
                                                        <option value="NaN" selected>Free</option>
                                            ...
                                            <div id="croppedResult" class="mt-4 d-none">
                                                <p class="fw-semibold mb-2">Cropped Output</p>
                                                <img class="img-thumbnail" alt="Cropped result will appear here" />
                                            </div>

                                            <div class="mt-4 d-grid gap-2">
                                                <button id="cropBtn" class="btn btn-primary">Crop & Preview</button>
                                                <a id="downloadBtn" class="btn btn-outline-secondary disabled" download="cropped.html">Download Cropped</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<script src="{{ asset('admin/assets/js/app.js') }}"></script>
        ...
        <script src="{{ asset('admin/assets/plugins/cropperjs/cropper.min.js') }}"></script>

        <!-- Color Picker Demo Js -->
        <script src="{{ asset('admin/assets/js/pages/form-image-cropper.js') }}"></script>
    </body>

<!-- Mirrored from coderthemes.com/paces/bootstrap/form-cropper.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:59:50 GMT -->
</html>
