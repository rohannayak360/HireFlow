...
<!-- Mirrored from coderthemes.com/paces/bootstrap/ui-list-group.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:59:12 GMT -->
<head>
        <meta charset="utf-8" />
        <title>List Group | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">List Group</h4>
                        </div>
                        ...
                        <div class="col-xl-4">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <ul class="list-group">
                                        <li class="list-group-item disabled" aria-disabled="true">Dropbox Cloud Storage</li>
                                        <li class="list-group-item">Slack Team Collaboration</li>
                                        <li class="list-group-item">Microsoft Windows OS</li>
                                        <li class="list-group-item">Zendesk Customer Support</li>
                                        <li class="list-group-item">Stripe Payment Integration</li>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="list-group">
                                        <a href="#" class="list-group-item list-group-item-action active">Stripe Payment Integration</a>
