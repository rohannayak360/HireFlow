...
<!-- Mirrored from coderthemes.com/paces/bootstrap/maps-leaflet.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 10:00:10 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Leaflet Maps | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
        ...
        <!-- leaflet CSS -->
        <link href="{{ asset('admin/assets/plugins/leaflet/leaflet.css') }}" rel="stylesheet" type="text/css" />
...
<script src="{{ asset('admin/assets/js/app.js') }}"></script>
        ...
        <!-- leaflet plugin -->
        <script src="{{ asset('admin/assets/plugins/leaflet/leaflet.js') }}"></script>

        <!-- leaflet map -->
        <script src="{{ asset('admin/assets/js/maps/leaflet-data.js') }}"></script>
        <script src="{{ asset('admin/assets/js/pages/maps-leaflet.js') }}"></script>
    </body>

<!-- Mirrored from coderthemes.com/paces/bootstrap/maps-leaflet.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 10:00:12 GMT -->
</html>
