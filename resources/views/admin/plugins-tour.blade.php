...
<!-- Mirrored from coderthemes.com/paces/bootstrap/plugins-tour.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:59:01 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Tour | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
        ...
        <!-- Tour Page style -->
        <link href="{{ asset('admin/assets/plugins/tourguidejs/tour.min.css') }}" rel="stylesheet" />
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Tour</h4>
                        </div>
                        ...
                        <div class="col-lg-5">
                            <div class="text-center mt-4 mb-5">
                                <div class="auth-brand text-center mb-4">
                                    <a href="{{ url('admin') }}" class="logo-dark">
                                        <img src="{{ asset('admin/assets/images/logo-black.png') }}" alt="dark logo" height="32" />
                                    </a>
                                    <a href="{{ url('admin') }}" class="logo-light">
                                        <img src="{{ asset('admin/assets/images/logo.png') }}" alt="logo" height="32" />
                                    </a>
                                </div>
                                ...
                                <div class="d-flex justify-content-center mt-4 flex-wrap gap-2">
                                    <button id="tourTrigger" class="btn btn-primary">
...
<script src="{{ asset('admin/assets/js/app.js') }}"></script>
        ...
        <!-- Tour Plugin Js-->
        <script src="{{ asset('admin/assets/plugins/tourguidejs/tour.js') }}"></script>

        <!-- Tour Page Js-->
        <script src="{{ asset('admin/assets/js/pages/plugins-tour.js') }}"></script>
    </body>

<!-- Mirrored from coderthemes.com/paces/bootstrap/plugins-tour.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:59:02 GMT -->
</html>
