...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-finance-expense-category.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:32 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Expense Categories | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Expense Categories</h4>
                        </div>
                                ...
                                <div class="card-header border-light justify-content-between">
                                    <div class="d-flex gap-2">
                                        ...
                                        <div class="app-search">
                                            <input data-table-search type="search" class="form-control" placeholder="Search categories..." />
                                            <i class="ti ti-search app-search-icon text-muted"></i>
                                        </div>

                                        <!-- Add New Category -->
                                        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#categoryModal"><i class="ti ti-plus me-1"></i> Add Category</button>
                                        ...
                                        <table class="table table-custom table-centered table-select table-hover w-100 mb-0">
                                            ...
                                            <tbody class="text-nowrap">
                                                <tr>
                                                    ...
                                                    <td><a href="#!" class="fw-semibold link-reset">#CAT-001</a></td>
                                                    <td>Office Supplies</td>
                                                    <td>$2,845.60</td>
                                                    <td><span class="badge bg-success-subtle text-success badge-label">Active</span></td>
                                                    <td>10 Oct, 2025 <small class="text-muted">04:10 PM</small></td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="#!" class="fw-semibold link-reset">#CAT-002</a></td>
                                                    <td>Travel</td>
                                                    <td>$5,920.00</td>
                                                    <td><span class="badge bg-success-subtle text-success badge-label">Active</span></td>
                                                    <td>08 Oct, 2025 <small class="text-muted">11:00 AM</small></td>
                                                    <td>
                                                        <div class="d-flex justify-content-center gap-1">
                                                            <a href="#!" class="btn btn-default btn-icon btn-sm"><i class="ti ti-edit fs-lg"></i></a>
                                                            <a href="#" data-table-delete-row class="btn btn-default btn-icon btn-sm"><i class="ti ti-trash fs-lg"></i></a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="#!" class="fw-semibold link-reset">#CAT-003</a></td>
                                                    <td>Meals</td>
                                                    <td>$1,280.75</td>
                                                    <td><span class="badge bg-success-subtle text-success badge-label">Active</span></td>
                                                    <td>05 Oct, 2025 <small class="text-muted">07:45 PM</small></td>
                                                    <td>
                                                        <div class="d-flex justify-content-center gap-1">
                                                            <a href="#!" class="btn btn-default btn-icon btn-sm"><i class="ti ti-edit fs-lg"></i></a>
                                                            <a href="#" data-table-delete-row class="btn btn-default btn-icon btn-sm"><i class="ti ti-trash fs-lg"></i></a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="#!" class="fw-semibold link-reset">#CAT-004</a></td>
                                                    <td>Entertainment</td>
                                                    <td>$2,140.20</td>
                                                    <td><span class="badge bg-warning-subtle text-warning badge-label">Inactive</span></td>
                                                    <td>03 Oct, 2025 <small class="text-muted">09:25 AM</small></td>
                                                    <td>
                                                        <div class="d-flex justify-content-center gap-1">
                                                            <a href="#!" class="btn btn-default btn-icon btn-sm"><i class="ti ti-edit fs-lg"></i></a>
                                                            <a href="#" data-table-delete-row class="btn btn-default btn-icon btn-sm"><i class="ti ti-trash fs-lg"></i></a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="#!" class="fw-semibold link-reset">#CAT-005</a></td>
                                                    <td>Equipment</td>
                                                    <td>$4,580.00</td>
                                                    <td><span class="badge bg-success-subtle text-success badge-label">Active</span></td>
                                                    <td>01 Oct, 2025 <small class="text-muted">03:15 PM</small></td>
                                                    <td>
                                                        <div class="d-flex justify-content-center gap-1">
                                                            <a href="#!" class="btn btn-default btn-icon btn-sm"><i class="ti ti-edit fs-lg"></i></a>
                                                            <a href="#" data-table-delete-row class="btn btn-default btn-icon btn-sm"><i class="ti ti-trash fs-lg"></i></a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="#!" class="fw-semibold link-reset">#CAT-006</a></td>
                                                    <td>Maintenance</td>
                                                    <td>$3,210.40</td>
                                                    <td><span class="badge bg-success-subtle text-success badge-label">Active</span></td>
                                                    <td>28 Sep, 2025 <small class="text-muted">02:00 PM</small></td>
                                                    <td>
                                                        <div class="d-flex justify-content-center gap-1">
                                                            <a href="#!" class="btn btn-default btn-icon btn-sm"><i class="ti ti-edit fs-lg"></i></a>
                                                            <a href="#" data-table-delete-row class="btn btn-default btn-icon btn-sm"><i class="ti ti-trash fs-lg"></i></a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="#!" class="fw-semibold link-reset">#CAT-007</a></td>
                                                    <td>Training & Events</td>
                                                    <td>$6,845.00</td>
                                                    <td><span class="badge bg-success-subtle text-success badge-label">Active</span></td>
                                                    <td>25 Sep, 2025 <small class="text-muted">10:35 AM</small></td>
                                                    <td>
                                                        <div class="d-flex justify-content-center gap-1">
                                                            <a href="#!" class="btn btn-default btn-icon btn-sm"><i class="ti ti-edit fs-lg"></i></a>
                                                            <a href="#" data-table-delete-row class="btn btn-default btn-icon btn-sm"><i class="ti ti-trash fs-lg"></i></a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="#!" class="fw-semibold link-reset">#CAT-008</a></td>
                                                    <td>Subscriptions</td>
                                                    <td>$980.75</td>
                                                    <td><span class="badge bg-warning-subtle text-warning badge-label">Inactive</span></td>
                                                    <td>21 Sep, 2025 <small class="text-muted">09:50 AM</small></td>
                                                    <td>
                                                        <div class="d-flex justify-content-center gap-1">
                                                            <a href="#!" class="btn btn-default btn-icon btn-sm"><i class="ti ti-edit fs-lg"></i></a>
                                                            <a href="#" data-table-delete-row class="btn btn-default btn-icon btn-sm"><i class="ti ti-trash fs-lg"></i></a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="#!" class="fw-semibold link-reset">#CAT-009</a></td>
                                                    <td>Marketing</td>
                                                    <td>$9,475.90</td>
                                                    <td><span class="badge bg-success-subtle text-success badge-label">Active</span></td>
                                                    <td>18 Sep, 2025 <small class="text-muted">01:40 PM</small></td>
                                                    <td>
                                                        <div class="d-flex justify-content-center gap-1">
                                                            <a href="#!" class="btn btn-default btn-icon btn-sm"><i class="ti ti-edit fs-lg"></i></a>
                                                            <a href="#" data-table-delete-row class="btn btn-default btn-icon btn-sm"><i class="ti ti-trash fs-lg"></i></a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="#!" class="fw-semibold link-reset">#CAT-010</a></td>
                                                    <td>Insurance</td>
                                                    <td>$2,540.00</td>
                                                    <td><span class="badge bg-danger-subtle text-danger badge-label">Inactive</span></td>
                                                    <td>15 Sep, 2025 <small class="text-muted">05:15 PM</small></td>
                                                    <td>
                                                        <div class="d-flex justify-content-center gap-1">
                                                            <a href="#!" class="btn btn-default btn-icon btn-sm"><i class="ti ti-edit fs-lg"></i></a>
                                                            <a href="#" data-table-delete-row class="btn btn-default btn-icon btn-sm"><i class="ti ti-trash fs-lg"></i></a>
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content border-0 shadow-sm">
                                <div class="modal-header bg-light border-bottom">
                                    <h5 class="modal-title fw-semibold" id="categoryModalLabel"><span data-icon="layers" class="me-1"></span> Add Expense Category</h5>
                                    ...
                                    <div class="modal-body">
                                        <div class="row g-3">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <textarea id="categoryDescription" class="form-control" rows="3" placeholder="Optional notes about this category"></textarea>
                                            </div>
