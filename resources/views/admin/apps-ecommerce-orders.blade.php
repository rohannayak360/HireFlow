...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-ecommerce-orders.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:08 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Orders | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                            ...
                            <div data-table data-table-rows-per-page="8" class="card">
                                <div class="card-header border-light justify-content-between">
                                    ...
                                    <div class="d-flex gap-1">
                                        <a href="{{ url('admin/apps-ecommerce-order-add') }}" class="btn btn-danger ms-1"> <i class="ti ti-plus fs-sm me-2"></i> Add Order </a>
                                    </div>
                                </div>
                                    ...
                                    <table class="table table-custom table-centered table-select table-hover w-100 mb-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="fs-sm mb-0 fw-medium"><a href="{{ url('admin/apps-ecommerce-order-details') }}" class="link-reset">#WB20100</a></h5>
                                                </td>
                                                ...
                                                <td>$129.45</td>
                                                <td class="text-success fw-semibold"><i class="ti ti-circle-filled fs-sm"></i> Paid</td>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-center gap-1">
                                                        <a href="{{ url('admin/apps-ecommerce-order-details') }}" class="btn btn-default btn-icon btn-sm"><i class="ti ti-eye fs-lg"></i></a>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="fs-sm mb-0 fw-medium"><a href="{{ url('admin/apps-ecommerce-order-details') }}" class="link-reset">#WB20101</a></h5>
                                                </td>
                                                ...
                                                <td>
                                                    <img src="{{ asset('admin/assets/images/cards/mastercard.svg') }}" alt="" class="me-2" height="28" />
                                                    xxxx 5487
                                                </td>
                                                <td>
                                                    <div class="d-flex justify-content-center gap-1">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="fs-sm mb-0 fw-medium"><a href="{{ url('admin/apps-ecommerce-order-details') }}" class="link-reset">#WB20102</a></h5>
                                                </td>
                                                ...
                                                <td>$59.90</td>
                                                <td class="text-danger fw-semibold"><i class="ti ti-circle-filled fs-sm"></i> Failed</td>
                                                <td><span class="badge badge-soft-danger fs-xxs">Cancelled</span></td>
                                                <td>
                                                    <img src="{{ asset('admin/assets/images/cards/paypal.svg') }}" alt="" class="me-2" height="28" />
                                                    xxx&#64;email.com
                                                </td>
                                                <td>
                                                    <div class="d-flex justify-content-center gap-1">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="fs-sm mb-0 fw-medium"><a href="{{ url('admin/apps-ecommerce-order-details') }}" class="link-reset">#WB20103</a></h5>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-start align-items-center gap-2">
                                                        ...
                                                        <div>
                                                            <h5 data-sort="customer" class="text-nowrap fs-base mb-0 lh-base">Isabella Moore</h5>
                                                ...
                                                <td><img src="{{ asset('admin/assets/images/cards/stripe.svg') }}" alt="" class="me-2" height="28" /> xxxx 9901</td>
                                                <td>
                                                    <div class="d-flex justify-content-center gap-1">
                                                        <a href="{{ url('admin/apps-ecommerce-order-details') }}" class="btn btn-default btn-icon btn-sm"><i class="ti ti-eye fs-lg"></i></a>
                                                        <a href="#" class="btn btn-default btn-icon btn-sm"><i class="ti ti-edit fs-lg"></i></a>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="fs-sm mb-0 fw-medium"><a href="{{ url('admin/apps-ecommerce-order-details') }}" class="link-reset">#WB20104</a></h5>
                                                </td>
                                                <td>28 Apr, 2025 <small class="text-muted">9:55 AM</small></td>
                                                <td>
                                                    <div class="d-flex justify-content-start align-items-center gap-2">
                                                        <div class="avatar avatar-sm">
                                                            <img src="{{ asset('admin/assets/images/users/user-5.jpg') }}" alt="avatar-11" class="img-fluid rounded-circle" />
                                                        </div>
                                                        <div>
                                                            <h5 data-sort="customer" class="text-nowrap fs-base mb-0 lh-base">Lucas Bennett</h5>
                                                ...
                                                <td class="text-success fw-semibold"><i class="ti ti-circle-filled fs-sm"></i> Paid</td>
                                                <td><span class="badge badge-soft-success fs-xxs">Delivered</span></td>
                                                <td><img src="{{ asset('admin/assets/images/cards/american-express.svg') }}" alt="" class="me-2" height="28" /> xxxx 4678</td>
                                                <td>
                                                    <div class="d-flex justify-content-center gap-1">
                                                        <a href="{{ url('admin/apps-ecommerce-order-details') }}" class="btn btn-default btn-icon btn-sm"><i class="ti ti-eye fs-lg"></i></a>
                                                        <a href="#" class="btn btn-default btn-icon btn-sm"><i class="ti ti-edit fs-lg"></i></a>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="fs-sm mb-0 fw-medium"><a href="{{ url('admin/apps-ecommerce-order-details') }}" class="link-reset">#WB30100</a></h5>
                                                </td>
                                                ...
                                                <td class="text-success fw-semibold"><i class="ti ti-circle-filled fs-sm"></i> Paid</td>
                                                <td><span class="badge badge-soft-success fs-xxs">Delivered</span></td>
                                                <td><img src="{{ asset('admin/assets/images/cards/discover-card.svg') }}" alt="" class="me-2" height="28" /> xxxx 1234</td>
                                                <td>
                                                    <div class="d-flex justify-content-center gap-1">
                                                        <a href="{{ url('admin/apps-ecommerce-order-details') }}" class="btn btn-default btn-icon btn-sm"><i class="ti ti-eye fs-lg"></i></a>
                                                        <a href="#" class="btn btn-default btn-icon btn-sm"><i class="ti ti-edit fs-lg"></i></a>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="fs-sm mb-0 fw-medium"><a href="{{ url('admin/apps-ecommerce-order-details') }}" class="link-reset">#WB30101</a></h5>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-start align-items-center gap-2">
                                                        ...
                                                        <div>
                                                            <h5 data-sort="customer" class="text-nowrap fs-base mb-0 lh-base">Liam Thompson</h5>
                                                ...
                                                <td><span class="badge badge-soft-warning fs-xxs">Processing</span></td>
                                                <td>
                                                    <img src="{{ asset('admin/assets/images/cards/unionpay.svg') }}" alt="" class="me-2" height="28" />
                                                    xxxx 9876
                                                </td>
                                                <td>
                                                    <div class="d-flex justify-content-center gap-1">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="fs-sm mb-0 fw-medium"><a href="{{ url('admin/apps-ecommerce-order-details') }}" class="link-reset">#WB30102</a></h5>
                                                </td>
                                                ...
                                                <td><span class="badge badge-soft-danger fs-xxs">Cancelled</span></td>
                                                <td>
                                                    <img src="{{ asset('admin/assets/images/cards/payoneer.svg') }}" alt="" class="me-2" height="28" />
                                                    xxx&#64;email.com
                                                </td>
                                                <td>
                                                    <div class="d-flex justify-content-center gap-1">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="fs-sm mb-0 fw-medium"><a href="{{ url('admin/apps-ecommerce-order-details') }}" class="link-reset">#WB30103</a></h5>
                                                </td>
                                                ...
                                                <td class="text-success fw-semibold"><i class="ti ti-circle-filled fs-sm"></i> Paid</td>
                                                <td><span class="badge badge-soft-info fs-xxs">Shipped</span></td>
                                                <td><img src="{{ asset('admin/assets/images/cards/google-wallet.svg') }}" alt="" class="me-2" height="28" /> xxx&#64;google</td>
                                                <td>
                                                    <div class="d-flex justify-content-center gap-1">
                                                        <a href="{{ url('admin/apps-ecommerce-order-details') }}" class="btn btn-default btn-icon btn-sm"><i class="ti ti-eye fs-lg"></i></a>
                                                        <a href="#" class="btn btn-default btn-icon btn-sm"><i class="ti ti-edit fs-lg"></i></a>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="fs-sm mb-0 fw-medium"><a href="{{ url('admin/apps-ecommerce-order-details') }}" class="link-reset">#WB30104</a></h5>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-start align-items-center gap-2">
                                                        ...
                                                        <div>
                                                            <h5 data-sort="customer" class="text-nowrap fs-base mb-0 lh-base">Charlotte Lee</h5>
                                                ...
                                                <td><span class="badge badge-soft-success fs-xxs">Delivered</span></td>
                                                <td>
                                                    <img src="{{ asset('admin/assets/images/cards/bhim.svg') }}" alt="" class="me-2" height="28" />
                                                    xxxx&#64;upi
                                                </td>
                                                <td>
                                                    <div class="d-flex justify-content-center gap-1">
...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-ecommerce-orders.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:10 GMT -->
</html>
