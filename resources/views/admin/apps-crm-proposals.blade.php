...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-crm-proposals.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:29 GMT -->
<head>
        <meta charset="utf-8" />
        <title>CRM Proposals | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Proposals</h4>
                        </div>
                                        ...
                                        <table class="table table-custom table-centered table-select table-hover w-100 mb-0">
                                            ...
                                            <tbody class="text-nowrap">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#!" class="fw-semibold link-reset">#PS008101</a>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar-sm border flex-shrink-0 border-dashed rounded-circle me-2 justify-content-center d-flex align-items-center">
                                                                <img src="{{ asset('admin/assets/images/logos/google.svg') }}" alt="Google" height="20" />
                                                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#!" class="fw-semibold link-reset">#PS008102</a>
                                                    </td>
                                                    <td>New Mobile App Development</td>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar-sm border flex-shrink-0 border-dashed rounded-circle me-2 justify-content-center d-flex align-items-center">
                                                                <img src="{{ asset('admin/assets/images/logos/apple.svg') }}" alt="Apple" height="20" />
                                                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#!" class="fw-semibold link-reset">#PS008103</a>
                                                    </td>
                                                    <td>Marketing Retargeting Plan</td>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar-sm border flex-shrink-0 border-dashed rounded-circle me-2 justify-content-center d-flex align-items-center">
                                                                <img src="{{ asset('admin/assets/images/logos/meta.svg') }}" alt="Meta" height="12" />
                                                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#!" class="fw-semibold link-reset">#PS008104</a>
                                                    </td>
                                                    <td>UI/UX Redesign for SaaS App</td>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar-sm border flex-shrink-0 border-dashed rounded-circle me-2 justify-content-center d-flex align-items-center">
                                                                <img src="{{ asset('admin/assets/images/logos/figma.svg') }}" alt="Figma" height="20" />
                                                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#!" class="fw-semibold link-reset">#PS008105</a>
                                                    </td>
                                                    <td>Cloud Infrastructure Setup</td>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar-sm border flex-shrink-0 border-dashed rounded-circle me-2 justify-content-center d-flex align-items-center">
                                                                <img src="{{ asset('admin/assets/images/logos/airbnb.svg') }}" alt="Azure" height="20" />
                                                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#!" class="fw-semibold link-reset">#PS008106</a>
                                                    </td>
                                                    <td>Digital Marketing Strategy</td>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar-sm border flex-shrink-0 border-dashed rounded-circle me-2 justify-content-center d-flex align-items-center">
                                                                <img src="{{ asset('admin/assets/images/logos/asana.svg') }}" alt="Hubspot" height="16" />
                                                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#!" class="fw-semibold link-reset">#PS008107</a>
                                                    </td>
                                                    <td>Backend API Integration</td>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar-sm border flex-shrink-0 border-dashed rounded-circle me-2 justify-content-center d-flex align-items-center">
                                                                <img src="{{ asset('admin/assets/images/logos/microsoft.svg') }}" alt="GitHub" height="16" class="rounded-circle" />
                                                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#!" class="fw-semibold link-reset">#PS008108</a>
                                                    </td>
                                                    <td>Performance Audit Report</td>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar-sm border flex-shrink-0 border-dashed rounded-circle me-2 justify-content-center d-flex align-items-center">
                                                                <img src="{{ asset('admin/assets/images/logos/dropbox.svg') }}" alt="Stripe" height="20" />
                                                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#!" class="fw-semibold link-reset">#PS008109</a>
                                                    </td>
                                                    <td>Data Migration Strategy</td>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar-sm border flex-shrink-0 border-dashed rounded-circle me-2 justify-content-center d-flex align-items-center">
                                                                <img src="{{ asset('admin/assets/images/logos/dropbox.svg') }}" alt="Dropbox" height="20" />
                                                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#!" class="fw-semibold link-reset">#PS008110</a>
                                                    </td>
                                                    <td>Customer Portal UI Design</td>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar-sm border flex-shrink-0 border-dashed rounded-circle me-2 justify-content-center d-flex align-items-center">
                                                                <img src="{{ asset('admin/assets/images/logos/openai.svg') }}" alt="Salesforce" height="20" />
                                                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#!" class="fw-semibold link-reset">#PS008111</a>
                                                    </td>
                                                    <td>Mobile Analytics Dashboard</td>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar-sm border flex-shrink-0 border-dashed rounded-circle me-2 justify-content-center d-flex align-items-center">
                                                                <img src="{{ asset('admin/assets/images/logos/h%26m.svg') }}" alt="Mixpanel" height="14" />
                                                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#!" class="fw-semibold link-reset">#PS008112</a>
                                                    </td>
                                                    <td>AI-Powered Lead Generator</td>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar-sm border flex-shrink-0 border-dashed rounded-circle me-2 justify-content-center d-flex align-items-center">
                                                                <img src="{{ asset('admin/assets/images/logos/openai.svg') }}" alt="OpenAI" height="20" />
                                                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#!" class="fw-semibold link-reset">#PS008113</a>
                                                    </td>
                                                    <td>Enterprise Security Audit</td>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar-sm border flex-shrink-0 border-dashed rounded-circle me-2 justify-content-center d-flex align-items-center">
                                                                <img src="{{ asset('admin/assets/images/logos/shell.svg') }}" alt="Cloudflare" height="20" />
                                                            </div>
