...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-chat.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:20 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Chat | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Chat</h4>
                        </div>
                            ...
                            <div class="card h-100 mb-0 border-end-0 rounded-end-0">
                                <div class="card-header p-3 border-light card-bg d-block">
                                    <div class="d-flex gap-2">
                                        ...
                                        <a href="#!" class="btn btn-dark btn-icon" data-bs-toggle="modal" data-bs-target="#createSingleChatModal">
                                            <i class="ti ti-pencil fs-xl"></i>
                                        </a>
                                    </div>
                                </div>
                                <div id="chat-sidebar" class="card-body p-2" style="height: calc(100% - 100px)" data-simplebar data-simplebar-md>
                                    <div class="list-group list-group-flush chat-list">
                                        ...
                                        <a href="#!" data-chat-id="chat8" class="list-group-item list-group-item-action d-flex gap-2 justify-content-between">
                                            <span class="d-flex justify-content-start align-items-center gap-2 overflow-hidden">
                                                <span class="avatar avatar-sm flex-shrink-0">
                                                    <img src="{{ asset('admin/assets/images/users/user-2.jpg') }}" alt="avatar-11" class="img-fluid rounded-circle" />
                                                </span>
                                                <span class="overflow-hidden">
                                        ...
                                        <a href="#!" data-chat-id="chat9" class="list-group-item list-group-item-action d-flex gap-2 justify-content-between">
                                            <span class="d-flex justify-content-start align-items-center gap-2 overflow-hidden">
                                                <span class="avatar avatar-sm flex-shrink-0">
                                                    <img src="{{ asset('admin/assets/images/users/user-3.jpg') }}" alt="avatar-12" class="img-fluid rounded-circle" />
                                                </span>
                                                <span class="overflow-hidden">
                                        ...
                                        <a href="#!" data-chat-id="chat11" class="list-group-item list-group-item-action d-flex gap-2 justify-content-between">
                                            <span class="d-flex justify-content-start align-items-center gap-2 overflow-hidden">
                                                <span class="avatar avatar-sm flex-shrink-0">
                                                    <img src="{{ asset('admin/assets/images/users/user-6.jpg') }}" alt="avatar-14" class="img-fluid rounded-circle" />
                                                </span>
                                                <span class="overflow-hidden">
                                        ...
                                        <a href="#!" data-chat-id="chat12" class="list-group-item list-group-item-action d-flex gap-2 justify-content-between">
                                            <span class="d-flex justify-content-start align-items-center gap-2 overflow-hidden">
                                                <span class="avatar avatar-sm flex-shrink-0">
                                                    <img src="{{ asset('admin/assets/images/users/user-9.jpg') }}" alt="avatar-15" class="img-fluid rounded-circle" />
                                                </span>
                                                <span class="overflow-hidden">
                        ...
                        <div class="card h-100 mb-0 rounded-start-0 flex-grow-1">
                            <div class="card-header card-bg">
                                ...
                                <div class="d-flex align-items-center gap-1">
                                    ...
                                    <button type="button" class="btn btn-default btn-icon" data-bs-toggle="modal" data-bs-target="#audioCallModal" data-bs-toggle="tooltip" title="Audio Call">
                                        <i class="ti ti-phone-call fs-lg"></i>
                                    </button>
                            ...
                            <div class="card-footer bg-body-secondary border-top border-dashed border-bottom-0 position-absolute bottom-0 w-100">
                                <div class="d-flex gap-2">
                                    ...
                                    <a data-send href="#!" class="btn btn-primary">
                                        Send
                                        <i class="ti ti-send-2 ms-1 fs-xl"></i>
                                    </a>
                                </div>
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-xl">
                            <div class="modal-content bg-dark text-white">
                                ...
                                <div class="modal-body d-flex flex-column align-items-center justify-content-center text-center py-5">
                                    <!-- User Avatar -->
                                    <div class="mb-4">
                                        <img src="{{ asset('admin/assets/images/users/user-3.jpg') }}" class="rounded-circle shadow" alt="User Photo" width="150" height="150" />
                                    </div>
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-md">
                            <div class="modal-content bg-dark text-white">
                                ...
                                <div class="modal-body d-flex flex-column align-items-center justify-content-center text-center py-5">
                                    <!-- User Avatar -->
                                    <div class="mb-4">
                                        <img src="{{ asset('admin/assets/images/users/user-3.jpg') }}" class="rounded-circle shadow" alt="User Photo" width="120" height="120" />
                                    </div>
...
<script src="{{ asset('admin/assets/js/app.js') }}"></script>
        ...
        <script src="{{ asset('admin/assets/js/pages/apps-chat.js') }}"></script>
    </body>

<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-chat.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:21 GMT -->
</html>
