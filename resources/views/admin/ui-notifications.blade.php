...
<!-- Mirrored from coderthemes.com/paces/bootstrap/ui-notifications.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:59:13 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Bootstrap Toasts | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Notifications</h4>
                        </div>
                                    ...
                                    <div class="p-3">
                                        ...
                                        <div class="toast fade show" role="alert" aria-live="assertive" aria-atomic="true">
                                            <div class="toast-header">
                                                <img src="{{ asset('admin/assets/images/logo-sm.png') }}" alt="brand-logo" height="16" class="me-1" />
...
<script src="{{ asset('admin/assets/js/app.js') }}"></script>
        ...
        <!-- Page js -->
        <script src="{{ asset('admin/assets/js/pages/ui-notifications.js') }}"></script>
    </body>
