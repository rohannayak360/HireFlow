...
<!-- Mirrored from coderthemes.com/paces/bootstrap/tables-datatables-range-search.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 10:00:04 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Range Search | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Range Search</h4>
                        </div>
                        ...
                        <div class="text-end">
                            <ol class="breadcrumb m-0 py-0">
                                ...
                                <li class="breadcrumb-item active">Range Search</li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header justify-content-between">
                                    ...
                                    <a href="https://datatables.net/examples/plug-ins/range_filtering.html" target="_blank" class="icon-link icon-link-hover link-primary fw-semibold">
                                        View Docs
...
<script src="{{ asset('admin/assets/js/app.js') }}"></script>
        ...
        <!-- Page js -->
        <script src="{{ asset('admin/assets/js/pages/datatables-range-search.js') }}"></script>
    </body>
