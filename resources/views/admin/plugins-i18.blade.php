...
<!-- Mirrored from coderthemes.com/paces/bootstrap/plugins-i18.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:57 GMT -->
<head>
        <meta charset="utf-8" />
        <title>i18support | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">i18 Support</h4>
                        </div>
                        ...
                        <div class="text-end">
                            <ol class="breadcrumb m-0 py-0">
                                ...
                                <li class="breadcrumb-item active">i18 Support</li>
                            </ol>
                        </div>
                    </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex flex-wrap gap-2">
                                        <button class="btn btn-light gap-1 d-inline-flex align-items-center" data-translator-lang="en">
                                            <img src="{{ asset('admin/assets/images/flags/us.svg') }}" alt="user-image" class="me-1 rounded" height="18" data-translator-image />
                                            <span class="align-middle">English</span>
                                        </button>

                                        <button class="btn btn-light gap-1 d-inline-flex align-items-center" data-translator-lang="hi">
                                            <img src="{{ asset('admin/assets/images/flags/in.svg') }}" alt="user-image" class="me-1 rounded" height="18" data-translator-image />
                                        ...
                                        <button class="btn btn-light gap-1 d-inline-flex align-items-center" data-translator-lang="it">
                                            <img src="{{ asset('admin/assets/images/flags/it.svg') }}" alt="user-image" class="me-1 rounded" height="18" data-translator-image />
                                            <span class="align-middle">Italian</span>
                                        </button>

                                        <button class="btn btn-light gap-1 d-inline-flex align-items-center" data-translator-lang="es">
                                            <img src="{{ asset('admin/assets/images/flags/es.svg') }}" alt="user-image" class="me-1 rounded" height="18" data-translator-image />
                                            <span class="align-middle">Spanish</span>
                                        </button>

                                        <button class="btn btn-light gap-1 d-inline-flex align-items-center" data-translator-lang="ru">
                                            <img src="{{ asset('admin/assets/images/flags/ru.svg') }}" alt="user-image" class="me-1 rounded" height="18" data-translator-image />
