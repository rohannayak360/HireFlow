...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-ecommerce-purchased-orders.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:19 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Purchased Orders | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Purchased Orders</h4>
                        </div>
                        ...
                        <div class="text-end">
                            <ol class="breadcrumb m-0 py-0">
                                ...
                                <li class="breadcrumb-item active">Purchased Orders</li>
                            </ol>
                        </div>
                    </div>
                            ...
                            <div data-table data-table-rows-per-page="10" class="card">
                                <div class="card-header border-light justify-content-between">
                                    ...
                                    <div class="d-flex gap-1">
                                        <a href="#addPurchaseOrderModal" class="btn btn-danger ms-1" data-bs-toggle="modal"> <i class="ti ti-plus fs-sm me-2"></i> Add New </a>
                                    </div>
                                </div>
                                    ...
                                    <table class="table table-custom table-centered table-select table-hover w-100 mb-0">
                                        <thead class="bg-light align-middle bg-opacity-25 thead-sm">
                                            <tr class="text-uppercase fs-xxs">
                                                <th class="ps-3" style="width: 1%">
                                                    <input data-table-select-all class="form-check-input form-check-input-light fs-14 mt-0" type="checkbox" id="select-all-orders" />
                                                </th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="#!" class="fw-semibold link-reset">PO-2025-0148</a>
                                                </td>
                                                <td>
                                                    <div>
                                                ...
                                                <td>12 Items</td>
                                                <td>05 Oct, 2025 <small class="text-muted">09:15 AM</small></td>
                                                <td>10 Oct, 2025 <small class="text-muted">Expected</small></td>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="#!" class="fw-semibold link-reset">PO-2025-0149</a></td>
                                                <td>
                                                    <div>
                                                ...
                                                <td>8 Items</td>
                                                <td>06 Oct, 2025 <small class="text-muted">02:45 PM</small></td>
                                                <td>12 Oct, 2025 <small class="text-muted">Expected</small></td>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="#!" class="fw-semibold link-reset">PO-2025-0150</a></td>
                                                <td>
                                                    <div>
                                                ...
                                                <td>25 Items</td>
                                                <td>02 Oct, 2025 <small class="text-muted">11:05 AM</small></td>
                                                <td>09 Oct, 2025 <small class="text-muted">Expected</small></td>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="#!" class="fw-semibold link-reset">PO-2025-0151</a></td>
                                                <td>
                                                    <div>
                                                ...
                                                <td>5 Items</td>
                                                <td>04 Oct, 2025 <small class="text-muted">03:30 PM</small></td>
                                                <td>09 Oct, 2025 <small class="text-muted">Delivered</small></td>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="#!" class="fw-semibold link-reset">PO-2025-0152</a></td>
                                                <td>
                                                    <div>
                                                ...
                                                <td>16 Items</td>
                                                <td>07 Oct, 2025 <small class="text-muted">08:20 AM</small></td>
                                                <td>14 Oct, 2025 <small class="text-muted">Expected</small></td>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="#!" class="fw-semibold link-reset">PO-2025-0153</a></td>
                                                <td>
                                                    <div>
                                                ...
                                                <td>9 Items</td>
                                                <td>03 Oct, 2025 <small class="text-muted">01:10 PM</small></td>
                                                <td>07 Oct, 2025 <small class="text-muted">Delivered</small></td>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="#!" class="fw-semibold link-reset">PO-2025-0154</a></td>
                                                <td>
                                                    <div>
                                                ...
                                                <td>14 Items</td>
                                                <td>08 Oct, 2025 <small class="text-muted">10:00 AM</small></td>
                                                <td>15 Oct, 2025 <small class="text-muted">Expected</small></td>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="#!" class="fw-semibold link-reset">PO-2025-0155</a></td>
                                                <td>
                                                    <div>
                                                ...
                                                <td>20 Items</td>
                                                <td>01 Oct, 2025 <small class="text-muted">04:30 PM</small></td>
                                                <td>06 Oct, 2025 <small class="text-muted">Delivered</small></td>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="#!" class="fw-semibold link-reset">PO-2025-0156</a></td>
                                                <td>
                                                    <div>
                                                ...
                                                <td>7 Items</td>
                                                <td>09 Oct, 2025 <small class="text-muted">11:50 AM</small></td>
                                                <td>15 Oct, 2025 <small class="text-muted">Expected</small></td>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="#!" class="fw-semibold link-reset">PO-2025-0157</a></td>
                                                <td>
                                                    <div>
                                                ...
                                                <td>10 Items</td>
                                                <td>06 Oct, 2025 <small class="text-muted">09:40 AM</small></td>
                                                <td>11 Oct, 2025 <small class="text-muted">Expected</small></td>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="#!" class="fw-semibold link-reset">PO-2025-0158</a></td>
                                                <td>
                                                    <div>
                                                ...
                                                <td>18 Items</td>
                                                <td>05 Oct, 2025 <small class="text-muted">05:25 PM</small></td>
                                                <td>13 Oct, 2025 <small class="text-muted">Expected</small></td>
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title fw-semibold" id="addPurchaseOrderModalLabel"><i class="ti ti-file-text me-2 text-danger"></i> Add New Purchase Order</h5>
                                ...
                                <form action="#!" method="post">
                                    <div class="modal-body">
                                        <div class="row g-3">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" id="poNumber" class="form-control" placeholder="PO-2025-0149" />
                                            </div>

                                            <!-- Supplier Name -->
                                            <div class="col-md-6">
                                                <label for="supplierName" class="form-label fw-semibold">Supplier Name</label>
                                                <input type="text" id="supplierName" class="form-control" placeholder="Global Tech Supplies" />
                                            </div>

                                            <!-- Supplier Email -->
                                            <div class="col-md-6">
                                                <label for="supplierEmail" class="form-label fw-semibold">Supplier Email</label>
                                                <input type="email" id="supplierEmail" class="form-control" placeholder="globaltech&#64;email.com" />
                                            </div>

                                            <!-- Items -->
                                            <div class="col-md-6">
                                                <label for="poItems" class="form-label fw-semibold">Items Count</label>
                                                <input type="number" id="poItems" class="form-control" placeholder="10" />
                                            </div>

                                            <!-- Order Date -->
                                            <div class="col-md-6">
                                                <label for="orderDate" class="form-label fw-semibold">Order Date</label>
                                                <input id="orderDate" type="date" class="form-control" data-provider="flatpickr" data-date-format="d M, Y" value="2025-10-05" />
                                            </div>

                                            <!-- Delivery Date -->
                                            <div class="col-md-6">
                                                <label for="deliveryDate" class="form-label fw-semibold">Delivery Date</label>
                                                <input id="deliveryDate" type="date" class="form-control" data-provider="flatpickr" data-date-format="d M, Y" value="2025-10-10" />
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="number" id="totalAmount" class="form-control" placeholder="3480.00" step="0.01" />
                                                </div>
                                            </div>
                                            ...
                                            <!-- Notes -->
                                            <div class="col-md-12">
                                                <label for="poNotes" class="form-label fw-semibold">Additional Notes</label>
                                                <textarea id="poNotes" class="form-control" rows="2" placeholder="Add any special instructions or remarks here..."></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="submit" class="btn btn-danger"><i class="ti ti-check me-1"></i> Save Purchase Order</button>
                                    </div>
                                </form>
                            </div>
                        </div>
