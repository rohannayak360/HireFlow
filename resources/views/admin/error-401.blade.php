...
<!-- Mirrored from coderthemes.com/paces/bootstrap/error-401.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:59:06 GMT -->
<head>
        <meta charset="utf-8" />
        <title>401 Error | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                    ...
                    <div class="col-xxl-5 col-md-6 col-sm-8">
                        <div class="card p-4">
                            ...
                            <div class="p-2 text-center">
                                ...
                                <h3 class="fw-bold text-uppercase">Access Restricted</h3>
                                <p class="text-muted">You don’t have permission to view this content.</p>

                                <button class="btn btn-primary mt-3 rounded-pill" onclick="window.location.href = 'index.html'">Return Home</button>
                            </div>
                        </div>
