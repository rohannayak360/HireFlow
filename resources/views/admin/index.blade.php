...
<!-- Mirrored from coderthemes.com/paces/bootstrap/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:55:54 GMT -->
<head>
        <meta charset="utf-8" />
                                        ...
                                        <div class="card-body pb-0">
                                            <div class="d-flex align-items-center justify-content-between mb-2">
                                                ...
                                                <div class="flex-grow-1 text-end">
                                                    <img class="d-none d-xxl-inline-block" src="{{ asset('admin/assets/images/svg/email-campaign.svg') }}" width="110" alt="Generic placeholder image" />
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-custom table-centered table-hover w-100 mb-0">
                                            <tbody class="text-nowrap">
                                                ...
                                                <tr>
                                                    <td style="width: 60px">
                                                        <img src="{{ asset('admin/assets/images/products/1.png') }}" alt="product-pic" height="36" />
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td style="width: 60px">
                                                        <img src="{{ asset('admin/assets/images/products/2.png') }}" alt="product-pic" height="36" />
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td style="width: 60px">
                                                        <img src="{{ asset('admin/assets/images/products/3.png') }}" alt="product-pic" height="36" />
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td style="width: 60px">
                                                        <img src="{{ asset('admin/assets/images/products/4.png') }}" alt="product-pic" height="36" />
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td style="width: 60px">
                                                        <img src="{{ asset('admin/assets/images/products/5.png') }}" alt="product-pic" height="36" />
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td style="width: 60px">
                                                        <img src="{{ asset('admin/assets/images/products/6.png') }}" alt="product-pic" height="36" />
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td style="width: 60px">
                                                        <img src="{{ asset('admin/assets/images/products/7.png') }}" alt="product-pic" height="36" />
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td style="width: 60px">
                                                        <img src="{{ asset('admin/assets/images/products/8.png') }}" alt="product-pic" height="36" />
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td style="width: 60px">
                                                        <img src="{{ asset('admin/assets/images/products/9.png') }}" alt="product-pic" height="36" />
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td style="width: 60px">
                                                        <img src="{{ asset('admin/assets/images/products/10.png') }}" alt="product-pic" height="36" />
                                                    </td>
                                                    <td>
...
<!-- Mirrored from coderthemes.com/paces/bootstrap/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:57:44 GMT -->
</html>
