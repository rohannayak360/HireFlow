...
<!-- Mirrored from coderthemes.com/paces/bootstrap/form-range-slider.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:59:48 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Range Slider | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Range Slider</h4>
                        </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-lg-8">
                                            ...
                                            <button id="lockbutton" class="btn btn-sm btn-primary">Lock</button>
                                        </div>
                                    </div>
...
<script src="{{ asset('admin/assets/js/app.js') }}"></script>
        ...
        <script src="{{ asset('admin/assets/plugins/wnumb/wNumb.min.js') }}"></script>

        <!-- noUiSlider Demo Js -->
        <script src="{{ asset('admin/assets/js/pages/form-range-slider.js') }}"></script>
    </body>
