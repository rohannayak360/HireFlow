...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-ecommerce-seller-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:18 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Seller Details | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Seller Details</h4>
                        </div>
                            ...
                            <div class="card card-top-sticky">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-center rounded border-light p-2 bg-light-subtle border">
                                        <div class="d-flex justify-content-start align-items-center gap-3">
                                            <div class="avatar avatar-xl">
                                                <img src="{{ asset('admin/assets/images/sellers/1.png') }}" alt="avatar-store" class="img-fluid rounded-circle" />
                                            </div>
                                            <div>
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <div class="d-flex align-items-center gap-2 mb-2">
                                            <div class="avatar-sm bg-light d-flex align-items-center justify-content-center rounded">
                                                <i class="ti ti-briefcase fs-xl text-muted"></i>
                                            </div>
                                        ...
                                        <div class="d-flex align-items-center gap-2 mb-2">
                                            <div class="avatar-sm bg-light d-flex align-items-center justify-content-center rounded">
                                                <i class="ti ti-map-pin fs-xl text-muted"></i>
                                            </div>
                                        ...
                                        <div class="d-flex align-items-center gap-2 mb-2">
                                            ...
                                            <p class="mb-0 fs-sm">
                                                Support:
                                                <a href="mailto:help&#64;stylehub.com" class="text-primary fw-semibold">help&#64;stylehub.com</a>
                                            </p>
                                        </div>

                                        <div class="d-flex align-items-center gap-2 mb-2">
                                            <div class="avatar-sm bg-light d-flex align-items-center justify-content-center rounded">
                                                <i class="ti ti-world fs-xl text-muted"></i>
                                            </div>
                                            <p class="mb-0 fs-sm">
                                                Website:
                                                <a href="#!" class="text-primary fw-semibold">www.stylehub.com</a>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <p class="mb-0">
                                                <span class="text-success"><i class="ti ti-circle-filled"></i></span>
                                ...
                                <div class="col">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <p class="mb-0">
                                                <span class="text-primary"><i class="ti ti-circle-filled"></i></span>
                                ...
                                <div class="col">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <p class="mb-0">
                                                <span class="text-info"><i class="ti ti-circle-filled"></i></span>
                                ...
                                <div class="col">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <p class="mb-0">
                                                <span class="text-secondary"><i class="ti ti-circle-filled"></i></span>
                                    ...
                                    <div data-table data-table-rows-per-page="8" class="card">
                                        <div class="card-header border-light justify-content-between">
                                            ...
                                            <div class="d-flex gap-1">
                                                ...
                                                <a href="{{ url('admin/apps-ecommerce-product-add') }}" class="btn btn-danger ms-1"> <i class="ti ti-plus fs-sm me-2"></i> Add Product </a>
                                            </div>
                                        </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div>
                                                                    <h5 class="mb-0">
                                                                        <a data-sort="product" href="{{ url('admin/apps-ecommerce-product-details') }}" class="link-reset">Gaming Laptop Pro</a>
                                                                    </h5>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div>
                                                                    <h5 class="mb-0">
                                                                        <a data-sort="product" href="{{ url('admin/apps-ecommerce-product-details') }}" class="link-reset">Vintage Leather Wallet</a>
                                                                    </h5>
                                                                </div>
                                                            </div>
                                                        </td>
...
<script src="{{ asset('admin/assets/js/app.js') }}"></script>
        ...
        <script src="{{ asset('admin/assets/js/pages/ecommerce-seller-details.js') }}"></script>
    </body>
