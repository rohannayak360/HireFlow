...
<!-- Mirrored from coderthemes.com/paces/bootstrap/maps-vector.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 10:00:06 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Vector Maps | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
...
<script src="{{ asset('admin/assets/js/app.js') }}"></script>
        ...
        <script src="{{ asset('admin/assets/js/maps/in-mill-en.js') }}"></script>
        <script src="{{ asset('admin/assets/js/maps/canada.js') }}"></script>
        <script src="{{ asset('admin/assets/js/maps/iraq.js') }}"></script>
        <script src="{{ asset('admin/assets/js/maps/russia.js') }}"></script>
        <script src="{{ asset('admin/assets/js/maps/spain.js') }}"></script>
        <script src="{{ asset('admin/assets/js/maps/us-aea-en.js') }}"></script>
        <script src="{{ asset('admin/assets/js/maps/us-lcc-en.js') }}"></script>
        <script src="{{ asset('admin/assets/js/maps/us-mill-en.js') }}"></script>

        <!-- Vector Map Demo js-->
        <script src="{{ asset('admin/assets/js/pages/maps-vector.js') }}"></script>
    </body>

<!-- Mirrored from coderthemes.com/paces/bootstrap/maps-vector.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 10:00:10 GMT -->
</html>
