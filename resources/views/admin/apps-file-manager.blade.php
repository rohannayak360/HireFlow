...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-file-manager.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:42 GMT -->
<head>
        <meta charset="utf-8" />
        <title>File Manager | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">File Manager</h4>
                        </div>
                            ...
                            <div class="card h-100 mb-0 rounded-0 border-0" data-simplebar>
                                <div class="card-body">
                                    ...
                                    <div class="list-group list-group-flush list-custom mt-3">
                                        <a href="{{ url('admin/file-manager') }}" class="list-group-item list-group-item-action active">
                                        ...
                                        <a href="javascript:void(0);" class="list-group-item list-group-item-action">
                                            <i class="ti ti-share me-1 opacity-75 fs-lg align-middle"></i>
                                        ...
                                        <a href="javascript:void(0);" class="list-group-item list-group-item-action">
                                            <i class="ti ti-download me-1 opacity-75 fs-lg align-middle"></i>
                            ...
                            <div class="card-header border-light justify-content-between">
                                ...
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <div class="app-search">
                                        ...
                                        <i class="ti ti-file app-search-icon text-muted"></i>
                                    </div>
                                        ...
                                        <div class="card border border-dashed mb-0">
                                            <div class="card-body p-2">
                                                <div class="d-flex align-items-center justify-content-between gap-2">
                                                    ...
                                                    <div class="flex-grow-1">
                                                        <h5 class="mb-1 fs-sm">
                                                            <a href="#!" class="link-reset">Premium Multi</a>
                                                        </h5>
                                                    ...
                                                    <div class="dropdown flex-shrink-0 text-muted">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            ...
                                                            <a href="{{ asset('admin/assets/images/users/user-1.jpg') }}" download class="dropdown-item">
                                                            ...
                                                            <a href="javascript:void(0);" class="dropdown-item" data-dismissible="#attex-react-folder">
                                        ...
                                        <div class="card border border-dashed mb-0">
                                            <div class="card-body p-2">
                                                <div class="d-flex align-items-center justify-content-between gap-2">
                                                    ...
                                                    <div class="flex-grow-1">
                                                        <h5 class="mb-1 fs-sm">
                                                            <a href="#!" class="link-reset">Material Design</a>
                                                        </h5>
                                                    ...
                                                    <div class="dropdown flex-shrink-0 text-muted">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            ...
                                                            <a href="javascript:void(0);" class="dropdown-item" data-dismissible="#material-design">
                                                                <i class="ti ti-trash me-1"></i>
                                                                Delete
                                                            </a>
                                                        </div>
                                        ...
                                        <div class="card border border-dashed mb-0">
                                            <div class="card-body p-2">
                                                <div class="d-flex align-items-center justify-content-between gap-2">
                                                    ...
                                                    <div class="flex-grow-1">
                                                        <h5 class="mb-1 fs-sm">
                                                            <a href="#!" class="link-reset">DashPro UI Kit</a>
                                                        </h5>
                                                    ...
                                                    <div class="dropdown flex-shrink-0 text-muted">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            ...
                                                            <a href="javascript:void(0);" class="dropdown-item" data-dismissible="#dashpro-ui">
                                                                <i class="ti ti-trash me-1"></i>
                                                                Delete
                                                            </a>
                                                        </div>
                                        ...
                                        <div class="card border border-dashed mb-0">
                                            <div class="card-body p-2">
                                                <div class="d-flex align-items-center justify-content-between gap-2">
                                                    ...
                                                    <div class="flex-grow-1">
                                                        <h5 class="mb-1 fs-sm">
                                                            <a href="#!" class="link-reset">VueStudio Pack</a>
                                                        </h5>
                                                    ...
                                                    <div class="dropdown flex-shrink-0 text-muted">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            ...
                                                            <a href="javascript:void(0);" class="dropdown-item" data-dismissible="#vuestudio-pack">
                                                                <i class="ti ti-trash me-1"></i>
                                                                Delete
                                                            </a>
                                                        </div>
                                        ...
                                        <div class="card border border-dashed mb-0">
                                            <div class="card-body p-2">
                                                <div class="d-flex align-items-center justify-content-between gap-2">
                                                    ...
                                                    <div class="flex-grow-1">
                                                        <h5 class="mb-1 fs-sm">
                                                            <a href="#!" class="link-reset">Nextify Pro</a>
                                                        </h5>
                                                    ...
                                                    <div class="dropdown flex-shrink-0 text-muted">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            ...
                                                            <a href="javascript:void(0);" class="dropdown-item" data-dismissible="#nextify-pro">
                                                                <i class="ti ti-trash me-1"></i>
                                                                Delete
                                                            </a>
                                                        </div>
                                        ...
                                        <div class="card border border-dashed mb-0">
                                            <div class="card-body p-2">
                                                <div class="d-flex align-items-center justify-content-between gap-2">
                                                    ...
                                                    <div class="flex-grow-1">
                                                        <h5 class="mb-1 fs-sm">
                                                            <a href="#!" class="link-reset">Blazor Studio</a>
                                                        </h5>
                                                    ...
                                                    <div class="dropdown flex-shrink-0 text-muted">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            ...
                                                            <a href="javascript:void(0);" class="dropdown-item" data-dismissible="#blazor-studio">
                                                                <i class="ti ti-trash me-1"></i>
                                                                Delete
                                                            </a>
                                                        </div>
                                        ...
                                        <div class="card border border-dashed mb-0">
                                            <div class="card-body p-2">
                                                <div class="d-flex align-items-center justify-content-between gap-2">
                                                    ...
                                                    <div class="flex-grow-1">
                                                        <h5 class="mb-1 fs-sm">
                                                            <a href="#!" class="link-reset">Angular Prime</a>
                                                        </h5>
                                                    ...
                                                    <div class="dropdown flex-shrink-0 text-muted">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            ...
                                                            <a href="javascript:void(0);" class="dropdown-item" data-dismissible="#angular-prime">
                                                                <i class="ti ti-trash me-1"></i>
                                                                Delete
                                                            </a>
                                                        </div>
                                        ...
                                        <div class="card border border-dashed mb-0">
                                            <div class="card-body p-2">
                                                <div class="d-flex align-items-center justify-content-between gap-2">
                                                    ...
                                                    <div class="flex-grow-1">
                                                        <h5 class="mb-1 fs-sm">
                                                            <a href="#!" class="link-reset">React Kit Pro</a>
                                                        </h5>
                                                    ...
                                                    <div class="dropdown flex-shrink-0 text-muted">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            ...
                                                            <a href="javascript:void(0);" class="dropdown-item" data-dismissible="#react-kit-pro">
                                                                <i class="ti ti-trash me-1"></i>
                                                                Delete
                                                            </a>
                                                        </div>
                                        ...
                                        <tbody>
                                                    ...
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            <h5 class="mb-1 fs-base">
                                                                <a data-sort="name" href="#!" class="link-reset">Project Overview Video</a>
                                                            </h5>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="flex-shrink-0 bg-light bg-opacity-50 text-muted d-inline-flex align-items-center justify-content-center rounded-2">
                                                            <img src="{{ asset('admin/assets/images/users/user-3.jpg') }}" alt="" class="avatar-xs rounded-circle" />
                                                        </div>
                                                        <h5 class="mb-0 fs-base">
                                                            <a href="#!" data-sort="owner" class="link-reset">john&#64;techgroup.com</a>
                                                        </h5>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="avatar-group avatar-group-xs">
                                                        <div class="avatar">
                                                            <img src="{{ asset('admin/assets/images/users/user-5.jpg') }}" alt="" class="rounded-circle avatar-xs" />
                                                        </div>
                                                        <div class="avatar">
                                                            <img src="{{ asset('admin/assets/images/users/user-7.jpg') }}" alt="" class="rounded-circle avatar-xs" />
                                                        </div>
                                                        <div class="avatar">
                                                            <img src="{{ asset('admin/assets/images/users/user-6.jpg') }}" alt="" class="rounded-circle avatar-xs" />
                                                        </div>
                                                        <div class="avatar">
                                                            <img src="{{ asset('admin/assets/images/users/user-4.jpg') }}" alt="" class="rounded-circle avatar-xs" />
                                                        </div>
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            <h5 class="mb-1 fs-base">
                                                                <a data-sort="name" href="#!" class="link-reset">Team Meeting Video</a>
                                                            </h5>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="flex-shrink-0 bg-light bg-opacity-50 text-muted d-inline-flex align-items-center justify-content-center rounded-2">
                                                            <img src="{{ asset('admin/assets/images/users/user-4.jpg') }}" alt="" class="avatar-xs rounded-circle" />
                                                        </div>
                                                        <h5 class="mb-0 fs-base">
                                                            <a href="#!" data-sort="owner" class="link-reset">michael&#64;devteam.com</a>
                                                        </h5>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="avatar-group avatar-group-xs">
                                                        <div class="avatar">
                                                            <img src="{{ asset('admin/assets/images/users/user-2.jpg') }}" alt="" class="rounded-circle avatar-xs" />
                                                        </div>
                                                        <div class="avatar">
                                                            <img src="{{ asset('admin/assets/images/users/user-3.jpg') }}" alt="" class="rounded-circle avatar-xs" />
                                                        </div>
                                                        <div class="avatar">
                                                            <img src="{{ asset('admin/assets/images/users/user-5.jpg') }}" alt="" class="rounded-circle avatar-xs" />
                                                        </div>
                                                    ...
                                                    <div class="d-flex align-items-center justify-content-end gap-2">
                                                        ...
                                                        <div class="dropdown flex-shrink-0 text-muted">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-end">
                                                                ...
                                                                <a href="{{ asset('admin/assets/images/users/user-4.jpg') }}" download class="dropdown-item">
                                                                    <i class="ti ti-download me-1"></i>
                                                                    Download
                                                                </a>
                                                                <a href="javascript:void(0);" class="dropdown-item">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            <h5 class="mb-1 fs-base">
                                                                <a data-sort="name" href="#!" class="link-reset">Marketing Strategy Design</a>
                                                            </h5>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="flex-shrink-0 bg-light bg-opacity-50 text-muted d-inline-flex align-items-center justify-content-center rounded-2">
                                                            <img src="{{ asset('admin/assets/images/users/user-2.jpg') }}" alt="" class="avatar-xs rounded-circle" />
                                                        </div>
                                                        <h5 class="mb-0 fs-base">
                                                            <a data-sort="owner" href="#!" class="link-reset">susan&#64;marketing.com</a>
                                                        </h5>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="avatar-group avatar-group-xs">
                                                        <div class="avatar">
                                                            <img src="{{ asset('admin/assets/images/users/user-1.jpg') }}" alt="" class="rounded-circle avatar-xs" />
                                                        </div>
                                                        <div class="avatar">
                                                            <img src="{{ asset('admin/assets/images/users/user-3.jpg') }}" alt="" class="rounded-circle avatar-xs" />
                                                        </div>
                                                        ...
                                                        <div class="avatar">
                                                            <img src="{{ asset('admin/assets/images/users/user-9.jpg') }}" alt="" class="rounded-circle avatar-xs" />
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="text-end pe-3">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="flex-shrink-0 bg-light bg-opacity-50 text-muted d-inline-flex align-items-center justify-content-center rounded-2">
                                                            <img src="{{ asset('admin/assets/images/users/user-8.jpg') }}" alt="" class="avatar-xs rounded-circle" />
                                                        </div>
                                                        <h5 class="mb-0 fs-base">
                                                    ...
                                                    <div class="d-flex align-items-center justify-content-end gap-2">
                                                        ...
                                                        <div class="dropdown flex-shrink-0 text-muted">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-end">
                                                                ...
                                                                <a href="{{ asset('admin/assets/files/proposal.html') }}" download class="dropdown-item">
                                                                    <i class="ti ti-download me-1"></i>
                                                                    Download
                                                                </a>
                                                                <a href="javascript:void(0);" class="dropdown-item">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            <h5 class="mb-1 fs-base">
                                                                <a data-sort="name" href="#!" class="link-reset">Database Schema</a>
                                                            </h5>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <h5 class="mb-0 fs-base">
                                                            <a href="#!" data-sort="owner" class="link-reset">alex&#64;creatix.io</a>
                                                        </h5>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="avatar-group avatar-group-xs">
                                                        ...
                                                        <div class="avatar">
                                                            <img src="{{ asset('admin/assets/images/users/user-8.jpg') }}" alt="" class="rounded-circle avatar-xs" />
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="text-end pe-3">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            <h5 class="mb-1 fs-base">
                                                                <a data-sort="name" href="#!" class="link-reset">Website Script</a>
                                                            </h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            <h5 class="mb-1 fs-base">
                                                                <a data-sort="name" href="#!" class="link-reset">Dependency Package</a>
                                                            </h5>
                                                    ...
                                                    <div class="d-flex align-items-center justify-content-end gap-2">
                                                        ...
                                                        <div class="dropdown flex-shrink-0 text-muted">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-end">
                                                                ...
                                                                <a href="{{ asset('admin/assets/files/dependency.html') }}" download class="dropdown-item">
                                                                    <i class="ti ti-download me-1"></i>
                                                                    Download
                                                                </a>
                                                                <a href="javascript:void(0);" class="dropdown-item">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            <h5 class="mb-1 fs-base">
                                                                <a data-sort="name" href="#!" class="link-reset">Internet Portal</a>
                                                            </h5>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="flex-shrink-0 bg-light bg-opacity-50 text-muted d-inline-flex align-items-center justify-content-center rounded-2">
                                                            <img src="{{ asset('admin/assets/images/users/user-6.jpg') }}" alt="" class="avatar-xs rounded-circle" />
                                                        </div>
                                                        <h5 class="mb-0 fs-base">
                                                            <a data-sort="owner" href="#!" class="link-reset">emma&#64;devcore.com</a>
                                                        </h5>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="avatar-group avatar-group-xs">
                                                        ...
                                                        <div class="avatar">
                                                            <img src="{{ asset('admin/assets/images/users/user-10.jpg') }}" alt="" class="rounded-circle avatar-xs" />
                                                        </div>
                                                        <div class="avatar">
                                                            <img src="{{ asset('admin/assets/images/users/user-3.jpg') }}" alt="" class="rounded-circle avatar-xs" />
                                                        </div>
                                                    ...
                                                    <div class="d-flex align-items-center justify-content-end gap-2">
                                                        ...
                                                        <div class="dropdown flex-shrink-0 text-muted">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-end">
                                                                ...
                                                                <a href="{{ asset('admin/assets/images/users/user-6.jpg') }}" download class="dropdown-item">
                                                                    <i class="ti ti-download me-1"></i>
                                                                    Download
                                                                </a>
                                                                <a href="javascript:void(0);" class="dropdown-item">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            <h5 class="mb-1 fs-base">
                                                                <a data-sort="name" href="#" class="link-reset">Podcast Episode 12</a>
                                                            </h5>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <h5 class="mb-0 fs-base">
                                                            <a data-sort="owner" href="#!" class="link-reset">alex&#64;creatix.io</a>
                                                        </h5>
                                                    </div>
                                                </td>
                                                <td>
...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-file-manager.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:43 GMT -->
</html>
