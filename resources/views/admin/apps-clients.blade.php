...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-clients.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:44 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Clients | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Clients</h4>
                        </div>
                            ...
                            <div data-table data-table-rows-per-page="8" class="card">
                                <div class="card-header border-light justify-content-between">
                                    <div class="d-flex gap-2">
                                        ...
                                        <button type="button" class="btn btn-secondary btn-icon" data-bs-toggle="modal" data-bs-target="#addClientModal">
                                            ...
                                            <tr>
                                                    ...
                                                    <div class="d-flex justify-content-start align-items-center gap-2">
                                                        ...
                                                        <div>
                                                            <h5 class="text-nowrap mb-0 lh-base fs-base">
                                                                <a data-sort="name" href="#!" class="link-reset">Emily Parker</a>
                                                            </h5>
                                                ...
                                                <td>
                                                    <span class="d-flex align-items-center fs-sm fw-bold">
                                                        <img src="{{ asset('admin/assets/images/flags/us.svg') }}" alt="" class="rounded-circle me-1" height="12" />
                                                        US
                                                    </span>
                                                </td>
                                                <td>Feb 2, 2024</td>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center justify-content-center gap-1">
                                                        <a href="javascript:void(0);" class="btn btn-default btn-icon btn-sm">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-start align-items-center gap-2">
                                                        ...
                                                        <div>
                                                            <h5 class="text-nowrap mb-0 lh-base fs-base">
                                                                <a data-sort="name" href="#!" class="link-reset">Liam Scott</a>
                                                            </h5>
                                                ...
                                                <td>
                                                    <span class="d-flex align-items-center fs-sm fw-bold">
                                                        <img src="{{ asset('admin/assets/images/flags/gb.svg') }}" alt="" class="rounded-circle me-1" height="12" />
                                                        UK
                                                    </span>
                                                </td>
                                                <td>Jan 15, 2024</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-start align-items-center gap-2">
                                                        ...
                                                        <div>
                                                            <h5 class="text-nowrap mb-0 lh-base fs-base">
                                                                <a data-sort="name" href="#!" class="link-reset">Sofia Müller</a>
                                                            </h5>
                                                ...
                                                <td>
                                                    <span class="d-flex align-items-center fs-sm fw-bold">
                                                        <img src="{{ asset('admin/assets/images/flags/de.svg') }}" alt="" class="rounded-circle me-1" height="12" />
                                                        DE
                                                    </span>
                                                </td>
                                                <td>Mar 12, 2024</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-start align-items-center gap-2">
                                                        ...
                                                        <div>
                                                            <h5 class="text-nowrap mb-0 lh-base fs-base">
                                                                <a data-sort="name" href="#!" class="link-reset">Carlos Méndez</a>
                                                            </h5>
                                                ...
                                                <td>
                                                    <span class="d-flex align-items-center fs-sm fw-bold">
                                                        <img src="{{ asset('admin/assets/images/flags/mx.svg') }}" alt="" class="rounded-circle me-1" height="12" />
                                                        MX
                                                    </span>
                                                </td>
                                                <td>Jan 8, 2024</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-start align-items-center gap-2">
                                                        ...
                                                        <div>
                                                            <h5 class="text-nowrap mb-0 lh-base fs-base">
                                                                <a data-sort="name" href="#!" class="link-reset">Nina Patel</a>
                                                            </h5>
                                                ...
                                                <td>
                                                    <span class="d-flex align-items-center fs-sm fw-bold">
                                                        <img src="{{ asset('admin/assets/images/flags/in.svg') }}" alt="" class="rounded-circle me-1" height="12" />
                                                        IN
                                                    </span>
                                                </td>
                                                <td>Feb 19, 2024</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-start align-items-center gap-2">
                                                        ...
                                                        <div>
                                                            <h5 class="text-nowrap mb-0 lh-base fs-base">
                                                                <a data-sort="name" href="#!" class="link-reset">Oliver Chen</a>
                                                            </h5>
                                                ...
                                                <td>
                                                    <span class="d-flex align-items-center fs-sm fw-bold">
                                                        <img src="{{ asset('admin/assets/images/flags/sg.svg') }}" alt="" class="rounded-circle me-1" height="12" />
                                                        SG
                                                    </span>
                                                </td>
                                                <td>Jan 30, 2024</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-start align-items-center gap-2">
                                                        ...
                                                        <div>
                                                            <h5 class="text-nowrap mb-0 lh-base fs-base">
                                                                <a data-sort="name" href="#!" class="link-reset">Maya Tanaka</a>
                                                            </h5>
                                                ...
                                                <td>
                                                    <span class="d-flex align-items-center fs-sm fw-bold">
                                                        <img src="{{ asset('admin/assets/images/flags/jp.svg') }}" alt="" class="rounded-circle me-1" height="12" />
                                                        JP
                                                    </span>
                                                </td>
                                                <td>Mar 5, 2024</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-start align-items-center gap-2">
                                                        ...
                                                        <div>
                                                            <h5 class="text-nowrap mb-0 lh-base fs-base">
                                                                <a data-sort="name" href="#!" class="link-reset">Lucas Ferreira</a>
                                                            </h5>
                                                ...
                                                <td>
                                                    <span class="d-flex align-items-center fs-sm fw-bold">
                                                        <img src="{{ asset('admin/assets/images/flags/br.svg') }}" alt="" class="rounded-circle me-1" height="12" />
                                                        BR
                                                    </span>
                                                </td>
                                                <td>Feb 24, 2024</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-start align-items-center gap-2">
                                                        ...
                                                        <div>
                                                            <h5 class="text-nowrap mb-0 lh-base fs-base">
                                                                <a data-sort="name" href="#!" class="link-reset">Anna Schmidt</a>
                                                            </h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-start align-items-center gap-2">
                                                        ...
                                                        <div>
                                                            <h5 class="text-nowrap mb-0 lh-base fs-base">
                                                                <a data-sort="name" href="#!" class="link-reset">Jason Lee</a>
                                                            </h5>
                                                ...
                                                <td>
                                                    <span class="d-flex align-items-center fs-sm fw-bold">
                                                        <img src="{{ asset('admin/assets/images/flags/au.svg') }}" alt="" class="rounded-circle me-1" height="12" />
                                                        AU
                                                    </span>
                                                </td>
                                                <td>Mar 14, 2024</td>
                                    ...
                                    <div class="modal-body">
                                        <div class="row g-3">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control" id="clientName" name="client_name" placeholder="Enter full name" required />
                                            </div>

                                            <!-- Email -->
                                            <div class="col-md-6">
                                                <label for="clientEmail" class="form-label">Email</label>
                                                <input type="email" class="form-control" id="clientEmail" name="email" placeholder="client&#64;example.com" required />
                                            </div>

                                            <!-- Phone -->
                                            <div class="col-md-6">
                                                <label for="clientPhone" class="form-label">Phone</label>
                                                <input type="tel" class="form-control" id="clientPhone" name="phone" placeholder="+1 (000) 000-0000" />
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="date" class="form-control flatpickr-input" data-provider="flatpickr" data-altFormat="F j, Y" id="clientEnrolled" name="enrolled_date" />
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control" id="clientJobTitle" name="job_title" placeholder="Frontend Developer" />
                                            </div>
...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-clients.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:45 GMT -->
</html>
