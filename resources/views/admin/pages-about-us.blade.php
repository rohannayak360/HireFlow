...
<!-- Mirrored from coderthemes.com/paces/bootstrap/pages-about-us.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:50 GMT -->
<head>
        <meta charset="utf-8" />
        <title>About Us | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">About Us</h4>
                        </div>
                                    ...
                                    <div class="row bg-light bg-opacity-50">
                                        <div class="col-lg-8 mx-auto py-5 text-center">
                                            ...
                                            <div class="avatar-group avatar-group-sm justify-content-center mt-3">
                                                <div class="avatar">
                                                    <img src="{{ asset('admin/assets/images/users/user-7.jpg') }}" alt="Dr. Ava Lee – AI Researcher" class="avatar-sm rounded-circle" />
                                                </div>
                                                <div class="avatar">
                                                    <img src="{{ asset('admin/assets/images/users/user-8.jpg') }}" alt="Ethan King – Data Scientist" class="avatar-sm rounded-circle" />
                                                </div>
                                                <div class="avatar">
                                                    <img src="{{ asset('admin/assets/images/users/user-9.jpg') }}" alt="Lucas White – ML Engineer" class="avatar-sm rounded-circle" />
                                                </div>
                                                <div class="avatar">
                                                    <img src="{{ asset('admin/assets/images/users/user-1.jpg') }}" alt="Sophia Chen – Robotics Expert" class="avatar-sm rounded-circle" />
                                                </div>
                                                <div class="avatar">
                                                    <img src="{{ asset('admin/assets/images/users/user-2.jpg') }}" alt="Raj Patel – AI Strategist" class="avatar-sm rounded-circle" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="row row-cols-xxl-5 row-cols-md-3 row-cols-1 justify-content-center">
                                                    ...
                                                    <div class="card border-light">
                                                        <div class="card-body border-0 pb-0 text-center">
                                                            <div class="mx-auto mb-3">
                                                                <img src="{{ asset('admin/assets/images/users/user-1.jpg') }}" alt="Emily Carter" class="img-fluid rounded" />
                                                            </div>
                                                ...
                                                <div class="col">
                                                    <div class="card border-light">
                                                        <div class="card-body border-0 pb-0 text-center">
                                                            <div class="mx-auto mb-3">
                                                                <img src="{{ asset('admin/assets/images/users/user-2.jpg') }}" alt="Michael Lee" class="img-fluid rounded" />
                                                            </div>
                                                ...
                                                <div class="col">
                                                    <div class="card border-light">
                                                        <div class="card-body border-0 pb-0 text-center">
                                                            <div class="mx-auto mb-3">
                                                                <img src="{{ asset('admin/assets/images/users/user-3.jpg') }}" alt="Sophia Gomez" class="img-fluid rounded" />
                                                            </div>
                                                ...
                                                <div class="col">
                                                    <div class="card border-light">
                                                        <div class="card-body border-0 pb-0 text-center">
                                                            <div class="mx-auto mb-3">
                                                                <img src="{{ asset('admin/assets/images/users/user-4.jpg') }}" alt="Daniel Kim" class="img-fluid rounded" />
                                                            </div>
                                                ...
                                                <div class="col">
                                                    <div class="card border-light">
                                                        <div class="card-body border-0 pb-0 text-center">
                                                            <div class="mx-auto mb-3">
                                                                <img src="{{ asset('admin/assets/images/users/user-8.jpg') }}" alt="Hannah White" class="img-fluid rounded" />
                                                            </div>
                                                ...
                                                <div class="col">
                                                    <div class="card border-light">
                                                        <div class="card-body border-0 pb-0 text-center">
                                                            <div class="mx-auto mb-3">
                                                                <img src="{{ asset('admin/assets/images/users/user-5.jpg') }}" alt="Liam Smith" class="img-fluid rounded" />
                                                            </div>
                                                ...
                                                <div class="col">
                                                    <div class="card border-light">
                                                        <div class="card-body border-0 pb-0 text-center">
                                                            <div class="mx-auto mb-3">
                                                                <img src="{{ asset('admin/assets/images/users/user-6.jpg') }}" alt="Chloe Brown" class="img-fluid rounded" />
                                                            </div>
                                                ...
                                                <div class="col">
                                                    <div class="card border-light">
                                                        <div class="card-body border-0 pb-0 text-center">
                                                            <div class="mx-auto mb-3">
                                                                <img src="{{ asset('admin/assets/images/users/user-7.jpg') }}" alt="Ethan Ross" class="img-fluid rounded" />
                                                            </div>
                                                ...
                                                <div class="col">
                                                    <div class="card border-light">
                                                        <div class="card-body border-0 pb-0 text-center">
                                                            <div class="mx-auto mb-3">
                                                                <img src="{{ asset('admin/assets/images/users/user-9.jpg') }}" alt="Lena Marshall" class="img-fluid rounded" />
                                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-xl-4">
                                                    <div class="card border-light p-2 card-h-100">
                                                        <div class="card-body pb-0">
                                                            <img src="{{ asset('admin/assets/images/flags/us.svg') }}" class="avatar-xl mb-3 rounded-circle" />
                                                ...
                                                <div class="col-xl-4">
                                                    <div class="card border-light p-2 card-h-100">
                                                        <div class="card-body pb-0">
                                                            <img src="{{ asset('admin/assets/images/flags/gb.svg') }}" class="avatar-xl mb-3 rounded-circle" />
                                                ...
                                                <div class="col-xl-4">
                                                    <div class="card border-light p-2 card-h-100">
                                                        <div class="card-body pb-0">
                                                            <img src="{{ asset('admin/assets/images/flags/in.svg') }}" class="avatar-xl mb-3 rounded-circle" />
