...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-users-contacts.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:30 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Contacts | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Contacts</h4>
                        </div>
                                    ...
                                    <div class="col">
                                        <div class="d-flex flex-wrap align-items-center gap-2">
                                            ...
                                            <div class="app-search">
                                                ...
                                                <i class="ti ti-stack-2 app-search-icon text-muted"></i>
                                            </div>
                    ...
                    <div class="row">
                            ...
                            <div class="card">
                                <div class="card-body text-center">
                                    ...
                                    <h5 class="mb-0 mt-2 d-flex align-items-center justify-content-center">
                                        <a href="{{ url('admin/apps-users-profile') }}" class="link-reset">Sophia Carter</a>
                                        <img src="{{ asset('admin/assets/images/flags/gb.svg') }}" alt="UK" class="ms-1 rounded" height="16" />
                                    </h5>
                                    <!-- Designation & Badge -->
                        ...
                        <div class="col-md-6 col-xxl-3">
                            <div class="card">
                                <div class="card-body text-center">
                                    <img src="{{ asset('admin/assets/images/users/user-2.jpg') }}" alt="avatar" class="rounded-circle" width="72" height="72" />
                                    <h5 class="mb-0 mt-2 d-flex align-items-center justify-content-center">
                                        <a href="{{ url('admin/apps-users-profile') }}" class="link-reset">Daniel Lee</a>
                                        <img src="{{ asset('admin/assets/images/flags/us.svg') }}" alt="US" class="ms-1 rounded" height="16" />
                                    </h5>
                        ...
                        <div class="col-md-6 col-xxl-3">
                            <div class="card">
                                <div class="card-body text-center">
                                    <img src="{{ asset('admin/assets/images/users/user-3.jpg') }}" alt="avatar" class="rounded-circle" width="72" height="72" />
                                    <h5 class="mb-0 mt-2 d-flex align-items-center justify-content-center">
                                        <a href="{{ url('admin/apps-users-profile') }}" class="link-reset">Maria Rodriguez</a>
                                        <img src="{{ asset('admin/assets/images/flags/es.svg') }}" alt="Spain" class="ms-1 rounded" height="16" />
                                    </h5>
                        ...
                        <div class="col-md-6 col-xxl-3">
                            <div class="card">
                                <div class="card-body text-center">
                                    <img src="{{ asset('admin/assets/images/users/user-4.jpg') }}" alt="avatar" class="rounded-circle" width="72" height="72" />
                                    <h5 class="mb-0 mt-2 d-flex align-items-center justify-content-center">
                                        <a href="{{ url('admin/apps-users-profile') }}" class="link-reset">Liam Zhang</a>
                                        <img src="{{ asset('admin/assets/images/flags/cn.svg') }}" alt="China" class="ms-1 rounded" height="16" />
                                    </h5>
                        ...
                        <div class="col-md-6 col-xxl-3">
                            <div class="card">
                                <div class="card-body text-center">
                                    ...
                                    <!-- Name & Flag -->
                                    <h5 class="mb-0 mt-2 d-flex align-items-center justify-content-center">
                                        <a href="{{ url('admin/apps-users-profile') }}" class="link-reset">Ethan Wright</a>
                                        <img src="{{ asset('admin/assets/images/flags/ca.svg') }}" alt="Canada" class="ms-1 rounded" height="16" />
                                    </h5>
                        ...
                        <div class="col-md-6 col-xxl-3">
                            <div class="card">
                                <div class="card-body text-center">
                                    ...
                                    <!-- Name & Flag -->
                                    <h5 class="mb-0 mt-2 d-flex align-items-center justify-content-center">
                                        <a href="{{ url('admin/apps-users-profile') }}" class="link-reset">Isabella Moretti</a>
                                        <img src="{{ asset('admin/assets/images/flags/it.svg') }}" alt="Italy" class="ms-1 rounded" height="16" />
                                    </h5>
                        ...
                        <div class="col-md-6 col-xxl-3">
                            <div class="card">
                                <div class="card-body text-center">
                                    <!-- Avatar -->
                                    <img src="{{ asset('admin/assets/images/users/user-9.jpg') }}" alt="avatar" class="rounded-circle" width="72" height="72" />

                                    <!-- Name & Flag -->
                                    <h5 class="mb-0 mt-2 d-flex align-items-center justify-content-center">
                                        <a href="{{ url('admin/apps-users-profile') }}" class="link-reset">Kenji Tanaka</a>
                                        <img src="{{ asset('admin/assets/images/flags/jp.svg') }}" alt="Japan" class="ms-1 rounded" height="16" />
                                    </h5>
                        ...
                        <div class="col-md-6 col-xxl-3">
                            <div class="card">
                                <div class="card-body text-center">
                                    <!-- Avatar -->
                                    <img src="{{ asset('admin/assets/images/users/user-10.jpg') }}" alt="avatar" class="rounded-circle" width="72" height="72" />

                                    <!-- Name & Flag -->
                                    <h5 class="mb-0 mt-2 d-flex align-items-center justify-content-center">
                                        <a href="{{ url('admin/apps-users-profile') }}" class="link-reset">Amira El-Sayed</a>
                                        <img src="{{ asset('admin/assets/images/flags/eg.svg') }}" alt="Egypt" class="ms-1 rounded" height="16" />
                                    </h5>
...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-users-contacts.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:31 GMT -->
</html>
