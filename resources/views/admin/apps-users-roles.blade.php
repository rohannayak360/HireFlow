...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-users-roles.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:31 GMT -->
<head>
        <meta charset="utf-8" />
        <title>User Roles | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="d-flex align-items-sm-center flex-sm-row flex-column my-3">
                                ...
                                <div class="text-end">
                                    <a href="javascript: void(0);" data-bs-toggle="modal" data-bs-target="#addRoleModal" class="btn btn-success"> <i class="ti ti-plus me-1"></i> Add New Role </a>
                                </div>
                            </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body d-flex flex-column justify-content-between">
                                            ...
                                            <ul class="list-unstyled mb-3">
                                                <li class="d-flex align-items-center mb-2"><i class="ti ti-check fs-lg text-success me-2"></i> Daily Risk Assessment</li>
                                                <li class="d-flex align-items-center mb-2"><i class="ti ti-check fs-lg text-success me-2"></i> Manage Security Logs</li>
                                                <li class="d-flex align-items-center mb-2"><i class="ti ti-check fs-lg text-success me-2"></i> Control Access Rights</li>
                                                <li class="d-flex align-items-center"><i class="ti ti-check fs-lg text-success me-2"></i> Emergency Protocols</li>
                                            </ul>
                                            ...
                                            <div class="d-flex justify-content-between align-items-center">
                                                ...
                                                <a href="{{ url('admin/apps-users-role-details') }}" class="btn btn-sm btn-outline-primary rounded-pill">Details</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-lg-3">
                                    <div class="card">
                                        ...
                                        <div class="card-body d-flex flex-column justify-content-between">
                                            ...
                                            <ul class="list-unstyled mb-3">
                                                <li class="d-flex align-items-center mb-2"><i class="ti ti-check fs-lg text-success me-2"></i> Timeline Tracking</li>
                                                <li class="d-flex align-items-center mb-2"><i class="ti ti-check fs-lg text-success me-2"></i> Task Assignments</li>
                                                <li class="d-flex align-items-center mb-2"><i class="ti ti-check fs-lg text-success me-2"></i> Budget Control</li>
                                                <li class="d-flex align-items-center"><i class="ti ti-check fs-lg text-success me-2"></i> Stakeholder Reporting</li>
                                            </ul>

                                            <p class="mb-2 text-muted">Total 5 users</p>
                                            <div class="avatar-group avatar-group-sm mb-3">
                                                <div class="avatar"><img src="{{ asset('admin/assets/images/users/user-2.jpg') }}" class="rounded-circle avatar-sm" alt="" /></div>
                                                <div class="avatar"><img src="{{ asset('admin/assets/images/users/user-5.jpg') }}" class="rounded-circle avatar-sm" alt="" /></div>
                                                <div class="avatar"><img src="{{ asset('admin/assets/images/users/user-6.jpg') }}" class="rounded-circle avatar-sm" alt="" /></div>
                                                <div class="avatar"><img src="{{ asset('admin/assets/images/users/user-1.jpg') }}" class="rounded-circle avatar-sm" alt="" /></div>
                                                <div class="avatar"><img src="{{ asset('admin/assets/images/users/user-8.jpg') }}" class="rounded-circle avatar-sm" alt="" /></div>
                                            </div>
                                ...
                                <div class="col-md-6 col-lg-3">
                                    <div class="card">
                                        ...
                                        <div class="card-body d-flex flex-column justify-content-between">
                                            ...
                                            <ul class="list-unstyled mb-3">
                                                <li class="d-flex align-items-center mb-2"><i class="ti ti-check fs-lg text-success me-2"></i> Codebase Maintenance</li>
                                                <li class="d-flex align-items-center mb-2"><i class="ti ti-check fs-lg text-success me-2"></i> API Integration</li>
                                                <li class="d-flex align-items-center mb-2"><i class="ti ti-check fs-lg text-success me-2"></i> Unit Testing</li>
                                                <li class="d-flex align-items-center"><i class="ti ti-check fs-lg text-success me-2"></i> Feature Deployment</li>
                                            </ul>

                                            <p class="mb-2 text-muted">Total 6 users</p>
                                            <div class="avatar-group avatar-group-sm mb-3">
                                                <div class="avatar"><img src="{{ asset('admin/assets/images/users/user-3.jpg') }}" class="rounded-circle avatar-sm" alt="" /></div>
                                                <div class="avatar"><img src="{{ asset('admin/assets/images/users/user-4.jpg') }}" class="rounded-circle avatar-sm" alt="" /></div>
                                                <div class="avatar"><img src="{{ asset('admin/assets/images/users/user-9.jpg') }}" class="rounded-circle avatar-sm" alt="" /></div>
                                                <div class="avatar"><img src="{{ asset('admin/assets/images/users/user-10.jpg') }}" class="rounded-circle avatar-sm" alt="" /></div>
                                ...
                                <div class="col-md-6 col-lg-3">
                                    <div class="card">
                                        ...
                                        <div class="card-body d-flex flex-column justify-content-between">
                                            ...
                                            <ul class="list-unstyled mb-3">
                                                <li class="d-flex align-items-center mb-2"><i class="ti ti-check fs-lg text-success me-2"></i> Respond to Tickets</li>
                                                <li class="d-flex align-items-center mb-2"><i class="ti ti-check fs-lg text-success me-2"></i> Live Chat Supervision</li>
                                                <li class="d-flex align-items-center mb-2"><i class="ti ti-check fs-lg text-success me-2"></i> FAQ Updates</li>
                                                <li class="d-flex align-items-center"><i class="ti ti-check fs-lg text-success me-2"></i> Support Metrics Review</li>
                                            </ul>
                                            ...
                                            <div class="avatar-group avatar-group-sm mb-3">
                                                <div class="avatar"><img src="{{ asset('admin/assets/images/users/user-1.jpg') }}" class="rounded-circle avatar-sm" alt="" /></div>
                                                <div class="avatar"><img src="{{ asset('admin/assets/images/users/user-5.jpg') }}" class="rounded-circle avatar-sm" alt="" /></div>
                                                <div class="avatar"><img src="{{ asset('admin/assets/images/users/user-7.jpg') }}" class="rounded-circle avatar-sm" alt="" /></div>
                                            </div>
                                            ...
                                            <table class="table table-custom table-centered table-select table-hover w-100 mb-0">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <h5 class="m-0">
                                                                <a href="#" class="link-reset">#USR00123</a>
                                                            </h5>
                                                        </td>
                                                        <td>
                                                            <div class="d-flex align-items-center gap-2">
                                                                ...
                                                                <div>
                                                                    <h5 class="fs-base mb-0">
                                                                        <a data-sort="user" href="#" class="link-reset">Nathan Young</a>
                                                                    </h5>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <h5 class="m-0">
                                                                <a href="#" class="link-reset">#USR00145</a>
                                                            </h5>
                                                        </td>
                                                        <td>
                                                            <div class="d-flex align-items-center gap-2">
                                                                ...
                                                                <div>
                                                                    <h5 class="fs-base mb-0">
                                                                        <a data-sort="user" href="#" class="link-reset">Leah Kim</a>
                                                                    </h5>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <h5 class="m-0">
                                                                <a href="#" class="link-reset">#USR00162</a>
                                                            </h5>
                                                        </td>
                                                        <td>
                                                            <div class="d-flex align-items-center gap-2">
                                                                ...
                                                                <div>
                                                                    <h5 class="fs-base mb-0">
                                                                        <a data-sort="user" href="#" class="link-reset">Sophie Lee</a>
                                                                    </h5>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <h5 class="m-0">
                                                                <a href="#" class="link-reset">#USR00178</a>
                                                            </h5>
                                                        </td>
                                                        <td>
                                                            <div class="d-flex align-items-center gap-2">
                                                                ...
                                                                <div>
                                                                    <h5 class="fs-base mb-0">
                                                                        <a data-sort="user" href="#" class="link-reset">David Tran</a>
                                                                    </h5>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <h5 class="m-0">
                                                                <a href="#" class="link-reset">#USR00189</a>
                                                            </h5>
                                                        </td>
                                                        <td>
                                                            <div class="d-flex align-items-center gap-2">
                                                                ...
                                                                <div>
                                                                    <h5 class="fs-base mb-0">
                                                                        <a data-sort="user" href="#" class="link-reset">Isabella Moore</a>
                                                                    </h5>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <h5 class="m-0">
                                                                <a href="#" class="link-reset">#USR00203</a>
                                                            </h5>
                                                        </td>
                                                        <td>
                                                            <div class="d-flex align-items-center gap-2">
                                                                ...
                                                                <div>
                                                                    <h5 class="fs-base mb-0">
                                                                        <a data-sort="user" href="#" class="link-reset">Daniel Cooper</a>
                                                                    </h5>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <h5 class="m-0">
                                                                <a href="#" class="link-reset">#USR00215</a>
                                                            </h5>
                                                        </td>
                                                        <td>
                                                            <div class="d-flex align-items-center gap-2">
                                                                ...
                                                                <div>
                                                                    <h5 class="fs-base mb-0">
                                                                        <a data-sort="user" href="#" class="link-reset">Ava Thompson</a>
                                                                    </h5>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <h5 class="m-0">
                                                                <a href="#" class="link-reset">#USR00228</a>
                                                            </h5>
                                                        </td>
                                                        <td>
                                                            <div class="d-flex align-items-center gap-2">
                                                                <div class="avatar avatar-sm">
                                                                    <img src="{{ asset('admin/assets/images/users/user-9.jpg') }}" class="img-fluid rounded-circle" alt="" />
                                                                </div>
                                                                <div>
                                                                    <h5 class="fs-base mb-0">
                                                                        <a data-sort="user" href="#" class="link-reset">Mason Carter</a>
                                                                    </h5>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <h5 class="m-0">
                                                                <a href="#" class="link-reset">#USR00239</a>
                                                            </h5>
                                                        </td>
                                                        <td>
                                                            <div class="d-flex align-items-center gap-2">
                                                                <div class="avatar avatar-sm">
                                                                    <img src="{{ asset('admin/assets/images/users/user-10.jpg') }}" class="img-fluid rounded-circle" alt="" />
                                                                </div>
                                                                <div>
                                                                    <h5 class="fs-base mb-0">
                                                                        <a data-sort="user" href="#" class="link-reset">Chloe Adams</a>
                                                                    </h5>
