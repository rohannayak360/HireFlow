...
<!-- Mirrored from coderthemes.com/paces/bootstrap/pages-pricing.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:50 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Pricing | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Pricing</h4>
                        </div>
                            ...
                            <div class="card h-100 my-4 my-lg-0">
                                <div class="card-body p-lg-4 pb-0 text-center">
                                    ...
                                    <ul class="list-unstyled text-start fs-sm mb-0">
                                        ...
                                        <li class="mb-2">
                                            <i class="ti ti-x text-danger me-2 fs-5"></i>
