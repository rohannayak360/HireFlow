...
<!-- Mirrored from coderthemes.com/paces/bootstrap/tables-datatables-fixed-header.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 10:00:01 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Fixed Header Datatables | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
        ...
        <link href="{{ asset('admin/assets/plugins/datatables/fixedHeader.bootstrap5.min.css') }}" rel="stylesheet" type="text/css" />
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Fixed Header</h4>
                        </div>
...
<script src="{{ asset('admin/assets/js/app.js') }}"></script>
        ...
        <script src="{{ asset('admin/assets/plugins/datatables/fixedHeader.bootstrap5.min.js') }}"></script>

        <!-- Page js -->
        <script src="{{ asset('admin/assets/js/pages/datatables-fixed-header.js') }}"></script>
    </body>

<!-- Mirrored from coderthemes.com/paces/bootstrap/tables-datatables-fixed-header.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 10:00:02 GMT -->
</html>
