...
<!-- Mirrored from coderthemes.com/paces/bootstrap/error-maintenance.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:59:06 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Maintenance | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                            ...
                            <div class="card-body">
                                ...
                                <div class="p-2 text-center">
                                    <div class="w-md-50 mx-auto">
                                        <img src="{{ asset('admin/assets/images/maintenance.svg') }}" alt="Maintenance" class="img-fluid" />
                                    </div>

                                    <h3 class="fw-bold text-uppercase">We’ll Be Back Soon</h3>
                                    <p class="text-muted">
                                    ...
                                    <button class="btn btn-primary mt-3 me-1">Call Support</button>
                                    <button class="btn btn-info mt-3">Send Email</button>
                                </div>
