...
<!-- Mirrored from coderthemes.com/paces/bootstrap/widgets-weather.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:59:16 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Weather Widgets | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Weather</h4>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="mb-0 text-muted text-center gap-3 d-flex justify-content-center">
                                        <span><i class="ti ti-wind"></i> 15km/h</span>
                                        <span><i class="ti ti-droplet"></i> 37%</span>
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="mb-0 text-muted text-center gap-3 d-flex justify-content-center">
                                        <span><i class="ti ti-wind"></i> 10km/h</span>
                                        <span><i class="ti ti-droplet"></i> 40%</span>
                                    </p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card border-0 rounded-3 text-white" style="background-image: url({{ asset('admin/assets/images/stock/small-7.jpg') }}); background-size: cover">
                                <div class="card-body bg-gradient bg-secondary bg-opacity-90 rounded-3">
                                    ...
                                    <div class="d-flex align-items-center justify-content-center gap-2 my-3">
                                        ...
                                        <h3 class="mb-0 fw-bold text-white">28°</h3>
                                    </div>
                                    ...
                                    <p class="mb-0 text-white text-opacity-75 text-center gap-3 d-flex justify-content-center">
                                        <span><i class="ti ti-wind"></i> 22km/h</span>
                                        <span><i class="ti ti-droplet"></i> 60%</span>
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="mb-0 text-muted text-center gap-3 d-flex justify-content-center">
                                        <span><i class="ti ti-wind"></i> 8km/h</span>
                                        <span><i class="ti ti-droplet"></i> 25%</span>
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="mb-0 text-muted text-center gap-3 d-flex justify-content-center">
                                        <span><i class="ti ti-wind"></i> 20km/h</span>
                                        <span><i class="ti ti-droplet"></i> 45%</span>
                                    </p>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="d-flex justify-content-center align-items-center gap-3">
                                                <div>
                                                    ...
                                                    <h2 class="mt-1 mb-0 text-white">32°</h2>
                                                </div>
                                                <div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="d-flex justify-content-center align-items-center gap-3">
                                                <div>
                                                    ...
                                                    <h2 class="mt-1 mb-0 text-white">27°</h2>
                                                </div>
                                                <div>
                    ...
                    <div class="row">
                                    ...
                                    <table class="table table-custom table-nowrap table-centered table-select table-hover w-100 mb-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>12 km/h</td>
                                                <td>
                                                    <a href="#" class="text-muted fs-20"><i class="ti ti-eye"></i></a>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                ...
                                <div class="card-header justify-content-between">
                                    ...
                                    <div class="dropdown ms-auto">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            <li>
                                                <a class="dropdown-item" href="#"> <i class="ti ti-report me-2"></i> View Full Weather Report </a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item" href="#"> <i class="ti ti-download me-2"></i> Export Data </a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item" href="#"> <i class="ti ti-filter me-2"></i> Filter Countries </a>
                                            </li>
                                            <li>
                                    ...
                                    <div class="px-3" data-simplebar style="height: 415px">
                                        ...
                                        <div class="row align-items-center g-0 py-2">
                                            <div class="col-4 d-flex align-items-center">
                                                <img src="{{ asset('admin/assets/images/flags/us.svg') }}" class="me-2 rounded-circle" height="26" />
                                                <span class="fw-semibold fs-16">USA</span>
                                            </div>

                                            <div class="col-4 text-end text-muted">
                                                <div class="fw-semibold">28°C <span class="text-muted fs-12">(Feels 30°)</span></div>
                                                <div class="fw-semibold fs-12"><i class="ti ti-droplet"></i> 45% | <i class="ti ti-wind"></i> 12 km/h</div>
                                            </div>

                                            <div class="col-4 text-success fw-semibold text-end"><i class="ti ti-sun"></i> Clear Sky</div>
                                        </div>

                                        <!-- UK -->
                                        <div class="row align-items-center g-0 py-2">
                                            <div class="col-4 d-flex align-items-center">
                                                <img src="{{ asset('admin/assets/images/flags/gb.svg') }}" class="me-2 rounded-circle" height="26" />
                                                <span class="fw-semibold fs-16">UK</span>
                                            </div>

                                            <div class="col-4 text-end text-muted">
                                                <div class="fw-semibold">19°C <span class="text-muted fs-12">(Feels 17°)</span></div>
                                                <div class="fw-semibold fs-12"><i class="ti ti-droplet"></i> 68% | <i class="ti ti-wind"></i> 20 km/h</div>
                                            </div>

                                            <div class="col-4 text-info fw-semibold text-end"><i class="ti ti-cloud-rain"></i> Rainy</div>
                                        </div>

                                        <!-- UAE -->
                                        <div class="row align-items-center g-0 py-2">
                                            <div class="col-4 d-flex align-items-center">
                                                <img src="{{ asset('admin/assets/images/flags/ae.svg') }}" class="me-2 rounded-circle" height="26" />
                                                <span class="fw-semibold fs-16">UAE</span>
                                            </div>

                                            <div class="col-4 text-end text-muted">
                                                <div class="fw-semibold">38°C <span class="text-muted fs-12">(Feels 41°)</span></div>
                                                <div class="fw-semibold fs-12"><i class="ti ti-droplet"></i> 20% | <i class="ti ti-wind"></i> 10 km/h</div>
                                            </div>

                                            <div class="col-4 text-warning fw-semibold text-end"><i class="ti ti-sun-high"></i> Sunny</div>
                                        </div>

                                        <!-- Japan -->
                                        <div class="row align-items-center g-0 py-2">
                                            <div class="col-4 d-flex align-items-center">
                                                <img src="{{ asset('admin/assets/images/flags/jp.svg') }}" class="me-2 rounded-circle" height="26" />
                                                <span class="fw-semibold fs-16">Japan</span>
                                            </div>

                                            <div class="col-4 text-end text-muted">
                                                <div class="fw-semibold">25°C <span class="text-muted fs-12">(Feels 26°)</span></div>
                                                <div class="fw-semibold fs-12"><i class="ti ti-droplet"></i> 70% | <i class="ti ti-wind"></i> 18 km/h</div>
                                            </div>

                                            <div class="col-4 text-danger fw-semibold text-end"><i class="ti ti-cloud-storm"></i> Stormy</div>
                                        </div>

                                        <!-- Australia -->
                                        <div class="row align-items-center g-0 py-2">
                                            <div class="col-4 d-flex align-items-center">
                                                <img src="{{ asset('admin/assets/images/flags/au.svg') }}" class="me-2 rounded-circle" height="26" />
                                                <span class="fw-semibold fs-16">Australia</span>
                                            </div>

                                            <div class="col-4 text-end text-muted">
                                                <div class="fw-semibold">22°C <span class="text-muted fs-12">(Feels 21°)</span></div>
                                                <div class="fw-semibold fs-12"><i class="ti ti-droplet"></i> 55% | <i class="ti ti-wind"></i> 30 km/h</div>
                                            </div>

                                            <div class="col-4 text-primary fw-semibold text-end"><i class="ti ti-wind"></i> Windy</div>
                                        </div>

                                        <!-- Canada -->
                                        <div class="row align-items-center g-0 py-2">
                                            <div class="col-4 d-flex align-items-center">
                                                <img src="{{ asset('admin/assets/images/flags/ca.svg') }}" class="me-2 rounded-circle" height="26" />
                                                <span class="fw-semibold fs-16">Canada</span>
                                            </div>

                                            <div class="col-4 text-end text-muted">
                                                <div class="fw-semibold">14°C <span class="text-muted fs-12">(Feels 12°)</span></div>
                                                <div class="fw-semibold fs-12"><i class="ti ti-droplet"></i> 52% | <i class="ti ti-wwind"></i> 15 km/h</div>
                                            </div>

                                            <div class="col-4 text-primary fw-semibold text-end"><i class="ti ti-cloud"></i> Cloudy</div>
                                        </div>

                                        <!-- Germany -->
                                        <div class="row align-items-center g-0 py-2">
                                            <div class="col-4 d-flex align-items-center">
                                                <img src="{{ asset('admin/assets/images/flags/de.svg') }}" class="me-2 rounded-circle" height="26" />
                                                <span class="fw-semibold fs-16">Germany</span>
                                            </div>

                                            <div class="col-4 text-end text-muted">
                                                <div class="fw-semibold">17°C <span class="text-muted fs-12">(Feels 16°)</span></div>
                                                <div class="fw-semibold fs-12"><i class="ti ti-droplet"></i> 60% | <i class="ti ti-wind"></i> 9 km/h</div>
                                            </div>

                                            <div class="col-4 text-info fw-semibold text-end"><i class="ti ti-cloud-drizzle"></i> Drizzle</div>
                                        </div>

                                        <!-- France -->
                                        <div class="row align-items-center g-0 py-2">
                                            <div class="col-4 d-flex align-items-center">
                                                <img src="{{ asset('admin/assets/images/flags/fr.svg') }}" class="me-2 rounded-circle" height="26" />
                                                <span class="fw-semibold fs-16">France</span>
                                            </div>

                                            <div class="col-4 text-end text-muted">
                                                <div class="fw-semibold">21°C <span class="text-muted fs-12">(Feels 20°)</span></div>
                                                <div class="fw-semibold fs-12"><i class="ti ti-droplet"></i> 48% | <i class="ti ti-wind"></i> 14 km/h</div>
                                            </div>

                                            <div class="col-4 text-warning fw-semibold text-end"><i class="ti ti-sun-wind"></i> Partly Sunny</div>
                                        </div>

                                        <!-- Brazil -->
                                        <div class="row align-items-center g-0 py-2">
                                            <div class="col-4 d-flex align-items-center">
                                                <img src="{{ asset('admin/assets/images/flags/br.svg') }}" class="me-2 rounded-circle" height="26" />
                                                <span class="fw-semibold fs-16">Brazil</span>
                                            </div>

                                            <div class="col-4 text-end text-muted">
                                                <div class="fw-semibold">30°C <span class="text-muted fs-12">(Feels 35°)</span></div>
                                                <div class="fw-semibold fs-12"><i class="ti ti-droplet"></i> 75% | <i class="ti ti-wind"></i> 22 km/h</div>
                                            </div>

                                            <div class="col-4 text-danger fw-semibold text-end"><i class="ti ti-cloud-storm"></i> Thunderstorm</div>
                                        </div>

                                        <!-- Singapore -->
                                        <div class="row align-items-center g-0 py-2">
                                            <div class="col-4 d-flex align-items-center">
                                                <img src="{{ asset('admin/assets/images/flags/sg.svg') }}" class="me-2 rounded-circle" height="26" />
                                                <span class="fw-semibold fs-16">Singapore</span>
                                            </div>

                                            <div class="col-4 text-end text-muted">
                                                <div class="fw-semibold">32°C <span class="text-muted fs-12">(Feels 39°)</span></div>
                                                <div class="fw-semibold fs-12"><i class="ti ti-droplet"></i> 83% | <i class="ti ti-wind"></i> 11 km/h</div>
                                            </div>

                                            <div class="col-4 text-success fw-semibold text-end"><i class="ti ti-cloud-rain"></i> Light Rain</div>
                                        </div>
                                    </div>
                                    <!-- end data-simplebar -->
                                </div>
                        ...
                        <div class="col-xxl-4 col-xl-6">
                            <div class="card overflow-hidden">
                                <!-- Top Weather Banner -->
                                <div class="position-relative" style="height: 200px; background: url(_assets/images/stock/small-6.html) center/cover">
                                    <!-- Date -->
                                    ...
                                    <ul class="nav nav-tabs border-0 position-absolute bottom-0 end-0 p-2">
                                        <li class="nav-item">
                                            <button class="nav-link active bg-transparent text-white fw-semibold border-0 border-bottom border-white rounded-0" data-bs-toggle="tab" data-bs-target="#todayTab">Today</button>
                                        </li>

                                        <li class="nav-item">
                                            <button class="nav-link bg-transparent text-white-50 fw-semibold border-0 rounded-0" data-bs-toggle="tab" data-bs-target="#weekTab">Week</button>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="card text-white overflow-hidden">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center px-3 py-2 bg-dark text-white text-opacity-75">
                                            <div class="d-flex align-items-center gap-1"><i class="ti ti-wind"></i> <span>12m/s</span></div>
                                            <div class="d-flex align-items-center gap-1"><i class="ti ti-compass"></i> <span>NE</span></div>
                                        </div>
                                    </div>
                                </div>
                                <!-- end col-->
                                ...
                                <div class="col-sm-6">
                                    <div class="card text-white overflow-hidden">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center px-3 py-2 bg-dark text-white text-opacity-75">
                                            <div class="d-flex align-items-center gap-1"><i class="ti ti-wind"></i> <span>8 m/s</span></div>
                                            <div class="d-flex align-items-center gap-1"><i class="ti ti-compass"></i> <span>SW</span></div>
                                        </div>
                                    </div>
                                </div>
                                <!-- end col-->
...
<!-- Mirrored from coderthemes.com/paces/bootstrap/widgets-weather.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:59:18 GMT -->
</html>
