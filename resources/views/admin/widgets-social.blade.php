...
<!-- Mirrored from coderthemes.com/paces/bootstrap/widgets-social.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:59:16 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Social Widgets | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Social</h4>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-xxl-6">
                                ...
                                <div class="card">
                                    <div class="card-body pb-2">
                                        <div class="d-flex align-items-center mb-2">
                                            <img class="me-2 avatar-md rounded-circle" src="{{ asset('admin/assets/images/users/user-10.jpg') }}" alt="Generic placeholder image" />
                                            <div class="w-100">
                                                <h5 class="m-0">
                                        ...
                                        <div class="row g-1">
                                            <!-- Left tall image -->
                                            <div class="col-md-6">
                                                <img src="{{ asset('admin/assets/images/gallery/10.jpg') }}" class="img-fluid w-100 h-100 rounded" style="aspect-ratio: 3/4; object-fit: cover" alt="Tall Image" />
                                            </div>

                                            <!-- Right column with two stacked images -->
                                            <div class="col-md-6 d-flex flex-column gap-1">
                                                <img src="{{ asset('admin/assets/images/gallery/2.jpg') }}" class="img-fluid w-100 rounded" style="aspect-ratio: 4/3; object-fit: cover" alt="Top Right" />
                                                <img src="{{ asset('admin/assets/images/gallery/3.jpg') }}" class="img-fluid w-100 rounded" style="aspect-ratio: 4/3; object-fit: cover" alt="Bottom Right" />
                                            </div>
                                        </div>
                                ...
                                <div class="card">
                                    <div class="card-body pb-2">
                                        <div class="d-flex align-items-center mb-2">
                                            <img class="me-2 avatar-sm rounded-circle" src="{{ asset('admin/assets/images/users/user-4.jpg') }}" alt="Generic placeholder image" />
                                            <div class="w-100">
                                                <h5 class="m-0">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-center mb-3">
                                            <img class="me-2 avatar-sm rounded-circle" src="{{ asset('admin/assets/images/users/user-2.jpg') }}" alt="Profile photo of Anika Roy" />
                                            <div class="w-100">
                                                <h5 class="m-0">
                                ...
                                <div class="card">
                                    <div class="card-body pb-2">
                                        <div class="d-flex align-items-center mb-2">
                                            <img class="me-2 avatar-sm rounded-circle" src="{{ asset('admin/assets/images/users/user-1.jpg') }}" alt="Profile photo of Anika Roy" />
                                            <div class="w-100">
                                                <h5 class="m-0">
                                                    <a href="#!" class="link-reset">David Dev</a>
                                                </h5>
                                                <p class="text-muted mb-0">
                                                    <small>Posted 2 hours ago</small>
                                                </p>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <!-- User Info -->
                                        <div class="d-flex align-items-center mb-2">
                                            <img class="me-2 avatar-sm rounded-circle" src="{{ asset('admin/assets/images/users/user-6.jpg') }}" alt="Profile photo of David Kim" />
                                            <div class="w-100">
                                                <h5 class="m-0">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body pb-2 d-flex align-items-center">
                                        <img src="{{ asset('admin/assets/images/users/user-6.jpg') }}" class="avatar-md rounded-circle me-2" />
                                        <div class="flex-grow-1">
                                            <h5 class="fw-semibold mb-0"><a href="#!" class="link-reset">Sarah Mitchell</a></h5>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                ...
                                                <li>
                                                    <a class="dropdown-item" href="#"><i class="ti ti-flag me-2"></i>Report</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body pb-0 d-flex align-items-center">
                                        <img src="{{ asset('admin/assets/images/users/user-3.jpg') }}" class="avatar-md rounded-circle me-2" />
                                        <div class="flex-grow-1">
                                            <h5 class="fw-semibold mb-0"><a href="#!" class="link-reset">Daniel Carter</a></h5>
                                    ...
                                    <div class="p-3 pb-1">
                                        ...
                                        <a href="#!" class="d-block border border-light rounded-4 text-reset overflow-hidden shadow-sm">
                                            <div class="d-flex">
                                                <img src="{{ asset('admin/assets/images/gallery/7.jpg') }}" class="img-fluid" style="width: 140px; object-fit: cover" />
                                                <div class="p-3">
                                ...
                                <div class="card">
                                    <!-- Header -->
                                    <div class="card-body pb-0 d-flex align-items-center">
                                        <img src="{{ asset('admin/assets/images/users/user-10.jpg') }}" class="avatar-md rounded-circle me-2" />

                                        <div class="flex-grow-1">
                                            <h5 class="fw-semibold mb-0"><a href="#!" class="link-reset">Evelyn Brooks</a></h5>
                                    ...
                                    <div class="px-3 pb-3 pt-2">
                                        <div class="bg-primary bg-opacity-10 text-primary rounded-3 p-4 text-center">
                                            ...
                                            <p class="mb-0 fst-italic">Clear skies in <strong>Vancouver</strong></p>
                                        </div>
                                    ...
                                    <div class="card-footer border-0 pt-0 d-flex justify-content-center gap-2">
                                        ...
                                        <a href="#" class="btn btn-sm fs-sm btn-link text-muted"><i class="ti ti-corner-up-left me-1"></i>Comment</a>
                                        <a href="#" class="btn btn-sm fs-sm btn-link text-muted"><i class="ti ti-share me-1"></i>Share</a>
                                    </div>
                                </div>
                                <!-- end card-->
                                ...
                                <div class="card">
                                    <!-- Header -->
                                    <div class="card-body pb-2 d-flex align-items-center">
                                        <img src="{{ asset('admin/assets/images/users/user-8.jpg') }}" class="avatar-sm rounded-circle me-2" />
                                        <div class="flex-grow-1">
                                            <h5 class="fw-semibold mb-0"><a href="#!" class="link-reset">Emma Wilson</a></h5>
                                    ...
                                    <div class="px-3">
                                        ...
                                        <div class="bg-light-subtle rounded-4 p-3 shadow-sm">
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('admin/assets/images/gallery/5.jpg') }}" class="rounded me-3" style="height: 60px; width: 60px; object-fit: cover" />
                                                ...
                                                <div class="flex-grow-1">
                                                    ...
                                                    <!-- Free Online Audio -->
                                                    <audio controls class="w-100 mt-2" style="height: 32px">
                            ...
                            <div class="col-xxl-6">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="#">
                                            <div class="position-relative">
                                                <textarea rows="3" class="form-control rounded-3" placeholder="Write something meaningful..."></textarea>
                                            </div>

                                            <div class="d-flex justify-content-between align-items-center mt-3">
                                                <!-- New Icon Bar -->
                                                <div class="d-flex gap-2">
                                                    <button type="button" class="btn btn-light btn-sm d-flex align-items-center gap-1 px-2">
                                                        <i class="ti ti-user fs-md"></i>
                                                ...
                                                <!-- New Post Button -->
                                                <button type="submit" class="btn btn-primary btn-sm px-3">Publish</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                                ...
                                <div class="card overflow-hidden">
                                    ...
                                    <div class="card-body text-center py-4">
                                        ...
                                        <p class="text-muted mb-4">You’ve just reached <strong>Milestone Tier 3</strong> for your outstanding activity. Keep up the great momentum!</p>
                                ...
                                <div class="card">
                                    <div class="card-body pb-2">
                                        ...
                                        <div class="row g-2">
                                            <div class="col-12">
                                                <img src="{{ asset('admin/assets/images/gallery/5.jpg') }}" class="img-fluid w-100 rounded-3" style="height: 260px; object-fit: cover" />
                                            </div>

                                            <div class="col-6">
                                                <img src="{{ asset('admin/assets/images/gallery/7.jpg') }}" class="img-fluid w-100 rounded-3" style="height: 150px; object-fit: cover" />
                                            </div>

                                            <div class="col-6">
                                                <img src="{{ asset('admin/assets/images/gallery/8.jpg') }}" class="img-fluid w-100 rounded-3" style="height: 150px; object-fit: cover" />
                                            </div>
                                        </div>
                                ...
                                <div class="card overflow-hidden">
                                    ...
                                    <div class="card-body pb-0">
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('admin/assets/images/users/user-4.jpg') }}" class="avatar-md rounded-circle me-2" alt="User" />
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item" href="#"><i class="ti ti-pin me-2"></i>Pin</a>
                                                    </li>
                                                    <li>
                                                        <a class="dropdown-item" href="#"><i class="ti ti-flag me-2"></i>Report</a>
                                                    </li>
                                    ...
                                    <div class="bg-light-subtle px-3 py-3 border-top">
                                        ...
                                        <div class="d-flex align-items-start mb-3">
                                            <img src="{{ asset('admin/assets/images/users/user-5.jpg') }}" class="avatar-sm rounded-circle me-3" alt="User" />

                                            <div class="flex-grow-1">
                                                <div class="d-flex justify-content-between">
                                                    <h6 class="fw-semibold mb-0 fs-sm"><a href="#!" class="link-reset">Ethan Reynolds</a></h6>
                                                ...
                                                <a href="javascript:void(0);" class="small text-muted"> <i class="ti ti-corner-up-left me-1"></i>Reply </a>

                                                <!-- Nested Reply -->
                                                <div class="d-flex align-items-start mt-3 ps-4 border-start">
                                                    <img src="{{ asset('admin/assets/images/users/user-6.jpg') }}" class="avatar-sm rounded-circle me-3" alt="User" />

                                                    <div class="flex-grow-1">
                                                        <div class="d-flex justify-content-between">
                                                            <h6 class="fw-semibold fs-sm mb-0"><a href="#!" class="link-reset">Mia Thompson</a></h6>
                                        ...
                                        <div class="d-flex align-items-center mt-3">
                                            <img src="{{ asset('admin/assets/images/users/user-3.jpg') }}" class="avatar-sm rounded-circle me-2" alt="User" />
                                            <input type="text" class="form-control form-control-sm rounded-pill" placeholder="Write a comment..." />
                                        </div>
                                    </div>
                                ...
                                <div class="card overflow-hidden">
                                    <!-- Event Banner -->
                                    <div class="position-relative">
                                        <img src="{{ asset('admin/assets/images/gallery/2.jpg') }}" class="img-fluid w-100" style="height: 180px; object-fit: cover" alt="Event Banner" />
                                    ...
                                    <div class="card-body">
                                        <!-- Author Info -->
                                        <div class="d-flex align-items-center mb-3">
                                            <img src="{{ asset('admin/assets/images/users/user-2.jpg') }}" class="avatar-md rounded-circle me-2" alt="User" />
                                            <div>
                                                <h5 class="fw-semibold mb-0"><a href="#!" class="link-reset">Anika Roy</a></h5>
                                        ...
                                        <div class="d-flex justify-content-center gap-2 mt-2">
                                            <button class="btn btn-outline-primary btn-sm"><i class="ti ti-bell me-1"></i> Remind Me</button>
                                            <button class="btn btn-primary btn-sm"><i class="ti ti-user-plus me-1"></i> Register</button>
                                        </div>
                                    </div>
                                </div>
                                <!-- end card-->
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body pb-0">
                                        <div class="d-flex align-items-center">
                                            <!-- Avatar -->
                                            <img src="{{ asset('admin/assets/images/users/user-6.jpg') }}" class="avatar-sm rounded-circle me-2" alt="User" />
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li>
                                                        <a class="dropdown-item" href="#"><i class="ti ti-edit me-2"></i>Edit Post</a>
                                                    </li>
                                                    <li>
                                                        <a class="dropdown-item" href="#"><i class="ti ti-trash me-2"></i>Delete Post</a>
                                                    </li>
                                                    <li>
                                                        <a class="dropdown-item" href="#"><i class="ti ti-share me-2"></i>Share</a>
                                                    </li>
                                                    <li>
                                                        <a class="dropdown-item" href="#"><i class="ti ti-pin me-2"></i>Pin to Top</a>
                                                    </li>
                                                    <li>
                                                        <a class="dropdown-item" href="#"><i class="ti ti-flag me-2"></i>Report Post</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                        ...
                                        <div class="bg-light-subtle p-3 ps-4 rounded-3 border">
                                            ...
                                            <form class="poll-form">
                                                <div class="form-check mb-2 p-2 card-bg rounded-3 shadow-sm">
                                                    <input class="form-check-input" type="radio" name="poll" id="pollReact" />
                                                    <label class="form-check-label fw-semibold" for="pollReact"> React (Meta) </label>
                                                </div>

                                                <div class="form-check mb-2 p-2 card-bg rounded-3 shadow-sm">
                                                    <input class="form-check-input" type="radio" name="poll" id="pollVue" />
                                                    <label class="form-check-label fw-semibold" for="pollVue"> Vue.js (Evan You) </label>
                                                </div>

                                                <div class="form-check mb-2 p-2 card-bg rounded-3 shadow-sm">
                                                    <input class="form-check-input" type="radio" name="poll" id="pollAngular" />
                                                ...
                                                <div class="form-check mb-3 p-2 card-bg rounded-3 shadow-sm">
                                                    <input class="form-check-input" type="radio" name="poll" id="pollSvelte" />
                                                    <label class="form-check-label fw-semibold" for="pollSvelte"> Svelte (Emerging Favorite) </label>
                                                </div>

                                                <!-- Submit Button -->
                                                <button type="submit" class="btn btn-primary w-100 rounded-pill">Submit Vote</button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card">
                                    <!-- Header -->
                                    <div class="card-body pb-0 d-flex align-items-center">
                                        <img src="{{ asset('admin/assets/images/users/user-7.jpg') }}" class="avatar-sm rounded-circle me-2" />
                                        <div class="flex-grow-1">
                                            <h5 class="fw-semibold mb-0"><a href="#!" class="link-reset">Ava Thompson</a></h5>
                                    ...
                                    <div class="p-3 pb-0">
                                        <div class="rounded-4 overflow-hidden shadow-sm">
                                            <img src="{{ asset('admin/assets/images/gallery/8.jpg') }}" class="img-fluid w-100" style="height: 260px; object-fit: cover" />
                                        </div>
                                    </div>
                                ...
                                <div class="card overflow-hidden">
                                    ...
                                    <div class="position-relative">
                                        <img src="{{ asset('admin/assets/images/gallery/12.jpg') }}" class="img-fluid w-100" style="height: 200px; object-fit: cover; filter: brightness(0.5)" />
                                    ...
                                    <div class="card-body d-flex align-items-center">
                                        <img src="{{ asset('admin/assets/images/users/user-4.jpg') }}" class="avatar-md rounded-circle me-2" />

                                        <div class="flex-grow-1">
                                            <h5 class="fw-semibold mb-0"><a href="#!" class="link-reset">Noah Carter</a></h5>
