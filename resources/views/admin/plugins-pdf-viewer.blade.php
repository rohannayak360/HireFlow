...
<!-- Mirrored from coderthemes.com/paces/bootstrap/plugins-pdf-viewer.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:57 GMT -->
<head>
        <meta charset="utf-8" />
        <title>PDF Viewer | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
...
<script src="{{ asset('admin/assets/js/app.js') }}"></script>
        ...
        <!-- PDF Plugin Js-->
        <script src="{{ asset('admin/assets/plugins/pdfjs/pdf.min.js') }}"></script>

        <!-- PDF Viewer Page Js-->
        <script src="{{ asset('admin/assets/js/pages/plugins-pdf-viewer.js') }}"></script>
    </body>
