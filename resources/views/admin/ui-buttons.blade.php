...
<!-- Mirrored from coderthemes.com/paces/bootstrap/ui-buttons.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:59:09 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Buttons | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Buttons</h4>
                        </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex flex-wrap gap-2">
                                        <button type="button" class="btn btn-primary btn-icon">
                                            <i class="ti ti-star fs-xl"></i>
                                        </button>
                                        <button type="button" class="btn btn-secondary btn-icon">
                                            <i class="ti ti-leaf fs-xl"></i>
                                        </button>
                                        ...
                                        <button type="button" class="btn btn-light">
                                            <i class="ti ti-hand-stop fs-xl me-1"></i>
                                            Stop
                                        </button>
                                        <button type="button" class="btn btn-dark">
                                            <i class="ti ti-bolt fs-xl me-1"></i>
                                            Boost
                                        </button>

                                        <button type="button" class="btn btn-outline-info">
                                            <i class="ti ti-credit-card fs-xl me-1"></i>
                                            Payment
                                        </button>
                                        <button type="button" class="btn btn-danger">
                                            <i class="ti ti-tools fs-xl me-1"></i>
                                            Tools
                                        </button>
                                    </div>
                                    ...
                                    <div class="d-flex flex-wrap gap-2 mt-3">
                                        ...
                                        <button class="btn btn-info btn-icon btn-lg" type="button">
                                            <i class="ti ti-star fs-xxl"></i>
                                        </button>
                                        <button class="btn btn-warning btn-icon btn-lg" type="button">
                                            <i class="ti ti-alert-octagon fs-xxl"></i>
                                        </button>
                                    </div>
                                </div>
                                <!-- end card-body -->
