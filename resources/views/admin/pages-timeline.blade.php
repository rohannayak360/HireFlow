...
<!-- Mirrored from coderthemes.com/paces/bootstrap/pages-timeline.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:50 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Timeline | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Timeline</h4>
                        </div>
                                    ...
                                    <div class="timeline timeline-icon-based">
                                        ...
                                        <div class="timeline-item d-flex align-items-stretch">
                                            ...
                                            <div class="timeline-dot bg-info-subtle">
                                                <i class="ti ti-dashboard fs-xl text-info"></i>
                                            </div>
                                            <div class="timeline-content ps-3 pb-4">
                                ...
                                <div class="card-body">
                                    <div class="timeline timeline-icon-bordered">
                                        ...
                                        <div class="timeline-item d-flex align-items-stretch">
                                            ...
                                            <div class="timeline-dot">
                                                <i class="ti ti-lock fs-xl text-muted"></i>
                                            </div>
                                            <div class="timeline-content ps-3">
