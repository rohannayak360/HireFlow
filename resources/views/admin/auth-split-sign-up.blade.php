...
<!-- Mirrored from coderthemes.com/paces/bootstrap/auth-split-sign-up.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:59:06 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Create New Account | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="col-md-auto">
                    ...
                    <div class="card auth-box-form border-0 mb-0">
                        ...
                        <div class="card-body min-vh-100 position-relative d-flex flex-column justify-content-center">
                            ...
                            <div class="mt-auto">
                                <p class="text-muted text-center auth-sub-text mx-auto"></p>
                                <div class="text-center">
                                    <h4 class="fw-bold text-dark">Let’s get you started 👋</h4>
                                    <p class="text-muted w-lg-75 mx-auto">Create your account by entering the form below.</p>
                                </div>
                                ...
                                <form class="mt-4">
                                    <div class="mb-3">
                                        ...
                                        <div class="app-search">
                                            <input type="text" class="form-control" id="userName" placeholder="David Dev" required />
                                            <i class="ti ti-user-circle app-search-icon text-muted"></i>
                                        </div>
                                    </div>
                            ...
                            <p class="text-muted text-center mt-4 mb-0">
                                ...
                                <a href="{{ url('admin/auth-split-sign-in') }}" class="text-decoration-underline link-offset-3 fw-semibold">Login</a>
                            </p>
