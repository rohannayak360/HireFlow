...
<!-- Mirrored from coderthemes.com/paces/bootstrap/auth-sign-in.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:59:04 GMT -->
<head>
        <meta charset="utf-8" />
                        ...
                        <div class="card p-4">
                            ...
                            <form action="https://coderthemes.com/paces/bootstrap/index.html">
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    ...
                                    <a href="{{ url('admin/auth-reset-pass') }}" class="text-decoration-underline link-offset-3 text-muted">Forgot Password?</a>
                                </div>
                            ...
                            <p class="text-muted text-center mt-4 mb-0">
                                New here?
                                <a href="{{ url('admin/auth-sign-up') }}" class="text-decoration-underline link-offset-3 fw-semibold">Create an account</a>
                            </p>
                        </div>
