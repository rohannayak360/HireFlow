...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-ecommerce-refunds.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:18 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Refunds | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Refunds</h4>
                        </div>
                                ...
                                <div class="card-header border-light justify-content-between">
                                    <div class="d-flex gap-2">
                                        <div class="app-search">
                                            <input data-table-search type="search" class="form-control" placeholder="Search refunds..." />
                                            <i class="ti ti-search app-search-icon text-muted"></i>
                                        </div>
                                    ...
                                    <div class="d-flex align-items-center gap-2 flex-wrap">
                                        ...
                                        <div class="app-search">
                                            <select data-table-filter="refund-status" class="form-select form-control my-1 my-md-0">
                                            ...
                                            <i class="ti ti-credit-card-refund app-search-icon text-muted"></i>
                                        </div>
                                    ...
                                    <div class="d-flex gap-1">
                                        ...
                                        <a href="#createRefundModal" class="btn btn-primary ms-1" data-bs-toggle="modal"> <i class="ti ti-plus fs-sm me-2"></i> Create Refund </a>
                                    </div>
                                </div>
                                    ...
                                    <table class="table table-custom table-centered table-select table-hover w-100 mb-0">
                                        <thead class="bg-light align-middle bg-opacity-25 thead-sm">
                                            <tr class="text-uppercase fs-xxs">
                                                ...
                                                <th data-table-sort data-column="refund-status">Status</th>
                                                <th>Requested</th>
                                                <th>Processed</th>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="fs-sm mb-0"><a href="{{ url('admin/apps-ecommerce-order-details') }}" class="link-reset">#INV-10423</a></h5>
                                                </td>
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <img src="{{ asset('admin/assets/images/products/1.png') }}" alt="" class="rounded" width="34" height="34" />
                                                        <div>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-start align-items-center gap-2">
                                                        <div class="avatar avatar-sm">
                                                            <img src="{{ asset('admin/assets/images/users/user-2.jpg') }}" alt="avatar-2" class="img-fluid rounded-circle" />
                                                        </div>
                                                        <div>
                                                ...
                                                <td><img src="{{ asset('admin/assets/images/cards/visa.svg') }}" alt="" class="me-2" height="28" /> xxxx 7832</td>
                                                <td>$129.45</td>
                                                <td>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-center gap-1">
                                                        <a href="#!" class="btn btn-default btn-icon btn-sm"><i class="ti ti-check fs-lg"></i></a>
                                                        <a href="#!" class="btn btn-default btn-icon btn-sm"><i class="ti ti-x fs-lg"></i></a>
                                                        <a href="#" data-table-delete-row class="btn btn-default btn-icon btn-sm"><i class="ti ti-trash fs-lg"></i></a>
                                                        <button class="btn btn-default btn-icon btn-sm dropdown-toggle drop-arrow-none" data-bs-toggle="dropdown"><i class="ti ti-dots-vertical fs-lg"></i></button>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="fs-sm mb-0"><a href="{{ url('admin/apps-ecommerce-order-details') }}" class="link-reset">#INV-10407</a></h5>
                                                </td>
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <img src="{{ asset('admin/assets/images/products/2.png') }}" alt="" class="rounded" width="34" height="34" />
                                                        <div>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-start align-items-center gap-2">
                                                        <div class="avatar avatar-sm">
                                                            <img src="{{ asset('admin/assets/images/users/user-5.jpg') }}" alt="avatar-5" class="img-fluid rounded-circle" />
                                                        </div>
                                                        <div>
                                                ...
                                                <td><img src="{{ asset('admin/assets/images/cards/mastercard.svg') }}" alt="" class="me-2" height="28" /> xxxx 2294</td>
                                                <td>$79.99</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="fs-sm mb-0"><a href="{{ url('admin/apps-ecommerce-order-details') }}" class="link-reset">#INV-10388</a></h5>
                                                </td>
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <img src="{{ asset('admin/assets/images/products/3.png') }}" alt="" class="rounded" width="34" height="34" />
                                                        <div>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-start align-items-center gap-2">
                                                        <div class="avatar avatar-sm">
                                                            <img src="{{ asset('admin/assets/images/users/user-3.jpg') }}" alt="avatar-3" class="img-fluid rounded-circle" />
                                                        </div>
                                                        <div>
                                                ...
                                                <td><img src="{{ asset('admin/assets/images/cards/american-express.svg') }}" alt="" class="me-2" height="28" /> xxxx 1145</td>
                                                <td>$249.00</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="fs-sm mb-0"><a href="{{ url('admin/apps-ecommerce-order-details') }}" class="link-reset">#INV-10352</a></h5>
                                                </td>
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <img src="{{ asset('admin/assets/images/products/4.png') }}" alt="" class="rounded" width="34" height="34" />
                                                        <div>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-start align-items-center gap-2">
                                                        <div class="avatar avatar-sm">
                                                            <img src="{{ asset('admin/assets/images/users/user-7.jpg') }}" alt="avatar-7" class="img-fluid rounded-circle" />
                                                        </div>
                                                        <div>
                                                ...
                                                <td><img src="{{ asset('admin/assets/images/cards/paypal.svg') }}" alt="" class="me-2" height="28" /> PayPal</td>
                                                <td>$59.99</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="fs-sm mb-0"><a href="{{ url('admin/apps-ecommerce-order-details') }}" class="link-reset">#INV-10341</a></h5>
                                                </td>
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <img src="{{ asset('admin/assets/images/products/5.png') }}" alt="" class="rounded" width="34" height="34" />
                                                        <div>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="avatar avatar-sm">
                                                            <img src="{{ asset('admin/assets/images/users/user-8.jpg') }}" alt="avatar-8" class="img-fluid rounded-circle" />
                                                        </div>
                                                        <div>
                                                ...
                                                <td><img src="{{ asset('admin/assets/images/cards/visa.svg') }}" alt="" class="me-2" height="28" /> xxxx 9821</td>
                                                <td>$39.00</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="fs-sm mb-0"><a href="#" class="link-reset">#INV-10322</a></h5>
                                                </td>
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <img src="{{ asset('admin/assets/images/products/6.png') }}" alt="" class="rounded" width="34" height="34" />
                                                        <div>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="avatar avatar-sm">
                                                            <img src="{{ asset('admin/assets/images/users/user-4.jpg') }}" alt="avatar-4" class="img-fluid rounded-circle" />
                                                        </div>
                                                        <div>
                                                ...
                                                <td><img src="{{ asset('admin/assets/images/cards/american-express.svg') }}" alt="" class="me-2" height="28" /> xxxx 6730</td>
                                                <td>$199.00</td>
                                                <td><span class="badge badge-label badge-soft-success">Approved</span></td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="fs-sm mb-0"><a href="#" class="link-reset">#INV-10305</a></h5>
                                                </td>
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <img src="{{ asset('admin/assets/images/products/7.png') }}" alt="" class="rounded" width="34" height="34" />
                                                        <div>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="avatar avatar-sm">
                                                            <img src="{{ asset('admin/assets/images/users/user-9.jpg') }}" alt="avatar-9" class="img-fluid rounded-circle" />
                                                        </div>
                                                        <div>
                                                ...
                                                <td><img src="{{ asset('admin/assets/images/cards/mastercard.svg') }}" alt="" class="me-2" height="28" /> xxxx 8142</td>
                                                <td>$89.50</td>
                                                <td><span class="badge badge-label badge-soft-secondary">Refunded</span></td>
                                            ...
                                            <tr>
                                                <td class="ps-3"><input class="form-check-input form-check-input-light fs-14 product-item-check mt-0" type="checkbox" /></td>
                                                <td>
                                                    <h5 class="fs-sm mb-0"><a href="#" class="link-reset">#INV-10293</a></h5>
                                                </td>
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <img src="{{ asset('admin/assets/images/products/8.png') }}" alt="" class="rounded" width="34" height="34" />
                                                        <div>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="avatar avatar-sm">
                                                            <img src="{{ asset('admin/assets/images/users/user-10.jpg') }}" alt="avatar-10" class="img-fluid rounded-circle" />
                                                        </div>
                                                        <div>
                                            ...
                                            <tr>
                                                <td class="ps-3"><input class="form-check-input form-check-input-light fs-14 product-item-check mt-0" type="checkbox" /></td>
                                                <td>
                                                    <h5 class="fs-sm mb-0"><a href="#" class="link-reset">#INV-10275</a></h5>
                                                </td>
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <img src="{{ asset('admin/assets/images/products/9.png') }}" alt="" class="rounded" width="34" height="34" />
                                                        <div>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="avatar avatar-sm">
                                                            <img src="{{ asset('admin/assets/images/users/user-3.jpg') }}" alt="avatar-11" class="img-fluid rounded-circle" />
                                                        </div>
                                                        <div>
                                                ...
                                                <td><img src="{{ asset('admin/assets/images/cards/visa.svg') }}" alt="" class="me-2" height="28" /> xxxx 9082</td>
                                                <td>$49.99</td>
                                                <td><span class="badge badge-label badge-soft-warning">Pending</span></td>
                                            ...
                                            <tr>
                                                <td class="ps-3"><input class="form-check-input form-check-input-light fs-14 product-item-check mt-0" type="checkbox" /></td>
                                                <td>
                                                    <h5 class="fs-sm mb-0"><a href="#" class="link-reset">#INV-10261</a></h5>
                                                </td>
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <img src="{{ asset('admin/assets/images/products/10.png') }}" alt="" class="rounded" width="34" height="34" />
                                                        <div>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="avatar avatar-sm">
                                                            <img src="{{ asset('admin/assets/images/users/user-2.jpg') }}" alt="avatar-12" class="img-fluid rounded-circle" />
                                                        </div>
                                                        <div>
                                                ...
                                                <td><img src="{{ asset('admin/assets/images/cards/mastercard.svg') }}" alt="" class="me-2" height="28" /> xxxx 3210</td>
                                                <td>$64.99</td>
                                                <td><span class="badge badge-label badge-soft-success">Approved</span></td>
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title fw-semibold" id="createRefundModalLabel"><i class="ti ti-credit-card me-2 text-primary"></i> Create Refund</h5>
                                ...
                                <form action="#!" method="post">
                                    <div class="modal-body">
                                        <!-- Order ID -->
                                        <div class="mb-3">
                                            <label for="refundOrderId" class="form-label fw-semibold">Order ID</label>
                                            <select id="refundOrderId" class="form-select">
                                        ...
                                        <!-- Customer Info -->
                                        <div class="mb-3">
                                            <label for="refundCustomer" class="form-label fw-semibold">Customer</label>
                                            <input id="refundCustomer" type="text" class="form-control" value="Mason Carter" readonly />
                                        </div>

                                        <!-- Refund Reason -->
                                        <div class="mb-3">
                                            <label for="refundReason" class="form-label fw-semibold">Reason</label>
                                            <textarea id="refundReason" class="form-control" rows="2" placeholder="Enter refund reason (e.g., damaged item, wrong product, etc.)"></textarea>
                                        </div>

                                        <!-- Refund Method -->
                                        <div class="mb-3">
                                            <label for="refundMethod" class="form-label fw-semibold">Refund Method</label>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input id="refundAmount" type="number" class="form-control" placeholder="129.45" value="129.45" />
                                            </div>
                                        </div>

                                        <!-- Refund Date -->
                                        <div>
                                            <label for="refundDate" class="form-label fw-semibold">Refund Date</label>
                                            <input id="refundDate" type="date" class="form-control" data-provider="flatpickr" data-date-format="d M, Y" value="2025-10-08" />
                                        </div>
                                    </div>

                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-light" data-bs-dismiss="modal">Cancel</button>
                                        <button type="submit" class="btn btn-primary"><i class="ti ti-check me-1"></i> Confirm Refund</button>
                                    </div>
                                </form>
                            </div>
                        </div>
...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-ecommerce-refunds.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:19 GMT -->
</html>
