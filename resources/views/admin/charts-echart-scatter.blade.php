...
<!-- Mirrored from coderthemes.com/paces/bootstrap/charts-echart-scatter.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:59:33 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Echart Scatter Chart | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Scatter Echart</h4>
                        </div>
                        ...
                        <div class="text-end">
                            <ol class="breadcrumb m-0 py-0">
                                ...
                                <li class="breadcrumb-item active">Scatter Echart</li>
                            </ol>
                        </div>
                    </div>
...
<script src="{{ asset('admin/assets/js/app.js') }}"></script>
        ...
        <!-- E Charts Demo js -->
        <script src="{{ asset('admin/assets/js/pages/chart-echart-scatter.js') }}"></script>
    </body>
