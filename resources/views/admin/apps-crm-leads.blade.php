...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-crm-leads.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:28 GMT -->
<head>
        <meta charset="utf-8" />
        <title>CRM Leads | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Leads</h4>
                        </div>
                                        ...
                                        <table class="table table-custom table-centered table-select table-hover w-100 mb-0">
                                            ...
                                            <tbody class="text-nowrap">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#!" class="fw-semibold link-reset">#LD007842</a>
                                                    </td>
                                                    <td>R. Thompson</td>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar-sm border flex-shrink-0 border-dashed rounded-circle me-2 justify-content-center d-flex align-items-center">
                                                                <img src="{{ asset('admin/assets/images/logos/amazon.svg') }}" alt="Product" height="20" />
                                                            </div>
                                                    ...
                                                    <td>
                                                        <img src="{{ asset('admin/assets/images/users/user-10.jpg') }}" alt="Product" class="avatar-xs rounded-circle" data-bs-toggle="tooltip" data-bs-placement="top" title="Emily Carter" />
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="d-flex align-items-center justify-content-center gap-1">
                                                            ...
                                                            <a href="#" data-table-delete-row="" class="btn btn-default btn-icon btn-sm rounded">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#!" class="fw-semibold link-reset">#LD007865</a>
                                                    </td>
                                                    <td>S. Kapoor</td>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar-sm border flex-shrink-0 border-dashed rounded-circle me-2 justify-content-center d-flex align-items-center">
                                                                <img src="{{ asset('admin/assets/images/logos/microsoft.svg') }}" alt="Product" height="20" class="rounded-circle" />
                                                            </div>
                                                    ...
                                                    <td>
                                                        <img src="{{ asset('admin/assets/images/users/user-2.jpg') }}" alt="Product" class="avatar-xs rounded-circle" data-bs-toggle="tooltip" data-bs-placement="top" title="Liam Brown" />
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#!" class="fw-semibold link-reset">#LD007866</a>
                                                    </td>
                                                    <td>A. Patel</td>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar-sm border flex-shrink-0 border-dashed rounded-circle me-2 justify-content-center d-flex align-items-center">
                                                                <img src="{{ asset('admin/assets/images/logos/google.svg') }}" alt="Product" height="20" />
                                                            </div>
                                                    ...
                                                    <td>
                                                        <img src="{{ asset('admin/assets/images/users/user-3.jpg') }}" alt="Product" class="avatar-xs rounded-circle" data-bs-toggle="tooltip" data-bs-placement="top" title="Emily Wang" />
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#!" class="fw-semibold link-reset">#LD007867</a>
                                                    </td>
                                                    <td>J. Fernandes</td>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar-sm border flex-shrink-0 border-dashed rounded-circle me-2 justify-content-center d-flex align-items-center">
                                                                <img src="{{ asset('admin/assets/images/logos/airbnb.svg') }}" alt="Product" height="20" />
                                                            </div>
                                                    ...
                                                    <td>
                                                        <img src="{{ asset('admin/assets/images/users/user-4.jpg') }}" alt="Product" class="avatar-xs rounded-circle" data-bs-toggle="tooltip" data-bs-placement="top" title="Sara Kim" />
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#!" class="fw-semibold link-reset">#LD007868</a>
                                                    </td>
                                                    <td>M. Zhang</td>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar-sm border flex-shrink-0 border-dashed rounded-circle me-2 justify-content-center d-flex align-items-center">
                                                                <img src="{{ asset('admin/assets/images/logos/apple.svg') }}" alt="Product" height="20" />
                                                            </div>
                                                    ...
                                                    <td>
                                                        <img src="{{ asset('admin/assets/images/users/user-5.jpg') }}" alt="Product" class="avatar-xs rounded-circle" data-bs-toggle="tooltip" data-bs-placement="top" title="David Li" />
                                                    </td>
                                                    <td>
                                                        <span class="badge bg-success-subtle text-success">In Progress</span>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#!" class="fw-semibold link-reset">#LD007869</a>
                                                    </td>
                                                    <td>N. Sharma</td>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar-sm border flex-shrink-0 border-dashed rounded-circle me-2 justify-content-center d-flex align-items-center">
                                                                <img src="{{ asset('admin/assets/images/logos/asana.svg') }}" alt="Product" height="14" />
                                                            </div>
                                                    ...
                                                    <td>
                                                        <img src="{{ asset('admin/assets/images/users/user-6.jpg') }}" alt="Product" class="avatar-xs rounded-circle" data-bs-toggle="tooltip" data-bs-placement="top" title="Natalie Jones" />
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#!" class="fw-semibold link-reset">#LD007870</a>
                                                    </td>
                                                    <td>K. Williams</td>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar-sm border flex-shrink-0 border-dashed rounded-circle me-2 justify-content-center d-flex align-items-center">
                                                                <img src="{{ asset('admin/assets/images/logos/dropbox.svg') }}" alt="Product" height="20" />
                                                            </div>
                                                    ...
                                                    <td>
                                                        <img src="{{ asset('admin/assets/images/users/user-7.jpg') }}" alt="Product" class="avatar-xs rounded-circle" data-bs-toggle="tooltip" data-bs-placement="top" title="Kevin Nguyen" />
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#!" class="fw-semibold link-reset">#LD007871</a>
                                                    </td>
                                                    <td>L. Mehra</td>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                    ...
                                                    <td>
                                                        <img src="{{ asset('admin/assets/images/users/user-8.jpg') }}" alt="Product" class="avatar-xs rounded-circle" data-bs-toggle="tooltip" data-bs-placement="top" title="Laura Mehra" />
                                                    </td>
                                                    <td>
                                                        <span class="badge bg-primary-subtle text-primary">Proposal Sent</span>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#!" class="fw-semibold link-reset">#LD007872</a>
                                                    </td>
                                                    <td>R. Iyer</td>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar-sm border flex-shrink-0 border-dashed rounded-circle me-2 justify-content-center d-flex align-items-center">
                                                                <img src="{{ asset('admin/assets/images/logos/slack.svg') }}" alt="Product" height="20" />
                                                            </div>
                                                    ...
                                                    <td>
                                                        <img src="{{ asset('admin/assets/images/users/user-9.jpg') }}" alt="Product" class="avatar-xs rounded-circle" data-bs-toggle="tooltip" data-bs-placement="top" title="Rohan Iyer" />
                                                    </td>
                                                    <td>
                                                        <span class="badge bg-success-subtle text-success">In Progress</span>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#!" class="fw-semibold link-reset">#LD007873</a>
                                                    </td>
                                                    <td>E. Fernandez</td>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar-sm border flex-shrink-0 border-dashed rounded-circle me-2 justify-content-center d-flex align-items-center">
                                                                <img src="{{ asset('admin/assets/images/logos/spotify.svg') }}" alt="Product" height="20" />
                                                            </div>
                                                    ...
                                                    <td>
                                                        <img src="{{ asset('admin/assets/images/users/user-10.jpg') }}" alt="Product" class="avatar-xs rounded-circle" data-bs-toggle="tooltip" data-bs-placement="top" title="Emma Fernandez" />
                                                    </td>
                                                    <td>
                                                        <span class="badge bg-warning-subtle text-warning">Pending</span>
                                                    </td>
