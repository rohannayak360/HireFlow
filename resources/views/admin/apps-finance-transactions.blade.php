...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-finance-transactions.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:33 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Transactions | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Transactions</h4>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="text-end">
                                            <h3 class="mb-2 fw-normal">$<span data-target="56240">0</span></h3>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="text-end">
                                            <h3 class="mb-2 fw-normal">$<span data-target="48920">0</span></h3>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="text-end">
                                            <h3 class="mb-2 fw-normal">$<span data-target="6530">0</span></h3>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="text-end">
                                            <h3 class="mb-2 fw-normal">$<span data-target="1790">0</span></h3>
                            ...
                            <div data-table data-table-rows-per-page="8" class="card">
                                <div class="card-header border-light justify-content-between">
                                    <div class="d-flex gap-2">
                                        ...
                                        <!-- Add New Transaction -->
                                        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#transactionModal"><i class="ti ti-plus me-1"></i> Add Transaction</button>
                                    ...
                                    <div class="d-flex align-items-center gap-2 flex-wrap">
                                        ...
                                        <!-- Type Filter -->
                                        <div class="app-search">
                                            <select data-table-filter="transaction-type" class="form-select form-control my-1 my-md-0">
                                        ...
                                        <table class="table table-custom table-centered table-select table-hover w-100 mb-0">
                                            <thead class="bg-light align-middle bg-opacity-25 thead-sm text-nowrap">
                                                <tr class="text-uppercase fs-xxs">
                                                    ...
                                                    <th>Description</th>
                                                    <th data-table-sort data-column="transaction-type">Type</th>
                                            ...
                                            <tbody class="text-nowrap">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="#!" class="fw-semibold link-reset">#TRX-2001</a></td>
                                                    ...
                                                    <td>10 Oct, 2025 <small class="text-muted">01:20 PM</small></td>
                                                    <td>
                                                ...
                                                <tr class="table-danger-subtle">
                                                    ...
                                                    <td><a href="#!" class="fw-semibold link-reset">#TRX-2002</a></td>
                                                    ...
                                                    <td>09 Oct, 2025 <small class="text-muted">04:10 PM</small></td>
                                                    <td>
                                                        <div class="d-flex gap-2 align-items-center">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="#!" class="fw-semibold link-reset">#TRX-2003</a></td>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <img src="{{ asset('admin/assets/images/cards/paypal.svg') }}" alt="PayPal" class="me-2" height="24" />
                                                            <span>PayPal</span>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td><span class="badge bg-success-subtle text-success badge-label">Completed</span></td>
                                                    <td>08 Oct, 2025 <small class="text-muted">02:45 PM</small></td>
                                                    <td>
                                                        <div class="d-flex gap-2 align-items-center">
                                                            <img src="{{ asset('admin/assets/images/users/user-7.jpg') }}" alt="Sophia Lee" class="avatar-xs rounded-circle" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="#!" class="fw-semibold link-reset">#TRX-2004</a></td>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <img src="{{ asset('admin/assets/images/cards/american-express.svg') }}" alt="Amex" class="me-2" height="24" />
                                                            <span>**** 3478</span>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td>07 Oct, 2025 <small class="text-muted">11:10 AM</small></td>
                                                    <td>
                                                        <div class="d-flex gap-2 align-items-center">
                                                ...
                                                <tr class="table-danger-subtle">
                                                    ...
                                                    <td><a href="#!" class="fw-semibold link-reset">#TRX-2005</a></td>
                                                    ...
                                                    <td>06 Oct, 2025 <small class="text-muted">08:35 AM</small></td>
                                                    <td>
                                                        <div class="d-flex gap-2 align-items-center">
                                                            <img src="{{ asset('admin/assets/images/users/user-9.jpg') }}" alt="Liam Brown" class="avatar-xs rounded-circle" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="#!" class="fw-semibold link-reset">#TRX-2006</a></td>
                                                    ...
                                                    <td><span class="badge bg-success-subtle text-success badge-label">Completed</span></td>
                                                    <td>05 Oct, 2025 <small class="text-muted">05:00 PM</small></td>
                                                    <td>
                                                        <div class="d-flex gap-2 align-items-center">
                                                ...
                                                <tr class="table-danger-subtle">
                                                    ...
                                                    <td><a href="#!" class="fw-semibold link-reset">#TRX-2007</a></td>
                                                    ...
                                                    <td><span class="badge bg-warning-subtle text-warning badge-label">Pending</span></td>
                                                    <td>04 Oct, 2025 <small class="text-muted">09:15 AM</small></td>
                                                    <td>
                                                        <div class="d-flex gap-2 align-items-center">
                                                            <img src="{{ asset('admin/assets/images/users/user-1.jpg') }}" alt="Olivia Green" class="avatar-xs rounded-circle" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="#!" class="fw-semibold link-reset">#TRX-2008</a></td>
                                                    ...
                                                    <td><span class="badge bg-success-subtle text-success badge-label">Completed</span></td>
                                                    <td>03 Oct, 2025 <small class="text-muted">04:25 PM</small></td>
                                                    <td>
                                                        <div class="d-flex gap-2 align-items-center">
                                                            <img src="{{ asset('admin/assets/images/users/user-8.jpg') }}" alt="Mason Carter" class="avatar-xs rounded-circle" />
                                                ...
                                                <tr class="table-danger-subtle">
                                                    ...
                                                    <td><a href="#!" class="fw-semibold link-reset">#TRX-2009</a></td>
                                                    ...
                                                    <td><span class="badge bg-warning-subtle text-warning badge-label">Pending</span></td>
                                                    <td>02 Oct, 2025 <small class="text-muted">01:10 PM</small></td>
                                                    <td>
                                                        <div class="d-flex gap-2 align-items-center">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="#!" class="fw-semibold link-reset">#TRX-2010</a></td>
                                                    ...
                                                    <td><span class="badge bg-success-subtle text-success badge-label">Completed</span></td>
                                                    <td>01 Oct, 2025 <small class="text-muted">03:35 PM</small></td>
                                                    <td>
                                                        <div class="d-flex gap-2 align-items-center">
                                                            <img src="{{ asset('admin/assets/images/users/user-9.jpg') }}" alt="Liam Brown" class="avatar-xs rounded-circle" />
                                                            <span>Liam Brown</span>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="#!" class="fw-semibold link-reset">#TRX-2011</a></td>
                                                    ...
                                                    <td><span class="badge bg-info-subtle text-info badge-label">Adjusted</span></td>
                                                    <td>30 Sep, 2025 <small class="text-muted">10:25 AM</small></td>
                                                    <td>
                                                        <div class="d-flex gap-2 align-items-center">
                                                            <img src="{{ asset('admin/assets/images/users/user-7.jpg') }}" alt="Sophia Lee" class="avatar-xs rounded-circle" />
                                                            <span>Sophia Lee</span>
                                                ...
                                                <tr class="table-danger-subtle">
                                                    ...
                                                    <td><a href="#!" class="fw-semibold link-reset">#TRX-2012</a></td>
                                                    ...
                                                    <td><span class="badge bg-success-subtle text-success badge-label">Completed</span></td>
                                                    <td>29 Sep, 2025 <small class="text-muted">06:40 PM</small></td>
                                                    <td>
                                                        <div class="d-flex gap-2 align-items-center">
                                                            <img src="{{ asset('admin/assets/images/users/user-1.jpg') }}" alt="Olivia Green" class="avatar-xs rounded-circle" />
                                                            <span>Olivia Green</span>
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-header">
                                    <h5 class="modal-title fw-semibold" id="transactionModalLabel"><i class="ti ti-plus me-1 text-primary"></i> Add New Transaction</h5>
                                    ...
                                    <form id="transactionForm" novalidate>
                                        <div class="row g-3">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <input type="text" class="form-control" name="description" placeholder="Enter transaction description" required />
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" data-provider="flatpickr" data-date-format="d M, Y" data-enable-time class="form-control" name="date" required />
                                            </div>

                                            <!-- Processed By -->
                                            <div class="col-md-6">
                                                <label class="form-label fw-medium">Processed By</label>
                                                <input type="text" class="form-control" name="processedBy" placeholder="Enter staff name" required />
                                            </div>
                                        </div>
                                    </form>
                                </div>
                                ...
                                <div class="modal-footer border-0">
                                    ...
                                    <button type="submit" form="transactionForm" class="btn btn-primary"><i class="ti ti-device-floppy me-1"></i> Save Transaction</button>
                                </div>
                            </div>
                        </div>
                    </div>
