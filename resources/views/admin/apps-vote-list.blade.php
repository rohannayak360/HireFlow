...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-vote-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:45 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Vote List | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Vote List</h4>
                        </div>
                                    ...
                                    <div class="border-bottom border-dashed px-4 py-3">
                                        <div class="d-flex gap-4 align-items-center">
                                                ...
                                                <div class="vstack gap-1 text-center">
                                                    <div>
                                                        <button type="button" class="btn p-0 btn-link">
                                                            <i class="ti ti-chevron-up fs-xxl"></i>
                                                        </button>
                                                    </div>
                                                    <h5 class="fw-bold m-0 fs-lg">35</h5>
                                                    <div>
                                                        <button type="button" class="btn p-0 btn-link">
                                                            <i class="ti ti-chevron-down fs-xxl"></i>
                                                        </button>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <!-- Short Description -->
                                                <p class="text-muted mb-2">Remote work has seen a massive rise in popularity since 2020. This vote explores whether it should remain a flexible option moving forward.</p>

                                                <!-- Meta Info -->
                                                <p class="d-flex flex-wrap gap-3 text-muted mb-1 align-items-center fs-base">
                                                    <span class="d-flex align-items-center gap-1">
                                                        <img src="{{ asset('admin/assets/images/users/user-7.jpg') }}" alt="avatar-7" class="img-fluid avatar-xs rounded-circle" />
                                                    ...
                                                    <span class="d-flex align-items-center gap-1">
                                                        <i class="ti ti-tag"></i>
                                                        <span class="badge bg-light text-primary">Workplace</span>
                                                    </span>
                                                    <span>
                                                        <i class="ti ti-messages"></i>
                                                        <a href="#!" class="link-reset">Comments: 89</a>
                                                    </span>
                                                    <span>
                                    ...
                                    <div class="border-bottom border-dashed px-4 py-3">
                                        <div class="d-flex gap-4 align-items-center">
                                            <div>
                                                <div class="vstack gap-1 text-center">
                                                    <div>
                                                        <button type="button" class="btn p-0 btn-link text-danger">
                                                            <i class="ti ti-chevron-up fs-xxl"></i>
                                                        </button>
                                                    </div>
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <p class="text-muted mb-2">As work-life balance becomes a higher priority, many advocate for a shorter workweek to improve productivity and employee well-being.</p>
                                                <p class="d-flex flex-wrap gap-3 text-muted mb-1 align-items-center fs-base">
                                                    <span class="d-flex align-items-center gap-1">
                                                        <img src="{{ asset('admin/assets/images/users/user-4.jpg') }}" alt="avatar-4" class="img-fluid avatar-xs rounded-circle" />
                                                    ...
                                                    <span class="d-flex align-items-center gap-1">
                                                        <i class="ti ti-tag"></i>
                                                        <span class="badge bg-light text-primary">Productivity</span>
                                                    </span>
                                                    <span>
                                                        <i class="ti ti-messages"></i>
                                                        <a href="#!" class="link-reset">Comments: 54</a>
                                                    </span>
                                                    <span>
                                                        <i class="ti ti-clock"></i>
                                                        Ends in: 4 days
                                            ...
                                            <span class="ms-auto fs-36 text-success text-opacity-25" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Thank you for voting">
                                    ...
                                    <div class="border-bottom border-dashed px-4 py-3">
                                        <div class="d-flex gap-4 align-items-center">
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <p class="text-muted mb-2">As AI becomes more accessible, businesses are debating its integration into daily operations for tasks like customer support and analysis.</p>
                                                <p class="d-flex flex-wrap gap-3 text-muted mb-1 align-items-center fs-base">
                                                    <span class="d-flex align-items-center gap-1">
                                                        <img src="{{ asset('admin/assets/images/users/user-8.jpg') }}" alt="avatar-8" class="img-fluid avatar-xs rounded-circle" />
                                                    ...
                                                    <span>
                                                        <i class="ti ti-messages"></i>
                                                        <a href="#!" class="link-reset">Comments: 112</a>
                                                    </span>
                                                    <span>
                                                        <i class="ti ti-clock"></i>
                                                        Ends in: 2 days
                                    ...
                                    <div class="border-bottom border-dashed px-4 py-3">
                                        <div class="d-flex gap-4 align-items-center">
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <p class="text-muted mb-2">With the success of remote setups, some argue that physical offices are no longer necessary. Others miss in-person collaboration.</p>
                                                <p class="d-flex flex-wrap gap-3 text-muted mb-1 align-items-center fs-base">
                                                    <span class="d-flex align-items-center gap-1">
                                                        <img src="{{ asset('admin/assets/images/users/user-6.jpg') }}" alt="avatar-6" class="img-fluid avatar-xs rounded-circle" />
                                                    ...
                                                    <span class="d-flex align-items-center gap-1">
                                                        <i class="ti ti-tag"></i>
                                                        <span class="badge bg-light text-primary">Remote</span>
                                                    </span>
                                                    <span>
                                                        <i class="ti ti-messages"></i>
                                                        <a href="#!" class="link-reset">Comments: 40</a>
                                                    </span>
                                                    <span>
                                                        <i class="ti ti-clock"></i>
                                                        Ends in: 3 days
                                    ...
                                    <div class="border-bottom border-dashed px-4 py-3">
                                        <div class="d-flex gap-4 align-items-center">
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <p class="text-muted mb-2">Many argue that skills matter more than formal education in today’s tech industry. Should degrees still be a hiring requirement?</p>
                                                <p class="d-flex flex-wrap gap-3 text-muted mb-1 align-items-center fs-base">
                                                    <span class="d-flex align-items-center gap-1">
                                                        <img src="{{ asset('admin/assets/images/users/user-9.jpg') }}" alt="avatar-9" class="img-fluid avatar-xs rounded-circle" />
                                                    ...
                                                    <span class="d-flex align-items-center gap-1">
                                                        <i class="ti ti-tag"></i>
                                                        <span class="badge bg-light text-primary">Career</span>
                                                    </span>
                                                    <span>
                                                        <i class="ti ti-messages"></i>
                                                        <a href="#!" class="link-reset">Comments: 87</a>
                                                    </span>
                                                    <span>
                                                        <i class="ti ti-clock"></i>
                                                        Ends in: 1 day
                                                    ...
                                                    <span class="d-flex align-items-center gap-1d-flex align-items-center gap-1">
                                                        <i class="ti ti-lock"></i>
                                                        <span class="badge text-bg-success">Open</span>
                                                    </span>
                                                </p>
                                    ...
                                    <div class="border-bottom border-dashed px-4 py-3">
                                        <div class="d-flex gap-4 align-items-center">
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <p class="text-muted mb-2">Teams spend hours in meetings weekly. Is cutting down on them the secret to improved focus and output?</p>
                                                <p class="d-flex flex-wrap gap-3 text-muted mb-1 align-items-center fs-base">
                                                    <span class="d-flex align-items-center gap-1">
                                                        <img src="{{ asset('admin/assets/images/users/user-10.jpg') }}" alt="avatar-10" class="img-fluid avatar-xs rounded-circle" />
                                                    ...
                                                    <span class="d-flex align-items-center gap-1">
                                                        <i class="ti ti-tag"></i>
                                                        <span class="badge bg-light text-primary">Efficiency</span>
                                                    </span>
                                                    <span>
                                                        <i class="ti ti-messages"></i>
                                                        <a href="#!" class="link-reset">Comments: 33</a>
                                                    </span>
                                                    <span>
                                                        <i class="ti ti-clock"></i>
                                                        Ends in: 6 days
                                                    ...
                                                    <span class="d-flex align-items-center gap-1">
                                                        <i class="ti ti-lock"></i>
                                                        <span class="badge text-bg-info">Ending Soon</span>
                                                    </span>
                                                </p>
                                            </div>
                                            <span class="ms-auto fs-36 text-success text-opacity-25" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Thank you for voting">
                                    ...
                                    <div class="px-4 py-3">
                                        <div class="d-flex gap-4 align-items-center">
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <p class="text-muted mb-2">Hybrid setups offer flexibility and collaboration—but do they satisfy everyone? Let’s vote on the future of work.</p>
                                                <p class="d-flex flex-wrap gap-3 text-muted mb-1 align-items-center fs-base">
                                                    <span class="d-flex align-items-center gap-1">
                                                        <img src="{{ asset('admin/assets/images/users/user-3.jpg') }}" alt="avatar-3" class="img-fluid avatar-xs rounded-circle" />
                                                    ...
                                                    <span class="d-flex align-items-center gap-1">
                                                        <i class="ti ti-tag"></i>
                                                        <span class="badge bg-light text-primary">Hybrid</span>
                                                    </span>
                                                    <span>
                                                        <i class="ti ti-messages"></i>
                                                        <a href="#!" class="link-reset">Comments: 61</a>
                                                    </span>
                                                    <span>
                                                        <i class="ti ti-clock"></i>
                                                        Ends in: 2 days
