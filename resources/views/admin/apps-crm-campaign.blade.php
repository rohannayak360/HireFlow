...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-crm-campaign.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:28 GMT -->
<head>
        <meta charset="utf-8" />
        <title>CRM Campaign | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Campaign</h4>
                        </div>
                                        ...
                                        <table class="table table-custom table-centered table-select table-hover w-100 mb-0">
                                            ...
                                            <tbody class="text-nowrap">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex gap-2 align-items-center">
                                                            <img src="{{ asset('admin/assets/images/users/user-7.jpg') }}" alt="Sandra Walton" class="avatar-xs rounded-circle" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex gap-2 align-items-center">
                                                            <img src="{{ asset('admin/assets/images/users/user-4.jpg') }}" alt="Derek Kim" class="avatar-xs rounded-circle" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex gap-2 align-items-center">
                                                            <img src="{{ asset('admin/assets/images/users/user-8.jpg') }}" alt="Ava Nguyen" class="avatar-xs rounded-circle" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex gap-2 align-items-center">
                                                            <img src="{{ asset('admin/assets/images/users/user-3.jpg') }}" alt="Ryan Patel" class="avatar-xs rounded-circle" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex gap-2 align-items-center">
                                                            <img src="{{ asset('admin/assets/images/users/user-2.jpg') }}" alt="Lily Chen" class="avatar-xs rounded-circle" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex gap-2 align-items-center">
                                                            <img src="{{ asset('admin/assets/images/users/user-9.jpg') }}" alt="Noah Brooks" class="avatar-xs rounded-circle" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex gap-2 align-items-center">
                                                            <img src="{{ asset('admin/assets/images/users/user-10.jpg') }}" alt="Sophia Lee" class="avatar-xs rounded-circle" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex gap-2 align-items-center">
                                                            <img src="{{ asset('admin/assets/images/users/user-1.jpg') }}" alt="Lucas Green" class="avatar-xs rounded-circle" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex gap-2 align-items-center">
                                                            <img src="{{ asset('admin/assets/images/users/user-2.jpg') }}" alt="Isabella Ray" class="avatar-xs rounded-circle" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex gap-2 align-items-center">
                                                            <img src="{{ asset('admin/assets/images/users/user-3.jpg') }}" alt="Leo White" class="avatar-xs rounded-circle" />
