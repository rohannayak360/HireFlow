...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-hrm-staffs.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:33 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Staffs List | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Staffs</h4>
                        </div>
                                ...
                                <div class="card-header border-light justify-content-between">
                                    <div class="d-flex gap-2">
                                        <div class="app-search">
                                            <input data-table-search type="text" class="form-control" placeholder="Search staff..." />
                                            <i class="ti ti-search app-search-icon text-muted"></i>
                                        </div>
                                    ...
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <!-- Department Filter -->
                                        <div class="app-search">
                                            <select data-table-filter="department" class="form-select form-control my-1 my-md-0">
                                    ...
                                    <table class="table table-custom table-centered table-select table-hover w-100 mb-0">
                                        <thead class="bg-light bg-opacity-25 thead-sm">
                                            <tr class="text-uppercase fs-xxs">
                                                ...
                                                <th data-table-sort data-column="department">Department</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="{{ url('admin/apps-hrm-staff-profile') }}" class="fw-semibold link-reset">STF-001</a></td>
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="avatar avatar-sm"><img src="{{ asset('admin/assets/images/users/user-3.jpg') }}" class="img-fluid rounded-circle" alt="" /></div>
                                                        <div>
                                                            <h5 class="mb-0 lh-base fs-base"><a href="{{ url('admin/apps-hrm-staff-profile') }}" class="link-reset">Samantha Green</a></h5>
                                                ...
                                                <td>
                                                    <span class="badge p-1 text-bg-light fs-sm"><img src="{{ asset('admin/assets/images/flags/us.svg') }}" height="12" class="rounded-circle me-1" />US</span>
                                                </td>
                                                <td>Feb 10, 2024</td>
                                                <td>HR Manager</td>
                                            ...
                                            <tr>
                                                <td><input class="form-check-input form-check-input-light fs-14 mt-0" type="checkbox" /></td>
                                                <td><a href="{{ url('admin/apps-hrm-staff-profile') }}" class="fw-semibold link-reset">STF-002</a></td>
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="avatar avatar-sm"><img src="{{ asset('admin/assets/images/users/user-5.jpg') }}" class="img-fluid rounded-circle" alt="" /></div>
                                                        <div>
                                                            <h5 class="mb-0 lh-base fs-base"><a href="{{ url('admin/apps-hrm-staff-profile') }}" class="link-reset">Liam Johnson</a></h5>
                                                ...
                                                <td>
                                                    <span class="badge p-1 text-bg-light fs-sm"><img src="{{ asset('admin/assets/images/flags/gb.svg') }}" height="12" class="rounded-circle me-1" />UK</span>
                                                </td>
                                                <td>Jan 25, 2024</td>
                                            ...
                                            <tr>
                                                <td><input class="form-check-input form-check-input-light fs-14 mt-0" type="checkbox" /></td>
                                                <td><a href="{{ url('admin/apps-hrm-staff-profile') }}" class="fw-semibold link-reset">STF-003</a></td>
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="avatar avatar-sm"><img src="{{ asset('admin/assets/images/users/user-7.jpg') }}" class="img-fluid rounded-circle" alt="" /></div>
                                                        <div>
                                                            <h5 class="mb-0 lh-base fs-base"><a href="{{ url('admin/apps-hrm-staff-profile') }}" class="link-reset">Noah Martinez</a></h5>
                                                ...
                                                <td>
                                                    <span class="badge p-1 text-bg-light fs-sm"><img src="{{ asset('admin/assets/images/flags/au.svg') }}" height="12" class="rounded-circle me-1" />AU</span>
                                                </td>
                                                <td>Mar 05, 2024</td>
                                            ...
                                            <tr>
                                                <td><input class="form-check-input form-check-input-light fs-14 mt-0" type="checkbox" /></td>
                                                <td><a href="{{ url('admin/apps-hrm-staff-profile') }}" class="fw-semibold link-reset">STF-004</a></td>
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="avatar avatar-sm"><img src="{{ asset('admin/assets/images/users/user-8.jpg') }}" class="img-fluid rounded-circle" alt="" /></div>
                                                        <div>
                                                            <h5 class="mb-0 lh-base fs-base"><a href="{{ url('admin/apps-hrm-staff-profile') }}" class="link-reset">Emily Davis</a></h5>
                                                ...
                                                <td>
                                                    <span class="badge p-1 text-bg-light fs-sm"><img src="{{ asset('admin/assets/images/flags/ca.svg') }}" height="12" class="rounded-circle me-1" />CA</span>
                                                </td>
                                                <td>Apr 18, 2024</td>
                                            ...
                                            <tr>
                                                <td><input class="form-check-input form-check-input-light fs-14 mt-0" type="checkbox" /></td>
                                                <td><a href="{{ url('admin/apps-hrm-staff-profile') }}" class="fw-semibold link-reset">STF-005</a></td>
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="avatar avatar-sm"><img src="{{ asset('admin/assets/images/users/user-9.jpg') }}" class="img-fluid rounded-circle" alt="" /></div>
                                                        <div>
                                                            <h5 class="mb-0 lh-base fs-base"><a href="{{ url('admin/apps-hrm-staff-profile') }}" class="link-reset">Lucas Brown</a></h5>
                                                ...
                                                <td>
                                                    <span class="badge p-1 text-bg-light fs-sm"><img src="{{ asset('admin/assets/images/flags/de.svg') }}" height="12" class="rounded-circle me-1" />GE</span>
                                                </td>
                                                <td>May 12, 2024</td>
                                            ...
                                            <tr>
                                                <td><input class="form-check-input form-check-input-light fs-14 mt-0" type="checkbox" /></td>
                                                <td><a href="{{ url('admin/apps-hrm-staff-profile') }}" class="fw-semibold link-reset">STF-006</a></td>
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="avatar avatar-sm"><img src="{{ asset('admin/assets/images/users/user-10.jpg') }}" class="img-fluid rounded-circle" alt="" /></div>
                                                        <div>
                                                            <h5 class="mb-0 lh-base fs-base"><a href="{{ url('admin/apps-hrm-staff-profile') }}" class="link-reset">Olivia Wilson</a></h5>
                                                ...
                                                <td>
                                                    <span class="badge p-1 text-bg-light fs-sm"><img src="{{ asset('admin/assets/images/flags/fr.svg') }}" height="12" class="rounded-circle me-1" />FR</span>
                                                </td>
                                                <td>Jun 02, 2024</td>
                                                <td>UX Designer</td>
                                                <td>Design</td>
                                            ...
                                            <tr>
                                                <td><input class="form-check-input form-check-input-light fs-14 mt-0" type="checkbox" /></td>
                                                <td><a href="{{ url('admin/apps-hrm-staff-profile') }}" class="fw-semibold link-reset">STF-007</a></td>
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="avatar avatar-sm"><img src="{{ asset('admin/assets/images/users/user-1.jpg') }}" class="img-fluid rounded-circle" alt="" /></div>
                                                        <div>
                                                            <h5 class="mb-0 lh-base fs-base"><a href="{{ url('admin/apps-hrm-staff-profile') }}" class="link-reset">Isabella Moore</a></h5>
                                                ...
                                                <td>
                                                    <span class="badge p-1 text-bg-light fs-sm"><img src="{{ asset('admin/assets/images/flags/es.svg') }}" height="12" class="rounded-circle me-1" />SP</span>
                                                </td>
                                                <td>Jul 21, 2024</td>
                                                <td>Data Analyst</td>
                                                <td>Analytics</td>
                                            ...
                                            <tr>
                                                <td><input class="form-check-input form-check-input-light fs-14 mt-0" type="checkbox" /></td>
                                                <td><a href="{{ url('admin/apps-hrm-staff-profile') }}" class="fw-semibold link-reset">STF-008</a></td>
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="avatar avatar-sm"><img src="{{ asset('admin/assets/images/users/user-2.jpg') }}" class="img-fluid rounded-circle" alt="" /></div>
                                                        <div>
                                                            <h5 class="mb-0 lh-base fs-base"><a href="{{ url('admin/apps-hrm-staff-profile') }}" class="link-reset">Ethan Clark</a></h5>
                                                ...
                                                <td>
                                                    <span class="badge p-1 text-bg-light fs-sm"><img src="{{ asset('admin/assets/images/flags/it.svg') }}" height="12" class="rounded-circle me-1" />IT</span>
                                                </td>
                                                <td>Aug 08, 2024</td>
                                                <td>QA Tester</td>
                                            ...
                                            <tr>
                                                <td><input class="form-check-input form-check-input-light fs-14 mt-0" type="checkbox" /></td>
                                                <td><a href="{{ url('admin/apps-hrm-staff-profile') }}" class="fw-semibold link-reset">STF-009</a></td>
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="avatar avatar-sm"><img src="{{ asset('admin/assets/images/users/user-4.jpg') }}" class="img-fluid rounded-circle" alt="" /></div>
                                                        <div>
                                                            <h5 class="mb-0 lh-base fs-base"><a href="{{ url('admin/apps-hrm-staff-profile') }}" class="link-reset">Charlotte Turner</a></h5>
                                                ...
                                                <td>
                                                    <span class="badge p-1 text-bg-light fs-sm"><img src="{{ asset('admin/assets/images/flags/ch.svg') }}" height="12" class="rounded-circle me-1" />SW</span>
                                                </td>
                                                <td>Sep 15, 2024</td>
                                                <td>Legal Advisor</td>
                                                <td>Legal</td>
                                            ...
                                            <tr>
                                                <td><input class="form-check-input form-check-input-light fs-14 mt-0" type="checkbox" /></td>
                                                <td><a href="{{ url('admin/apps-hrm-staff-profile') }}" class="fw-semibold link-reset">STF-010</a></td>
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="avatar avatar-sm"><img src="{{ asset('admin/assets/images/users/user-9.jpg') }}" class="img-fluid rounded-circle" alt="" /></div>
                                                        <div>
                                                            <h5 class="mb-0 lh-base fs-base"><a href="{{ url('admin/apps-hrm-staff-profile') }}" class="link-reset">Amelia Walker</a></h5>
                                                ...
                                                <td>+65 8123 4567</td>
                                                <td>
                                                    <span class="badge p-1 text-bg-light fs-sm"><img src="{{ asset('admin/assets/images/flags/sg.svg') }}" height="12" class="rounded-circle me-1" />SI</span>
                                                </td>
                                                <td>Oct 04, 2024</td>
                                            ...
                                            <tr>
                                                <td><input class="form-check-input form-check-input-light fs-14 mt-0" type="checkbox" /></td>
                                                <td><a href="{{ url('admin/apps-hrm-staff-profile') }}" class="fw-semibold link-reset">STF-011</a></td>
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="avatar avatar-sm"><img src="{{ asset('admin/assets/images/users/user-7.jpg') }}" class="img-fluid rounded-circle" alt="" /></div>
                                                        <div>
                                                            <h5 class="mb-0 lh-base fs-base"><a href="{{ url('admin/apps-hrm-staff-profile') }}" class="link-reset">Benjamin Scott</a></h5>
                                                ...
                                                <td>
                                                    <span class="badge p-1 text-bg-light fs-sm"><img src="{{ asset('admin/assets/images/flags/nl.svg') }}" height="12" class="rounded-circle me-1" />NE</span>
                                                </td>
                                                <td>Nov 11, 2024</td>
                                            ...
                                            <tr>
                                                <td><input class="form-check-input form-check-input-light fs-14 mt-0" type="checkbox" /></td>
                                                <td><a href="{{ url('admin/apps-hrm-staff-profile') }}" class="fw-semibold link-reset">STF-012</a></td>
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="avatar avatar-sm"><img src="{{ asset('admin/assets/images/users/user-6.jpg') }}" class="img-fluid rounded-circle" alt="" /></div>
                                                        <div>
                                                            <h5 class="mb-0 lh-base fs-base"><a href="{{ url('admin/apps-hrm-staff-profile') }}" class="link-reset">Henry Lewis</a></h5>
                                                ...
                                                <td>
                                                    <span class="badge p-1 text-bg-light fs-sm"><img src="{{ asset('admin/assets/images/flags/ie.svg') }}" height="12" class="rounded-circle me-1" />IR</span>
                                                </td>
                                                <td>Dec 02, 2024</td>
                                            ...
                                            <tr>
                                                <td><input class="form-check-input form-check-input-light fs-14 mt-0" type="checkbox" /></td>
                                                <td><a href="{{ url('admin/apps-hrm-staff-profile') }}" class="fw-semibold link-reset">STF-013</a></td>
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="avatar avatar-sm"><img src="{{ asset('admin/assets/images/users/user-1.jpg') }}" class="img-fluid rounded-circle" alt="" /></div>
                                                        <div>
                                                            <h5 class="mb-0 lh-base fs-base"><a href="{{ url('admin/apps-hrm-staff-profile') }}" class="link-reset">Grace Adams</a></h5>
                                                ...
                                                <td>
                                                    <span class="badge p-1 text-bg-light fs-sm"><img src="{{ asset('admin/assets/images/flags/pt.svg') }}" height="12" class="rounded-circle me-1" />PO</span>
                                                </td>
                                                <td>Dec 18, 2024</td>
                                    ...
                                    <div class="modal-body">
                                        <div class="row g-3">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="email" class="form-control" id="staffEmail" placeholder="name&#64;example.com" required />
                                            </div>

                                            <div class="col-md-6">
                                                <label for="staffPhone" class="form-label">Phone</label>
                                                <input type="text" class="form-control" id="staffPhone" placeholder="+1 202 555 0123" />
                                            </div>

                                            <div class="col-md-6">
                                                <label for="staffCountry" class="form-label">Country</label>
                                                <select id="staffCountry" class="form-select">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control" id="staffRole" placeholder="e.g. Software Engineer" />
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="date" class="form-control" data-provider="flatpickr" data-date-format="d M, Y" id="staffJoinDate" />
                                            </div>
                                        </div>
                                    </div>
...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-hrm-staffs.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:35 GMT -->
</html>
