...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-projects-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:21 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Project Overview | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Project Overview</h4>
                        </div>
                                        ...
                                        <div class="card-header align-items-start p-4">
                                            <div class="avatar-xxl me-3">
                                                <span class="avatar-title text-bg-light rounded">
                                                    <img src="{{ asset('admin/assets/images/logos/starbucks.svg') }}" height="48" alt="Brand-img" />
                                                </span>
                                            </div>
                                            <div>
                                                ...
                                                <div class="tab-pane fade" id="activity" role="tabpanel">
                                                    <div class="d-flex gap-1 border-bottom border-dashed pb-3">
                                                        <div class="me-2 flex-shrink-0">
                                                            <img src="{{ asset('admin/assets/images/users/user-1.jpg') }}" class="avatar-md rounded-circle" alt="" />
                                                        </div>
                                                    ...
                                                    <div class="d-flex gap-1 border-bottom border-dashed py-3">
                                                        <div class="me-2 flex-shrink-0">
                                                            <img src="{{ asset('admin/assets/images/users/user-2.jpg') }}" class="avatar-md rounded-circle" alt="" />
                                                        </div>
                                                        <div class="flex-grow-1 text-muted">
                                                    ...
                                                    <div class="d-flex gap-1 border-bottom border-dashed py-3">
                                                        <div class="me-2 flex-shrink-0">
                                                            <img src="{{ asset('admin/assets/images/users/user-3.jpg') }}" class="avatar-md rounded-circle" alt="" />
                                                        </div>
                                                        <div class="flex-grow-1 text-muted">
                                                    ...
                                                    <div class="d-flex gap-1 border-bottom border-dashed py-3">
                                                        <div class="me-2 flex-shrink-0">
                                                            <img src="{{ asset('admin/assets/images/users/user-4.jpg') }}" class="avatar-md rounded-circle" alt="" />
                                                        </div>
                                                        <div class="flex-grow-1 text-muted">
                                                    ...
                                                    <div class="d-flex gap-1 border-bottom border-dashed py-3">
                                                        <div class="me-2 flex-shrink-0">
                                                            <img src="{{ asset('admin/assets/images/users/user-5.jpg') }}" class="avatar-md rounded-circle" alt="" />
                                                        </div>
