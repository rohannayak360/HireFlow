...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-projects-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:21 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Projects List | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Projects List</h4>
                        </div>
                            ...
                            <div data-table data-table-rows-per-page="8" class="card">
                                <div class="card-header border-light justify-content-between">
                                    ...
                                    <div class="d-flex gap-1">
                                        <a href="{{ url('admin/apps-projects-grid') }}" class="btn btn-soft-primary btn-icon">
                                            <i class="ti ti-category fs-lg"></i>
                                        </a>
                                        <a href="{{ url('admin/apps-projects-list') }}" class="btn btn-primary btn-icon">
                                                    ...
                                                    <div class="d-flex">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-1 d-flex align-items-center">
                                                                <a data-sort="project" href="{{ url('admin/apps-projects-details') }}" class="link-reset">AI Analytics Dashboard</a>
                                                            </h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-1 d-flex align-items-center">
                                                                <a data-sort="project" href="{{ url('admin/apps-projects-details') }}" class="link-reset">E-commerce Platform</a>
                                                            </h5>
                                                ...
                                                <td>
                                                    <div class="avatar-group avatar-group-xs">
                                                        <div class="avatar">
                                                            <img src="{{ asset('admin/assets/images/users/user-6.jpg') }}" class="rounded-circle avatar-xs" alt="user-img" />
                                                        </div>
                                                        <div class="avatar">
                                                            <img src="{{ asset('admin/assets/images/users/user-8.jpg') }}" class="rounded-circle avatar-xs" alt="user-img" />
                                                        </div>
                                                        <div class="avatar">
                                                            <img src="{{ asset('admin/assets/images/users/user-7.jpg') }}" class="rounded-circle avatar-xs" alt="user-img" />
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-1 d-flex align-items-center">
                                                                <a data-sort="project" href="{{ url('admin/apps-projects-details') }}" class="link-reset">UI Kit Design</a>
                                                            </h5>
                                                ...
                                                <td>
                                                    <div class="avatar-group avatar-group-xs">
                                                        <div class="avatar">
                                                            <img src="{{ asset('admin/assets/images/users/user-4.jpg') }}" class="rounded-circle avatar-xs" alt="user-img" />
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-1 d-flex align-items-center">
                                                                <a data-sort="project" href="{{ url('admin/apps-projects-details') }}" class="link-reset">Website Redesign</a>
                                                            </h5>
                                                ...
                                                <td>
                                                    <div class="avatar-group avatar-group-xs">
                                                        <div class="avatar">
                                                            <img src="{{ asset('admin/assets/images/users/user-2.jpg') }}" class="rounded-circle avatar-xs" alt="user-img" />
                                                        </div>
                                                        <div class="avatar">
                                                            <img src="{{ asset('admin/assets/images/users/user-7.jpg') }}" class="rounded-circle avatar-xs" alt="user-img" />
                                                        </div>
                                                        <div class="avatar">
                                                            <img src="{{ asset('admin/assets/images/users/user-9.jpg') }}" class="rounded-circle avatar-xs" alt="user-img" />
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-1 d-flex align-items-center">
                                                                <a data-sort="project" href="{{ url('admin/apps-projects-details') }}" class="link-reset">Marketing Report</a>
                                                            </h5>
                                                ...
                                                <td>
                                                    <div class="avatar-group avatar-group-xs">
                                                        <div class="avatar">
                                                            <img src="{{ asset('admin/assets/images/users/user-5.jpg') }}" class="rounded-circle avatar-xs" alt="user-img" />
                                                        </div>
                                                        <div class="avatar">
                                                            <img src="{{ asset('admin/assets/images/users/user-10.jpg') }}" class="rounded-circle avatar-xs" alt="user-img" />
                                                        </div>
                                                        <div class="avatar">
                                                            <img src="{{ asset('admin/assets/images/users/user-8.jpg') }}" class="rounded-circle avatar-xs" alt="user-img" />
                                                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-1 d-flex align-items-center">
                                                                <a data-sort="project" href="{{ url('admin/apps-projects-details') }}" class="link-reset">Sales Pitch Deck</a>
                                                            </h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-1 d-flex align-items-center">
                                                                <a data-sort="project" href="{{ url('admin/apps-projects-details') }}" class="link-reset">Mobile UI Mockups</a>
                                                            </h5>
                                                ...
                                                <td>
                                                    <div class="avatar-group avatar-group-xs">
                                                        ...
                                                        <div class="avatar">
                                                            <img src="{{ asset('admin/assets/images/users/user-1.jpg') }}" class="rounded-circle avatar-xs" alt="user-img" />
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-1 d-flex align-items-center">
                                                                <a data-sort="project" href="{{ url('admin/apps-projects-details') }}" class="link-reset">Server Maintenance</a>
                                                            </h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-1 d-flex align-items-center">
                                                                <a data-sort="project" href="{{ url('admin/apps-projects-details') }}" class="link-reset">Security Audit</a>
                                                            </h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-1 d-flex align-items-center">
                                                                <a data-sort="project" href="{{ url('admin/apps-projects-details') }}" class="link-reset">Plugin Development</a>
                                                            </h5>
                                                ...
                                                <td>
                                                    <div class="avatar-group avatar-group-xs">
                                                        <div class="avatar">
                                                            <img src="{{ asset('admin/assets/images/users/user-3.jpg') }}" class="rounded-circle avatar-xs" alt="user-img" />
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
