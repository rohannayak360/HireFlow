...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-hrm-payroll.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:36 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Payroll | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Payroll</h4>
                        </div>
                                ...
                                <div class="card-header border-light justify-content-between">
                                    <div class="d-flex gap-2">
                                        ...
                                        <div class="app-search">
                                            <input data-table-search type="text" class="form-control" placeholder="Search payroll records..." />
                                            <i class="ti ti-search app-search-icon text-muted"></i>
                                        </div>
                                    ...
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <!-- Pay Period Filter -->
                                        <div class="app-search">
                                            <select data-table-filter="period" class="form-select form-control my-1 my-md-0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-0 lh-base fs-base"><a href="#!" class="link-reset">Samantha Green</a></h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-0 lh-base fs-base"><a href="#!" class="link-reset">David Lee</a></h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-0 lh-base fs-base"><a href="#!" class="link-reset">Maria Smith</a></h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-0 lh-base fs-base"><a href="#!" class="link-reset">Michael Adams</a></h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-0 lh-base fs-base"><a href="#!" class="link-reset">Olivia Brown</a></h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-0 lh-base fs-base"><a href="#!" class="link-reset">Daniel Carter</a></h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-0 lh-base fs-base"><a href="#!" class="link-reset">Emily Davis</a></h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-0 lh-base fs-base"><a href="#!" class="link-reset">James Walker</a></h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="avatar avatar-sm">
                                                            <img src="{{ asset('admin/assets/images/users/user-7.jpg') }}" class="img-fluid rounded-circle" alt="" />
                                                        </div>
                                                        <div>
                                                            <h5 class="mb-0 lh-base fs-base"><a href="#!" class="link-reset">Sophia Martinez</a></h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-0 lh-base fs-base"><a href="#!" class="link-reset">Henry Clark</a></h5>
                                            ...
                                            <tr>
                                                    ...
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-0 lh-base fs-base">
                                                                <a href="#!" class="link-reset">Isabella Johnson</a>
                                                            </h5>
                                                ...
                                                <td class="text-center">
                                                    <div class="d-flex justify-content-center gap-1">
                                                        <a href="#" class="btn btn-default btn-icon btn-sm" title="View Payslip"><i class="ti ti-eye fs-lg"></i></a>
                                                        <a href="#" class="btn btn-default btn-icon btn-sm" title="Edit Record"><i class="ti ti-edit fs-lg"></i></a>
                                                        <a href="#" class="btn btn-default btn-icon btn-sm" data-table-delete-row title="Delete"><i class="ti ti-trash fs-lg"></i></a>
                                                    </div>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-0 lh-base fs-base">
                                                                <a href="#!" class="link-reset">Liam Turner</a>
                                                            </h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-0 lh-base fs-base">
                                                                <a href="#!" class="link-reset">Charlotte Evans</a>
                                                            </h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-0 lh-base fs-base">
                                                                <a href="#!" class="link-reset">Benjamin Scott</a>
                                                            </h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-0 lh-base fs-base">
                                                                <a href="#!" class="link-reset">Grace Mitchell</a>
                                                            </h5>
                        ...
                        <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
                            <div class="modal-content">
                                <div class="modal-header border-bottom">
                                    <h5 class="modal-title fw-semibold" id="addPayrollModalLabel"><i class="ti ti-plus me-1"></i> Add Payroll Record</h5>
                                ...
                                <form id="addPayrollForm">
                                    <div class="modal-body">
                                        <div class="row g-3">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" id="role" class="form-control" placeholder="Enter position title" required />
                                            </div>

                                            <!-- Pay Period -->
                                            <div class="col-md-6">
                                                <label for="payPeriod" class="form-label"> Pay Period <span class="text-danger">*</span> </label>
                                                <select id="payPeriod" class="form-select" required>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="number" id="baseSalary" class="form-control" placeholder="e.g., 5000" min="0" required />
                                            </div>

                                            <!-- Allowances -->
                                            <div class="col-md-6">
                                                <label for="allowances" class="form-label">Allowances ($)</label>
                                                <input type="number" id="allowances" class="form-control" placeholder="e.g., 300" min="0" />
                                            </div>

                                            <!-- Total Earnings (auto-calculated) -->
                                            <div class="col-md-6">
                                                <label for="totalEarnings" class="form-label">Total Earnings ($)</label>
                                                <input type="number" id="totalEarnings" class="form-control" placeholder="Auto-calculated" readonly />
                                            </div>

                                            <!-- Deductions -->
                                            <div class="col-md-6">
                                                <label for="deductions" class="form-label">Deductions ($)</label>
                                                <input type="number" id="deductions" class="form-control" placeholder="e.g., 100" min="0" />
                                            </div>

                                            <!-- Net Pay (auto-calculated) -->
                                            <div class="col-md-6">
                                                <label for="netPay" class="form-label">Net Pay ($)</label>
                                                <input type="number" id="netPay" class="form-control" placeholder="Auto-calculated" readonly />
                                            </div>

                                            <!-- Pay Status -->
                                            <div class="col-md-6">
                                                <label for="pay-status" class="form-label"> Pay Status <span class="text-danger">*</span> </label>
                                            ...
                                            <div class="col-12">
                                                ...
                                                <textarea id="remarks" class="form-control" rows="2" placeholder="Optional remarks or notes"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="modal-footer border-top">
                                        ...
                                        <button type="submit" class="btn btn-primary"><i class="ti ti-device-floppy me-1"></i> Save Payroll</button>
                                    </div>
                                </form>
                            </div>
                        </div>
