...
<!-- Mirrored from coderthemes.com/paces/bootstrap/pages-terms-conditions.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:56 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Terms & Conditions | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Terms & Conditions</h4>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card position-relative">
                                <div class="position-absolute top-0 end-0">
                                    <img src="{{ asset('admin/assets/images/auth-card-bg.svg') }}" class="auth-card-bg-img" style="opacity: 0.7" alt="auth-card-bg" />
                                </div>
