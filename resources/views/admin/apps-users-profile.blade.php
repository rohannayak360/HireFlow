...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-users-profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:31 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Profile | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Profile</h4>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <article class="card overflow-hidden mb-0">
                                <div class="position-relative card-side-img overflow-hidden" style="min-height: 300px; background-image: url({{ asset('admin/assets/images/profile-bg.jpg') }})">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="">
                                            ...
                                            <div class="d-flex align-items-center gap-2 mb-2">
                                                ...
                                                <p class="mb-0 fs-sm">
                                                    Email
                                                    <a href="mailto:hello&#64;example.com" class="text-primary fw-semibold">hello&#64;example.com</a>
                                                </p>
                                            </div>
                                            <div class="d-flex align-items-center gap-2 mb-2">
                                                <div class="avatar-sm text-bg-light bg-opacity-75 d-flex align-items-center justify-content-center rounded-circle">
                                        ...
                                        <ul class="nav nav-tabs card-header-tabs nav-bordered">
                                            <li class="nav-item">
                                                <a href="#about-me" data-bs-toggle="tab" aria-expanded="false" class="nav-link">
                                                    <i class="ti ti-user-circle d-md-none d-block fs-lg"></i>
                                            ...
                                            <li class="nav-item">
                                                <a href="#timeline" data-bs-toggle="tab" aria-expanded="true" class="nav-link active">
                                                    <i class="ti ti-clock d-md-none d-block fs-lg"></i>
                                                    <span class="d-none d-md-block fw-bold">Timeline</span>
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="#settings" data-bs-toggle="tab" aria-expanded="false" class="nav-link">
                                                    <i class="ti ti-settings d-md-none d-block fs-lg"></i>
                                                    ...
                                                    <table class="table table-centered table-custom table-sm table-nowrap table-hover mb-0">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td>
                                                                    <h5 class="fs-sm my-1">
                                                                        <a href="#" class="text-body">Blazor Admin Theme – Final QA</a>
                                                                    </h5>
                                                                ...
                                                                <td>
                                                                    <div class="d-flex align-items-center gap-2">
                                                                        <div class="avatar avatar-sm">
                                                                            <img src="{{ asset('admin/assets/images/users/user-7.jpg') }}" alt="avatar" class="img-fluid rounded-circle" />
                                                                        </div>
                                                                        <div>
                                                                ...
                                                                <td>9h 10min</td>
                                                                <td>
                                                                    <a href="#" class="text-muted fs-xxl">
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <h5 class="fs-sm my-1">
                                                                        <a href="#" class="text-body">Vue 3 UI Kit Refactor</a>
                                                                    </h5>
                                                                ...
                                                                <td>
                                                                    <div class="d-flex align-items-center gap-2">
                                                                        <div class="avatar avatar-sm">
                                                                            <img src="{{ asset('admin/assets/images/users/user-8.jpg') }}" alt="avatar" class="img-fluid rounded-circle" />
                                                                        </div>
                                                                        <div>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <h5 class="fs-sm my-1">
                                                                        <a href="#" class="text-body">HTML Email Templates Pack</a>
                                                                    </h5>
                                                                ...
                                                                <td>
                                                                    <div class="d-flex align-items-center gap-2">
                                                                        <div class="avatar avatar-sm">
                                                                            <img src="{{ asset('admin/assets/images/users/user-9.jpg') }}" alt="avatar" class="img-fluid rounded-circle" />
                                                                        </div>
                                                                        <div>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <h5 class="fs-sm my-1">
                                                                        <a href="#" class="text-body">Bootstrap 5 Theme Migration</a>
                                                                    </h5>
                                                                ...
                                                                <td>
                                                                    <div class="d-flex align-items-center gap-2">
                                                                        <div class="avatar avatar-sm">
                                                                            <img src="{{ asset('admin/assets/images/users/user-10.jpg') }}" alt="avatar" class="img-fluid rounded-circle" />
                                                                        </div>
                                                                        <div>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <h5 class="fs-sm my-1">
                                                                        <a href="#" class="text-body">SaaS Dashboard: UX Testing</a>
                                                                    </h5>
                                                                ...
                                                                <td>
                                                                    <div class="d-flex align-items-center gap-2">
                                                                        <div class="avatar avatar-sm">
                                                                            <img src="{{ asset('admin/assets/images/users/user-2.jpg') }}" alt="avatar" class="img-fluid rounded-circle" />
                                                                        </div>
                                                                        <div>
                                            ...
                                            <div class="tab-pane show active" id="timeline">
                                                ...
                                                <div class="border border-light border-dashed rounded p-2 mb-3">
                                                    <div class="d-flex align-items-center mb-2">
                                                        <img class="me-2 avatar-md rounded-circle" src="{{ asset('admin/assets/images/users/user-3.jpg') }}" alt="Generic placeholder image" />
                                                        <div class="w-100">
                                                    ...
                                                    <img src="{{ asset('admin/assets/images/stock/small-1.jpg') }}" alt="post-img" class="rounded me-1" height="60" />
                                                    <img src="{{ asset('admin/assets/images/stock/small-2.jpg') }}" alt="post-img" class="rounded me-1" height="60" />
                                                    <img src="{{ asset('admin/assets/images/stock/small-3.jpg') }}" alt="post-img" class="rounded" height="60" />
                                            ...
                                            <div class="tab-pane" id="settings">
                                                <form>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="mb-3">
                                                                ...
                                                                <span class="form-text fs-xs fst-italic text-muted">
                                                                    <a href="#" class="link-reset">Click here to change your email</a>
                                                                </span>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                    ...
                                                    <div class="row g-3">
                                                        ...
                                                        <div class="col-md-6">
                                                            <label for="social-sky" class="form-label">Dribbble</label>
                                                            <div class="input-group">
                                                                <span class="input-group-text">
                                                                    <svg
                                                                        xmlns="http://www.w3.org/2000/svg"
