...
<!-- Mirrored from coderthemes.com/paces/bootstrap/tables-datatables-export-data.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:59:53 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Export Data Datatables | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Export Data</h4>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header justify-content-between">
                                    ...
                                    <a href="https://datatables.net/reference/button/" target="_blank" class="icon-link icon-link-hover link-primary fw-semibold">
                                        View Docs
...
<script src="{{ asset('admin/assets/js/app.js') }}"></script>
        ...
        <script src="{{ asset('admin/assets/plugins/datatables/buttons.bootstrap5.min.js') }}"></script>
        ...
        <!-- Page js -->
        <script src="{{ asset('admin/assets/js/pages/datatables-export-data.js') }}"></script>
    </body>

<!-- Mirrored from coderthemes.com/paces/bootstrap/tables-datatables-export-data.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:59:57 GMT -->
</html>
