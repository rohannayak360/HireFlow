...
<!-- Mirrored from coderthemes.com/paces/bootstrap/form-wizard.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:59:40 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Form Wizard | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Wizard</h4>
                        </div>
                                        ...
                                        <ul class="nav nav-tabs wizard-tabs" data-wizard-nav role="tablist">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" data-bs-toggle="tab" href="#documents">
                                                    <span class="d-flex align-items-center">
                                                        <i class="ti ti-folder-open fs-32"></i>
                                                        <span class="flex-grow-1 ms-2 text-truncate">
