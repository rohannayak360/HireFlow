...
<!-- Mirrored from coderthemes.com/paces/bootstrap/form-fileuploads.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:59:43 GMT -->
<head>
        <meta charset="utf-8" />
        <title>File Uploads | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
        ...
        <!-- Dropzone Plugin CSS -->
        <link rel="stylesheet" href="{{ asset('admin/assets/plugins/dropzone/dropzone.css') }}" type="text/css" />

        <!-- Filepond Plugin CSS -->
        <link rel="stylesheet" href="{{ asset('admin/assets/plugins/filepond/filepond.min.css') }}" type="text/css" />
        <link rel="stylesheet" href="{{ asset('admin/assets/plugins/filepond/filepond-plugin-image-preview.min.css') }}" />
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">File Uploads</h4>
                        </div>
...
<script src="{{ asset('admin/assets/js/app.js') }}"></script>
        ...
        <!-- Filepond Plugin Js -->
        <script src="{{ asset('admin/assets/plugins/filepond/filepond.min.js') }}"></script>
        <script src="{{ asset('admin/assets/plugins/filepond/filepond-plugin-image-preview.min.js') }}"></script>
        <script src="{{ asset('admin/assets/plugins/filepond/filepond-plugin-file-validate-size.min.js') }}"></script>
        <script src="{{ asset('admin/assets/plugins/filepond/filepond-plugin-image-exif-orientation.min.js') }}"></script>
        <script src="{{ asset('admin/assets/plugins/filepond/filepond-plugin-file-encode.min.js') }}"></script>

        <!-- File Upload Demo Js -->
        <script src="{{ asset('admin/assets/js/pages/form-fileupload.js') }}"></script>
    </body>

<!-- Mirrored from coderthemes.com/paces/bootstrap/form-fileuploads.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:59:46 GMT -->
</html>
