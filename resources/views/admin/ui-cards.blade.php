...
<!-- Mirrored from coderthemes.com/paces/bootstrap/ui-cards.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:59:10 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Cards | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Cards</h4>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <div class="card-action">
                                        ...
                                        <a href="#!" class="card-action-item" data-action="card-refresh">
                                            <i class="ti ti-refresh align-middle"></i>
                                        </a>
                                        <a href="#!" class="card-action-item" data-action="card-close">
                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="row g-0 align-items-center">
                                    <div class="col-md-4">
                                        <img src="{{ asset('admin/assets/images/stock/small-1.jpg') }}" class="img-fluid rounded-start" alt="..." />
                                    </div>
                                    <div class="col-md-8">
                                        <div class="card-body">
                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="row g-0 align-items-center">
                                    ...
                                    <!-- end col -->
                                    <div class="col-md-4">
                                        <img src="{{ asset('admin/assets/images/stock/small-2.jpg') }}" class="img-fluid rounded-end" alt="..." />
                                    </div>
                                    <!-- end col -->
                                </div>
                                <!-- end row-->
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-lg-3">
                            <div class="card">
                                <img src="{{ asset('admin/assets/images/stock/small-3.jpg') }}" class="card-img-top" alt="..." />
                                <div class="card-body">
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div class="card">
                                <img src="{{ asset('admin/assets/images/stock/small-4.jpg') }}" class="card-img-top" alt="..." />
                                <div class="card-body">
                                    <h5 class="card-title mb-2">
                                        <a href="#" class="text-primary stretched-link">Card with stretched link</a>
                                    </h5>
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div class="card">
                                <img src="{{ asset('admin/assets/images/stock/small-5.jpg') }}" class="card-img-top" alt="..." />
                                <div class="card-body">
                                    <h5 class="card-title mb-2">Card with stretched link</h5>
                                    <a href="#" class="btn btn-primary mt-2 stretched-link">Go somewhere</a>
                                </div>
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div class="card">
                                <img src="{{ asset('admin/assets/images/stock/small-6.jpg') }}" class="card-img-top" alt="..." />
                                <div class="card-body">
                                    <h5 class="card-title mb-2">
                                        <a href="#" class="text-primary stretched-link">Card with stretched link</a>
                                    </h5>
                        ...
                        <div class="col-12">
                            <div class="card-group mb-3">
                                <div class="card d-block">
                                    <img class="card-img-top" src="{{ asset('admin/assets/images/stock/small-8.jpg') }}" alt="Card image cap" />
                                    <div class="card-body">
                                ...
                                <div class="card d-block">
                                    <img class="card-img-top" src="{{ asset('admin/assets/images/stock/small-9.jpg') }}" alt="Card image cap" />
                                    <div class="card-body">
                                        <h5 class="card-title mb-2">Card title</h5>
                                ...
                                <div class="card d-block">
                                    <img class="card-img-top" src="{{ asset('admin/assets/images/stock/small-10.jpg') }}" alt="Card image cap" />
                                    <div class="card-body">
                                        <h5 class="card-title mb-2">Card title</h5>
...
<!-- Mirrored from coderthemes.com/paces/bootstrap/ui-cards.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:59:11 GMT -->
</html>
