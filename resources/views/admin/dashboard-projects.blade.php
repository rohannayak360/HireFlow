...
<!-- Mirrored from coderthemes.com/paces/bootstrap/dashboard-projects.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:03 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Projects Dashboard | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                                    ...
                                    <table class="table table-custom table-nowrap table-centered table-hover w-100 mb-0">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ asset('admin/assets/images/users/user-2.jpg') }}" alt="" class="avatar-sm rounded-circle me-2" />
                                                        <div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ asset('admin/assets/images/users/user-3.jpg') }}" alt="" class="avatar-sm rounded-circle me-2" />
                                                        <div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ asset('admin/assets/images/users/user-4.jpg') }}" class="avatar-sm rounded-circle me-2" alt="" />
                                                        <div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ asset('admin/assets/images/users/user-5.jpg') }}" class="avatar-sm rounded-circle me-2" />
                                                        <div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ asset('admin/assets/images/users/user-6.jpg') }}" class="avatar-sm rounded-circle me-2" />
                                                        <div>
                                    ...
                                    <table class="table table-custom table-nowrap table-centered table-hover w-100 mb-0">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ asset('admin/assets/images/users/user-9.jpg') }}" class="avatar-sm rounded-circle me-2" />
                                                        <div>
                                                            <span class="text-muted fs-12">Assigned To</span>
                                                            <h5 class="fs-base mb-0 fw-normal">Chloe Martin</h5>
                                                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ asset('admin/assets/images/users/user-10.jpg') }}" class="avatar-sm rounded-circle me-2" />
                                                        <div>
                                                            <span class="text-muted fs-12">Assigned To</span>
...
<script src="{{ asset('admin/assets/js/app.js') }}"></script>
        ...
        <!-- Dashboard js -->
        <script src="{{ asset('admin/assets/js/pages/dashboard-projects.js') }}"></script>
    </body>

<!-- Mirrored from coderthemes.com/paces/bootstrap/dashboard-projects.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:04 GMT -->
</html>
