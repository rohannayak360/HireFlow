...
<!-- Mirrored from coderthemes.com/paces/bootstrap/ui-pagination.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:59:13 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Pagination | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Pagination</h4>
                        </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <nav>
                                        <ul class="pagination pagination-boxed pagination-secondary mb-0">
                                            <li class="page-item">
                                                <a class="page-link" href="javascript: void(0);" aria-label="Previous">
                                                    <i class="ti ti-arrow-left align-middle fs-lg"></i>
                                                </a>
                                            </li>
                                            <li class="page-item">
                                                <a class="page-link" href="javascript: void(0);">1</a>
                                            ...
                                            <li class="page-item">
                                                <a class="page-link" href="javascript: void(0);" aria-label="Next">
                                                    <i class="ti ti-arrow-right align-middle fs-lg"></i>
                                                </a>
                                            </li>
                                        </ul>
                                    </nav>
