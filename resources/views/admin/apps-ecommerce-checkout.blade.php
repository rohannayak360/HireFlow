...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-ecommerce-checkout.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:12 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Checkout | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Checkout</h4>
                        </div>
                    ...
                    <div class="row">
                                            ...
                                            <div class="tab-pane fade" id="courseInfo">
                                                ...
                                                <div class="border p-3 mb-3 rounded">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-4 text-sm-end mt-3 mt-sm-0">
                                                            <img src="{{ asset('admin/assets/images/cards/paypal.svg') }}" height="32" alt="paypal-img" />
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="border p-3 mb-3 rounded">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-4 text-sm-end mt-3 mt-sm-0">
                                                            <img src="{{ asset('admin/assets/images/cards/mastercard.svg') }}" height="32" alt="master-card-img" />
                                                            <img src="{{ asset('admin/assets/images/cards/discover-card.svg') }}" height="32" alt="discover-card-img" />
                                                            <img src="{{ asset('admin/assets/images/cards/visa.svg') }}" height="32" alt="visa-card-img" />
                                                            <img src="{{ asset('admin/assets/images/cards/stripe.svg') }}" height="32" alt="stripe-card-img" />
                                                        </div>
                                                    </div>
                                                    <!-- end row -->
                                                    <div class="row mt-4">
                                                ...
                                                <div class="border p-3 mb-3 rounded">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-4 text-sm-end mt-3 mt-sm-0">
                                                            <img src="{{ asset('admin/assets/images/cards/payoneer.svg') }}" height="32" alt="payoneer" />
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="border p-3 mb-3 rounded">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-4 text-sm-end mt-3 mt-sm-0">
                                                            <img src="{{ asset('admin/assets/images/cards/cod.png') }}" height="24" alt="COD-img" />
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="tab-pane fade" id="parentInfo">
                                                <div class="p-4">
                                                    ...
                                                    <div class="mt-4">
                                                        ...
                                                        <a href="{{ url('admin/apps-ecommerce-products-grid') }}" class="btn btn-link fw-semibold text-muted"><i class="ti ti-arrow-left me-1"></i> Continue Shopping</a>
                                                    </div>
                        ...
                        <div class="col-lg-4">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-center gap-3 mb-3">
                                        <img src="{{ asset('admin/assets/images/products/2.png') }}" class="me-1 rounded" width="42" alt="MacBook Air" />
                                        <div>
                                            <p class="mb-1 fw-semibold">
                                                <a href="{{ url('admin/apps-ecommerce-product-details') }}" class="link-reset">Apple MacBook Air M3 13”</a>
                                            </p>
                                    ...
                                    <div class="d-flex align-items-center gap-3 mb-3">
                                        <img src="{{ asset('admin/assets/images/products/5.png') }}" class="me-1 rounded" width="42" alt="Sony Headphones" />
                                        <div>
                                            <p class="mb-1 fw-semibold">
                                                <a href="{{ url('admin/apps-ecommerce-product-details') }}" class="link-reset">Sony WH-1000XM5 Wireless Headphones</a>
                                            </p>
                                    ...
                                    <div class="d-flex align-items-center gap-3">
                                        <img src="{{ asset('admin/assets/images/products/7.png') }}" class="me-1 rounded" width="42" alt="Apple Watch" />
                                        <div>
                                            <p class="mb-1 fw-semibold">
                                                <a href="{{ url('admin/apps-ecommerce-product-details') }}" class="link-reset">Apple Watch Series 9 GPS</a>
                                            </p>
...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-ecommerce-checkout.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:14 GMT -->
</html>
