...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-blog-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:46 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Blog List | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">List</h4>
                        </div>
                                    ...
                                    <div class="row g-5">
                                            ...
                                            <article class="card flex-md-row mb-3 border border-light">
                                                <div class="col-md-4">
                                                    <div class="position-relative h-100 overflow-hidden rounded-start">
                                                        ...
                                                        <img src="{{ asset('admin/assets/images/blog/blog-1.jpg') }}" class="w-100 h-100 object-fit-cover" alt="Building APIs" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-8 d-flex flex-column">
                                                    <div class="card-body">
                                                        ...
                                                        <h6 class="card-title fs-lg lh-base mb-2">
                                                            <a href="{{ url('admin/apps-blog-article') }}" class="link-reset">Building REST APIs with Node.js</a>
                                                        </h6>
                                                    ...
                                                    <div class="card-footer bg-transparent border-top mt-auto d-flex justify-content-between align-items-center">
                                                        ...
                                                        <a class="link-primary fw-semibold d-flex align-items-center gap-1" href="{{ url('admin/apps-blog-article') }}"> Read more <i class="ti ti-arrow-right"></i> </a>
                                                    </div>
                                                </div>
                                            </article>
                                            ...
                                            <article class="card flex-md-row mb-3 border border-light">
                                                <div class="col-md-4">
                                                    <div class="position-relative h-100 overflow-hidden rounded-start">
                                                        ...
                                                        <img src="{{ asset('admin/assets/images/blog/blog-2.jpg') }}" class="w-100 h-100 object-fit-cover" alt="UI Design Tips" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-8 d-flex flex-column">
                                                    <div class="card-body">
                                                        <h6 class="card-title fs-lg lh-base mb-2">
                                                            <a href="{{ url('admin/apps-blog-article') }}" class="link-reset">10 Essential UI Design Tips for Better User Experience</a>
                                                        </h6>
                                                        ...
                                                        <div>
                                                            <a href="#!" class="badge badge-label badge-default">Design</a>
                                                            <a href="#!" class="badge badge-label badge-default">UI/UX</a>
                                            ...
                                            <article class="card flex-md-row mb-3 border border-light">
                                                <div class="col-md-4">
                                                    <div class="position-relative h-100 overflow-hidden rounded-start">
                                                        ...
                                                        <img src="{{ asset('admin/assets/images/blog/blog-3.jpg') }}" class="w-100 h-100 object-fit-cover" alt="AI in Web Development" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-8 d-flex flex-column">
                                                    <div class="card-body">
                                                        <h6 class="card-title fs-lg lh-base mb-2">
                                                            <a href="{{ url('admin/apps-blog-article') }}" class="link-reset">How AI is Transforming Modern Web Development</a>
                                                        </h6>
                                                        ...
                                                        <div>
                                                            ...
                                                            <a href="#!" class="badge badge-label badge-default">Web</a>
                                                    ...
                                                    <div class="card-footer bg-transparent border-top mt-auto d-flex justify-content-between align-items-center">
                                                        <div class="d-flex align-items-center gap-2">
                                                            ...
                                                            <div>
                                                                <h5 class="text-nowrap fs-base mb-0 lh-base">
                                                                    <a href="#!" class="link-reset">Michael Brown</a>
                                                                </h5>
                                                            </div>
                                                        </div>
                                                        <a class="link-primary fw-semibold d-flex align-items-center gap-1" href="{{ url('admin/apps-blog-article') }}"> Read more <i class="ti ti-arrow-right"></i> </a>
                                            ...
                                            <article class="card flex-md-row mb-3 border border-light">
                                                <div class="col-md-4">
                                                    <div class="position-relative h-100 overflow-hidden rounded-start">
                                                        ...
                                                        <img src="{{ asset('admin/assets/images/blog/blog-4.jpg') }}" class="w-100 h-100 object-fit-cover" alt="Content Marketing Strategies" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-8 d-flex flex-column">
                                                    <div class="card-body">
                                                        <h6 class="card-title fs-lg lh-base mb-2">
                                                            <a href="{{ url('admin/apps-blog-article') }}" class="link-reset">Top 5 Content Marketing Strategies That Work in 2025</a>
                                                        </h6>
                                                        ...
                                                        <div>
                                                            ...
                                                            <a href="#!" class="badge badge-label badge-default">Strategy</a>
                                                        </div>
                                                    ...
                                                    <div class="card-footer bg-transparent border-top mt-auto d-flex justify-content-between align-items-center">
                                                        <div class="d-flex align-items-center gap-2">
                                                            ...
                                                            <div>
                                                                <h5 class="text-nowrap fs-base mb-0 lh-base">
                                                                    <a href="#!" class="link-reset">Emily Carter</a>
                                                                </h5>
                                                            </div>
                                                        </div>
                                                        <a class="link-primary fw-semibold d-flex align-items-center gap-1" href="{{ url('admin/apps-blog-article') }}"> Read more <i class="ti ti-arrow-right"></i> </a>
                                            ...
                                            <article class="card flex-md-row mb-3 border border-light">
                                                <div class="col-md-4">
                                                    <div class="position-relative h-100 overflow-hidden rounded-start">
                                                        ...
                                                        <img src="{{ asset('admin/assets/images/blog/blog-5.jpg') }}" class="w-100 h-100 object-fit-cover" alt="Startup Growth" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-8 d-flex flex-column">
                                                    <div class="card-body">
                                                        <h6 class="card-title fs-lg lh-base mb-2">
                                                            <a href="{{ url('admin/apps-blog-article') }}" class="link-reset">Scaling Your Startup: Lessons from Successful Founders</a>
                                                        </h6>
                                                    ...
                                                    <div class="card-footer bg-transparent border-top mt-auto d-flex justify-content-between align-items-center">
                                                        <div class="d-flex align-items-center gap-2">
                                                            ...
                                                            <div>
                                                                <h5 class="text-nowrap fs-base mb-0 lh-base">
                                                                    <a href="#!" class="link-reset">David Wilson</a>
                                                                </h5>
                                                            </div>
                                                        </div>
                                                        <a class="link-primary fw-semibold d-flex align-items-center gap-1" href="{{ url('admin/apps-blog-article') }}"> Read more <i class="ti ti-arrow-right"></i> </a>
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <div class="d-grid mb-4">
                                                <a href="{{ url('admin/apps-blog-add') }}" class="btn btn-primary btn-lg fs-base d-flex align-items-center justify-content-center gap-2"> <i class="ti ti-circle-dashed-plus"></i> Add New Article </a>
                                            </div>
                                            ...
                                            <div class="mb-5">
                                                ...
                                                <ul class="list-group list-group-flush">
                                                    <li class="list-group-item ps-0 d-flex justify-content-between align-items-center">
                                                        <a href="#" class="link-reset fw-medium"><i class="ti ti-folder me-2"></i>Development</a>
                                                        <span class="badge text-bg-light">12</span>
                                                    </li>
                                                    <li class="list-group-item ps-0 d-flex justify-content-between align-items-center">
                                                        <a href="#" class="link-reset fw-medium"><i class="ti ti-folder me-2"></i>Design</a>
                                                        <span class="badge text-bg-light">8</span>
                                                    </li>
                                                    <li class="list-group-item ps-0 d-flex justify-content-between align-items-center">
                                                        <a href="#" class="link-reset fw-medium"><i class="ti ti-folder me-2"></i>Marketing</a>
                                                        <span class="badge text-bg-light">5</span>
                                                    </li>
                                                    <li class="list-group-item ps-0 d-flex justify-content-between align-items-center">
                                                        <a href="#" class="link-reset fw-medium"><i class="ti ti-folder me-2"></i>Technology</a>
                                                        <span class="badge text-bg-light">9</span>
                                                    </li>
                                                    <li class="list-group-item ps-0 d-flex justify-content-between align-items-center">
                                                        <a href="#" class="link-reset fw-medium"><i class="ti ti-folder me-2"></i>Startup</a>
                                            ...
                                            <div class="mb-5">
                                                ...
                                                <ul class="list-group list-group-flush">
                                                    <li class="list-group-item ps-0">
                                                        <a href="#" class="link-reset fw-medium"><i class="ti ti-article me-2"></i>Unlocking the Secrets of Modern UI Design</a>
                                                    </li>
                                                    <li class="list-group-item ps-0">
                                                        <a href="#" class="link-reset fw-medium"><i class="ti ti-article me-2"></i>How to Build a Portfolio with Tailwind CSS</a>
                                                    </li>
                                                    <li class="list-group-item ps-0">
                                                        <a href="#" class="link-reset fw-medium"><i class="ti ti-article me-2"></i>Boost Productivity with These Web Dev Tools</a>
                                                    </li>
                                                    <li class="list-group-item ps-0">
                                                        <a href="#" class="link-reset fw-medium"><i class="ti ti-article me-2"></i>The Future of Frontend: Trends to Watch in 2025</a>
                                                    </li>
                                                    <li class="list-group-item ps-0">
                                                        <a href="#" class="link-reset fw-medium"><i class="ti ti-article me-2"></i>Essential Tips for Clean and Maintainable Code</a>
                                                    </li>
                                                </ul>
                                            </div>
...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-blog-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:48 GMT -->
</html>
