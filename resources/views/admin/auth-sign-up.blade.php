...
<!-- Mirrored from coderthemes.com/paces/bootstrap/auth-sign-up.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:59:04 GMT -->
<head>
        <meta charset="utf-8" />
                    ...
                    <div class="col-xxl-5 col-md-6 col-sm-8">
                        <div class="card p-4">
                            ...
                            <p class="text-muted text-center mt-4 mb-0">
                                ...
                                <a href="{{ url('admin/auth-sign-in') }}" class="text-decoration-underline link-offset-3 fw-semibold">Login</a>
                            </p>
                        </div>
