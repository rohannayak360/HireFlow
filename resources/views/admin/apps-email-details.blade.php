...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-email-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:37 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Design Reviews & Feedback | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Email Details</h4>
                        </div>
                        ...
                        <div class="card h-100 mb-0 rounded-start-0 flex-grow-1 border-start-0">
                            ...
                            <div class="card-header card-bg justify-content-between">
                                <div class="d-flex flex-wrap align-items-center gap-1">
                                    <!-- Back to Inbox -->
                                    <a href="{{ url('admin/apps-email-inbox') }}" class="btn btn-default btn-icon btn-sm" data-bs-toggle="tooltip" title="Back to Inbox">
                                ...
                                <div class="d-flex align-items-center gap-1">
                                    <button type="button" class="btn btn-icon btn-sm btn-ghost-secondary rounded-circle">
                                        <i class="ti ti-corner-up-right-double fs-xl"></i>
                                    </button>
                                ...
                                <div class="pb-3">
                                    <div class="d-flex align-items-center">
                                        <a class="d-flex align-items-center flex-grow-1 text-reset" data-bs-toggle="collapse" href="#EmailOne" role="button" aria-expanded="false" aria-controls="EmailOne">
                                            <img src="{{ asset('admin/assets/images/users/user-3.jpg') }}" class="avatar-md rounded-circle" alt="User Avatar" />
                                        ...
                                        <div class="mt-3">
                                            ...
                                            <div class="mt-2 d-flex flex-wrap gap-3">
                                                <div class="d-flex p-2 gap-2 align-items-center text-start position-relative border border-dashed rounded">
                                                    ...
                                                    <div>
                                                        <h4 class="fs-sm mb-1">
                                                            <a href="#!" class="link-reset stretched-link">testimonial-glitch.mp4</a>
                                                        </h4>
                                                        <p class="fs-xs mb-0">4.7 MB</p>
                                                    </div>
                                                    <i class="ti ti-download fs-24 text-muted"></i>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="py-3 border-top border-dashed">
                                    ...
                                    <div class="collapse show" id="EmailTwo">
                                        ...
                                        <div class="mt-3">
                                            ...
                                            <div class="mt-2 d-flex flex-wrap gap-3">
                                                <div class="d-flex p-2 gap-2 align-items-center text-start position-relative border border-dashed rounded">
                                                    <i class="ti ti-file fs-24 text-danger"></i>
                                                    <div>
                                                        <h4 class="fs-sm mb-1">
                                                            <a href="#!" class="link-reset stretched-link">footer-contrast-notes.pdf</a>
                                                        </h4>
                                                ...
                                                <div class="d-flex p-2 gap-3 align-items-center text-start position-relative border border-dashed rounded">
                                                    ...
                                                    <div>
                                                        <h4 class="fs-sm mb-1">
                                                            <a href="#!" class="link-reset stretched-link">responsive-issues.png</a>
                                                        </h4>
                                ...
                                <div class="d-flex flex-wrap align-items-center justify-content-between">
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <button class="btn btn-sm btn-default" type="button">
                                            <i class="ti ti-corner-up-right-double fs-lg"></i>
