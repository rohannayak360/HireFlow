...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-forum-view.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:49 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Forum | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Forum</h4>
                        </div>
                                    ...
                                    <div class="card mb-1">
                                        <div class="card-body">
                                            <div class="d-flex gap-4 align-items-center">
                                                ...
                                                <div class="flex-grow-1">
                                                    <!-- Category -->
                                                    <p class="text-muted text-uppercase mb-2 fs-sm fw-semibold">Development Talk</p>

                                                    <h4 class="fs-lg mb-2">
                                                        <a href="{{ url('admin/apps-forum-post') }}" class="link-reset">What's the best JavaScript framework in 2025?</a>
                                                    </h4>

                                                    <!-- Short Description -->
                                                    <p class="text-muted mb-0">With so many frameworks available, developers often debate which one offers the best balance of performance, scalability, and ease of use. Share your thoughts!</p>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- end card-body-->
                                        <div class="card-footer">
                                            <p class="d-flex flex-wrap gap-3 text-muted mb-0 align-items-center justify-content-between fs-sm">
                                                <span class="d-flex align-items-center gap-2">
                                                    <img src="{{ asset('admin/assets/images/users/user-5.jpg') }}" alt="avatar-5" class="img-fluid avatar-sm rounded" />
                                                    <span>
                                                ...
                                                <span class="d-flex align-items-center gap-1">
                                                    ...
                                                    <a href="#!" class="link-reset">Answers: 45</a>
                                                </span>
                                                <span class="d-flex align-items-center gap-1">
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex gap-4 align-items-center">
                                                <div class="flex-grow-1">
                                                    ...
                                                    <h4 class="fs-lg mb-2">
                                                        <a href="{{ url('admin/apps-forum-post') }}" class="link-reset">Should AI tools be regulated by governments?</a>
                                                    </h4>
                                                    <p class="text-muted mb-0">As AI becomes more powerful, discussions around ethics and control are growing. What’s your take on government involvement?</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="card-footer">
                                            <p class="d-flex flex-wrap gap-3 text-muted mb-0 align-items-center justify-content-between fs-sm">
                                                <span class="d-flex align-items-center gap-2">
                                                    <img src="{{ asset('admin/assets/images/users/user-8.jpg') }}" alt="avatar-8" class="img-fluid avatar-sm rounded" />
                                                    <span>
                                                ...
                                                <span class="d-flex align-items-center gap-1">
                                                    <i class="ti ti-messages"></i>
                                                    <a href="#!" class="link-reset">Answers: 62</a>
                                                </span>
                                                <span class="d-flex align-items-center gap-1">
                                                    <i class="ti ti-clock"></i>
                                                    Ends in: 4 days
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex gap-4 align-items-center">
                                                <div class="flex-grow-1">
                                                    ...
                                                    <h4 class="fs-lg mb-2">
                                                        <a href="{{ url('admin/apps-forum-post') }}" class="link-reset">Is minimalism still relevant in modern UI design?</a>
                                                    </h4>
                                                    <p class="text-muted mb-0">Clean interfaces have been a trend for years, but some argue they now lack innovation. What’s your opinion?</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="card-footer">
                                            <p class="d-flex flex-wrap gap-3 text-muted mb-0 align-items-center justify-content-between fs-sm">
                                                <span class="d-flex align-items-center gap-2">
                                                    <img src="{{ asset('admin/assets/images/users/user-2.jpg') }}" alt="avatar-2" class="img-fluid avatar-sm rounded" />
                                                    <span>
                                                ...
                                                <span class="d-flex align-items-center gap-1">
                                                    <i class="ti ti-messages"></i>
                                                    <a href="#!" class="link-reset">Answers: 31</a>
                                                </span>
                                                <span class="d-flex align-items-center gap-1">
                                                    <i class="ti ti-clock"></i>
                                                    Ends in: 2 days
                                                ...
                                                <span class="d-flex align-items-center gap-1">
                                                    <span class="badge text-bg-info">8</span>
                                                </span>
                                            </p>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex gap-4 align-items-center">
                                                <div class="flex-grow-1">
                                                    ...
                                                    <h4 class="fs-lg mb-2">
                                                        <a href="{{ url('admin/apps-forum-post') }}" class="link-reset">What’s better for growth: startups or large companies?</a>
                                                    </h4>
                                                    <p class="text-muted mb-0">Both have pros and cons—startups offer agility, while big companies provide stability. Which helped your career most?</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="card-footer">
                                            <p class="d-flex flex-wrap gap-3 text-muted mb-0 align-items-center justify-content-between fs-sm">
                                                <span class="d-flex align-items-center gap-2">
                                                    <img src="{{ asset('admin/assets/images/users/user-6.jpg') }}" alt="avatar-6" class="img-fluid avatar-sm rounded" />
                                                    <span>
                                                ...
                                                <span>
                                                    <i class="ti ti-messages"></i>
                                                    <a href="#!" class="link-reset">Answers: 50</a>
                                                </span>
                                                <span>
                                                    <i class="ti ti-clock"></i>
                                                    Ends in: 1 day
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex gap-4 align-items-center">
                                                <div class="flex-grow-1">
                                                    ...
                                                    <h4 class="fs-lg mb-2">
                                                        <a href="{{ url('admin/apps-forum-post') }}" class="link-reset">CI/CD or traditional release cycles: what works better?</a>
                                                    </h4>
                                                    <p class="text-muted mb-0">Continuous deployment speeds up delivery, but some teams prefer slower, stable releases. What’s your team's approach?</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="card-footer">
                                            <p class="d-flex flex-wrap gap-3 text-muted mb-0 align-items-center justify-content-between fs-sm">
                                                <span class="d-flex align-items-center gap-2">
                                                    <img src="{{ asset('admin/assets/images/users/user-4.jpg') }}" alt="avatar-4" class="img-fluid avatar-sm rounded" />
                                                    <span>
                                                ...
                                                <span class="d-flex align-items-center gap-1">
                                                    <i class="ti ti-messages"></i>
                                                    <a href="#!" class="link-reset">Answers: 76</a>
                                                </span>
                                                <span class="d-flex align-items-center gap-1">
                                                    <i class="ti ti-clock"></i>
                                                    Ends in: 6 days
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex gap-4 align-items-center">
                                                <div class="flex-grow-1">
                                                    ...
                                                    <h4 class="fs-lg mb-2">
                                                        <a href="{{ url('admin/apps-forum-post') }}" class="link-reset">What’s the best way to start contributing to open source?</a>
                                                    </h4>
                                                    <p class="text-muted mb-0">Many developers want to join the open-source movement but don’t know where to begin. What advice would you give?</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="card-footer">
                                            <p class="d-flex flex-wrap gap-3 text-muted mb-0 align-items-center justify-content-between fs-sm">
                                                <span class="d-flex align-items-center gap-2">
                                                    <img src="{{ asset('admin/assets/images/users/user-1.jpg') }}" alt="avatar-1" class="img-fluid avatar-sm rounded" />
                                                    <span>
                                                ...
                                                <span class="d-flex align-items-center gap-1">
                                                    <i class="ti ti-messages"></i>
                                                    <a href="#!" class="link-reset">Answers: 39</a>
                                                </span>
                                                <span class="d-flex align-items-center gap-1">
                                                    <i class="ti ti-clock"></i>
                                                    Ends in: 7 days
                                        ...
                                        <div class="card-body border-bottom border-dashed">
                                            ...
                                            <ul class="list-group list-group-flush fs-sm">
                                                <li class="list-group-item ps-0">
                                                    <a href="#" class="link-reset fw-medium">Development Talk</a>
                                                </li>
                                                <li class="list-group-item ps-0">
                                                    <a href="#" class="link-reset fw-medium">AI & Ethics</a>
                                                </li>
                                                <li class="list-group-item ps-0">
                                                    <a href="#" class="link-reset fw-medium">Product Design</a>
                                                </li>
                                                <li class="list-group-item ps-0">
                                                    <a href="#" class="link-reset fw-medium">Career Growth</a>
                                                </li>
                                                <li class="list-group-item ps-0">
                                                    <a href="#" class="link-reset fw-medium">Open Source</a>
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="card-body border-bottom border-dashed">
                                            ...
                                            <ul class="list-group list-group-flush fs-sm">
                                                <li class="list-group-item ps-0">
                                                    <a href="#" class="link-reset fw-medium">Unlocking the Secrets of Modern UI Design</a>
                                                </li>
                                                <li class="list-group-item ps-0">
                                                    <a href="#" class="link-reset fw-medium">How to Build a Portfolio with Tailwind CSS</a>
                                                </li>
                                                <li class="list-group-item ps-0">
                                                    <a href="#" class="link-reset fw-medium">Boost Productivity with These Web Dev Tools</a>
                                                </li>
                                                <li class="list-group-item ps-0">
                                                    <a href="#" class="link-reset fw-medium">The Future of Frontend: Trends to Watch in 2025</a>
                                                </li>
                                                <li class="list-group-item ps-0">
                                                    <a href="#" class="link-reset fw-medium">Essential Tips for Clean and Maintainable Code</a>
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="card-body">
