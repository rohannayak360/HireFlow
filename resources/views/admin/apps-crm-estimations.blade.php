...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-crm-estimations.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:29 GMT -->
<head>
        <meta charset="utf-8" />
        <title>CRM Estimations | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Estimations</h4>
                        </div>
                                        ...
                                        <table class="table table-custom table-centered table-select table-hover w-100 mb-0">
                                            ...
                                            <tbody class="text-nowrap">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#!" class="fw-semibold link-reset">#EST00042</a>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar-sm border flex-shrink-0 border-dashed rounded-circle me-2 justify-content-center d-flex align-items-center">
                                                                <img src="{{ asset('admin/assets/images/logos/airbnb.svg') }}" alt="Salesforce" height="20" />
                                                            </div>
                                                    ...
                                                    <td>
                                                        <div class="d-flex gap-2 align-items-center">
                                                            <img src="{{ asset('admin/assets/images/users/user-5.jpg') }}" alt="Jason Miller" class="avatar-xs rounded-circle" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#!" class="fw-semibold link-reset">#EST00043</a>
                                                    </td>
                                                    <td>Lead Tracking Module</td>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar-sm border flex-shrink-0 border-dashed rounded-circle me-2 justify-content-center d-flex align-items-center">
                                                                <img src="{{ asset('admin/assets/images/logos/amazon.svg') }}" alt="Zendesk" height="20" />
                                                            </div>
                                                    ...
                                                    <td>
                                                        <div class="d-flex gap-2 align-items-center">
                                                            <img src="{{ asset('admin/assets/images/users/user-4.jpg') }}" alt="Ava Green" class="avatar-xs rounded-circle" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#!" class="fw-semibold link-reset">#EST00044</a>
                                                    </td>
                                                    <td>Marketing Automation</td>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar-sm border flex-shrink-0 border-dashed rounded-circle me-2 justify-content-center d-flex align-items-center">
                                                                <img src="{{ asset('admin/assets/images/logos/apple.svg') }}" alt="HubSpot" height="20" />
                                                            </div>
                                                    ...
                                                    <td>
                                                        <div class="d-flex gap-2 align-items-center">
                                                            <img src="{{ asset('admin/assets/images/users/user-2.jpg') }}" alt="Liam Scott" class="avatar-xs rounded-circle" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#!" class="fw-semibold link-reset">#EST00045</a>
                                                    </td>
                                                    <td>Sales Pipeline Setup</td>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar-sm border flex-shrink-0 border-dashed rounded-circle me-2 justify-content-center d-flex align-items-center">
                                                                <img src="{{ asset('admin/assets/images/logos/asana.svg') }}" alt="Pipedrive" height="16" />
                                                            </div>
                                                    ...
                                                    <td>
                                                        <div class="d-flex gap-2 align-items-center">
                                                            <img src="{{ asset('admin/assets/images/users/user-3.jpg') }}" alt="Noah Carter" class="avatar-xs rounded-circle" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#!" class="fw-semibold link-reset">#EST00046</a>
                                                    </td>
                                                    <td>Support Portal Development</td>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar-sm border flex-shrink-0 border-dashed rounded-circle me-2 justify-content-center d-flex align-items-center">
                                                                <img src="{{ asset('admin/assets/images/logos/dropbox.svg') }}" alt="Intercom" height="20" />
                                                            </div>
                                                    ...
                                                    <td>
                                                        <div class="d-flex gap-2 align-items-center">
                                                            <img src="{{ asset('admin/assets/images/users/user-1.jpg') }}" alt="Emily Stone" class="avatar-xs rounded-circle" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#!" class="fw-semibold link-reset">#EST00047</a>
                                                    </td>
                                                    <td>Client Onboarding System</td>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar-sm border flex-shrink-0 border-dashed rounded-circle me-2 justify-content-center d-flex align-items-center">
                                                                <img src="{{ asset('admin/assets/images/logos/figma.svg') }}" alt="Freshdesk" height="20" />
                                                            </div>
                                                    ...
                                                    <td>
                                                        <div class="d-flex gap-2 align-items-center">
                                                            <img src="{{ asset('admin/assets/images/users/user-6.jpg') }}" alt="Sophia White" class="avatar-xs rounded-circle" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#!" class="fw-semibold link-reset">#EST00048</a>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar-sm border flex-shrink-0 border-dashed rounded-circle me-2 d-flex justify-content-center align-items-center">
                                                                <img src="{{ asset('admin/assets/images/logos/meta.svg') }}" alt="SAP" height="14" />
                                                            </div>
                                                    ...
                                                    <td>
                                                        <div class="d-flex gap-2 align-items-center">
                                                            <img src="{{ asset('admin/assets/images/users/user-7.jpg') }}" alt="Mason Lee" class="avatar-xs rounded-circle" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#!" class="fw-semibold link-reset">#EST00049</a>
                                                    </td>
                                                    <td>Workflow Automation Engine</td>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar-sm border flex-shrink-0 border-dashed rounded-circle me-2 d-flex justify-content-center align-items-center">
                                                                <img src="{{ asset('admin/assets/images/logos/slack.svg') }}" alt="Slack" height="20" />
                                                            </div>
                                                    ...
                                                    <td>
                                                        <div class="d-flex gap-2 align-items-center">
                                                            <img src="{{ asset('admin/assets/images/users/user-8.jpg') }}" alt="Olivia James" class="avatar-xs rounded-circle" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#!" class="fw-semibold link-reset">#EST00050</a>
                                                    </td>
                                                    <td>Partner API Integration</td>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar-sm border flex-shrink-0 border-dashed rounded-circle me-2 d-flex justify-content-center align-items-center">
                                                                <img src="{{ asset('admin/assets/images/logos/microsoft.svg') }}" alt="Zoom" height="16" />
                                                            </div>
                                                    ...
                                                    <td>
                                                        <div class="d-flex gap-2 align-items-center">
                                                            <img src="{{ asset('admin/assets/images/users/user-9.jpg') }}" alt="Ella Kim" class="avatar-xs rounded-circle" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#!" class="fw-semibold link-reset">#EST00051</a>
                                                    </td>
                                                    <td>Mobile CRM App Build</td>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar-sm border flex-shrink-0 border-dashed rounded-circle me-2 d-flex justify-content-center align-items-center">
                                                                <img src="{{ asset('admin/assets/images/logos/openai.svg') }}" alt="Airtable" height="20" />
                                                            </div>
                                                    ...
                                                    <td>
                                                        <div class="d-flex gap-2 align-items-center">
                                                            <img src="{{ asset('admin/assets/images/users/user-10.jpg') }}" alt="Daniel Park" class="avatar-xs rounded-circle" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#!" class="fw-semibold link-reset">#EST00052</a>
                                                    </td>
                                                    <td>Smart Contact Syncing</td>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar-sm border flex-shrink-0 border-dashed rounded-circle me-2 d-flex justify-content-center align-items-center">
                                                                <img src="{{ asset('admin/assets/images/logos/shell.svg') }}" alt="Zoho" height="20" />
                                                            </div>
                                                    ...
                                                    <td>
                                                        <div class="d-flex gap-2 align-items-center">
                                                            <img src="{{ asset('admin/assets/images/users/user-4.jpg') }}" alt="Chloe Nguyen" class="avatar-xs rounded-circle" />
