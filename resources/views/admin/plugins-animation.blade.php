...
<!-- Mirrored from coderthemes.com/paces/bootstrap/plugins-animation.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:59:02 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Animation | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Animation</h4>
                        </div>
                                            ...
                                            <div class="card card-top-sticky overflow-hidden">
                                                <div class="card-body">
                                                    <div id="animation_box" class="animate__animated">
                                                        <img src="{{ asset('admin/assets/images/blog/blog-1.jpg') }}" class="img-fluid rounded" alt="user" />
                                                    </div>
                                            ...
                                            <div class="accordion" id="animationAccordion">
                                                ...
                                                <div class="accordion-item">
                                                    <h2 class="accordion-header" id="headingAttention">
                                                        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseAttention">Attention Seekers</button>
                                                    </h2>
                                                ...
                                                <div class="accordion-item">
                                                    <h2 class="accordion-header" id="headingBounceIn">
                                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseBounceIn">Bouncing Entrances</button>
                                                    </h2>
                                                ...
                                                <div class="accordion-item">
                                                    <h2 class="accordion-header" id="headingFadeIn">
                                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFadeIn">Fading Entrances</button>
                                                    </h2>
                                                ...
                                                <div class="accordion-item">
                                                    <h2 class="accordion-header" id="headingFadeOut">
                                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFadeOut">Fading Exits</button>
                                                    </h2>
                                                ...
                                                <div class="accordion-item">
                                                    <h2 class="accordion-header" id="headingFlip">
                                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFlip">Flippers</button>
                                                    </h2>
                                                ...
                                                <div class="accordion-item">
                                                    <h2 class="accordion-header" id="headingLightSpeed">
                                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseLightSpeed">Light Speed</button>
                                                    </h2>
                                                ...
                                                <div class="accordion-item">
                                                    <h2 class="accordion-header" id="headingRotate">
                                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseRotate">Rotate</button>
                                                    </h2>
                                                ...
                                                <div class="accordion-item">
                                                    <h2 class="accordion-header" id="headingZoom">
                                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseZoom">Zoom</button>
                                                    </h2>
                                                ...
                                                <div class="accordion-item">
                                                    <h2 class="accordion-header" id="headingSlide">
                                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSlide">Sliding</button>
                                                    </h2>
                                                ...
                                                <div class="accordion-item">
                                                    <h2 class="accordion-header" id="headingSpecial">
                                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSpecial">Special</button>
                                                    </h2>
...
<script src="{{ asset('admin/assets/js/app.js') }}"></script>
        ...
        <script src="{{ asset('admin/assets/js/pages/plugins-animation.js') }}"></script>
    </body>
