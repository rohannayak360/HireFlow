...
<!-- Mirrored from coderthemes.com/paces/bootstrap/form-other-plugin.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:59:50 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Other Plugins | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Other Plugins</h4>
                        </div>
                        ...
                        <div class="text-end">
                            <ol class="breadcrumb m-0 py-0">
                                ...
                                <li class="breadcrumb-item active">Other Plugins</li>
                            </ol>
                        </div>
                    </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="input-group" data-touchspin>
                                                <button type="button" class="btn btn-light floating" data-minus>
                                                    <i class="ti ti-minus"></i>
                                                </button>
                                                <input type="number" class="form-control form-control-sm border-0" value="1" max="800000" />
                                                <button type="button" class="btn btn-light floating" data-plus>
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="input-group mt-2" data-touchspin>
                                                <button type="button" class="btn btn-secondary floating" data-minus>
                                                    <i class="ti ti-minus"></i>
                                                </button>
                                                <input type="number" class="form-control form-control-sm border-0" value="100" max="800000" />
                                                <button type="button" class="btn btn-secondary floating" data-plus>
                                                    <i class="ti ti-plus"></i>
                                                </button>
                                            </div>

                                            <div class="input-group mt-2" data-touchspin>
                                                <button type="button" class="btn btn-info floating" data-minus>
                                                    <i class="ti ti-minus"></i>
                                                </button>
                                                <input type="number" class="form-control form-control-sm border-0" value="100" max="800000" />
                                                <button type="button" class="btn btn-info floating" data-plus>
                                                    <i class="ti ti-plus"></i>
                                                </button>
                                            </div>

                                            <div class="input-group mt-2" data-touchspin>
                                                <button type="button" class="btn btn-success floating" data-minus>
                                                    <i class="ti ti-minus"></i>
                                                </button>
                                                <input type="number" class="form-control form-control-sm border-0" value="100" max="800000" />
                                                <button type="button" class="btn btn-success floating" data-plus>
                                                    <i class="ti ti-plus"></i>
                                                </button>
                                            </div>

                                            <div class="input-group mt-2" data-touchspin>
                                                <button type="button" class="btn btn-warning floating" data-minus>
                                                    <i class="ti ti-minus"></i>
                                                </button>
                                                <input type="number" class="form-control form-control-sm border-0" value="100" max="800000" />
                                                <button type="button" class="btn btn-warning floating" data-plus>
                                                    <i class="ti ti-plus"></i>
                                                </button>
                                            </div>

                                            <div class="input-group mt-2" data-touchspin>
                                                <button type="button" class="btn btn-danger floating" data-minus>
                                                    <i class="ti ti-minus"></i>
                                                </button>
                                                <input type="number" class="form-control form-control-sm border-0" value="100" max="800000" />
                                                <button type="button" class="btn btn-danger floating" data-plus>
                                                    <i class="ti ti-plus"></i>
                                                </button>
                                            </div>

                                            <div class="input-group mt-2" data-touchspin>
                                                <button type="button" class="btn btn-dark floating" data-minus>
                                                    <i class="ti ti-minus"></i>
                                                </button>
                                                <input type="number" class="form-control form-control-sm border-0" value="100" max="800000" />
                                                <button type="button" class="btn btn-dark floating" data-plus>
                                                    <i class="ti ti-plus"></i>
                                                </button>
                                            </div>

                                            <div class="input-group mt-2" data-touchspin>
                                                <button type="button" class="btn btn-purple floating" data-minus>
                                                    <i class="ti ti-minus"></i>
                                                </button>
                                                <input type="number" class="form-control form-control-sm border-0" value="100" max="800000" />
                                                <button type="button" class="btn btn-purple floating" data-plus>
                                                    <i class="ti ti-plus"></i>
                                                </button>
                                            </div>

                                            <div class="input-group mt-2" data-touchspin>
                                                <button type="button" class="btn btn-soft-primary floating" data-minus>
                                                    <i class="ti ti-minus"></i>
                                                </button>
                                                <input type="number" class="form-control form-control-sm border-0" value="100" max="800000" />
                                                <button type="button" class="btn btn-soft-primary floating" data-plus>
                                                    <i class="ti ti-plus"></i>
                                                </button>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="input-group" data-touchspin>
                                                <button type="button" class="btn btn-light floating" data-minus disabled>
                                                    <i class="ti ti-minus"></i>
                                                </button>
                                                <input type="number" class="form-control form-control-sm border-0" value="1" max="800000" disabled />
                                                <button type="button" class="btn btn-light floating" data-plus disabled>
                                                    <i class="ti ti-plus"></i>
                                                </button>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="input-group" data-touchspin>
                                                <button type="button" class="btn btn-primary rounded-circle floating" data-minus>
                                                    <i class="ti ti-minus"></i>
                                                </button>
                                                <input type="number" class="form-control form-control-sm border-0" value="100" max="800000" />
                                                <button type="button" class="btn btn-primary rounded-circle floating" data-plus>
                                                    <i class="ti ti-plus"></i>
                                                </button>
                                            </div>
                                            ...
                                            <div class="input-group border-0 mt-2" data-touchspin>
                                                <button type="button" class="btn btn-outline-secondary" data-minus>
                                                    <i class="ti ti-minus"></i>
                                                </button>
                                                <input type="number" class="form-control border-secondary" value="2" min="0" max="100" />
                                                <button type="button" class="btn btn-outline-secondary" data-plus>
                                                    <i class="ti ti-plus"></i>
                                                </button>
                                            </div>

                                            <div class="input-group border-0 mt-2" data-touchspin>
                                                <button type="button" class="btn btn-soft-success" data-minus>
                                                    <i class="ti ti-minus"></i>
                                                </button>
                                                <input type="number" class="form-control border-success-subtle" value="2" min="0" max="100" />
                                                <button type="button" class="btn btn-soft-success" data-plus>
                                                    <i class="ti ti-plus"></i>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="input-group input-group-sm" data-touchspin>
                                                <div class="btn-group-vertical">
                                                    ...
                                                    <button type="button" class="btn btn-soft-danger" data-minus>
                                                        <i class="ti ti-minus"></i>
                                                    </button>
                                                </div>
                                            ...
                                            <div class="input-group mt-2" data-touchspin>
                                                <div class="btn-group-vertical">
                                                    <button type="button" class="btn btn-success" data-plus>
                                                        <i class="ti ti-plus"></i>
                                                    </button>
                                                    <button type="button" class="btn btn-danger" data-minus>
                                                        <i class="ti ti-minus"></i>
                                                    </button>
                                                </div>
                                                <input type="number" class="form-control border-0" value="1" min="0" max="10" />
                                            ...
                                            <div class="input-group input-group-lg mt-2" data-touchspin>
                                                <div class="btn-group-vertical">
                                                    <button type="button" class="btn btn-dark" data-plus>
                                                        <i class="ti ti-plus"></i>
                                                    </button>
                                                    <button type="button" class="btn btn-dark" data-minus>
                                                        <i class="ti ti-minus"></i>
                                                    </button>
                                                </div>
                                                <input type="number" class="form-control border-0" value="1" min="0" max="10" />
...
<script src="{{ asset('admin/assets/js/app.js') }}"></script>
        ...
        <!-- InputMask Plugin js -->
        <script src="{{ asset('admin/assets/plugins/inputmask/inputmask.min.js') }}"></script>

        <!-- Jquery for Typehead-->
        <script src="{{ asset('admin/assets/plugins/jquery/jquery.min.js') }}"></script>

        <!-- Typehead Plugin js -->
        <script src="{{ asset('admin/assets/plugins/handlebars/handlebars.min.js') }}"></script>
        <script src="{{ asset('admin/assets/plugins/typeahead/typeahead.bundle.min.js') }}"></script>

        <!-- Inputmask Demo js -->
        <script src="{{ asset('admin/assets/js/pages/form-inputmask.js') }}"></script>

        <!-- Typehead Demo js -->
        <script src="{{ asset('admin/assets/js/pages/form-typehead.js') }}"></script>
    </body>

<!-- Mirrored from coderthemes.com/paces/bootstrap/form-other-plugin.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:59:51 GMT -->
</html>
