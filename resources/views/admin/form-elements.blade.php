...
<!-- Mirrored from coderthemes.com/paces/bootstrap/form-elements.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:59:39 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Form Elements | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Basic Elements</h4>
                        </div>
                                                ...
                                                <div class="col-lg-8">
                                                    <div class="input-group" data-password>
                                                        ...
                                                        <div class="input-group-text password-eye" data-password="false">
                                                            <i class="ti ti-eye d-block eye-icon" data-pass="show"></i>
                                                            <i class="ti ti-eye-off d-none eye-icon" data-pass="hide"></i>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row g-lg-4 g-2">
                                                ...
                                                <div class="col-lg-8">
                                                    <div class="input-group">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item" href="%21.html#">Action</a>
                                                            <a class="dropdown-item" href="%21.html#">Another action</a>
                                                            <a class="dropdown-item" href="%21.html#">Something else here</a>
                                                        </div>
...
<script src="{{ asset('admin/assets/js/app.js') }}"></script>
        ...
        <script src="{{ asset('admin/assets/js/pages/form-elements.js') }}"></script>
    </body>
