...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-ecommerce-warehouse.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:19 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Warehouse | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Warehouse</h4>
                        </div>
                            ...
                            <div data-table data-table-rows-per-page="10" class="card">
                                <div class="card-header border-light justify-content-between">
                                    ...
                                    <div class="d-flex align-items-center gap-2 flex-wrap">
                                        ...
                                        <div class="app-search">
                                            <select data-table-filter="warehouse-status" class="form-select form-control my-1 my-md-0">
                                        ...
                                        <!-- Location Filter -->
                                        <div class="app-search">
                                            <select data-table-filter="warehouse-location" class="form-select form-control my-1 my-md-0">
                                    ...
                                    <div class="d-flex gap-1">
                                        <!-- Add New Button -->
                                        <a href="#addWarehouseModal" class="btn btn-danger ms-1" data-bs-toggle="modal"> <i class="ti ti-plus fs-sm me-2"></i> Add New </a>
                                    </div>
                                </div>
                                    ...
                                    <table class="table table-custom table-centered table-select table-hover w-100 mb-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="avatar avatar-sm">
                                                            <img src="{{ asset('admin/assets/images/users/user-1.jpg') }}" alt="avatar-1" class="img-fluid rounded-circle" />
                                                        </div>
                                                        <div>
                                                ...
                                                <td><a href="tel:+14165559876" class="text-reset">+1 416 555 9876</a></td>
                                                <td>95,000 sq.ft</td>
                                                <td>38,240 units</td>
                                                <td>12,680 units</td>
                                                <td>$1.28M</td>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-center gap-1">
                                                        ...
                                                        <a href="#" class="btn btn-default btn-icon btn-sm" data-table-delete-row><i class="ti ti-trash fs-lg"></i></a>
                                                    </div>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="tel:+14165551234" class="text-reset">+1 416 555 1234</a></td>
                                                <td>68,000 sq.ft</td>
                                                <td>22,500 units</td>
                                                <td>9,340 units</td>
                                                <td>$870K</td>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="tel:+13105557654" class="text-reset">+1 310 555 7654</a></td>
                                                <td>120,000 sq.ft</td>
                                                <td>51,800 units</td>
                                                <td>14,250 units</td>
                                                <td>$1.94M</td>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="tel:+49301234567" class="text-reset">+49 30 1234 567</a></td>
                                                <td>88,000 sq.ft</td>
                                                <td>29,400 units</td>
                                                <td>10,200 units</td>
                                                <td>$980K</td>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="tel:+6567892345" class="text-reset">+65 6789 2345</a></td>
                                                <td>102,000 sq.ft</td>
                                                <td>47,600 units</td>
                                                <td>8,700 units</td>
                                                <td>$1.15M</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="avatar avatar-sm">
                                                            <img src="{{ asset('admin/assets/images/users/user-6.jpg') }}" alt="avatar-6" class="img-fluid rounded-circle" />
                                                        </div>
                                                        <div>
                                                ...
                                                <td><a href="tel:+97145567890" class="text-reset">+971 4 556 7890</a></td>
                                                <td>77,000 sq.ft</td>
                                                <td>33,900 units</td>
                                                <td>7,850 units</td>
                                                <td>$940K</td>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="tel:+551112345678" class="text-reset">+55 11 1234 5678</a></td>
                                                <td>90,000 sq.ft</td>
                                                <td>41,200 units</td>
                                                <td>11,800 units</td>
                                                <td>$1.02M</td>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="tel:+27115555678" class="text-reset">+27 11 555 5678</a></td>
                                                <td>85,000 sq.ft</td>
                                                <td>36,900 units</td>
                                                <td>9,900 units</td>
                                                <td>$895K</td>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="tel:+14165553456" class="text-reset">+1 416 555 3456</a></td>
                                                <td>92,000 sq.ft</td>
                                                <td>40,850 units</td>
                                                <td>10,600 units</td>
                                                <td>$1.12M</td>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="tel:+61298765432" class="text-reset">+61 2 9876 5432</a></td>
                                                <td>105,000 sq.ft</td>
                                                <td>50,200 units</td>
                                                <td>12,450 units</td>
                                                <td>$1.35M</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="avatar avatar-sm">
                                                            <img src="{{ asset('admin/assets/images/users/user-1.jpg') }}" alt="avatar-11" class="img-fluid rounded-circle" />
                                                        </div>
                                                        <div>
                                                ...
                                                <td><a href="tel:+46855667890" class="text-reset">+46 8 5566 7890</a></td>
                                                <td>80,000 sq.ft</td>
                                                <td>34,500 units</td>
                                                <td>7,450 units</td>
                                                <td>$880K</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="avatar avatar-sm">
                                                            <img src="{{ asset('admin/assets/images/users/user-7.jpg') }}" alt="avatar-12" class="img-fluid rounded-circle" />
                                                        </div>
                                                        <div>
                                                ...
                                                <td><a href="tel:+77272345678" class="text-reset">+7 727 234 5678</a></td>
                                                <td>70,000 sq.ft</td>
                                                <td>28,300 units</td>
                                                <td>8,200 units</td>
                                                <td>$760K</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="avatar avatar-sm">
                                                            <img src="{{ asset('admin/assets/images/users/user-4.jpg') }}" alt="avatar-13" class="img-fluid rounded-circle" />
                                                        </div>
                                                        <div>
                                                ...
                                                <td><a href="tel:+81678901234" class="text-reset">+81 6 7890 1234</a></td>
                                                <td>99,000 sq.ft</td>
                                                <td>45,900 units</td>
                                                <td>11,600 units</td>
                                                <td>$1.22M</td>
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title fw-semibold" id="addWarehouseModalLabel"><i class="ti ti-building me-2 text-danger"></i> Add New Warehouse</h5>
                                ...
                                <form action="#!" method="post">
                                    <div class="modal-body">
                                        <div class="row g-3">
                                            <!-- Warehouse ID -->
                                            <div class="col-md-6">
                                                <label for="warehouseId" class="form-label fw-semibold">Warehouse ID</label>
                                                <input type="text" id="warehouseId" class="form-control" placeholder="#WH-002" />
                                            </div>

                                            <!-- Warehouse Name -->
                                            <div class="col-md-6">
                                                <label for="warehouseName" class="form-label fw-semibold">Warehouse Name</label>
                                                <input type="text" id="warehouseName" class="form-control" placeholder="North Region Hub" />
                                            </div>

                                            <!-- Location -->
                                            <div class="col-md-6">
                                                <label for="warehouseLocation" class="form-label fw-semibold">Location</label>
                                                <input type="text" id="warehouseLocation" class="form-control" placeholder="Los Angeles, USA" />
                                            </div>

                                            <!-- Manager -->
                                            <div class="col-md-6">
                                                <label for="warehouseManager" class="form-label fw-semibold">Manager Name</label>
                                                <input type="text" id="warehouseManager" class="form-control" placeholder="Liam Parker" />
                                            </div>

                                            <!-- Manager Email -->
                                            <div class="col-md-6">
                                                <label for="warehouseEmail" class="form-label fw-semibold">Manager Email</label>
                                                <input type="email" id="warehouseEmail" class="form-control" placeholder="liam.parker&#64;company.com" />
                                            </div>

                                            <!-- Contact Number -->
                                            <div class="col-md-6">
                                                <label for="warehousePhone" class="form-label fw-semibold">Contact Number</label>
                                                <input type="tel" id="warehousePhone" class="form-control" placeholder="+1 212 555 0184" />
                                            </div>

                                            <!-- Area -->
                                            <div class="col-md-6">
                                                <label for="warehouseArea" class="form-label fw-semibold">Total Area</label>
                                                <input type="text" id="warehouseArea" class="form-control" placeholder="85,000 sq.ft" />
                                            </div>

                                            <!-- Capacity -->
                                            <div class="col-md-6">
                                                <label for="warehouseCapacity" class="form-label fw-semibold">Total Capacity</label>
                                                <input type="text" id="warehouseCapacity" class="form-control" placeholder="40,000 units" />
                                            </div>

                                            <!-- Current Stock -->
                                            <div class="col-md-6">
                                                <label for="warehouseStock" class="form-label fw-semibold">Current Stock</label>
                                                <input type="text" id="warehouseStock" class="form-control" placeholder="12,500 units" />
                                            </div>

                                            <!-- Asset Value -->
                                            <div class="col-md-6">
                                                <label for="warehouseValue" class="form-label fw-semibold">Asset Value</label>
                                                <div class="input-group">
                                                    <span class="input-group-text">$</span>
                                                    <input type="number" id="warehouseValue" class="form-control" placeholder="1.25M" />
                                                </div>
                                            </div>

                                            <!-- Status -->
                                            <div class="col-md-6">
                                                <label for="warehouseStatus" class="form-label fw-semibold">Status</label>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="submit" class="btn btn-danger"><i class="ti ti-check me-1"></i> Save Warehouse</button>
                                    </div>
                                </form>
                            </div>
                        </div>
