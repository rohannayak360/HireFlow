...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-ecommerce-product-views.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:19 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Product Views | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Product Views</h4>
                        </div>
                        ...
                        <div class="text-end">
                            <ol class="breadcrumb m-0 py-0">
                                ...
                                <li class="breadcrumb-item active">Product Views</li>
                            </ol>
                        </div>
                    </div>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar-md me-3">
                                                            <img src="{{ asset('admin/assets/images/products/2.png') }}" alt="Product" class="img-fluid rounded" />
                                                        </div>
                                                        <div>
                                                            <h5 class="mb-0">
                                                                <a data-sort="product" href="{{ url('admin/apps-ecommerce-product-details') }}" class="link-reset">Smart Fitness Watch</a>
                                                            </h5>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    <span class="ms-1"><a href="{{ url('admin/apps-ecommerce-reviews') }}" data-sort="rating" class="link-reset fw-semibold">(54)</a></span>
                                                </td>
                                                <td>45.2k</td>
                                                <td>820</td>
                                                <td>7.3%</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar-md me-3">
                                                            <img src="{{ asset('admin/assets/images/products/3.png') }}" alt="Product" class="img-fluid rounded" />
                                                        </div>
                                                        <div>
                                                            <h5 class="mb-0">
                                                                <a data-sort="product" href="{{ url('admin/apps-ecommerce-product-details') }}" class="link-reset">Portable Bluetooth Speaker</a>
                                                            </h5>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    <span class="ms-1"><a href="{{ url('admin/apps-ecommerce-reviews') }}" data-sort="rating" class="link-reset fw-semibold">(31)</a></span>
                                                </td>
                                                <td>28.9k</td>
                                                <td>410</td>
                                                <td>5.8%</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar-md me-3">
                                                            <img src="{{ asset('admin/assets/images/products/4.png') }}" alt="Product" class="img-fluid rounded" />
                                                        </div>
                                                        <div>
                                                            <h5 class="mb-0"><a data-sort="product" href="{{ url('admin/apps-ecommerce-product-details') }}" class="link-reset">Gaming Mouse</a></h5>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>GM-77215</td>
                                                <td>$49.99</td>
                                                <td>
                                                    <span class="text-warning"> <i class="ti ti-star-filled"></i><i class="ti ti-star-filled"></i><i class="ti ti-star-filled"></i><i class="ti ti-star-filled"></i><i class="ti ti-star"></i> </span>
                                                    <span class="ms-1"><a href="{{ url('admin/apps-ecommerce-reviews') }}" data-sort="rating" class="link-reset fw-semibold">(67)</a></span>
                                                </td>
                                                <td>22.4k</td>
                                                <td>340</td>
                                                <td>6.4%</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar-md me-3">
                                                            <img src="{{ asset('admin/assets/images/products/5.png') }}" alt="Product" class="img-fluid rounded" />
                                                        </div>
                                                        <div>
                                                            <h5 class="mb-0"><a data-sort="product" href="{{ url('admin/apps-ecommerce-product-details') }}" class="link-reset">Noise Cancelling Headphones</a></h5>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>NC-88321</td>
                                                <td>$199.00</td>
                                                <td>
                                                    <span class="text-warning"> <i class="ti ti-star-filled"></i><i class="ti ti-star-filled"></i><i class="ti ti-star-filled"></i><i class="ti ti-star-filled"></i><i class="ti ti-star-filled"></i> </span>
                                                    <span class="ms-1"><a href="{{ url('admin/apps-ecommerce-reviews') }}" data-sort="rating" class="link-reset fw-semibold">(128)</a></span>
                                                </td>
                                                <td>60.1k</td>
                                                <td>1500</td>
                                                <td>9.8%</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar-md me-3">
                                                            <img src="{{ asset('admin/assets/images/products/6.png') }}" alt="Product" class="img-fluid rounded" />
                                                        </div>
                                                        <div>
                                                            <h5 class="mb-0"><a data-sort="product" href="{{ url('admin/apps-ecommerce-product-details') }}" class="link-reset">4K Action Camera</a></h5>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>AC-90763</td>
                                                ...
                                                <td>
                                                    <span class="text-warning"> <i class="ti ti-star-filled"></i><i class="ti ti-star-filled"></i><i class="ti ti-star-filled"></i><i class="ti ti-star-filled"></i><i class="ti ti-star"></i> </span>
                                                    <span class="ms-1"><a href="{{ url('admin/apps-ecommerce-reviews') }}" data-sort="rating" class="link-reset fw-semibold">(94)</a></span>
                                                </td>
                                                <td>18.9k</td>
                                                <td>610</td>
                                                <td>6.0%</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar-md me-3">
                                                            <img src="{{ asset('admin/assets/images/products/7.png') }}" alt="Product" class="img-fluid rounded" />
                                                        </div>
                                                        <div>
                                                            <h5 class="mb-0"><a data-sort="product" href="{{ url('admin/apps-ecommerce-product-details') }}" class="link-reset">Wireless Charger Pad</a></h5>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>WC-23815</td>
                                                <td>$39.95</td>
                                                <td>
                                                    <span class="text-warning"> <i class="ti ti-star-filled"></i><i class="ti ti-star-filled"></i><i class="ti ti-star-filled"></i><i class="ti ti-star"></i><i class="ti ti-star"></i> </span>
                                                    <span class="ms-1"><a href="{{ url('admin/apps-ecommerce-reviews') }}" data-sort="rating" class="link-reset fw-semibold">(41)</a></span>
                                                </td>
                                                <td>12.3k</td>
                                                <td>220</td>
                                                <td>4.1%</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar-md me-3">
                                                            <img src="{{ asset('admin/assets/images/products/8.png') }}" alt="Product" class="img-fluid rounded" />
                                                        </div>
                                                        <div>
                                                            <h5 class="mb-0"><a data-sort="product" href="{{ url('admin/apps-ecommerce-product-details') }}" class="link-reset">Mechanical Keyboard</a></h5>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>MK-48519</td>
                                                ...
                                                <td>
                                                    <span class="text-warning"> <i class="ti ti-star-filled"></i><i class="ti ti-star-filled"></i><i class="ti ti-star-filled"></i><i class="ti ti-star-filled"></i><i class="ti ti-star"></i> </span>
                                                    <span class="ms-1"><a href="{{ url('admin/apps-ecommerce-reviews') }}" data-sort="rating" class="link-reset fw-semibold">(77)</a></span>
                                                </td>
                                                <td>30.5k</td>
                                                <td>540</td>
                                                <td>7.2%</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar-md me-3">
                                                            <img src="{{ asset('admin/assets/images/products/9.png') }}" alt="Product" class="img-fluid rounded" />
                                                        </div>
                                                        <div>
                                                            <h5 class="mb-0"><a data-sort="product" href="{{ url('admin/apps-ecommerce-product-details') }}" class="link-reset">Drone with Camera</a></h5>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>DR-61208</td>
                                                ...
                                                <td>
                                                    <span class="text-warning"> <i class="ti ti-star-filled"></i><i class="ti ti-star-filled"></i><i class="ti ti-star-filled"></i><i class="ti ti-star-filled"></i><i class="ti ti-star-filled"></i> </span>
                                                    <span class="ms-1"><a href="{{ url('admin/apps-ecommerce-reviews') }}" data-sort="rating" class="link-reset fw-semibold">(189)</a></span>
                                                </td>
                                                <td>75.9k</td>
                                                <td>1900</td>
                                                <td>10.2%</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar-md me-3">
                                                            <img src="{{ asset('admin/assets/images/products/10.png') }}" alt="Product" class="img-fluid rounded" />
                                                        </div>
                                                        <div>
                                                            <h5 class="mb-0"><a data-sort="product" href="{{ url('admin/apps-ecommerce-product-details') }}" class="link-reset">Smart Home Hub</a></h5>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>SH-30051</td>
                                                ...
                                                <td>
                                                    <span class="text-warning"> <i class="ti ti-star-filled"></i><i class="ti ti-star-filled"></i><i class="ti ti-star-filled"></i><i class="ti ti-star"></i><i class="ti ti-star"></i> </span>
                                                    <span class="ms-1"><a href="{{ url('admin/apps-ecommerce-reviews') }}" data-sort="rating" class="link-reset fw-semibold">(58)</a></span>
                                                </td>
                                                <td>21.7k</td>
                                                <td>470</td>
                                                <td>5.5%</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar-md me-3">
                                                            <img src="{{ asset('admin/assets/images/products/1.png') }}" alt="Product" class="img-fluid rounded" />
                                                        </div>
                                                        <div>
                                                            <h5 class="mb-0"><a data-sort="product" href="{{ url('admin/apps-ecommerce-product-details') }}" class="link-reset">Mini Projector</a></h5>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>MP-12081</td>
                                                ...
                                                <td>
                                                    <span class="text-warning"> <i class="ti ti-star-filled"></i><i class="ti ti-star-filled"></i><i class="ti ti-star-filled"></i><i class="ti ti-star"></i><i class="ti ti-star"></i> </span>
                                                    <span class="ms-1"><a href="{{ url('admin/apps-ecommerce-reviews') }}" data-sort="rating" class="link-reset fw-semibold">(35)</a></span>
                                                </td>
                                                <td>15.9k</td>
                                                <td>310</td>
                                                <td>4.7%</td>
...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-ecommerce-product-views.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:20 GMT -->
</html>
