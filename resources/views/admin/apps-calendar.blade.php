...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-calendar.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:43 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Calendar | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Calendar</h4>
                        </div>
...
<script src="{{ asset('admin/assets/js/app.js') }}"></script>
        ...
        <!-- Fullcalendar js -->
        <script src="{{ asset('admin/assets/plugins/fullcalendar/index.global.min.js') }}"></script>

        <!-- Calendar App Demo js -->
        <script src="{{ asset('admin/assets/js/pages/apps-calendar.js') }}"></script>
    </body>
