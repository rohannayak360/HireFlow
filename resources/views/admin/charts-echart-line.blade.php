...
<!-- Mirrored from coderthemes.com/paces/bootstrap/charts-echart-line.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:59:30 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Echart Line Chart | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Line Echart</h4>
                        </div>
                        ...
                        <div class="text-end">
                            <ol class="breadcrumb m-0 py-0">
                                ...
                                <li class="breadcrumb-item active">Line Echart</li>
                            </ol>
                        </div>
                    </div>
...
<script src="{{ asset('admin/assets/js/app.js') }}"></script>
        ...
        <!-- E Charts Demo js -->
        <script src="{{ asset('admin/assets/js/pages/chart-echart-line.js') }}"></script>
    </body>

<!-- Mirrored from coderthemes.com/paces/bootstrap/charts-echart-line.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:59:32 GMT -->
</html>
