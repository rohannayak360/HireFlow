...
<!-- Mirrored from coderthemes.com/paces/bootstrap/charts-echart-geo-map.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:59:33 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Echart GEO Map | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">GEO Maps</h4>
                        </div>
                        ...
                        <div class="text-end">
                            <ol class="breadcrumb m-0 py-0">
                                ...
                                <li class="breadcrumb-item active">GEO Maps</li>
                            </ol>
                        </div>
                    </div>
...
<script src="{{ asset('admin/assets/js/app.js') }}"></script>
        ...
        <!-- E Charts js -->
        <script src="{{ asset('admin/assets/plugins/echarts/echarts.min.js') }}"></script>

        <script src="../../../cdn.jsdelivr.net/npm/echarts/map/js/world.js"></script>

        <!-- E Charts Demo js -->
        <script src="{{ asset('admin/assets/js/pages/chart-echart-geo-map.js') }}"></script>
    </body>

<!-- Mirrored from coderthemes.com/paces/bootstrap/charts-echart-geo-map.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:59:35 GMT -->
</html>
