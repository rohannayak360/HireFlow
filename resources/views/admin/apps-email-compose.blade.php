...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-email-compose.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:37 GMT -->
<head>
        <meta charset="utf-8" />
        <title>New Email (Compose) | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                    ...
                    <div class="outlook-box gap-1 email-app">
                        <div class="offcanvas-lg offcanvas-start outlook-left-menu outlook-left-menu-sm" tabindex="-1" id="emailSidebaroffcanvas">
                            <div class="card h-100 mb-0 rounded-end-0" data-simplebar>
                                <div class="card-body">
                                    <a href="{{ url('admin/apps-email-inbox') }}" class="btn btn-danger fw-medium w-100">Back to Inbox</a>
...
<script src="{{ asset('admin/assets/js/app.js') }}"></script>
        ...
        <script src="{{ asset('admin/assets/js/pages/apps-email-compose.js') }}"></script>
    </body>
