...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-crm-customers.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:29 GMT -->
<head>
        <meta charset="utf-8" />
        <title>CRM Customers | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                                            ...
                                            <tr>
                                                    ...
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-0 lh-base fs-base">
                                                                <a href="{{ url('admin/users-profile') }}" class="link-reset">Michael Thompson</a>
                                                            </h5>
                                                ...
                                                <td>
                                                    <span class="badge p-1 text-bg-light fs-sm">
                                                        <img src="{{ asset('admin/assets/images/flags/gb.svg') }}" class="rounded-circle me-1" height="12" />
                                                        UK
                                                    </span>
                                                </td>
                                                <td>Jan 15, 2024</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-0 lh-base fs-base">
                                                                <a href="{{ url('admin/users-profile') }}" class="link-reset">Sara Mitchell</a>
                                                            </h5>
                                                ...
                                                <td>
                                                    <span class="badge p-1 text-bg-light fs-sm">
                                                        <img src="{{ asset('admin/assets/images/flags/us.svg') }}" class="rounded-circle me-1" height="12" />
                                                        US
                                                    </span>
                                                </td>
                                                <td>Feb 1, 2024</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-0 lh-base fs-base">
                                                                <a href="{{ url('admin/users-profile') }}" class="link-reset">Ravi Deshmukh</a>
                                                            </h5>
                                                ...
                                                <td>
                                                    <span class="badge p-1 text-bg-light fs-sm">
                                                        <img src="{{ asset('admin/assets/images/flags/in.svg') }}" class="rounded-circle me-1" height="12" />
                                                        IN
                                                    </span>
                                                </td>
                                                <td>Mar 10, 2024</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-0 lh-base fs-base">
                                                                <a href="{{ url('admin/users-profile') }}" class="link-reset">Laura Kim</a>
                                                            </h5>
                                                ...
                                                <td>
                                                    <span class="badge p-1 text-bg-light fs-sm">
                                                        <img src="{{ asset('admin/assets/images/flags/kr.svg') }}" class="rounded-circle me-1" height="12" />
                                                        KR
                                                    </span>
                                                </td>
                                                <td>Dec 20, 2023</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-0 lh-base fs-base">
                                                                <a href="{{ url('admin/users-profile') }}" class="link-reset">Jean Dupont</a>
                                                            </h5>
                                                ...
                                                <td>
                                                    <span class="badge p-1 text-bg-light fs-sm">
                                                        <img src="{{ asset('admin/assets/images/flags/fr.svg') }}" class="rounded-circle me-1" height="12" />
                                                        FR
                                                    </span>
                                                </td>
                                                <td>Apr 5, 2024</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-0 lh-base fs-base">
                                                                <a href="{{ url('admin/users-profile') }}" class="link-reset">Amanda Rivera</a>
                                                            </h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-0 lh-base fs-base">
                                                                <a href="{{ url('admin/users-profile') }}" class="link-reset">Carlos Mendes</a>
                                                            </h5>
                                                ...
                                                <td>
                                                    <span class="badge p-1 text-bg-light fs-sm">
                                                        <img src="{{ asset('admin/assets/images/flags/br.svg') }}" class="rounded-circle me-1" height="12" />
                                                        BR
                                                    </span>
                                                </td>
                                                <td>Feb 18, 2024</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-0 lh-base fs-base">
                                                                <a href="{{ url('admin/users-profile') }}" class="link-reset">Lena Hoffmann</a>
                                                            </h5>
                                                ...
                                                <td>
                                                    <span class="badge p-1 text-bg-light fs-sm">
                                                        <img src="{{ asset('admin/assets/images/flags/de.svg') }}" class="rounded-circle me-1" height="12" />
                                                        DE
                                                    </span>
                                                </td>
                                                <td>Apr 3, 2024</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-0 lh-base fs-base">
                                                                <a href="{{ url('admin/users-profile') }}" class="link-reset">Akira Sato</a>
                                                            </h5>
                                                ...
                                                <td>
                                                    <span class="badge p-1 text-bg-light fs-sm">
                                                        <img src="{{ asset('admin/assets/images/flags/jp.svg') }}" class="rounded-circle me-1" height="12" />
                                                        JP
                                                    </span>
                                                </td>
                                                <td>Feb 12, 2024</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-0 lh-base fs-base">
                                                                <a href="{{ url('admin/users-profile') }}" class="link-reset">Sophie Dubois</a>
                                                            </h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-0 lh-base fs-base">
                                                                <a href="{{ url('admin/users-profile') }}" class="link-reset">Omar Farouk</a>
                                                            </h5>
                                                ...
                                                <td>
                                                    <span class="badge p-1 text-bg-light fs-sm">
                                                        <img src="{{ asset('admin/assets/images/flags/eg.svg') }}" class="rounded-circle me-1" height="12" />
                                                        EG
                                                    </span>
                                                </td>
                                                <td>Apr 12, 2024</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-0 lh-base fs-base">
                                                                <a href="{{ url('admin/users-profile') }}" class="link-reset">John Smith</a>
                                                            </h5>
                                                ...
                                                <td>
                                                    <span class="badge p-1 text-bg-light fs-sm">
                                                        <img src="{{ asset('admin/assets/images/flags/ca.svg') }}" class="rounded-circle me-1" height="12" />
                                                        CA
                                                    </span>
                                                </td>
                                                <td>Feb 5, 2024</td>
...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-crm-customers.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:30 GMT -->
</html>
