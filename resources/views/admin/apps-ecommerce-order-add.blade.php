...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-ecommerce-order-add.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:11 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Create/Edit Order | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Add/Edit Order</h4>
                        </div>
                        ...
                        <div class="text-end">
                            <ol class="breadcrumb m-0 py-0">
                                ...
                                <li class="breadcrumb-item active">Add/Edit Order</li>
                            </ol>
                        </div>
                    </div>
                                    ...
                                    <form id="orderForm">
                                        <div class="row g-3">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control" id="orderId" placeholder="#WB20100" disabled />
                                            </div>

                                            <!-- Order Date -->
                                            <div class="col-md-6">
                                                <label class="form-label">Order Date</label>
                                                <input type="datetime-local" data-provider="flatpickr" data-altFormat="F j, Y" class="form-control flatpickr-input" id="orderDate" required />
                                            </div>

                                            <!-- Customer Name -->
                                            <div class="col-md-6">
                                                <label class="form-label">Customer Name</label>
                                                <input type="text" class="form-control" id="customerName" placeholder="Mason Carter" required />
                                            </div>

                                            <!-- Customer Email -->
                                            <div class="col-md-6">
                                                <label class="form-label">Customer Email</label>
                                                <input type="email" class="form-control" id="customerEmail" placeholder="mason.carter&#64;shopmail.com" required />
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="number" step="0.01" class="form-control" id="amount" placeholder="129.45" required />
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" maxlength="4" class="form-control" id="cardNumber" placeholder="7832" />
                                            </div>
