...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-todo.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:44 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Todo List App | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Todo List</h4>
                        </div>
                    ...
                    <div class="outlook-box gap-1">
                        <div class="offcanvas-lg offcanvas-start outlook-left-menu outlook-left-menu-lg" tabindex="-1" id="emailSidebaroffcanvas">
                            <div class="card h-100 mb-0 rounded-end-0" data-simplebar>
                                <div class="card-body">
                                    <button class="btn btn-success fw-medium w-100" data-bs-toggle="modal" data-bs-target="#addTaskModal">
                                        Create New
                                        <i class="ti ti-plus ms-1"></i>
                                    </button>
                                    <div class="my-3">
                                        <label for="taskDate" class="form-label">Select Date</label>
                                        <input type="text" id="taskDate" data-provider="flatpickr" data-altFormat="F j, Y" class="form-control flatpickr-input" placeholder="Select Date" />
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        <label for="taskStatus" class="form-label">Select Status</label>
                        ...
                        <div data-table data-table-rows-per-page="15" class="card h-100 mb-0 rounded-start-0 flex-grow-1 border-start-0">
                            ...
                            <div class="card-body p-0" style="height: calc(100% - 100px)" data-simplebar data-simplebar-md>
                                <div class="nested-sortable-handle">
                                    <div class="border-bottom py-2 px-3 d-flex gap-2 align-items-center">
                                        ...
                                        <a href="#" data-bs-toggle="modal" data-bs-target="#taskDetailsModal" class="link-reset fw-medium">Complete Presentation Slides for Meeting</a>
                                        ...
                                        <div class="d-flex align-items-center gap-3 flex-wrap justify-content-md-end ms-auto">
                                            <div class="avatar-group avatar-group-sm flex-shrink-0">
                                                <div class="avatar" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-secondary" data-bs-placement="top" title="Cruise ⚒️">
                                                    <img src="{{ asset('admin/assets/images/users/user-2.jpg') }}" alt="" class="rounded-circle fs-24 avatar-img-size" />
                                                </div>
                                                <div class="avatar" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-secondary" data-bs-placement="top" title="Kevin">
                                                    <img src="{{ asset('admin/assets/images/users/user-3.jpg') }}" alt="" class="rounded-circle fs-24 avatar-img-size" />
                                                </div>
                                                <div class="avatar" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-secondary" data-bs-placement="top" title="Thomas 🏠">
                                                    <img src="{{ asset('admin/assets/images/users/user-4.jpg') }}" alt="" class="rounded-circle fs-24 avatar-img-size" />
                                                </div>
                                            </div>
                                    ...
                                    <div class="border-bottom py-2 px-3 d-flex gap-2 align-items-center">
                                        <i class="ti ti-grip-horizontal align-middle sort-handle"></i>
                                        <input type="checkbox" class="form-check-input rounded-circle mt-0 fs-16" id="task2" />
                                        <a href="#" data-bs-toggle="modal" data-bs-target="#taskDetailsModal" class="link-reset fw-medium">Finalize Product Roadmap for Launch</a>

                                        <div class="d-flex align-items-center gap-3 flex-wrap justify-content-md-end ms-auto">
                                            <div class="avatar-group avatar-group-sm flex-shrink-0">
                                                <div class="avatar" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-secondary" data-bs-placement="top" title="Maria 💻">
                                                    <img src="{{ asset('admin/assets/images/users/user-5.jpg') }}" alt="" class="rounded-circle fs-24 avatar-img-size" />
                                                </div>
                                                <div class="avatar" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-secondary" data-bs-placement="top" title="James">
                                                    <img src="{{ asset('admin/assets/images/users/user-6.jpg') }}" alt="" class="rounded-circle fs-24 avatar-img-size" />
                                                </div>
                                                <div class="avatar" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-secondary" data-bs-placement="top" title="Sophia 🚀">
                                                    <img src="{{ asset('admin/assets/images/users/user-7.jpg') }}" alt="" class="rounded-circle fs-24 avatar-img-size" />
                                                </div>
                                            </div>
                                    ...
                                    <div class="border-bottom py-2 px-3 d-flex gap-2 align-items-center">
                                        <i class="ti ti-grip-horizontal align-middle sort-handle"></i>
                                        <input type="checkbox" class="form-check-input rounded-circle mt-0 fs-16" id="task3" />
                                        <a href="#" data-bs-toggle="modal" data-bs-target="#taskDetailsModal" class="link-reset fw-medium">Design Marketing Assets for Campaign</a>

                                        <div class="d-flex align-items-center gap-3 flex-wrap justify-content-md-end ms-auto">
                                            <div class="avatar-group avatar-group-sm flex-shrink-0">
                                                <div class="avatar" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-secondary" data-bs-placement="top" title="Olivia 🎨">
                                                    <img src="{{ asset('admin/assets/images/users/user-8.jpg') }}" alt="" class="rounded-circle fs-24 avatar-img-size" />
                                                </div>
                                                <div class="avatar" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-secondary" data-bs-placement="top" title="Daniel">
                                                    <img src="{{ asset('admin/assets/images/users/user-9.jpg') }}" alt="" class="rounded-circle fs-24 avatar-img-size" />
                                                </div>
                                                <div class="avatar" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-secondary" data-bs-placement="top" title="Liam 📷">
                                                    <img src="{{ asset('admin/assets/images/users/user-10.jpg') }}" alt="" class="rounded-circle fs-24 avatar-img-size" />
                                                </div>
                                            </div>
                                    ...
                                    <div class="border-bottom py-2 px-3 d-flex gap-2 align-items-center">
                                        <i class="ti ti-grip-horizontal align-middle sort-handle"></i>
                                        <input type="checkbox" class="form-check-input rounded-circle mt-0 fs-16" id="task4" />
                                        <a href="#" data-bs-toggle="modal" data-bs-target="#taskDetailsModal" class="link-reset fw-medium">Prepare Financial Report for Q3 Review</a>

                                        <div class="d-flex align-items-center gap-3 flex-wrap justify-content-md-end ms-auto">
                                            <div class="avatar-group avatar-group-sm flex-shrink-0">
                                                <div class="avatar" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-secondary" data-bs-placement="top" title="Emma 💼">
                                                    <img src="{{ asset('admin/assets/images/users/user-1.jpg') }}" alt="" class="rounded-circle fs-24 avatar-img-size" />
                                                </div>
                                                <div class="avatar" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-secondary" data-bs-placement="top" title="Michael">
                                                    <img src="{{ asset('admin/assets/images/users/user-2.jpg') }}" alt="" class="rounded-circle fs-24 avatar-img-size" />
                                                </div>
                                                <div class="avatar" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-secondary" data-bs-placement="top" title="Chloe 📊">
                                                    <img src="{{ asset('admin/assets/images/users/user-4.jpg') }}" alt="" class="rounded-circle fs-24 avatar-img-size" />
                                                </div>
                                            </div>
                                    ...
                                    <div class="border-bottom py-2 px-3 d-flex gap-2 align-items-center">
                                        <i class="ti ti-grip-horizontal align-middle sort-handle"></i>
                                        <input type="checkbox" class="form-check-input rounded-circle mt-0 fs-16" id="task5" />
                                        <a href="#" data-bs-toggle="modal" data-bs-target="#taskDetailsModal" class="link-reset fw-medium">Organize Client Feedback Workshop</a>

                                        <div class="d-flex align-items-center gap-3 flex-wrap justify-content-md-end ms-auto">
                                            <div class="avatar-group avatar-group-sm flex-shrink-0">
                                                <div class="avatar" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-secondary" data-bs-placement="top" title="Isabella 📝">
                                                    <img src="{{ asset('admin/assets/images/users/user-3.jpg') }}" alt="" class="rounded-circle fs-24 avatar-img-size" />
                                                </div>
                                                <div class="avatar" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-secondary" data-bs-placement="top" title="Lucas">
                                                    <img src="{{ asset('admin/assets/images/users/user-5.jpg') }}" alt="" class="rounded-circle fs-24 avatar-img-size" />
                                                </div>
                                                <div class="avatar" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-secondary" data-bs-placement="top" title="Noah 🎤">
                                                    <img src="{{ asset('admin/assets/images/users/user-7.jpg') }}" alt="" class="rounded-circle fs-24 avatar-img-size" />
                                                </div>
                                            </div>
                                    ...
                                    <div class="border-bottom py-2 px-3 d-flex gap-2 align-items-center">
                                        <i class="ti ti-grip-horizontal align-middle sort-handle"></i>
                                        <input type="checkbox" class="form-check-input rounded-circle mt-0 fs-16" id="task6" />
                                        <a href="#" data-bs-toggle="modal" data-bs-target="#taskDetailsModal" class="link-reset fw-medium">Update Company Website Content</a>

                                        <div class="d-flex align-items-center gap-3 flex-wrap justify-content-md-end ms-auto">
                                            <div class="avatar-group avatar-group-sm flex-shrink-0">
                                                <div class="avatar" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-secondary" data-bs-placement="top" title="Mason 🌐">
                                                    <img src="{{ asset('admin/assets/images/users/user-6.jpg') }}" alt="" class="rounded-circle fs-24 avatar-img-size" />
                                                </div>
                                                <div class="avatar" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-secondary" data-bs-placement="top" title="Ava">
                                                    <img src="{{ asset('admin/assets/images/users/user-8.jpg') }}" alt="" class="rounded-circle fs-24 avatar-img-size" />
                                                </div>
                                                <div class="avatar" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-secondary" data-bs-placement="top" title="Ethan 🖋">
                                                    <img src="{{ asset('admin/assets/images/users/user-10.jpg') }}" alt="" class="rounded-circle fs-24 avatar-img-size" />
                                                </div>
                                            </div>
                                    ...
                                    <div class="border-bottom py-2 px-3 d-flex gap-2 align-items-center">
                                        <i class="ti ti-grip-horizontal align-middle sort-handle"></i>
                                        <input type="checkbox" class="form-check-input rounded-circle mt-0 fs-16" id="task7" />
                                        <a href="#" data-bs-toggle="modal" data-bs-target="#taskDetailsModal" class="link-reset fw-medium">Conduct Security Audit for New App</a>
                                    ...
                                    <div class="border-bottom py-2 px-3 d-flex gap-2 align-items-center">
                                        <i class="ti ti-grip-horizontal align-middle sort-handle"></i>
                                        <input type="checkbox" class="form-check-input rounded-circle mt-0 fs-16" id="task8" />
                                        <a href="#" data-bs-toggle="modal" data-bs-target="#taskDetailsModal" class="link-reset fw-medium">Draft Press Release for Product Launch</a>
                                    ...
                                    <div class="border-bottom py-2 px-3 d-flex gap-2 align-items-center">
                                        <i class="ti ti-grip-horizontal align-middle sort-handle"></i>
                                        <input type="checkbox" class="form-check-input rounded-circle mt-0 fs-16" id="task9" />
                                        <a href="#" data-bs-toggle="modal" data-bs-target="#taskDetailsModal" class="link-reset fw-medium">Update CRM Database Records</a>
                                    ...
                                    <div class="border-bottom py-2 px-3 d-flex gap-2 align-items-center">
                                        <i class="ti ti-grip-horizontal align-middle sort-handle"></i>
                                        <input type="checkbox" class="form-check-input rounded-circle mt-0 fs-16" id="task10" />
                                        <a href="#" data-bs-toggle="modal" data-bs-target="#taskDetailsModal" class="link-reset fw-medium">Plan Internal Team Training Session</a>
                                    ...
                                    <div class="border-bottom py-2 px-3 d-flex gap-2 align-items-center">
                                        <i class="ti ti-grip-horizontal align-middle sort-handle"></i>
                                        <input type="checkbox" class="form-check-input rounded-circle mt-0 fs-16" id="task11" />
                                        <a href="#" data-bs-toggle="modal" data-bs-target="#taskDetailsModal" class="link-reset fw-medium">Review Supplier Contract Renewals</a>
                                    ...
                                    <div class="border-bottom py-2 px-3 d-flex gap-2 align-items-center">
                                        <i class="ti ti-grip-horizontal align-middle sort-handle"></i>
                                        <input type="checkbox" class="form-check-input rounded-circle mt-0 fs-16" id="task12" />
                                        <a href="#" data-bs-toggle="modal" data-bs-target="#taskDetailsModal" class="link-reset fw-medium">Compile Monthly Marketing Metrics</a>
                                    ...
                                    <div class="border-bottom py-2 px-3 d-flex gap-2 align-items-center">
                                        <i class="ti ti-grip-horizontal align-middle sort-handle"></i>
                                        <input type="checkbox" class="form-check-input rounded-circle mt-0 fs-16" id="task13" />
                                        <a href="#" data-bs-toggle="modal" data-bs-target="#taskDetailsModal" class="link-reset fw-medium">Prepare Year-End Performance Review</a>
                                    ...
                                    <div class="border-bottom py-2 px-3 d-flex gap-2 align-items-center">
                                        <i class="ti ti-grip-horizontal align-middle sort-handle"></i>
                                        <input type="checkbox" class="form-check-input rounded-circle mt-0 fs-16" id="task14" />
                                        <a href="#" data-bs-toggle="modal" data-bs-target="#taskDetailsModal" class="link-reset fw-medium">Coordinate Social Media Influencer Outreach</a>
                                    ...
                                    <div class="border-bottom py-2 px-3 d-flex gap-2 align-items-center">
                                        <i class="ti ti-grip-horizontal align-middle sort-handle"></i>
                                        <input type="checkbox" class="form-check-input rounded-circle mt-0 fs-16" id="task15" />
                                        <a href="#" data-bs-toggle="modal" data-bs-target="#taskDetailsModal" class="link-reset fw-medium">Test and Deploy New Checkout System</a>
                                ...
                                <div class="modal-body pb-0">
                                    <div class="d-flex align-items-center mb-4">
                                        <div class="avatar me-2" data-bs-toggle="tooltip" title="Assigned by Alex Johnson">
                                            <img src="{{ asset('admin/assets/images/users/user-8.jpg') }}" alt="" class="rounded-circle avatar-img-size" style="width: 40px; height: 40px" />
                                        </div>
                                        <div>
                                        ...
                                        <div class="col-12">
                                            <div class="bg-light-subtle mx-n3 p-3 border-top border-bottom border-dashed">
                                                <div class="d-flex align-items-start">
                                                    <img class="me-2 avatar-sm rounded-circle" src="{{ asset('admin/assets/images/users/user-5.jpg') }}" alt="Generic placeholder image" />
                                                    <div class="w-100 fs-sm">
                                                        ...
                                                        <div class="d-flex align-items-start mt-3">
                                                            <a class="pe-2" href="#">
                                                                <img src="{{ asset('admin/assets/images/users/user-6.jpg') }}" class="avatar-sm rounded-circle" alt="Generic placeholder image" />
                                                            </a>
                                                            <div class="w-100">
                                                                <h6 class="mt-0 mb-1">
                                                ...
                                                <div class="d-flex align-items-start mt-3">
                                                    <a class="pe-2" href="#">
                                                        <img src="{{ asset('admin/assets/images/users/user-3.jpg') }}" class="rounded-circle" alt="Generic placeholder image" height="31" />
                                                    </a>
                                                    <div class="w-100">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="date" class="form-control" id="DueDate" data-provider="flatpickr" data-date-format="d M, Y" required />
                                            </div>
                                            <div class="col-md-6">
                                                ...
                                                <select class="form-select" name="taskPriority">
                                                    ...
                                                    <option value="badge-soft-danger p-1" selected>High</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="mt-3">
                                            ...
                                            <input type="text" class="form-control" name="taskAvatars" placeholder="Comma-separated user IDs" />
...
<script src="{{ asset('admin/assets/js/app.js') }}"></script>
        ...
        <!-- Todo Init Js -->
        <script src="{{ asset('admin/assets/js/pages/apps-todo.js') }}"></script>
    </body>
