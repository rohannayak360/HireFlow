...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-blog-grid.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:48 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Blog | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                    ...
                    <div class="row" data-masonry='{"percentPosition": true }'>
                            ...
                            <article class="card rounded-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <h6 class="card-title fs-lg lh-base mb-2">
                                        <a href="{{ url('admin/apps-blog-article') }}" class="link-reset">Mastering Figma: 7 Pro Tips for Better UI Design</a>
                                    </h6>
                        ...
                        <div class="col-xl-3 col-md-6">
                            <article class="card rounded-3">
                                ...
                                <!-- Card image -->
                                <img class="card-img-top rounded-top-3" src="{{ asset('admin/assets/images/blog/blog-1.jpg') }}" alt="Building APIs" />
                        ...
                        <div class="col-xl-3 col-md-6">
                            <article class="card rounded-3">
                                ...
                                <!-- Card image -->
                                <img class="card-img-top rounded-top-3" src="{{ asset('admin/assets/images/blog/blog-2.jpg') }}" alt="SEO Strategies" />

                                <!-- Card Body -->
                                <div class="card-body">
                                    <!-- Title -->
                                    <h6 class="card-title fs-lg lh-base mb-2">
                                        <a href="{{ url('admin/apps-blog-article') }}" class="link-reset">SEO Strategies for 2025: How to Rank Higher</a>
                                    </h6>
                        ...
                        <div class="col-xl-3 col-md-6">
                            <article class="card rounded-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <!-- Title -->
                                    <h6 class="card-title fs-lg lh-base mb-2">
                                        <a href="{{ url('admin/apps-blog-article') }}" class="link-reset">Web Design Trends to Watch in 2025</a>
                                    </h6>
                        ...
                        <div class="col-xl-3 col-md-6">
                            <article class="card rounded-3">
                                ...
                                <!-- Card image -->
                                <img class="card-img-top rounded-top-3" src="{{ asset('admin/assets/images/blog/blog-3.jpg') }}" alt="Entrepreneur Tips" />

                                <!-- Card Body -->
                                <div class="card-body">
                                    <!-- Title -->
                                    <h6 class="card-title fs-lg lh-base mb-2">
                                        <a href="{{ url('admin/apps-blog-article') }}" class="link-reset">5 Key Tips for New Entrepreneurs</a>
                                    </h6>
                        ...
                        <div class="col-xl-3 col-md-6">
                            <article class="card rounded-3">
                                ...
                                <!-- Card image -->
                                <img class="card-img-top rounded-top-3" src="{{ asset('admin/assets/images/blog/blog-4.jpg') }}" alt="Tech Innovations" />

                                <!-- Card Body -->
                                <div class="card-body">
                                    <!-- Title -->
                                    <h6 class="card-title fs-lg lh-base mb-2">
                                        <a href="{{ url('admin/apps-blog-article') }}" class="link-reset">The Future of Artificial Intelligence</a>
                                    </h6>
                        ...
                        <div class="col-xl-3 col-md-6">
                            <article class="card bg-primary bg-gradient rounded-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <!-- Title -->
                                    <h6 class="card-title fs-lg lh-base mb-2">
                                        <a href="{{ url('admin/apps-blog-article') }}" class="text-white">Top Data Science Trends in 2025</a>
                                    </h6>
                                ...
                                <div class="card-footer bg-transparent d-flex justify-content-between border-light border-opacity-25">
                                    ...
                                    <a class="text-white fw-semibold d-flex align-items-center gap-1" href="{{ url('admin/apps-blog-article') }}">Read more <i class="ti ti-arrow-right"></i></a>
                                </div>
                            </article>
                        </div>
                        <!-- end col-->
                        ...
                        <div class="col-xl-3 col-md-6">
                            <article class="card rounded-3">
                                ...
                                <!-- Card image -->
                                <img class="card-img-top rounded-top-3" src="{{ asset('admin/assets/images/blog/blog-5.jpg') }}" alt="Data Science Trends" />

                                <!-- Card Body -->
                                <div class="card-body">
                                    <!-- Title -->
                                    <h6 class="card-title fs-lg lh-base mb-2">
                                        <a href="{{ url('admin/apps-blog-article') }}" class="link-reset">Top Data Science Trends in 2025</a>
                                    </h6>
...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-blog-grid.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:49 GMT -->
</html>
