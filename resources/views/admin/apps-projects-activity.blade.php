...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-projects-activity.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:22 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Activity Stream | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Activity Stream</h4>
                        </div>
                                ...
                                <div class="card-body">
                                    <div class="pb-2 d-flex gap-3 align-items-center">
                                        ...
                                        <a href="#!" class="link-reset fw-semibold">
                                            <img src="{{ asset('admin/assets/images/users/user-1.jpg') }}" alt="" class="rounded-circle avatar-xxs" />
                                            Olivia Lee
                                        </a>
                                        Added a new design asset
                                    </div>
                                    <div class="py-2 d-flex gap-3 align-items-center">
                                        <span class="badge badge-label text-bg-success">Update</span>
                                        <span class="text-muted">Today at 08:48:20 am</span>
                                        <a href="#!" class="link-reset fw-semibold">
                                            <img src="{{ asset('admin/assets/images/users/user-2.jpg') }}" alt="" class="rounded-circle avatar-xxs" />
                                            Ethan Wong
                                        </a>
                                    ...
                                    <div class="py-2 d-flex gap-3 align-items-center">
                                        ...
                                        <a href="#!" class="link-reset fw-semibold">
                                            <img src="{{ asset('admin/assets/images/users/user-3.jpg') }}" alt="" class="rounded-circle avatar-xxs" />
                                            Grace Kim
                                        </a>
                                    ...
                                    <div class="py-2 d-flex gap-3 align-items-center">
                                        ...
                                        <a href="#!" class="link-reset fw-semibold">
                                            <img src="{{ asset('admin/assets/images/users/user-4.jpg') }}" alt="" class="rounded-circle avatar-xxs" />
                                            Noah Smith
                                        </a>
                                    ...
                                    <div class="py-2 d-flex gap-3 align-items-center">
                                        ...
                                        <a href="#!" class="link-reset fw-semibold">
                                            <img src="{{ asset('admin/assets/images/users/user-5.jpg') }}" alt="" class="rounded-circle avatar-xxs" />
                                            Mia Johnson
                                        </a>
                                    ...
                                    <div class="py-2 d-flex gap-3 align-items-center">
                                        ...
                                        <a href="#!" class="link-reset fw-semibold">
                                            <img src="{{ asset('admin/assets/images/users/user-6.jpg') }}" alt="" class="rounded-circle avatar-xxs" />
                                            Liam Davis
                                        </a>
                                    ...
                                    <div class="py-2 d-flex gap-3 align-items-center">
                                        ...
                                        <a href="#!" class="link-reset fw-semibold">
                                            <img src="{{ asset('admin/assets/images/users/user-7.jpg') }}" alt="" class="rounded-circle avatar-xxs" />
                                            Sophia Martinez
                                        </a>
                                    ...
                                    <div class="py-2 d-flex gap-3 align-items-center">
                                        ...
                                        <a href="#!" class="link-reset fw-semibold">
                                            <img src="{{ asset('admin/assets/images/users/user-8.jpg') }}" alt="" class="rounded-circle avatar-xxs" />
                                            Jack Wilson
                                        </a>
                                    ...
                                    <div class="py-2 d-flex gap-3 align-items-center">
                                        ...
                                        <a href="#!" class="link-reset fw-semibold">
                                            <img src="{{ asset('admin/assets/images/users/user-9.jpg') }}" alt="" class="rounded-circle avatar-xxs" />
                                            Ella Moore
                                        </a>
                                    ...
                                    <div class="py-2 d-flex gap-3 align-items-center">
                                        ...
                                        <a href="#!" class="link-reset fw-semibold">
                                            <img src="{{ asset('admin/assets/images/users/user-10.jpg') }}" alt="" class="rounded-circle avatar-xxs" />
                                            Benjamin Taylor
                                        </a>
                            ...
                            <div class="card card-h-100">
                                ...
                                <div class="card-body">
                                    <div class="timeline timeline-icon-bordered">
                                            ...
                                            <div class="timeline-content ps-3 pb-3">
                                                <div class="d-flex justify-content-between">
                                                    <h5 class="mb-1">
                                                        ...
                                                        <span class="badge badge-label badge-soft-info ms-2">Deploy</span>
                                                    </h5>
                                                ...
                                                <div class="d-flex align-items-center gap-2">
                                                    <img src="{{ asset('admin/assets/images/users/user-6.jpg') }}" alt="Natalie Brooks" class="rounded-circle avatar-xxs" />
                                                    <a href="#!" class="fw-semibold link-reset">Natalie Brooks</a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="timeline-item d-flex align-items-stretch">
                                            ...
                                            <div class="timeline-content ps-3 pb-3">
                                                <div class="d-flex justify-content-between">
                                                    <h5 class="mb-1">
                                                        Team Sync-Up
                                                        <span class="badge badge-label badge-soft-secondary ms-2">Meeting</span>
                                                    </h5>
                                                ...
                                                <div class="d-flex align-items-center gap-2">
                                                    <img src="{{ asset('admin/assets/images/users/user-4.jpg') }}" alt="Oliver Grant" class="rounded-circle avatar-xxs" />
                                                    <a href="#!" class="fw-semibold link-reset">Oliver Grant</a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="timeline-item d-flex align-items-stretch">
                                            ...
                                            <div class="timeline-content ps-3 pb-3">
                                                <div class="d-flex justify-content-between">
                                                    <h5 class="mb-1">
                                                        UI Design Review
                                                        <span class="badge badge-label badge-soft-success ms-2">Design</span>
                                                    </h5>
                                                ...
                                                <div class="d-flex align-items-center gap-2">
                                                    <img src="{{ asset('admin/assets/images/users/user-9.jpg') }}" alt="Clara Jensen" class="rounded-circle avatar-xxs" />
                                                    <a href="#!" class="fw-semibold link-reset">Clara Jensen</a>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="timeline-content ps-3 pb-3">
                                                <div class="d-flex justify-content-between">
                                                    <h5 class="mb-1">
                                                        ...
                                                        <span class="badge badge-label badge-soft-danger ms-2">Backend</span>
                                                    </h5>
                                                ...
                                                <div class="d-flex align-items-center gap-2">
                                                    <img src="{{ asset('admin/assets/images/users/user-10.jpg') }}" alt="Leo Armstrong" class="rounded-circle avatar-xxs" />
                                                    <a href="#!" class="fw-semibold link-reset">Leo Armstrong</a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="timeline-item d-flex align-items-stretch">
                                            <div class="timeline-dot">
                                                <i class="ti ti-user-hexagon fs-xl text-info"></i>
                                            </div>
                                            <div class="timeline-content ps-3 pb-3">
                                                <div class="d-flex justify-content-between">
                                                    <h5 class="mb-1">
                                                        Security Audit Completed
                                                        <span class="badge badge-label badge-soft-warning ms-2">Audit</span>
                                                    </h5>
                                                ...
                                                <div class="d-flex align-items-center gap-2">
                                                    <img src="{{ asset('admin/assets/images/users/user-8.jpg') }}" alt="Liam Carter" class="rounded-circle avatar-xxs" />
                                                    <a href="#!" class="fw-semibold link-reset">Liam Carter</a>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="timeline-content ps-3 pb-3">
                                                <div class="d-flex justify-content-between">
                                                    <h5 class="mb-1">
                                                        ...
                                                        <span class="badge badge-label badge-soft-primary ms-2">Onboarding</span>
                                                    </h5>
                                                ...
                                                <div class="d-flex align-items-center gap-2">
                                                    <img src="{{ asset('admin/assets/images/users/user-7.jpg') }}" alt="Emma Davis" class="rounded-circle avatar-xxs" />
                                                    <a href="#!" class="fw-semibold link-reset">Emma Davis</a>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="timeline-content ps-3 pb-3">
                                                <div class="d-flex justify-content-between">
                                                    <h5 class="mb-1">
                                                        ...
                                                        <span class="badge badge-label badge-soft-secondary ms-2">Docs</span>
                                                    </h5>
                                                ...
                                                <div class="d-flex align-items-center gap-2">
                                                    <img src="{{ asset('admin/assets/images/users/user-7.jpg') }}" alt="Sophia Reed" class="rounded-circle avatar-xxs" />
                                                    <a href="#!" class="fw-semibold link-reset">Sophia Reed</a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="timeline-item d-flex align-items-stretch">
                                            ...
                                            <div class="timeline-content ps-3">
                                                <div class="d-flex justify-content-between">
                                                    <h5 class="mb-1">
                                                        Task Completed
                                                        <span class="badge badge-label badge-soft-success ms-2">Done</span>
                                                    </h5>
                                                ...
                                                <div class="d-flex align-items-center gap-2">
                                                    <img src="{{ asset('admin/assets/images/users/user-5.jpg') }}" alt="Daniel Chen" class="rounded-circle avatar-xxs" />
                                                    <a href="#!" class="fw-semibold link-reset">Daniel Chen</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-projects-activity.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:23 GMT -->
</html>
