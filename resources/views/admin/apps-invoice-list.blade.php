...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-invoice-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:23 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Invoices | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Invoices</h4>
                        </div>
                            ...
                            <div data-table data-table-rows-per-page="8" class="card">
                                <div class="card-header border-light justify-content-between">
                                    <div class="d-flex gap-2">
                                        ...
                                        <a href="{{ url('admin/apps-invoice-create') }}" class="btn btn-secondary rounded-circle btn-icon"> <i class="ti ti-plus fs-lg"></i></a>
                                    ...
                                    <table class="table table-custom table-centered table-select table-hover w-100 mb-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="m-0">
                                                        <i class="ti ti-invoice text-success fs-lg"></i>
                                                        <a href="{{ url('admin/apps-invoice-details') }}" class="link-reset fw-semibold">#INS-0120010</a>
                                                    </h5>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-start align-items-center gap-2">
                                                        ...
                                                        <div>
                                                            <h5 class="text-nowrap fs-base mb-0 lh-base"><a data-sort="name" href="#!" class="link-reset">Emily Parker</a></h5>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center justify-content-center gap-1">
                                                        <a href="{{ url('admin/apps-invoice-details') }}" class="btn btn-default btn-icon btn-sm"><i class="ti ti-eye fs-lg"></i></a>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="m-0">
                                                        <i class="ti ti-invoice text-warning fs-lg"></i>
                                                        <a href="{{ url('admin/apps-invoice-details') }}" class="link-reset fw-semibold">#INS-0120009</a>
                                                    </h5>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-start align-items-center gap-2">
                                                        ...
                                                        <div>
                                                            <h5 class="text-nowrap fs-base mb-0 lh-base"><a data-sort="name" href="#!" class="link-reset">Michael Scott</a></h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="m-0">
                                                        ...
                                                        <a href="{{ url('admin/apps-invoice-details') }}" class="link-reset fw-semibold">#INS-0120008</a>
                                                    </h5>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-start align-items-center gap-2">
                                                        ...
                                                        <div>
                                                            <h5 class="text-nowrap fs-base mb-0 lh-base"><a data-sort="name" href="#!" class="link-reset">Samantha Reed</a></h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="m-0">
                                                        <i class="ti ti-invoice text-info fs-lg"></i>
                                                        <a href="{{ url('admin/apps-invoice-details') }}" class="link-reset fw-semibold">#INS-0120007</a>
                                                    </h5>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-start align-items-center gap-2">
                                                        ...
                                                        <div>
                                                            <h5 class="text-nowrap fs-base mb-0 lh-base"><a data-sort="name" href="#!" class="link-reset">Jonathan Lee</a></h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="m-0">
                                                        <i class="ti ti-invoice text-success fs-lg"></i>
                                                        <a href="{{ url('admin/apps-invoice-details') }}" class="link-reset fw-semibold">#INS-0120006</a>
                                                    </h5>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-start align-items-center gap-2">
                                                        ...
                                                        <div>
                                                            <h5 class="text-nowrap fs-base mb-0 lh-base"><a data-sort="name" href="#!" class="link-reset">Carlos Diaz</a></h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="m-0">
                                                        <i class="ti ti-invoice text-warning fs-lg"></i>
                                                        <a href="{{ url('admin/apps-invoice-details') }}" class="link-reset fw-semibold">#INS-0120005</a>
                                                    </h5>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-start align-items-center gap-2">
                                                        ...
                                                        <div>
                                                            <h5 class="text-nowrap fs-base mb-0 lh-base"><a data-sort="name" href="#!" class="link-reset">Lisa Brown</a></h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="m-0">
                                                        <i class="ti ti-invoice text-info fs-lg"></i>
                                                        <a href="{{ url('admin/apps-invoice-details') }}" class="link-reset fw-semibold">#INS-0120004</a>
                                                    </h5>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-start align-items-center gap-2">
                                                        ...
                                                        <div>
                                                            <h5 class="text-nowrap fs-base mb-0 lh-base"><a data-sort="name" href="#!" class="link-reset">Ryan Mitchell</a></h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="m-0">
                                                        <i class="ti ti-invoice text-success fs-lg"></i>
                                                        <a href="{{ url('admin/apps-invoice-details') }}" class="link-reset fw-semibold">#INS-0120003</a>
                                                    </h5>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-start align-items-center gap-2">
                                                        ...
                                                        <div>
                                                            <h5 class="text-nowrap fs-base mb-0 lh-base"><a data-sort="name" href="#!" class="link-reset">Nina Hughes</a></h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="m-0">
                                                        <i class="ti ti-invoice text-warning fs-lg"></i>
                                                        <a href="{{ url('admin/apps-invoice-details') }}" class="link-reset fw-semibold">#INS-0120002</a>
                                                    </h5>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-start align-items-center gap-2">
                                                        ...
                                                        <div>
                                                            <h5 class="text-nowrap fs-base mb-0 lh-base"><a data-sort="name" href="#!" class="link-reset">Oliver Grant</a></h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="m-0">
                                                        <i class="ti ti-invoice text-danger fs-lg"></i>
                                                        <a href="{{ url('admin/apps-invoice-details') }}" class="link-reset fw-semibold">#INS-0120001</a>
                                                    </h5>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-start align-items-center gap-2">
                                                        ...
                                                        <div>
                                                            <h5 class="text-nowrap fs-base mb-0 lh-base"><a data-sort="name" href="#!" class="link-reset">Sophia Kim</a></h5>
