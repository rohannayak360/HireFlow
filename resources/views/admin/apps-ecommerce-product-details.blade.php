...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-ecommerce-product-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:05 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Product Details | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Product Details</h4>
                        </div>
                                            ...
                                            <div class="card card-top-sticky border-0">
                                                <div class="card-body p-0">
                                                    ...
                                                    <div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel">
                                                        <div class="carousel-inner" role="listbox">
                                                            <div class="carousel-item text-center active">
                                                                <img src="{{ asset('admin/assets/images/products/single-1.png') }}" alt="" class="img-fluid" />
                                                            </div>
                                                            <div class="carousel-item text-center">
                                                                <img src="{{ asset('admin/assets/images/products/single-2.png') }}" alt="" class="img-fluid" />
                                                            </div>
                                                            <div class="carousel-item text-center">
                                                                <img src="{{ asset('admin/assets/images/products/single-3.png') }}" alt="" class="img-fluid" />
                                                            </div>
                                                            <div class="carousel-item text-center">
                                                                <img src="{{ asset('admin/assets/images/products/single-4.png') }}" alt="" class="img-fluid" />
                                                            </div>
                                                        </div>
                                                        <div class="carousel-indicators m-0 mt-3 d-lg-flex d-none position-static h-100 rounded gap-2">
                                                            <button type="button" data-bs-target="#carouselExampleFade" data-bs-slide-to="0" aria-current="true" aria-label="Slide 1" class="h-auto rounded bg-light-subtle border active" style="width: auto !important">
                                                                <img src="{{ asset('admin/assets/images/products/single-1.png') }}" class="d-block avatar-xl" alt="indicator-img" />
                                                            </button>
                                                            <button type="button" data-bs-target="#carouselExampleFade" data-bs-slide-to="1" aria-label="Slide 2" class="h-auto rounded bg-light-subtle border" style="width: auto !important">
                                                                <img src="{{ asset('admin/assets/images/products/single-2.png') }}" class="d-block avatar-xl" alt="indicator-img" />
                                                            </button>
                                                            <button type="button" data-bs-target="#carouselExampleFade" data-bs-slide-to="2" aria-label="Slide 3" class="h-auto rounded bg-light-subtle border" style="width: auto !important">
                                                                <img src="{{ asset('admin/assets/images/products/single-3.png') }}" class="d-block avatar-xl" alt="indicator-img" />
                                                            </button>
                                                            <button type="button" data-bs-target="#carouselExampleFade" data-bs-slide-to="3" aria-label="Slide 4" class="h-auto rounded bg-light-subtle border" style="width: auto !important">
                                                                <img src="{{ asset('admin/assets/images/products/single-4.png') }}" class="d-block avatar-xl" alt="indicator-img" />
                                                            </button>
                                                        </div>
                                                    </div>
                                                    <!-- end carousel-->
                                                    ...
                                                    <div class="text-center my-3">
                                                        <a href="{{ url('admin/apps-ecommerce-product-add') }}" class="btn btn-light me-1">
                                                            <i class="ti ti-pencil fs-lg me-1"></i>
                                                            Edit
                                                        </a>
                                                        <a href="{{ url('admin/apps-ecommerce-product-add') }}" class="btn btn-danger">
                                                            <i class="ti ti-circle-dashed-plus fs-lg me-1"></i>
                                                            Delisting
                                                        </a>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="d-flex align-items-center justify-content-between">
                                                    ...
                                                    <div class="flex-grow-1 d-inline-flex align-items-center justify-content-end fs-lg">
                                                        ...
                                                        <span class="ms-1 fs-base">
                                                            <a href="{{ url('admin/apps-ecommerce-reviews') }}" class="link-reset fw-medium">(859 Reviews)</a>
                                                        </span>
                                                    </div>
                                                </div>
                                                <div class="mt-3 mb-4">
...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-ecommerce-product-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:06 GMT -->
</html>
