...
<!-- Mirrored from coderthemes.com/paces/bootstrap/error-500.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:59:06 GMT -->
<head>
        <meta charset="utf-8" />
        <title>500 Error | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                    ...
                    <div class="col-xxl-5 col-md-6 col-sm-8">
                        <div class="card p-4">
                            ...
                            <div class="p-4 text-center">
                                ...
                                <h3 class="fw-bold text-uppercase">Server Error</h3>
                                <p class="text-muted fs-5">We ran into an issue while processing your request. Please try again in a moment.</p>

                                <div class="mt-4 d-flex justify-content-center gap-1">
                                    <button class="btn btn-primary" onclick="window.location.reload()">Try Again</button>
                                    <button class="btn btn-outline-info">Get Support</button>
                                </div>
                            </div>
                        </div>
