...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-ecommerce-sales.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:20 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Sales Reports | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Sales Reports</h4>
                        </div>
                            ...
                            <div data-table data-table-rows-per-page="8" class="card">
                                <div class="card-header border-light justify-content-between">
                                    ...
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <button type="submit" class="btn btn-secondary"><i class="ti ti-download me-2"></i> Export Report</button>
                                    </div>
                                </div>
...
<script src="{{ asset('admin/assets/js/app.js') }}"></script>
        ...
        <!-- Page only -->
        <script src="{{ asset('admin/assets/js/pages/ecommerce-sales.js') }}"></script>
    </body>
