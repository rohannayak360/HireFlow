...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-hrm-leaves.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:36 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Leaves | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Leaves</h4>
                        </div>
                                ...
                                <div class="card-header border-light justify-content-between">
                                    <div class="d-flex gap-2">
                                        ...
                                        <div class="app-search">
                                            <input data-table-search type="search" class="form-control" placeholder="Search leave records..." />
                                            <i class="ti ti-search app-search-icon text-muted"></i>
                                        </div>
                                    ...
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <!-- Leave Type Filter -->
                                        <div class="app-search">
                                            <select data-table-filter="leave_type" class="form-select form-control my-1 my-md-0">
                                        ...
                                        <table class="table table-custom table-centered table-hover w-100 mb-0">
                                            <thead class="bg-light align-middle bg-opacity-25 thead-sm text-nowrap">
                                                <tr class="text-uppercase fs-xxs">
                                                    ...
                                                    <th data-table-sort data-column="leave_type">Leave Type</th>
                                                    <th>Reason</th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center justify-content-center gap-1">
                                                            <a href="#" class="btn btn-success btn-icon btn-sm rounded-circle"><i class="ti ti-check fs-lg"></i></a>
                                                            <a href="#" class="btn btn-danger btn-icon btn-sm rounded-circle"><i class="ti ti-x fs-lg"></i></a>
                                    ...
                                    <div class="modal-body">
                                        <div class="row g-3">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input type="text" id="employeeId" class="form-control" placeholder="e.g., EMP-1056" required />
                                            </div>

                                            <!-- Employee Name -->
                                            <div class="col-md-4">
                                                <label for="employeeName" class="form-label">Employee Name</label>
                                                <input type="text" id="employeeName" class="form-control" placeholder="Enter name" required />
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input type="date" class="form-control" data-provider="flatpickr" data-date-format="d M, Y" id="dateFrom" required />
                                            </div>

                                            <!-- Date To -->
                                            <div class="col-md-4">
                                                <label for="dateTo" class="form-label">Date To</label>
                                                <input type="date" class="form-control" data-provider="flatpickr" data-date-format="d M, Y" id="dateTo" required />
                                            </div>
                                            ...
                                            <!-- Status -->
                                            <div class="col-md-4">
                                                <label for="leave-status" class="form-label">Status</label>
                                                <select id="leave-status" class="form-select" required>
                                            ...
                                            <!-- Applied On -->
                                            <div class="col-md-4">
                                                <label for="appliedOn" class="form-label">Applied On</label>
                                                <input type="date" class="form-control" data-provider="flatpickr" data-date-format="d M, Y" id="appliedOn" />
                                            </div>

                                            <!-- Remarks -->
                                            <div class="col-md-12">
                                                <label for="remarks" class="form-label">Remarks</label>
                                                <textarea id="remarks" class="form-control" rows="3" placeholder="Optional remarks..."></textarea>
                                            </div>
                                        </div>
                                    </div>
