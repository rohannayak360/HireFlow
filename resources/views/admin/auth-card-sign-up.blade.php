...
<!-- Mirrored from coderthemes.com/paces/bootstrap/auth-card-sign-up.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:59:05 GMT -->
<head>
        <meta charset="utf-8" />
                                ...
                                <div class="col-lg-6">
                                    <div class="card-body">
                                        ...
                                        <div class="row text-muted g-2">
                                            ...
                                            <div class="col-lg-6">
                                                <a href="#!" class="btn btn-default w-100"
                                                    ><svg xmlns="http://www.w3.org/2000/svg" class="me-1" width="14px" height="14px" viewBox="0 0 64 64">
                                                        <path
                                                            fill="currentColor"
                                        ...
                                        <p class="text-muted text-center mt-4 mb-0">
                                            ...
                                            <a href="{{ url('admin/auth-card-sign-in') }}" class="text-decoration-underline link-offset-3 fw-semibold">Login</a>
                                        </p>
