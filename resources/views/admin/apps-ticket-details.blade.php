...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-ticket-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:38 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Ticket Details | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Ticket Details</h4>
                        </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-md-4">
                                            ...
                                            <div class="d-flex align-items-center gap-2">
                                                <img src="{{ asset('admin/assets/images/users/user-5.jpg') }}" alt="Ava Sullivan" class="rounded-circle avatar-sm" />
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="d-flex align-items-center gap-2">
                                                <img src="{{ asset('admin/assets/images/users/user-4.jpg') }}" alt="Liam Brooks" class="rounded-circle avatar-sm" />
                                    ...
                                    <div class="d-flex gap-2 justify-content-center">
                                        <a href="{{ url('admin/apps-ticket-create') }}" class="btn btn-primary"><i class="ti ti-pencil me-1"></i>Edit Ticket</a>
                                        <a href="#" class="btn btn-danger"><i class="ti ti-x me-1"></i>Close Ticket</a>
                                        <a href="{{ url('admin/apps-ticket-list') }}" class="btn btn-outline-secondary"><i class="ti ti-arrow-left me-1"></i>Back to List</a>
                                    </div>
                                </div>
                            </div>
                        </div>
