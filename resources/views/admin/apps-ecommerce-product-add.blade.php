...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-ecommerce-product-add.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:06 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Create New Products | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
        ...
        <!-- Dropzone Plugin CSS -->
        <link href="{{ asset('admin/assets/plugins/dropzone/dropzone.css') }}" rel="stylesheet" type="text/css" />
                    ...
                    <div class="row">
                        <div class="col-xxl-12">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="skuId" placeholder="SOFA-10058" required="" />
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        <label for="stockNumber" class="form-label">Stock <span class="text-danger">*</span></label>
                                                        <input type="number" class="form-control" id="stockNumber" placeholder="250" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    <div>
                                                        ...
                                                        <div id="snow-editor">
                                                            <p>
                                                                Introducing the <strong><em>Azure Comfort Single Sofa</em></strong
                                        ...
                                        <div class="card-body">
                                            <div class="mb-3">
                                                ...
                                                <div class="app-search">
                                                    <input type="number" class="form-control" id="basePrice" placeholder="Enter base price (e.g., 199.99)" />
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="app-search">
                                                    ...
                                                    <i class="ti ti-discount app-search-icon text-muted"></i>
                                                </div>
                                            </div>
                                            ...
                                            <div class="mb-0">
                                                ...
                                                <div class="app-search">
                                                    <input type="number" class="form-control" id="discountValue" placeholder="Enter discount amount or percentage" />
                            ...
                            <div class="mt-2 mb-4 d-flex gap-2 justify-content-center">
                                <a href="#!" class="btn btn-danger fw-semibold"> Discard </a>
                                <a href="#!" class="btn btn-secondary"> Save as Draft </a>
...
<script src="{{ asset('admin/assets/js/app.js') }}"></script>
        ...
        <!-- Add Product Page js -->
        <script src="{{ asset('admin/assets/js/pages/ecommerce-product-add.js') }}"></script>
    </body>

<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-ecommerce-product-add.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:08 GMT -->
</html>
