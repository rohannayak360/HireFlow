...
<!-- Mirrored from coderthemes.com/paces/bootstrap/charts-apex-radar.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:59:27 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Radar Apexcharts | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Radar Apexchart</h4>
                        </div>
                        ...
                        <div class="text-end">
                            <ol class="breadcrumb m-0 py-0">
                                ...
                                <li class="breadcrumb-item active">Radar Apexchart</li>
                            </ol>
                        </div>
                    </div>
                                ...
                                <div class="card-body">
                                    <div dir="ltr">
                                        ...
                                        <div class="text-center mt-2">
                                            <button id="update-radar" class="btn btn-sm btn-primary">Update</button>
                                        </div>
                                    </div>
                                </div>
                                <!-- end card body-->
...
<script src="{{ asset('admin/assets/js/app.js') }}"></script>
        ...
        <script src="{{ asset('admin/assets/js/pages/chart-apex-radar.js') }}"></script>
    </body>

<!-- Mirrored from coderthemes.com/paces/bootstrap/charts-apex-radar.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:59:28 GMT -->
</html>
