...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-ecommerce-products-grid.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:04 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Products Grid | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Products Grid</h4>
                        </div>
                            ...
                            <form class="bg-light-subtle rounded border p-3">
                                <div class="d-flex flex-wrap justify align-items-center gap-3">
                                    ...
                                    <div class="d-flex gap-1">
                                        <a href="{{ url('admin/apps-ecommerce-products-grid') }}" class="btn btn-soft-primary btn-icon active">
                                            <i class="ti ti-category fs-lg"></i>
                                        </a>
                                        <a href="{{ url('admin/apps-ecommerce-products') }}" class="btn btn-soft-primary btn-icon">
                                            <i class="ti ti-list-check fs-lg"></i>
                                        </a>
                                        <a href="{{ url('admin/apps-ecommerce-product-add') }}" class="btn btn-danger ms-1">
                                                ...
                                                <label for="4-star-rating" class="form-check-label d-block">
                                                    <span class="d-flex align-items-center">
                                                        <span class="flex-grow-1 d-inline-flex align-items-center">
                                                            ...
                                                            <i class="ti ti-star-filled text-warning"></i>
                                                            <i class="ti ti-star-filled text-warning"></i>
                                                            <i class="ti ti-star-filled text-muted"></i>
                            ...
                            <div class="row row-cols-xxl-4 row-cols-lg-3 row-cols-sm-2 row-col-1 g-2">
                                <div class="col">
                                    <article class="card h-100 mb-2">
                                        ...
                                        <div class="card-body pb-0">
                                            <div class="p-3">
                                                <img src="{{ asset('admin/assets/images/products/1.png') }}" alt="modern-sofa" class="img-fluid" />
                                            </div>
                                            <!-- Title -->
                                            <h6 class="card-title fs-sm lh-base mb-2">
                                                <a href="{{ url('admin/apps-ecommerce-product-details') }}" class="link-reset">Modern Minimalist Fabric Sofa Single Seater</a>
                                            </h6>
                                            ...
                                            <div>
                                                ...
                                                <span class="ms-1">
                                                    <a href="{{ url('admin/apps-ecommerce-reviews') }}" class="link-reset fw-semibold">(45)</a>
                                                </span>
                                            </div>
                                        </div>
                                ...
                                <div class="col">
                                    <article class="card h-100 mb-2">
                                        ...
                                        <div class="card-body pb-0">
                                            <div class="p-3">
                                                <img src="{{ asset('admin/assets/images/products/2.png') }}" alt="funky-shoes" class="img-fluid" />
                                            </div>
                                            <!-- Title -->
                                            <h6 class="card-title fs-sm lh-base mb-2">
                                                <a href="{{ url('admin/apps-ecommerce-product-details') }}" class="link-reset">Funky Streetwear Sneakers - Neon Splash</a>
                                            </h6>
                                            ...
                                            <div>
                                                ...
                                                <span class="ms-1">
                                                    <a href="{{ url('admin/apps-ecommerce-reviews') }}" class="link-reset fw-semibold">(32)</a>
                                                </span>
                                            </div>
                                        </div>
                                ...
                                <div class="col">
                                    <article class="card h-100 mb-2">
                                        ...
                                        <div class="card-body pb-0">
                                            <div class="p-3">
                                                <img src="{{ asset('admin/assets/images/products/3.png') }}" alt="earbuds" class="img-fluid" />
                                            </div>
                                            <!-- Title -->
                                            <h6 class="card-title fs-sm lh-base mb-2">
                                                <a href="{{ url('admin/apps-ecommerce-product-details') }}" class="link-reset">Noise Canceling Wireless Earbuds - Black Edition</a>
                                            </h6>
                                            ...
                                            <div>
                                                ...
                                                <span class="ms-1">
                                                    <a href="{{ url('admin/apps-ecommerce-reviews') }}" class="link-reset fw-semibold">(58)</a>
                                                </span>
                                            </div>
                                        </div>
                                ...
                                <div class="col">
                                    <article class="card h-100 mb-2">
                                        ...
                                        <div class="card-body pb-0">
                                            <div class="p-3">
                                                <img src="{{ asset('admin/assets/images/products/4.png') }}" alt="wooden-chair" class="img-fluid" />
                                            </div>
                                            <!-- Title -->
                                            <h6 class="card-title fs-sm lh-base mb-2">
                                                <a href="{{ url('admin/apps-ecommerce-product-details') }}" class="link-reset">Minimalist Solid Wood Dining Chair</a>
                                            </h6>
                                            ...
                                            <div>
                                                ...
                                                <span class="ms-1">
                                                    <a href="{{ url('admin/apps-ecommerce-reviews') }}" class="link-reset fw-semibold">(46)</a>
                                                </span>
                                            </div>
                                        </div>
                                ...
                                <div class="col">
                                    <article class="card h-100 mb-2">
                                        ...
                                        <div class="card-body pb-0">
                                            <div class="p-3">
                                                <img src="{{ asset('admin/assets/images/products/5.png') }}" alt="black-wall-watch" class="img-fluid" />
                                            </div>
                                            <!-- Title -->
                                            <h6 class="card-title fs-sm lh-base mb-2">
                                                <a href="{{ url('admin/apps-ecommerce-product-details') }}" class="link-reset">Modern Black Minimalist Wall Clock</a>
                                            </h6>
                                            ...
                                            <div>
                                                ...
                                                <span class="ms-1">
                                                    <a href="{{ url('admin/apps-ecommerce-reviews') }}" class="link-reset fw-semibold">(62)</a>
                                                </span>
                                            </div>
                                        </div>
                                ...
                                <div class="col">
                                    <article class="card h-100 mb-2">
                                        ...
                                        <div class="card-body pb-0">
                                            <div class="p-3">
                                                <img src="{{ asset('admin/assets/images/products/6.png') }}" alt="brown-chair" class="img-fluid" />
                                            </div>
                                            <!-- Title -->
                                            <h6 class="card-title fs-sm lh-base mb-2">
                                                <a href="{{ url('admin/apps-ecommerce-product-details') }}" class="link-reset">Elegant Brown Wooden Chair</a>
                                            </h6>
                                            ...
                                            <div>
                                                ...
                                                <span class="ms-1">
                                                    <a href="{{ url('admin/apps-ecommerce-reviews') }}" class="link-reset fw-semibold">(48)</a>
                                                </span>
                                            </div>
                                        </div>
                                ...
                                <div class="col">
                                    <article class="card h-100 mb-2">
                                        ...
                                        <div class="card-body pb-0">
                                            <div class="p-3">
                                                <img src="{{ asset('admin/assets/images/products/7.png') }}" alt="imac" class="img-fluid" />
                                            </div>
                                            <!-- Title -->
                                            <h6 class="card-title fs-sm lh-base mb-2">
                                                <a href="{{ url('admin/apps-ecommerce-product-details') }}" class="link-reset">Apple iMac 24" Retina 4.5K Display</a>
                                            </h6>
                                            ...
                                            <div>
                                                ...
                                                <span class="ms-1">
                                                    <a href="{{ url('admin/apps-ecommerce-reviews') }}" class="link-reset fw-semibold">(65)</a>
                                                </span>
                                            </div>
                                        </div>
                                ...
                                <div class="col">
                                    <article class="card h-100 mb-2">
                                        ...
                                        <div class="card-body pb-0">
                                            <div class="p-3">
                                                <img src="{{ asset('admin/assets/images/products/8.png') }}" alt="coolest-chair" class="img-fluid" />
                                            </div>
                                            <!-- Title -->
                                            <h6 class="card-title fs-sm lh-base mb-2">
                                                <a href="{{ url('admin/apps-ecommerce-product-details') }}" class="link-reset">Coolest Ergonomic Lounge Chair</a>
                                            </h6>
                                            ...
                                            <div>
                                                ...
                                                <span class="ms-1">
                                                    <a href="{{ url('admin/apps-ecommerce-reviews') }}" class="link-reset fw-semibold">(52)</a>
                                                </span>
                                            </div>
                                        </div>
                                ...
                                <div class="col">
                                    <article class="card h-100 mb-2">
                                        ...
                                        <div class="card-body pb-0">
                                            <div class="p-3">
                                                <img src="{{ asset('admin/assets/images/products/9.png') }}" alt="ipad" class="img-fluid" />
                                            </div>
                                            <!-- Title -->
                                            <h6 class="card-title fs-sm lh-base mb-2">
                                                <a href="{{ url('admin/apps-ecommerce-product-details') }}" class="link-reset">Apple iPad 10.9" Wi-Fi 64GB - Silver</a>
                                            </h6>
                                            ...
                                            <div>
                                                ...
                                                <span class="ms-1">
                                                    <a href="{{ url('admin/apps-ecommerce-reviews') }}" class="link-reset fw-semibold">(142)</a>
                                                </span>
                                            </div>
                                        </div>
                                ...
                                <div class="col">
                                    <article class="card h-100 mb-2">
                                        <div class="card-body pb-0">
                                            <div class="p-3">
                                                <img src="{{ asset('admin/assets/images/products/10.png') }}" alt="minimal-jacket" class="img-fluid" />
                                            </div>
                                            <h6 class="card-title fs-sm lh-base mb-2">
                                                <a href="{{ url('admin/apps-ecommerce-product-details') }}" class="link-reset">Minimalist Denim Jacket – Indigo Blue</a>
                                            </h6>
                                            <div>
                                                <span class="text-warning">
                                                    <i class="ti ti-star-filled"></i>
                                                ...
                                                <span class="ms-1">
                                                    <a href="{{ url('admin/apps-ecommerce-reviews') }}" class="link-reset fw-semibold">(54)</a>
                                                </span>
                                            </div>
                                        </div>
                                        <div class="card-footer bg-transparent d-flex justify-content-between">
                                ...
                                <div class="col">
                                    <article class="card h-100 mb-2">
                                        <div class="card-body pb-0">
                                            <div class="p-3">
                                                <img src="{{ asset('admin/assets/images/products/1.png') }}" alt="smartwatch" class="img-fluid" />
                                            </div>
                                            <h6 class="card-title fs-sm lh-base mb-2">
                                                <a href="{{ url('admin/apps-ecommerce-product-details') }}" class="link-reset">Next-Gen Smartwatch S9 – Graphite Black</a>
                                            </h6>
                                            <div>
                                                <span class="text-warning">
                                                    <i class="ti ti-star-filled"></i>
                                                ...
                                                <span class="ms-1">
                                                    <a href="{{ url('admin/apps-ecommerce-reviews') }}" class="link-reset fw-semibold">(128)</a>
                                                </span>
                                            </div>
                                        </div>
                                        <div class="card-footer bg-transparent d-flex justify-content-between">
                                ...
                                <div class="col">
                                    <article class="card h-100 mb-2">
                                        <div class="card-body pb-0">
                                            <div class="p-3">
                                                <img src="{{ asset('admin/assets/images/products/2.png') }}" alt="headphones" class="img-fluid" />
                                            </div>
                                            <h6 class="card-title fs-sm lh-base mb-2">
                                                <a href="{{ url('admin/apps-ecommerce-product-details') }}" class="link-reset">Noise-Cancel Pro Headphones – Arctic White</a>
                                            </h6>
                                            <div>
                                                <span class="text-warning">
                                                    <i class="ti ti-star-filled"></i>
                                                ...
                                                <span class="ms-1">
                                                    <a href="{{ url('admin/apps-ecommerce-reviews') }}" class="link-reset fw-semibold">(87)</a>
                                                </span>
                                            </div>
                                        </div>
                                        <div class="card-footer bg-transparent d-flex justify-content-between">
...
<script src="{{ asset('admin/assets/js/app.js') }}"></script>
        ...
        <script src="{{ asset('admin/assets/js/pages/ecommerce-products.js') }}"></script>
    </body>

<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-ecommerce-products-grid.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:05 GMT -->
</html>
