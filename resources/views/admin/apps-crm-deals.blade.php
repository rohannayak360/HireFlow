...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-crm-deals.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:27 GMT -->
<head>
        <meta charset="utf-8" />
        <title>CRM Deals | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Deals</h4>
                        </div>
                        ...
                        <div class="col-lg col-md-auto">
                            <div class="card mb-2">
                                <div class="card-body">
                                    ...
                                    <div class="progress progress-sm mb-0">
                                        <div class="progress-bar bg-secondary" role="progressbar" style="width: 5.1%" aria-valuenow="5.1" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <tbody class="text-nowrap">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center justify-content-center gap-1">
                                                            <a href="javascript:void(0);" class="btn btn-default btn-icon btn-sm rounded">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar-sm border flex-shrink-0 border-dashed rounded-circle me-2 justify-content-center d-flex align-items-center">
                                                                <img src="{{ asset('admin/assets/images/logos/openai.svg') }}" alt="Product" height="20" />
                                                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar-sm border flex-shrink-0 border-dashed rounded-circle me-2 justify-content-center d-flex align-items-center">
                                                                <img src="{{ asset('admin/assets/images/logos/shell.svg') }}" alt="Product" height="20" />
                                                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar-sm border flex-shrink-0 border-dashed rounded-circle me-2 justify-content-center d-flex align-items-center">
                                                                <img src="{{ asset('admin/assets/images/logos/figma.svg') }}" alt="Product" height="20" />
                                                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="avatar-sm border flex-shrink-0 border-dashed rounded-circle me-2 justify-content-center d-flex align-items-center">
                                                                <img src="{{ asset('admin/assets/images/logos/asana.svg') }}" alt="Product" height="20" />
                                                            </div>
...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-crm-deals.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:28 GMT -->
</html>
