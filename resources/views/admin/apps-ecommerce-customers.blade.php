...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-ecommerce-customers.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:11 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Customers | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                            ...
                            <div data-table data-table-rows-per-page="8" class="card">
                                <div class="card-header border-light d-flex align-items-center justify-content-between flex-wrap gap-2">
                                    ...
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <!-- Export Dropdown -->
                                        <div class="dropdown">
                                            <button class="btn btn-default dropdown-toggle drop-arrow-none" type="button" data-bs-toggle="dropdown" aria-expanded="false"><i class="ti ti-download me-1"></i> Export <i class="ti ti-chevron-down align-middle ms-1"></i></button>
                                        ...
                                        <!-- Add New Button -->
                                        <a href="#!" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addCustomerModal"> <i class="ti ti-plus me-1 fs-sm"></i> Add Customer </a>
                                    </div>
                                </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-0">
                                                                <a data-sort="customer" href="#!" class="link-reset">Carlos Méndez</a>
                                                            </h5>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td><img src="{{ asset('admin/assets/images/flags/us.svg') }}" alt="" class="rounded-circle me-1" height="16" /> United States</td>
                                                <td>2 Feb, 2024 <small class="text-muted">08:34 AM</small></td>
                                                <td>58</td>
                                                <td>$198.25</td>
                                                <td>
                                                    <div class="d-flex align-items-center justify-content-center gap-1">
                                                        <a href="javascript:void(0);" class="btn btn-default btn-icon btn-sm"> <i class="ti ti-eye fs-lg"></i></a>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-0">
                                                                <a data-sort="customer" href="#!" class="link-reset">Sophie Laurent</a>
                                                            </h5>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td><img src="{{ asset('admin/assets/images/flags/fr.svg') }}" alt="" class="rounded-circle me-1" height="16" /> France</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-0">
                                                                <a data-sort="customer" href="#!" class="link-reset">Akira Tanaka</a>
                                                            </h5>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td><img src="{{ asset('admin/assets/images/flags/jp.svg') }}" alt="" class="rounded-circle me-1" height="16" /> Japan</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-0">
                                                                <a data-sort="customer" href="#!" class="link-reset">Emma Watson</a>
                                                            </h5>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td><img src="{{ asset('admin/assets/images/flags/gb.svg') }}" alt="" class="rounded-circle me-1" height="16" /> United Kingdom</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-0">
                                                                <a data-sort="customer" href="#!" class="link-reset">Lucas Schmidt</a>
                                                            </h5>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td><img src="{{ asset('admin/assets/images/flags/de.svg') }}" alt="" class="rounded-circle me-1" height="16" /> Germany</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-0">
                                                                <a data-sort="customer" href="#!" class="link-reset">Isabella Rossi</a>
                                                            </h5>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td><img src="{{ asset('admin/assets/images/flags/it.svg') }}" alt="" class="rounded-circle me-1" height="16" /> Italy</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-0">
                                                                <a data-sort="customer" href="#!" class="link-reset">Mateo Vargas</a>
                                                            </h5>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td><img src="{{ asset('admin/assets/images/flags/ar.svg') }}" alt="" class="rounded-circle me-1" height="16" /> Argentina</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-0">
                                                                <a data-sort="customer" href="#!" class="link-reset">Priya Sharma</a>
                                                            </h5>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td><img src="{{ asset('admin/assets/images/flags/in.svg') }}" alt="" class="rounded-circle me-1" height="16" /> India</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-0">
                                                                <a data-sort="customer" href="#!" class="link-reset">Liam O’Connor</a>
                                                            </h5>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td><img src="{{ asset('admin/assets/images/flags/au.svg') }}" alt="" class="rounded-circle me-1" height="16" /> Australia</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <div>
                                                            <h5 class="mb-0">
                                                                <a data-sort="customer" href="#!" class="link-reset">Olga Petrova</a>
                                                            </h5>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td><img src="{{ asset('admin/assets/images/flags/ru.svg') }}" alt="" class="rounded-circle me-1" height="16" /> Russia</td>
...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-ecommerce-customers.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:12 GMT -->
</html>
