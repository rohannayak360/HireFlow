...
<!-- Mirrored from coderthemes.com/paces/bootstrap/form-layout.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:59:50 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Forms Layout | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Layouts</h4>
                        </div>
                                        ...
                                        <div class="col-sm-6 text-center">
                                            <div class="avatar avatar-xl mx-auto">
                                                <span class="avatar-title bg-secondary-subtle text-secondary rounded-circle fw-bold">
                                                    <i class="ti ti-user-hexagon text-secondary fs-28 fill-secondary"></i>
                                                </span>
                                            </div>
                                            ...
                                            <a href="{{ url('admin/auth-sign-up') }}" class="link-primary text-decoration-underline fw-semibold link-offset-3">Create Your Account</a>
                                        </div>
                                    </div>
                                    <!-- end row-->
                                </div>
                                                    ...
                                                    <div class="row g-4 align-items-center">
                                                        <div class="col-sm-6 border-end border-dashed">
                                                            <div class="p-4">
                                                                ...
                                                                <form>
                                                                    <div class="mb-3">
                                                                        <label for="userEmail1" class="form-label">
                                                                            Email address
                                                                            <span class="text-danger">*</span>
                                                                        </label>
                                                                        <div class="input-group">
                                                                    ...
                                                                    <div class="mb-3">
                                                                        <label for="userPassword1" class="form-label">
                                                                            Password
                                                                            <span class="text-danger">*</span>
                                                                        </label>
                                                                        <div class="input-group">
                                                        ...
                                                        <div class="col-sm-6 text-center">
                                                            <div class="avatar avatar-xl mx-auto">
                                                                <span class="avatar-title bg-purple-subtle text-purple rounded-circle fw-bold">
                                                                    <i class="ti ti-user-hexagon text-purple fs-28 fill-purple"></i>
                                                                </span>
                                                            </div>
                                                            <h4 class="mt-3">Don't Have an Account Yet?</h4>
                                                            <p class="text-muted mb-3">Join us today and unlock access to personalized features, updates, and more!</p>
