...
<!-- Mirrored from coderthemes.com/paces/bootstrap/pages-gallery.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:50 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Gallery | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
        ...
        <!-- glightbox css -->
        <link href="{{ asset('admin/assets/plugins/glightbox/glightbox.min.css') }}" rel="stylesheet" />
                                    ...
                                    <div class="row row-cols-xxl-5 row-cols-lg-4 row-cols-md-3 g-2 row-cols-1 position-relative" id="grid">
                                        ...
                                        <div class="col position-absolute" data-category="machine-learning">
                                            <div class="card border-0 mb-0 position-relative overflow-hidden gallery-item">
                                                <img class="card-img rounded-2" src="{{ asset('admin/assets/images/gallery/1.jpg') }}" alt="" />
                                                <div class="gall-overlay d-flex align-items-center justify-content-center">
                                                    ...
                                                    <a class="image-popup btn btn-sm btn-primary" href="{{ asset('admin/assets/images/gallery/1.jpg') }}">View</a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col position-absolute" data-category="machine-learning">
                                            <div class="card border-0 mb-0 position-relative overflow-hidden gallery-item">
                                                <img class="card-img rounded-2" src="{{ asset('admin/assets/images/gallery/5.jpg') }}" alt="" />
                                                <div class="gall-overlay d-flex align-items-center justify-content-center">
                                                    <div class="badge text-bg-dark badge-label position-absolute top-0 start-0 m-3 z-1">Machine Learning</div>
                                                    <a class="image-popup btn btn-sm btn-primary" href="{{ asset('admin/assets/images/gallery/5.jpg') }}">View</a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col position-absolute" data-category="machine-learning">
                                            <div class="card border-0 mb-0 position-relative overflow-hidden gallery-item">
                                                <img class="card-img rounded-2" src="{{ asset('admin/assets/images/gallery/6.jpg') }}" alt="" />
                                                <div class="gall-overlay d-flex align-items-center justify-content-center">
                                                    <div class="badge text-bg-dark badge-label position-absolute top-0 start-0 m-3 z-1">Machine Learning</div>
                                                    <a class="image-popup btn btn-sm btn-primary" href="{{ asset('admin/assets/images/gallery/6.jpg') }}">View</a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col position-absolute" data-category="machine-learning">
                                            <div class="card border-0 mb-0 position-relative overflow-hidden gallery-item">
                                                <img class="card-img rounded-2" src="{{ asset('admin/assets/images/gallery/11.jpg') }}" alt="" />
                                                <div class="gall-overlay d-flex align-items-center justify-content-center">
                                                    <div class="badge text-bg-dark badge-label position-absolute top-0 start-0 m-3 z-1">Machine Learning</div>
                                                    <a class="image-popup btn btn-sm btn-primary" href="{{ asset('admin/assets/images/gallery/11.jpg') }}">View</a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col position-absolute" data-category="computer-vision">
                                            <div class="card border-0 mb-0 position-relative overflow-hidden gallery-item">
                                                <img class="card-img rounded-2" src="{{ asset('admin/assets/images/gallery/2.jpg') }}" alt="" />
                                                <div class="gall-overlay d-flex align-items-center justify-content-center">
                                                    <div class="badge text-bg-dark badge-label position-absolute top-0 start-0 m-3 z-1">Computer Vision</div>
                                                    <a class="image-popup btn btn-sm btn-primary" href="{{ asset('admin/assets/images/gallery/2.jpg') }}">View</a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col position-absolute" data-category="computer-vision">
                                            <div class="card border-0 mb-0 position-relative overflow-hidden gallery-item">
                                                <img class="card-img rounded-2" src="{{ asset('admin/assets/images/gallery/7.jpg') }}" alt="" />
                                                <div class="gall-overlay d-flex align-items-center justify-content-center">
                                                    <div class="badge text-bg-dark badge-label position-absolute top-0 start-0 m-3 z-1">Computer Vision</div>
                                                    <a class="image-popup btn btn-sm btn-primary" href="{{ asset('admin/assets/images/gallery/7.jpg') }}">View</a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col position-absolute" data-category="computer-vision">
                                            <div class="card border-0 mb-0 position-relative overflow-hidden gallery-item">
                                                <img class="card-img rounded-2" src="{{ asset('admin/assets/images/gallery/12.jpg') }}" alt="" />
                                                <div class="gall-overlay d-flex align-items-center justify-content-center">
                                                    <div class="badge text-bg-dark badge-label position-absolute top-0 start-0 m-3 z-1">Computer Vision</div>
                                                    <a class="image-popup btn btn-sm btn-primary" href="{{ asset('admin/assets/images/gallery/12.jpg') }}">View</a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col position-absolute" data-category="nlp">
                                            <div class="card border-0 mb-0 position-relative overflow-hidden gallery-item">
                                                <img class="card-img rounded-2" src="{{ asset('admin/assets/images/gallery/3.jpg') }}" alt="" />
                                                <div class="gall-overlay d-flex align-items-center justify-content-center">
                                                    <div class="badge text-bg-dark badge-label position-absolute top-0 start-0 m-3 z-1">NLP</div>
                                                    <a class="image-popup btn btn-sm btn-primary" href="{{ asset('admin/assets/images/gallery/3.jpg') }}">View</a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col position-absolute" data-category="nlp">
                                            <div class="card border-0 mb-0 position-relative overflow-hidden gallery-item">
                                                <img class="card-img rounded-2" src="{{ asset('admin/assets/images/gallery/8.jpg') }}" alt="" />
                                                <div class="gall-overlay d-flex align-items-center justify-content-center">
                                                    <div class="badge text-bg-dark badge-label position-absolute top-0 start-0 m-3 z-1">NLP</div>
                                                    <a class="image-popup btn btn-sm btn-primary" href="{{ asset('admin/assets/images/gallery/8.jpg') }}">View</a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col position-absolute" data-category="nlp">
                                            <div class="card border-0 mb-0 position-relative overflow-hidden gallery-item">
                                                <img class="card-img rounded-2" src="{{ asset('admin/assets/images/gallery/13.jpg') }}" alt="" />
                                                <div class="gall-overlay d-flex align-items-center justify-content-center">
                                                    <div class="badge text-bg-dark badge-label position-absolute top-0 start-0 m-3 z-1">NLP</div>
                                                    <a class="image-popup btn btn-sm btn-primary" href="{{ asset('admin/assets/images/gallery/13.jpg') }}">View</a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col position-absolute" data-category="nlp">
                                            <div class="card border-0 mb-0 position-relative overflow-hidden gallery-item">
                                                <img class="card-img rounded-2" src="{{ asset('admin/assets/images/gallery/14.jpg') }}" alt="" />
                                                <div class="gall-overlay d-flex align-items-center justify-content-center">
                                                    <div class="badge text-bg-dark badge-label position-absolute top-0 start-0 m-3 z-1">NLP</div>
                                                    <a class="image-popup btn btn-sm btn-primary" href="{{ asset('admin/assets/images/gallery/14.jpg') }}">View</a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col position-absolute" data-category="robotics">
                                            <div class="card border-0 mb-0 position-relative overflow-hidden gallery-item">
                                                <img class="card-img rounded-2" src="{{ asset('admin/assets/images/gallery/4.jpg') }}" alt="" />
                                                <div class="gall-overlay d-flex align-items-center justify-content-center">
                                                    <div class="badge text-bg-dark badge-label position-absolute top-0 start-0 m-3 z-1">Robotics</div>
                                                    <a class="image-popup btn btn-sm btn-primary" href="{{ asset('admin/assets/images/gallery/4.jpg') }}">View</a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col position-absolute" data-category="robotics">
                                            <div class="card border-0 mb-0 position-relative overflow-hidden gallery-item">
                                                <img class="card-img rounded-2" src="{{ asset('admin/assets/images/gallery/9.jpg') }}" alt="" />
                                                <div class="gall-overlay d-flex align-items-center justify-content-center">
                                                    <div class="badge text-bg-dark badge-label position-absolute top-0 start-0 m-3 z-1">Robotics</div>
                                                    <a class="image-popup btn btn-sm btn-primary" href="{{ asset('admin/assets/images/gallery/9.jpg') }}">View</a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col position-absolute" data-category="robotics">
                                            <div class="card border-0 mb-0 position-relative overflow-hidden gallery-item">
                                                <img class="card-img rounded-2" src="{{ asset('admin/assets/images/gallery/10.jpg') }}" alt="" />
                                                <div class="gall-overlay d-flex align-items-center justify-content-center">
                                                    <div class="badge text-bg-dark badge-label position-absolute top-0 start-0 m-3 z-1">Robotics</div>
                                                    <a class="image-popup btn btn-sm btn-primary" href="{{ asset('admin/assets/images/gallery/10.jpg') }}">View</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<script src="{{ asset('admin/assets/js/app.js') }}"></script>
        ...
        <!-- Glightbox Plugin Js -->
        <script src="{{ asset('admin/assets/plugins/glightbox/glightbox.min.js') }}"></script>

        <!-- Web travels Plugin Js -->
        <script src="{{ asset('admin/assets/plugins/web-animations/web-animations.min.js') }}"></script>

        <!-- Muuri Plugin Js -->
        <script src="{{ asset('admin/assets/plugins/muuri/muuri.min.js') }}"></script>

        <!-- Gallery Demo Js -->
        <script src="{{ asset('admin/assets/js/pages/pages-gallery.js') }}"></script>
    </body>

<!-- Mirrored from coderthemes.com/paces/bootstrap/pages-gallery.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:55 GMT -->
</html>
