...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-task-create.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:23 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Create New Task | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Create Task</h4>
                        </div>
                            ...
                            <div class="card-body">
                                ...
                                <form>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="taskDescription" rows="4" placeholder="Write a short task description..."></textarea>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" data-provider="flatpickr" data-date-format="d M, Y" class="form-control" id="startDate" />
                                        </div>
                                        <!-- End Start Date -->
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" data-provider="flatpickr" data-date-format="d M, Y" class="form-control" id="dueDate" />
                                        </div>
                                        <!-- End Due Date -->
                                    </div>
                                    <!-- End Dates -->
                                    ...
                                    <div class="d-flex justify-content-end mt-4">
                                        ...
                                        <button type="submit" class="btn btn-primary"><i class="ti ti-plus me-1"></i> Create Task</button>
                                    </div>
                                    <!-- End Buttons -->
                                </form>
                                <!-- End Form -->
