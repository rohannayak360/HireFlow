...
<!-- Mirrored from coderthemes.com/paces/bootstrap/plugins-idle-timer.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:58 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Idle Timer | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                                    ...
                                    <div class="toast-container position-fixed top-0 end-0 p-3">
                                        ...
                                        <div id="liveToast" class="toast shadow-lg text-bg-warning border-warning" role="alert" aria-live="assertive" aria-atomic="true">
                                            <div class="toast-header text-bg-warning border-warning">
                                                <img src="{{ asset('admin/assets/images/logo-sm.png') }}" class="rounded me-2" height="20" alt="..." />
...
<script src="{{ asset('admin/assets/js/app.js') }}"></script>
        ...
        <script src="{{ asset('admin/assets/js/pages/plugins-idle-timer.js') }}"></script>
    </body>

<!-- Mirrored from coderthemes.com/paces/bootstrap/plugins-idle-timer.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:59 GMT -->
</html>
