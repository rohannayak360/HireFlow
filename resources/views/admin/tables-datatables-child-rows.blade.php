...
<!-- Mirrored from coderthemes.com/paces/bootstrap/tables-datatables-child-rows.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 10:00:03 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Child Row Datatables | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
...
<script src="{{ asset('admin/assets/js/app.js') }}"></script>
        ...
        <!-- Page js -->
        <script src="{{ asset('admin/assets/js/pages/datatables-child-rows.js') }}"></script>
    </body>
