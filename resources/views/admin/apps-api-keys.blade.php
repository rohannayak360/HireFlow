...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-api-keys.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:45 GMT -->
<head>
        <meta charset="utf-8" />
        <title>API Keys | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">API Keys</h4>
                        </div>
                            ...
                            <div data-table data-table-rows-per-page="8" class="card">
                                <div class="card-header border-light justify-content-between">
                                    <div class="d-flex gap-2">
                                        ...
                                        <button type="button" class="btn btn-secondary btn-icon" data-bs-toggle="modal" data-bs-target="#addApiKeyModal">
                                    ...
                                    <table class="table text-nowrap table-custom table-centered table-hover w-100 mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="d-flex align-items-center fs-sm fw-bold">
                                                        <img src="{{ asset('admin/assets/images/flags/ca.svg') }}" alt="" class="rounded-circle me-1" height="12" />
                                                        CA
                                                    </span>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="d-flex align-items-center fs-sm fw-bold">
                                                        <img src="{{ asset('admin/assets/images/flags/fr.svg') }}" alt="" class="rounded-circle me-1" height="12" />
                                                        FR
                                                    </span>
                                                </td>
                                                <td>
...
<script src="{{ asset('admin/assets/js/app.js') }}"></script>
        ...
        <!-- APIKey Page Init -->
        <script src="{{ asset('admin/assets/js/pages/apps-api-keys.js') }}"></script>
    </body>

<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-api-keys.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:46 GMT -->
</html>
