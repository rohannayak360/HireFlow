...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-promo-coupons.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:38 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Coupons | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Coupons</h4>
                        </div>
                                ...
                                <div class="card-header border-light justify-content-between">
                                    <div class="d-flex gap-2">
                                        ...
                                        <div class="app-search">
                                            <input data-table-search type="search" class="form-control" placeholder="Search coupon..." />
                                            <i class="ti ti-search app-search-icon text-muted"></i>
                                        </div>
                                    ...
                                    <div class="d-flex align-items-center gap-2 flex-wrap">
                                        ...
                                        <!-- Status Filter -->
                                        <div class="app-search">
                                            <select data-table-filter="coupon-status" class="form-select form-control my-1 my-md-0">
                                        ...
                                        <!-- Type Filter -->
                                        <div class="app-search">
                                            <select data-table-filter="coupon-type" class="form-select form-control my-1 my-md-0">
                                    ...
                                    <div class="d-flex gap-1">
                                        <button class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#addCouponModal"><i class="ti ti-plus me-1"></i> Add Coupon</button>
                                    </div>
                                </div>
                                <!-- /.card-header -->
                                    ...
                                    <table class="table table-custom table-centered table-select table-hover w-100 mb-0">
                                        <thead class="bg-light align-middle bg-opacity-25 thead-sm">
                                            <tr class="text-uppercase fs-xxs">
                                                ...
                                                <th data-table-sort data-column="coupon-type">Discount Type</th>
                                                ...
                                                <th data-table-sort data-column="coupon-status">Status</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="fs-sm mb-0">
                                                        <a href="#!" class="link-reset">SAVE20</a>
                                                    </h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="fs-sm mb-0">
                                                        <a href="#!" class="link-reset">FREESHIP</a>
                                                    </h5>
                                                ...
                                                <td>Unlimited</td>
                                                <td>230</td>
                                                <td class="text-warning fw-semibold"><i class="ti ti-circle-filled fs-sm me-1"></i> Upcoming</td>
                                                <td>
                                                    <div class="d-flex justify-content-center gap-1">
                                                        <a href="#!" class="btn btn-default btn-icon btn-sm">
                                                            <i class="ti ti-eye fs-lg"></i>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="fs-sm mb-0">
                                                        <a href="#!" class="link-reset">WELCOME10</a>
                                                    </h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="fs-sm mb-0">
                                                        <a href="#!" class="link-reset">SUMMER25</a>
                                                    </h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="fs-sm mb-0">
                                                        <a href="#!" class="link-reset">FLAT50</a>
                                                    </h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="fs-sm mb-0">
                                                        <a href="#!" class="link-reset">WINTER15</a>
                                                    </h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="fs-sm mb-0">
                                                        <a href="#!" class="link-reset">BULK30</a>
                                                    </h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="fs-sm mb-0">
                                                        <a href="#!" class="link-reset">NEWYEAR40</a>
                                                    </h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="fs-sm mb-0">
                                                        <a href="#!" class="link-reset">APP20</a>
                                                    </h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="fs-sm mb-0">
                                                        <a href="#!" class="link-reset">VIP100</a>
                                                    </h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="fs-sm mb-0">
                                                        <a href="#!" class="link-reset">FIRSTBUY15</a>
                                                    </h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h5 class="fs-sm mb-0">
                                                        <a href="#!" class="link-reset">FALL30</a>
                                                    </h5>
                        ...
                        <div class="modal-dialog modal-lg modal-dialog-centered">
                            <div class="modal-content border-0 shadow">
                                <div class="modal-header bg-light">
                                    <h5 class="modal-title fw-semibold" id="addCouponModalLabel"><i class="ti ti-ticket me-2 text-primary"></i> Add New Coupon</h5>
                                ...
                                <form id="addCouponForm">
                                    <div class="modal-body">
                                        <div class="row g-3">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="number" class="form-control" name="discount_value" placeholder="e.g., 20 or 50" required />
                                            </div>

                                            <!-- Minimum Order -->
                                            <div class="col-md-6">
                                                <label class="form-label">Minimum Order Value</label>
                                                <input type="number" class="form-control" name="min_order" placeholder="e.g., 100" />
                                            </div>

                                            <!-- Start Date -->
                                            <div class="col-md-6">
                                                <label class="form-label">Start Date <span class="text-danger">*</span></label>
                                                <input type="text" data-provider="flatpickr" data-date-format="d M, Y" class="form-control" name="start_date" placeholder="Select start date" required />
                                            </div>

                                            <!-- End Date -->
                                            <div class="col-md-6">
                                                <label class="form-label">End Date <span class="text-danger">*</span></label>
                                                <input type="text" data-provider="flatpickr" data-date-format="d M, Y" class="form-control" name="end_date" placeholder="Select end date" required />
                                            </div>

                                            <!-- Usage Limit -->
                                            <div class="col-md-6">
                                                <label class="form-label">Usage Limit</label>
                                                <input type="number" class="form-control" name="usage_limit" placeholder="e.g., 1000" />
                                            </div>

                                            <!-- Per User Limit -->
                                            <div class="col-md-6">
                                                <label class="form-label">Per User Limit</label>
                                                <input type="number" class="form-control" name="user_limit" placeholder="e.g., 5" />
                                            </div>
                                            ...
                                            <div class="col-12">
                                                <div class="d-flex flex-wrap gap-3 mt-2">
                                                    ...
                                                    <div class="form-check form-switch">
                                                        <input class="form-check-input" type="checkbox" id="isFreeShipping" />
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="submit" class="btn btn-primary"><i class="ti ti-plus me-1"></i> Add Coupon</button>
                                    </div>
                                </form>
                            </div>
                            <!-- /.modal-content -->
