...
<!-- Mirrored from coderthemes.com/paces/bootstrap/widgets-mixed.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:59:15 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Mixed Widgets | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Mixed</h4>
                        </div>
                        ...
                        <div class="text-end">
                            <ol class="breadcrumb m-0 py-0">
                                ...
                                <li class="breadcrumb-item active">Mixed</li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-3 row-cols-xxl-5">
                        <div class="col">
                            <div class="card border-0 rounded-3 text-white" style="background-image: url({{ asset('admin/assets/images/stock/small-6.jpg') }}); background-size: cover">
                                <div class="card-body bg-gradient bg-primary bg-opacity-90 rounded-3">
                                    <iconify-icon icon="solar:wallet-money-bold-duotone" class="fs-36"></iconify-icon>
                                    ...
                                    <h4 class="fw-medium fs-16 mb-1 text-white">$<span data-target="3200">0</span></h4>
                                </div>
                            </div>
                        </div>
                        <!-- end col -->
                        ...
                        <div class="col">
                            <div class="card border-0 rounded-3 text-white" style="background-image: url({{ asset('admin/assets/images/stock/small-7.jpg') }}); background-size: cover">
                                <div class="card-body bg-gradient bg-secondary bg-opacity-90 rounded-3">
                                    <iconify-icon icon="solar:airbuds-bold-duotone" class="fs-36"></iconify-icon>
                                    ...
                                    <h4 class="fw-medium fs-16 mb-1 text-white">$<span data-target="1800">0</span></h4>
                                </div>
                            </div>
                        </div>
                        <!-- end col -->
                        ...
                        <div class="col">
                            <div class="card border-0 rounded-3 text-white" style="background-image: url({{ asset('admin/assets/images/stock/small-8.jpg') }}); background-size: cover">
                                <div class="card-body bg-gradient bg-warning bg-opacity-90 rounded-3">
                                    <iconify-icon icon="solar:medal-ribbons-star-bold-duotone" class="fs-36"></iconify-icon>
                                    ...
                                    <h4 class="fw-medium fs-16 mb-1 text-white">$<span data-target="5000">0</span></h4>
                                </div>
                            </div>
                        </div>
                        <!-- end col -->
                        ...
                        <div class="col">
                            <div class="card border-0 rounded-3 text-white" style="background-image: url({{ asset('admin/assets/images/stock/small-9.jpg') }}); background-size: cover">
                                <div class="card-body bg-gradient bg-danger bg-opacity-90 rounded-3">
                                    <iconify-icon icon="solar:heart-pulse-bold-duotone" class="fs-36"></iconify-icon>
                                    ...
                                    <h4 class="fw-medium fs-16 mb-1 text-white">$<span data-target="2400">0</span></h4>
                                </div>
                            </div>
                        </div>
                        <!-- end col -->
                        ...
                        <div class="col">
                            <div class="card border-0 rounded-3 text-white" style="background-image: url({{ asset('admin/assets/images/stock/small-10.jpg') }}); background-size: cover">
                                <div class="card-body bg-gradient bg-info bg-opacity-90 rounded-3">
                                    <iconify-icon icon="solar:lightbulb-bolt-bold-duotone" class="fs-36"></iconify-icon>
                                    ...
                                    <h4 class="fw-medium fs-16 mb-1 text-white">$<span data-target="15000">0</span></h4>
                                </div>
                            </div>
                        </div>
                        <!-- end col -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4">
                            <div class="card bg-success bg-gradient border-0">
                                <div class="card-body" style="background-image: url({{ asset('admin/assets/images/flower-style.svg') }}); background-size: contain; background-repeat: no-repeat; background-position: right bottom">
                                    ...
                                    <div class="d-flex gap-1">
                                        <a href="#!" class="btn btn-sm btn-success bg-white bg-opacity-10"> <i class="ti ti-chart-bar me-1"></i> Report </a>
                                        <a href="#!" class="btn btn-sm btn-success bg-white bg-opacity-10">
                                            <i class="ti ti-phone"></i>
                                        </a>
                                        <a href="#!" target="_blank" class="btn btn-sm btn-success bg-white bg-opacity-10">
                            ...
                            <div class="card bg-info bg-gradient border-0">
                                <div class="card-body" style="background-image: url({{ asset('admin/assets/images/flower-style.svg') }}); background-size: contain; background-repeat: no-repeat; background-position: right bottom">
                                    ...
                                    <div class="d-flex gap-2">
                                        <a href="#!" class="btn btn-sm btn-info bg-white bg-opacity-10"> <i class="ti ti-users me-1"></i> Insights </a>
                                        <a href="#!" class="btn btn-sm btn-info bg-white bg-opacity-10">
                        ...
                        <div class="col-xl-4">
                            <div class="card bg-danger bg-gradient border-0">
                                <div class="card-body" style="background-image: url({{ asset('admin/assets/images/flower-style.svg') }}); background-size: contain; background-repeat: no-repeat; background-position: right bottom">
                                    ...
                                    <div class="d-flex gap-2">
                                        <a href="#!" class="btn btn-sm btn-danger bg-white bg-opacity-10"> <i class="ti ti-bell me-1"></i> Alerts </a>
                                        <a href="#!" class="btn btn-sm btn-danger bg-white bg-opacity-10">
                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-center mb-4">
                                        <div class="me-3 position-relative">
                                            <img src="{{ asset('admin/assets/images/users/user-5.jpg') }}" alt="avatar" class="rounded-circle" width="72" height="72" />
                                        ...
                                        <div>
                                            <h5 class="mb-1 d-flex align-items-center">
                                                ...
                                                <img src="{{ asset('admin/assets/images/flags/gb.svg') }}" alt="UK" class="ms-2 rounded-circle" height="16" />
                                            </h5>
                                        ...
                                        <li class="mb-2">
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                <h5 class="fs-base mb-0 fw-medium">
                                                    <a href="#" class="link-reset">sophia&#64;designhub.com</a>
                                                </h5>
                                            </div>
                                        </li>
                                        <li class="mb-2">
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                <h5 class="fs-base mb-0 fw-medium">
                                                    <a href="#" class="link-reset">+44 7911 123456</a>
                                                </h5>
                                            </div>
                                        </li>
                                        <li class="mb-2">
                        ...
                        <div class="col-md-6 col-xxl-3">
                            <div class="card card-h-100">
                                <div class="card-body">
                                    <div class="d-flex align-items-center mb-4">
                                        <div class="me-3 position-relative">
                                            <img src="{{ asset('admin/assets/images/users/user-6.jpg') }}" alt="avatar" class="rounded-circle" width="72" height="72" />
                                        ...
                                        <div>
                                            <h5 class="mb-1 d-flex align-items-center">
                                                <a href="#!" class="link-reset">Marcus Lee</a>
                                                <img src="{{ asset('admin/assets/images/flags/us.svg') }}" alt="US" class="ms-2 rounded-circle" height="16" />
                                            </h5>
                                    ...
                                    <ul class="list-unstyled text-muted mb-4">
                                        <li class="mb-2">
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                <h5 class="fs-base mb-0 fw-medium">
                                                    <a href="#" class="link-reset">marcus&#64;devhub.com</a>
                                                </h5>
                                            </div>
                                        </li>
                                        <li class="mb-2">
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                <h5 class="fs-base mb-0 fw-medium">
                                                    <a href="#" class="link-reset">+1 408-222-9876</a>
                                                </h5>
                                            </div>
                                        </li>
                                        <li class="mb-2">
                        ...
                        <div class="col-md-6 col-xxl-3">
                            <div class="card card-h-100">
                                <div class="card-body">
                                    <div class="d-flex align-items-center mb-4">
                                        <div class="me-3 position-relative">
                                            <img src="{{ asset('admin/assets/images/users/user-7.jpg') }}" alt="avatar" class="rounded-circle" width="72" height="72" />
                                    ...
                                    <ul class="list-unstyled text-muted mb-4">
                                        <li class="mb-2">
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                <h5 class="fs-base mb-0 fw-medium">
                                                    <a href="#" class="link-reset">emily&#64;marketboost.com</a>
                                                </h5>
                                            </div>
                                        </li>
                                        <li class="mb-2">
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                <h5 class="fs-base mb-0 fw-medium">
                                                    <a href="#" class="link-reset">+1 212-555-7890</a>
                                                </h5>
                                            </div>
                                        </li>
                                        <li class="mb-2">
                        ...
                        <div class="col-md-6 col-xxl-3">
                            <div class="card card-h-100">
                                <div class="card-body">
                                    <div class="d-flex align-items-center mb-4">
                                        <div class="me-3 position-relative">
                                            <img src="{{ asset('admin/assets/images/users/user-8.jpg') }}" alt="avatar" class="rounded-circle" width="72" height="72" />
                                        ...
                                        <div>
                                            <h5 class="mb-1">
                                                <a href="#!" class="link-reset">Daniel Smith</a>
                                                <img src="{{ asset('admin/assets/images/flags/ca.svg') }}" alt="US" class="ms-2 rounded-circle" height="16" />
                                            </h5>
                                    ...
                                    <ul class="list-unstyled text-muted mb-4">
                                        <li class="mb-2">
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                <h5 class="fs-base mb-0 fw-medium">
                                                    <a href="#" class="link-reset">daniel&#64;analyticspro.io</a>
                                                </h5>
                                            </div>
                                        </li>
                                        <li class="mb-2">
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                <h5 class="fs-base mb-0 fw-medium">
                                                    <a href="#" class="link-reset">+1 987-654-3210</a>
                                                </h5>
                                            </div>
                                        </li>
                                        <li class="mb-2">
                    ...
                    <div class="row">
                        <div class="col-xl-4">
                            <div class="card">
                                ...
                                <div class="card-body py-0" style="height: 360px" id="chat-container" data-simplebar>
                                    <!-- Message 1 -->
                                    <div class="d-flex align-items-start gap-2 my-3 chat-item">
                                        <img src="{{ asset('admin/assets/images/users/user-5.jpg') }}" class="avatar-md rounded-circle" alt="User" />
                                        <div>
                                    ...
                                    <div class="d-flex align-items-start gap-2 my-3 text-end chat-item justify-content-end">
                                        ...
                                        <img src="{{ asset('admin/assets/images/users/user-2.jpg') }}" class="avatar-md rounded-circle" alt="User" />
                                    </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="text-center mt-3">
                                        <a href="#!" class="link-reset text-decoration-underline fw-semibold link-offset-3"> View all Links <i class="ti ti-link"></i> </a>
                                    </div>
                                </div>
                                <!-- end card-body-->
                            </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-center gap-2 mb-3">
                                        <img src="{{ asset('admin/assets/images/flags/in.svg') }}" alt="India" class="avatar-xxs rounded" />
                                        <h5 class="mb-0 fw-medium"><a href="#!" class="link-reset">India</a> <small class="text-muted">Pop: 1.43B</small></h5>
                                        <div class="ms-auto">
                                    ...
                                    <div class="d-flex align-items-center gap-2 mb-3">
                                        <img src="{{ asset('admin/assets/images/flags/de.svg') }}" alt="Germany" class="avatar-xxs rounded" />
                                        <h5 class="mb-0 fw-medium"><a href="#!" class="link-reset">Germany</a> <small class="text-muted">Pop: 83.2M</small></h5>
                                        <div class="ms-auto">
                                            <div class="d-flex align-items-center gap-3 text-end">
                                    ...
                                    <div class="d-flex align-items-center gap-2 mb-3">
                                        <img src="{{ asset('admin/assets/images/flags/fr.svg') }}" alt="France" class="avatar-xxs rounded" />
                                        <h5 class="mb-0 fw-medium"><a href="#!" class="link-reset">France</a> <small class="text-muted">Pop: 67.5M</small></h5>
                                        <div class="ms-auto">
                                            <div class="d-flex align-items-center gap-3 text-end">
                                    ...
                                    <div class="d-flex align-items-center gap-2 mb-3">
                                        <img src="{{ asset('admin/assets/images/flags/us.svg') }}" alt="United States" class="avatar-xxs rounded" />
                                        <h5 class="mb-0 fw-medium"><a href="#!" class="link-reset">United States</a> <small class="text-muted">Pop: 339.9M</small></h5>
                                        <div class="ms-auto">
                                            <div class="d-flex align-items-center gap-3 text-end">
                                    ...
                                    <div class="d-flex align-items-center gap-2 mb-3">
                                        <img src="{{ asset('admin/assets/images/flags/gb.svg') }}" alt="United Kingdom" class="avatar-xxs rounded" />
                                        <h5 class="mb-0 fw-medium"><a href="#!" class="link-reset">United Kingdom</a> <small class="text-muted">Pop: 67.3M</small></h5>
                                        <div class="ms-auto">
                                            <div class="d-flex align-items-center gap-3 text-end">
                                    ...
                                    <div class="d-flex align-items-center gap-2 mb-3">
                                        <img src="{{ asset('admin/assets/images/flags/ca.svg') }}" alt="Canada" class="avatar-xxs rounded" />
                                        <h5 class="mb-0 fw-medium"><a href="#!" class="link-reset">Canada</a> <small class="text-muted">Pop: 39.6M</small></h5>
                                        <div class="ms-auto">
                                            <div class="d-flex align-items-center gap-3 text-end">
                                    ...
                                    <div class="d-flex align-items-center gap-2 mb-3">
                                        <img src="{{ asset('admin/assets/images/flags/jp.svg') }}" alt="Japan" class="avatar-xxs rounded" />
                                        <h5 class="mb-0 fw-medium"><a href="#!" class="link-reset">Japan</a> <small class="text-muted">Pop: 123.3M</small></h5>
                                        <div class="ms-auto">
                                            <div class="d-flex align-items-center gap-3 text-end">
                                    ...
                                    <div class="d-flex align-items-center gap-2 mb-3">
                                        <img src="{{ asset('admin/assets/images/flags/au.svg') }}" alt="Australia" class="avatar-xxs rounded" />
                                        <h5 class="mb-0 fw-medium"><a href="#!" class="link-reset">Australia</a> <small class="text-muted">Pop: 26.8M</small></h5>
                                        <div class="ms-auto">
                                            <div class="d-flex align-items-center gap-3 text-end">
                                    ...
                                    <div class="text-center mt-4">
                                        <a href="#!" class="link-reset text-decoration-underline fw-semibold link-offset-3"> View all Countries <i class="ti ti-world"></i> </a>
                                    </div>
                                </div>
                                <!-- end card-body -->
                            </div>
                                ...
                                <div class="col-xl-6">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center mb-1">
                                                <div class="d-flex align-items-center gap-2">
                                                    <img src="{{ asset('admin/assets/images/logos/meta.svg') }}" alt="Meta" class="avatar-xxs rounded" />
                                                    <span>Facebook</span>
                                                </div>
                                            ...
                                            <div class="d-flex justify-content-between align-items-center mb-1">
                                                <div class="d-flex align-items-center gap-2">
                                                    <img src="{{ asset('admin/assets/images/logos/instagram.svg') }}" alt="Meta" class="avatar-xxs rounded" />
                                                    <span>Instagram</span>
                                                </div>
                                            ...
                                            <div class="d-flex justify-content-between align-items-center mb-1">
                                                <div class="d-flex align-items-center gap-2">
                                                    <img src="{{ asset('admin/assets/images/logos/linkedin.svg') }}" alt="Meta" class="avatar-xxs rounded" />
                                                    <span>LinkedIn</span>
                                                </div>
                                            ...
                                            <div class="d-flex justify-content-between align-items-center mb-1">
                                                <div class="d-flex align-items-center gap-2">
                                                    <img src="{{ asset('admin/assets/images/logos/google.svg') }}" alt="Meta" class="avatar-xxs rounded" />
                                            ...
                                            <div class="d-flex justify-content-between align-items-center mb-1">
                                                <div class="d-flex align-items-center gap-2">
                                                    <img src="{{ asset('admin/assets/images/logos/x.svg') }}" alt="Twitter X" class="avatar-xxs rounded" />
                                                    <span>Twitter / X</span>
                                                </div>
                                    ...
                                    <div class="card bg-secondary bg-gradient border-0">
                                        <div class="card-body" style="background-image: url({{ asset('admin/assets/images/flower-style.svg') }}); background-size: contain; background-repeat: no-repeat; background-position: right bottom">
                                            ...
                                            <a href="mailto:support&#64;company.com" class="btn btn-light w-100"> Contact Support </a>
                                        </div>
                                    </div>
                                </div>
                                <!-- end col-->
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="avatar-group avatar-group-sm mb-3">
                                                <div class="avatar">
                                                    <img src="{{ asset('admin/assets/images/users/user-7.jpg') }}" alt="" class="rounded-circle avatar-sm" />
                                                </div>
                                                <div class="avatar">
                                                    <img src="{{ asset('admin/assets/images/users/user-8.jpg') }}" alt="" class="rounded-circle avatar-sm" />
                                                </div>
                                                <div class="avatar">
                                                    <img src="{{ asset('admin/assets/images/users/user-9.jpg') }}" alt="" class="rounded-circle avatar-sm" />
                                                </div>
                                                <div class="avatar">
                                                    <img src="{{ asset('admin/assets/images/users/user-10.jpg') }}" alt="" class="rounded-circle avatar-sm" />
                                                </div>
                                            </div>

                                            <!-- Text -->
                                            <p class="mb-1"><strong>5 Team Members</strong> are currently waiting for your update on this project.</p>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-center mb-3">
                                                <div class="avatar-group avatar-group-sm me-2">
                                                    <div class="avatar">
                                                        <img src="{{ asset('admin/assets/images/users/user-2.jpg') }}" class="rounded-circle avatar-sm" />
                                                    </div>
                                                    <div class="avatar">
                                                        <img src="{{ asset('admin/assets/images/users/user-3.jpg') }}" class="rounded-circle avatar-sm" />
                                                    </div>
                                                    <div class="avatar">
                                                        <img src="{{ asset('admin/assets/images/users/user-4.jpg') }}" class="rounded-circle avatar-sm" />
                                                    </div>
                                                    <div class="avatar">
                                                        <img src="{{ asset('admin/assets/images/users/user-5.jpg') }}" class="rounded-circle avatar-sm" />
                                                    </div>
                                                </div>
                                            ...
                                            <!-- Project Info -->
                                            <div class="mb-3">
                                                <p class="mb-1"><strong>Design System Revamp</strong> requires your final approval.</p>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="app-search">
                                        <input type="text" class="form-control" placeholder="Search something here..." />
                                        <iconify-icon icon="solar:magic-stick-3-bold-duotone" class="app-search-icon text-secondary fs-18"></iconify-icon>
                                    </div>
                                    ...
                                    <div class="app-search mt-3">
                                        <input type="text" class="form-control border-light bg-body" placeholder="Search something here..." />
                                        <i data-lucide="search" class="app-search-icon text-muted"></i>
                                    </div>
                                </div>
                                <!-- card-body-->
...
<!-- Mirrored from coderthemes.com/paces/bootstrap/widgets-mixed.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:59:16 GMT -->
</html>
