...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-finance-income.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:32 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Income | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Income</h4>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="text-end">
                                            <h3 class="mb-2 fw-normal">$<span data-target="45280">0</span></h3>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="text-end">
                                            <h3 class="mb-2 fw-normal">$<span data-target="38560">0</span></h3>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="text-end">
                                            <h3 class="mb-2 fw-normal">$<span data-target="4860">0</span></h3>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="text-end">
                                            <h3 class="mb-2 fw-normal">$<span data-target="1120">0</span></h3>
                                ...
                                <div class="card-header border-light justify-content-between">
                                    <div class="d-flex gap-2">
                                        ...
                                        <div class="app-search">
                                            <input data-table-search type="search" class="form-control" placeholder="Search income..." />
                                            <i class="ti ti-search app-search-icon text-muted"></i>
                                        </div>

                                        <!-- Add New Income -->
                                        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#incomeModal"><i class="ti ti-plus me-1"></i> Add Income</button>
                                    ...
                                    <div class="d-flex align-items-center gap-2 flex-wrap">
                                        ...
                                        <!-- Source Filter -->
                                        <div class="app-search">
                                            <select data-table-filter="income-source" class="form-select form-control my-1 my-md-0">
                                        ...
                                        <table class="table table-custom table-centered table-select table-hover w-100 mb-0">
                                            <thead class="bg-light align-middle bg-opacity-25 thead-sm text-nowrap">
                                                <tr class="text-uppercase fs-xxs">
                                                    ...
                                                    <th>Income Title</th>
                                                    <th data-table-sort data-column="income-source">Source</th>
                                                    <th>Payment Type</th>
                                            ...
                                            <tbody class="text-nowrap">
                                                <tr>
                                                    ...
                                                    <td><a href="#!" class="fw-semibold link-reset">#INC-1001</a></td>
                                                    <td>Website Development Payment</td>
                                                    <td data-column="income-source">Services</td>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <img src="{{ asset('admin/assets/images/cards/visa.svg') }}" alt="Visa" class="me-2" height="26" />
                                                            <span>**** 3294</span>
                                                        </div>
                                                    </td>
                                                    <td>$1,250.00</td>
                                                    <td><span class="badge bg-success-subtle text-success badge-label">Received</span></td>
                                                    <td>03 Oct, 2025 <small class="text-muted">11:00 AM</small></td>
                                                    <td>
                                                        <div class="d-flex gap-2 align-items-center">
                                                            <img src="{{ asset('admin/assets/images/users/user-3.jpg') }}" alt="Emily Clark" class="avatar-xs rounded-circle" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="#!" class="fw-semibold link-reset">#INC-1002</a></td>
                                                    <td>Consulting Fees (Q3)</td>
                                                    <td data-column="income-source">Consulting</td>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <img src="{{ asset('admin/assets/images/cards/mastercard.svg') }}" alt="MasterCard" class="me-2" height="26" />
                                                            <span>**** 8712</span>
                                                        </div>
                                                    </td>
                                                    <td>$780.00</td>
                                                    <td><span class="badge bg-warning-subtle text-warning badge-label">Pending</span></td>
                                                    <td>01 Oct, 2025 <small class="text-muted">04:20 PM</small></td>
                                                    <td>
                                                        <div class="d-flex gap-2 align-items-center">
                                                            <img src="{{ asset('admin/assets/images/users/user-7.jpg') }}" alt="Daniel Ray" class="avatar-xs rounded-circle" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="#!" class="fw-semibold link-reset">#INC-1003</a></td>
                                                    ...
                                                    <td>$2,430.00</td>
                                                    <td><span class="badge bg-success-subtle text-success badge-label">Received</span></td>
                                                    <td>04 Oct, 2025 <small class="text-muted">02:35 PM</small></td>
                                                    <td>
                                                        <div class="d-flex gap-2 align-items-center">
                                                            <img src="{{ asset('admin/assets/images/users/user-4.jpg') }}" alt="Emma Johnson" class="avatar-xs rounded-circle" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="#!" class="fw-semibold link-reset">#INC-1004</a></td>
                                                    <td>Affiliate Payout - September</td>
                                                    <td data-column="income-source">Affiliate</td>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <img src="{{ asset('admin/assets/images/cards/paypal.svg') }}" alt="PayPal" class="me-2" height="26" />
                                                            <span>PayPal</span>
                                                        </div>
                                                    </td>
                                                    <td>$645.25</td>
                                                    <td><span class="badge bg-success-subtle text-success badge-label">Received</span></td>
                                                    <td>02 Oct, 2025 <small class="text-muted">09:30 AM</small></td>
                                                    <td>
                                                        <div class="d-flex gap-2 align-items-center">
                                                            <img src="{{ asset('admin/assets/images/users/user-6.jpg') }}" alt="David Wilson" class="avatar-xs rounded-circle" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="#!" class="fw-semibold link-reset">#INC-1005</a></td>
                                                    ...
                                                    <td>$1,120.00</td>
                                                    <td><span class="badge bg-warning-subtle text-warning badge-label">Pending</span></td>
                                                    <td>29 Sep, 2025 <small class="text-muted">01:15 PM</small></td>
                                                    <td>
                                                        <div class="d-flex gap-2 align-items-center">
                                                            <img src="{{ asset('admin/assets/images/users/user-8.jpg') }}" alt="Lucas Martin" class="avatar-xs rounded-circle" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="#!" class="fw-semibold link-reset">#INC-1006</a></td>
                                                    <td>Investment Dividend Q3</td>
                                                    <td data-column="income-source">Investments</td>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <img src="{{ asset('admin/assets/images/cards/note.svg') }}" alt="Bank Transfer" class="me-2" height="26" />
                                                            <span>Bank Transfer</span>
                                                        </div>
                                                    </td>
                                                    <td>$3,950.50</td>
                                                    <td><span class="badge bg-success-subtle text-success badge-label">Received</span></td>
                                                    <td>27 Sep, 2025 <small class="text-muted">10:00 AM</small></td>
                                                    <td>
                                                        <div class="d-flex gap-2 align-items-center">
                                                            <img src="{{ asset('admin/assets/images/users/user-9.jpg') }}" alt="Olivia Brown" class="avatar-xs rounded-circle" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="#!" class="fw-semibold link-reset">#INC-1007</a></td>
                                                    ...
                                                    <td>$870.75</td>
                                                    <td><span class="badge bg-success-subtle text-success badge-label">Received</span></td>
                                                    <td>25 Sep, 2025 <small class="text-muted">08:10 PM</small></td>
                                                    <td>
                                                        <div class="d-flex gap-2 align-items-center">
                                                            <img src="{{ asset('admin/assets/images/users/user-10.jpg') }}" alt="Ethan Brooks" class="avatar-xs rounded-circle" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="#!" class="fw-semibold link-reset">#INC-1008</a></td>
                                                    ...
                                                    <td>$2,200.00</td>
                                                    <td><span class="badge bg-success-subtle text-success badge-label">Received</span></td>
                                                    <td>22 Sep, 2025 <small class="text-muted">12:30 PM</small></td>
                                                    <td>
                                                        <div class="d-flex gap-2 align-items-center">
                                                            <img src="{{ asset('admin/assets/images/users/user-7.jpg') }}" alt="Liam Davis" class="avatar-xs rounded-circle" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="#!" class="fw-semibold link-reset">#INC-1009</a></td>
                                                    ...
                                                    <td>$399.00</td>
                                                    <td><span class="badge bg-warning-subtle text-warning badge-label">Pending</span></td>
                                                    <td>20 Sep, 2025 <small class="text-muted">04:05 PM</small></td>
                                                    <td>
                                                        <div class="d-flex gap-2 align-items-center">
                                                            <img src="{{ asset('admin/assets/images/users/user-1.jpg') }}" alt="Sophia Turner" class="avatar-xs rounded-circle" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="#!" class="fw-semibold link-reset">#INC-1010</a></td>
                                                    <td>Refund - Cancelled Subscription</td>
                                                    <td data-column="income-source">Other</td>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <img src="{{ asset('admin/assets/images/cards/american-express.svg') }}" alt="Amex" class="me-2" height="26" />
                                                            <span>**** 9812</span>
                                                        </div>
                                                    </td>
                                                    <td>$-125.00</td>
                                                    <td><span class="badge bg-danger-subtle text-danger badge-label">Refunded</span></td>
                                                    <td>18 Sep, 2025 <small class="text-muted">05:45 PM</small></td>
                                                    <td>
                                                        <div class="d-flex gap-2 align-items-center">
                                                            <img src="{{ asset('admin/assets/images/users/user-2.jpg') }}" alt="Noah Walker" class="avatar-xs rounded-circle" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="#!" class="fw-semibold link-reset">#INC-1011</a></td>
                                                    ...
                                                    <td>$3,580.00</td>
                                                    <td><span class="badge bg-success-subtle text-success badge-label">Received</span></td>
                                                    <td>15 Sep, 2025 <small class="text-muted">03:20 PM</small></td>
                                                    <td>
                                                        <div class="d-flex gap-2 align-items-center">
                                                            <img src="{{ asset('admin/assets/images/users/user-4.jpg') }}" alt="Grace Miller" class="avatar-xs rounded-circle" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="#!" class="fw-semibold link-reset">#INC-1012</a></td>
                                                    ...
                                                    <td>$940.00</td>
                                                    <td><span class="badge bg-success-subtle text-success badge-label">Received</span></td>
                                                    <td>12 Sep, 2025 <small class="text-muted">11:55 AM</small></td>
                                                    <td>
                                                        <div class="d-flex gap-2 align-items-center">
                                                            <img src="{{ asset('admin/assets/images/users/user-5.jpg') }}" alt="Chloe Adams" class="avatar-xs rounded-circle" />
                                ...
                                <form id="incomeForm">
                                    <div class="modal-body">
                                        <div class="row g-3">
                                            <!-- Income Title -->
                                            <div class="col-md-6">
                                                <label for="incomeTitle" class="form-label">Income Title <span class="text-danger">*</span></label>
                                                <input type="text" id="incomeTitle" class="form-control" placeholder="Enter income title" required />
                                            </div>

                                            <!-- Amount -->
                                            <div class="col-md-6">
                                                <label for="incomeAmount" class="form-label">Amount ($) <span class="text-danger">*</span></label>
                                                <input type="number" step="0.01" id="incomeAmount" class="form-control" placeholder="Enter amount" required />
                                            </div>
                                            ...
                                            <!-- Payment Type -->
                                            <div class="col-md-6">
                                                <label for="incomePayment" class="form-label">Payment Type</label>
                                                <select id="incomePayment" class="form-select">
                                            ...
                                            <!-- Client Name -->
                                            <div class="col-md-6">
                                                <label for="incomeClient" class="form-label">Client Name</label>
                                                <input type="text" id="incomeClient" class="form-control" placeholder="Enter client or company name" />
                                            </div>

                                            <!-- Status -->
                                            <div class="col-md-6">
                                                <label for="incomeStatus" class="form-label">Status</label>
                                                <select id="incomeStatus" class="form-select">
                                            ...
                                            <!-- Date -->
                                            <div class="col-md-6">
                                                <label for="incomeDate" class="form-label">Date & Time</label>
                                                <input type="text" data-provider="flatpickr" data-date-format="d M, Y" data-enable-time id="incomeDate" class="form-control" />
                                            </div>

                                            <!-- Received By -->
                                            <div class="col-md-6">
                                                <label for="incomeReceivedBy" class="form-label">Received By</label>
                                                <div class="d-flex align-items-center gap-2">
                                                    <img src="{{ asset('admin/assets/images/users/user-5.jpg') }}" alt="user" class="avatar-xs rounded-circle" />
                                                    <input type="text" id="incomeReceivedBy" class="form-control" placeholder="Enter receiver name" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12">
                                                ...
                                                <textarea id="incomeNotes" class="form-control" rows="3" placeholder="Optional remarks or description"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="modal-footer border-top">
                                        ...
                                        <button type="submit" class="btn btn-primary"><i class="ti ti-device-floppy me-1"></i> Save Income</button>
                                    </div>
                                </form>
                            </div>
                        </div>
...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-finance-income.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:33 GMT -->
</html>
