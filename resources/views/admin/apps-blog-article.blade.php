...
<!-- Mirrored from coderthemes.com/paces/bootstrap/apps-blog-article.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jun 2026 09:58:49 GMT -->
<head>
        <meta charset="utf-8" />
        <title>Blog Article | Paces - Multipurpose Tailwind CSS & Bootstrap Admin Dashboard Template</title>
                ...
                <div class="container-fluid">
                    <div class="page-title-head d-flex align-items-center">
                        <div class="flex-grow-1">
                            <h4 class="page-main-title m-0">Article</h4>
                        </div>
                                    ...
                                    <div class="row g-5">
                                        ...
                                        <div class="col-lg-8">
                                            ...
                                            <p class="d-flex flex-wrap gap-3 text-muted mb-0 mt-3 align-items-center fs-base">
                                                ...
                                                <span class="d-flex align-items-center gap-1"><i class="ti ti-calendar fs-md"></i> Mar 18, 2025</span>
                                                <span class="d-flex align-items-center gap-1"><i class="ti ti-message-circle fs-md"></i> <a href="#!" class="link-reset">42</a></span>
                                                <span class="d-flex align-items-center gap-1"><i class="ti ti-eye fs-md"></i> 982</span>
                                            </p>

                                            <!-- Image -->
                                            <img src="{{ asset('admin/assets/images/blog/blog-post.jpg') }}" class="img-fluid rounded mt-4" alt="blog-img" />
                                            ...
                                            <div class="d-flex align-items-center gap-4 border mt-4 border-dashed p-4 rounded mb-14">
                                                <div class="text-center flex-shrink-0 me-7 me-lg-13">
                                                    <div class="mb-2">
                                                        <img src="{{ asset('admin/assets/images/users/user-1.jpg') }}" class="avatar-xl rounded-circle" alt="" />
                                                    </div>
                                                    <div class="mb-0">
