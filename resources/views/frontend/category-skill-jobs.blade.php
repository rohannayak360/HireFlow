					...
					<div class="category-jobs-info">
						<div class="nav">
							<ul>
								...
								<li class="active"><a href="{{ url('category-skill-jobs') }}">Jobs by Skill</a></li>
							</ul>
						</div>
					</div>
                </div>
				...
				<div class="container">
					<div class="row">
						<div class="col-lg-12 m-b30">
							<div class="job-bx">
								<div class="job-bx-title clearfix">
									<h6 class="text-uppercase">Browse Jobs by IT Skills
						...
						<div class="col-lg-12 m-b30">
							<div class="job-bx">
								<div class="job-bx-title clearfix">
									<h6 class="text-uppercase">Browse Jobs By Non-IT Skills
									<a href="javascript:void(0);" class="float-end font-12 text-primary">View All</a></h6>
								</div>
								<div class="row">
									<div class="col-lg-3 col-md-6 col-sm-6">
