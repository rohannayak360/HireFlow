...
<div id="loading-area"></div>
    <!-- Content -->
    <div class="page-content bg-white login-style2" style="background-image: url({{ asset('frontend/images/background/bg6.jpg') }}); background-size: cover;">
                ...
                <div class="row">
					<div class="col-lg-6 col-md-6 d-flex">
						<div class="text-white max-w400 align-self-center">
							<div class="logo">
								<a href="{{ url('/') }}"><img src="{{ asset('frontend/images/logo-white2.png') }}" alt=""></a>
							</div>
							...
							<div class="tab-content nav">
								<form id="login" class="tab-pane active col-12 p-a0 ">
									...
									<div class="text-center">
										<button class="site-button float-start">login</button>
										<a data-bs-toggle="tab" href="#forgot-password" class="site-button-link forget-pass m-t15 float-end"><i class="fa fa-unlock-alt"></i> Forgot Password</a> 
									</div>
								</form>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-12 text-center">
						<span class="float-start">© Copyright by <i class="fa fa-heart m-lr5 text-red heart"></i>
						<a href="javascript:void(0);">DexignZone </a> </span>
