							...
							<div class="sticky-top">
								<div class="candidate-info">
									...
									<ul>
										...
										<li><a href="{{ url('jobs-saved-jobs') }}" class="active">
						...
						<div class="col-xl-9 col-lg-8 m-b30">
							<div class="job-bx save-job table-job-bx clearfix">
								<div class="job-bx-title clearfix">
									<h5 class="font-weight-700 float-start text-uppercase">269 Saved Jobs</h5>
									<div class="float-end">
								...
								<table>
									...
									<tbody>
										<tr>
											...
											<td class="job-name"><a href="{{ url('job-detail') }}">Social Media Expert</a></td>
											<td class="criterias text-primary"><a href="{{ url('company-profile') }}">@company-name</a></td>
											<td class="date">December 15,2021</td>
											<td class="job-links">
										...
										<tr>
											...
											<td class="job-name"><a href="{{ url('job-detail') }}">Web Designer</a></td>
											<td class="criterias text-primary"><a href="{{ url('company-profile') }}">@company-name</a></td>
											<td class="date">November 10,2021</td>
											<td class="job-links">
												<a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#exampleModalLong">
												<i class="fa fa-eye"></i></a>
												<a href="javascript:void(0);"><i class="ti-trash"></i></a>
										...
										<tr> 
											...
											<td class="job-name"><a href="{{ url('job-detail') }}">Finance Accountant</a></td>
											<td class="criterias text-primary"><a href="{{ url('company-profile') }}">@company-name</a></td>
											<td class="date">October 5,2021</td>
											<td class="job-links">
												<a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#exampleModalLong">
												<i class="fa fa-eye"></i></a>
												<a href="javascript:void(0);"><i class="ti-trash"></i></a>
