						...
						<ul id="masonry" class="dez-gallery-listing gallery-grid-4 gallery mfp-gallery sp10">
							<li class="web design card-container col-lg-3 col-md-4 col-sm-6 col-6">
								<div class="dez-box dez-gallery-box">
									<div class="dez-media dez-img-overlay1 dez-img-effect">
										<a href="javascript:void(0);"> <img src="{{ asset('frontend/images/gallery/middle/pic1.jpg') }}"  alt=""> </a>
										<div class="overlay-bx">
											<div class="overlay-icon"> 
												<a class="mfp-link" title="Designing" href="{{ asset('frontend/images/gallery/middle/pic1.jpg') }}"> <i class="ti-fullscreen"></i> </a>	
											</div>
										</div>
									</div>
								</div>
							...
							<li class="advertising branding photography card-container col-lg-3 col-md-4 col-sm-6 col-6">
								<div class="dez-box dez-gallery-box">
									...
									<a href="javascript:void(0);"> <img src="{{ asset('frontend/images/gallery/middle/pic2.jpg') }}"  alt=""> </a>
										<div class="overlay-bx">
											<div class="overlay-icon"> 
												<a class="mfp-link" title="Construct" href="{{ asset('frontend/images/gallery/middle/pic2.jpg') }}"> <i class="ti-fullscreen"></i> </a>	
											</div>
										</div>
									</div>
								</div>
							...
							<li class="branding design photography card-container col-lg-3 col-md-4 col-sm-6 col-6">
								<div class="dez-box dez-gallery-box">
									<div class="dez-media dez-img-overlay1 dez-img-effect"> 
									<a href="javascript:void(0);"> <img src="{{ asset('frontend/images/gallery/middle/pic3.jpg') }}"  alt=""> </a>
										<div class="overlay-bx">
											<div class="overlay-icon"> 
												<a class="mfp-link" title="Finance" href="{{ asset('frontend/images/gallery/middle/pic3.jpg') }}"> <i class="ti-fullscreen"></i> </a>	
											</div>
										</div>
									</div>
								</div>
							...
							<li class="web design card-container col-lg-3 col-md-4 col-sm-6 col-6">
								<div class="dez-box dez-gallery-box">
									<div class="dez-media dez-img-overlay1 dez-img-effect"> 
									<a href="javascript:void(0);"> <img src="{{ asset('frontend/images/gallery/middle/pic4.jpg') }}"  alt=""> </a>
										<div class="overlay-bx">
											<div class="overlay-icon"> 
												<a class="mfp-link" title="Development" href="{{ asset('frontend/images/gallery/middle/pic4.jpg') }}"> <i class="ti-fullscreen"></i> </a>	
											</div>
										</div>
									</div>
								</div>
							...
							<li class="web branding card-container col-lg-3 col-md-4 col-sm-6 col-6">
								<div class="dez-box dez-gallery-box">
									<div class="dez-media dez-img-overlay1 dez-img-effect">
									<a href="javascript:void(0);"> <img src="{{ asset('frontend/images/gallery/middle/pic5.jpg') }}"  alt=""> </a>
										<div class="overlay-bx">
											<div class="overlay-icon"> 
												<a class="mfp-link" title="Archeology" href="{{ asset('frontend/images/gallery/middle/pic5.jpg') }}"> <i class="ti-fullscreen"></i> </a>	
											</div>
										</div>
									</div>
								</div>
							...
							<li class="advertising design photography card-container col-lg-3 col-md-4 col-sm-6 col-6">
								<div class="dez-box dez-gallery-box">
									<div class="dez-media dez-img-overlay1 dez-img-effect ">
									<a href="javascript:void(0);"> <img src="{{ asset('frontend/images/gallery/middle/pic6.jpg') }}"  alt=""> </a>
										<div class="overlay-bx">
											<div class="overlay-icon"> 
												<a class="mfp-link" title="Designing" href="{{ asset('frontend/images/gallery/middle/pic6.jpg') }}"> <i class="ti-fullscreen"></i> </a>	
											</div>
										</div>
									</div>
								</div>
							...
							<li class="web branding card-container col-lg-3 col-md-4 col-sm-6 col-6">
								<div class="dez-box dez-gallery-box">
									<div class="dez-media dez-img-overlay1 dez-img-effect">
										<a href="javascript:void(0);"> <img src="{{ asset('frontend/images/gallery/middle/pic7.jpg') }}"  alt=""> </a>
										<div class="overlay-bx">
											<div class="overlay-icon"> 
												<a class="mfp-link" title="Construct" href="{{ asset('frontend/images/gallery/middle/pic7.jpg') }}"> <i class="ti-fullscreen"></i> </a>	
											</div>
										</div>
									</div>
								</div>
							...
							<li class="advertising design photography card-container col-lg-3 col-md-4 col-sm-6 col-6">
								<div class="dez-box dez-gallery-box">
									<div class="dez-media dez-img-overlay1 dez-img-effect dez-img-effect "> 
									<a href="javascript:void(0);"> <img src="{{ asset('frontend/images/gallery/middle/pic8.jpg') }}"  alt=""> </a>
										<div class="overlay-bx">
											<div class="overlay-icon"> 
												<a class="mfp-link" title="Development" href="{{ asset('frontend/images/gallery/middle/pic8.jpg') }}"> <i class="ti-fullscreen"></i> </a>	
											</div>
										</div>
									</div>
								</div>
							...
							<li class="web photography card-container col-lg-3 col-md-4 col-sm-6 col-6">
								<div class="dez-box dez-gallery-box">
									<div class="dez-media dez-img-overlay1 dez-img-effect"> 
									<a href="javascript:void(0);"> <img src="{{ asset('frontend/images/gallery/middle/pic9.jpg') }}"  alt=""> </a>
										<div class="overlay-bx">
											<div class="overlay-icon"> 
												<a class="mfp-link" title="Archeology" href="{{ asset('frontend/images/gallery/middle/pic9.jpg') }}"> <i class="ti-fullscreen"></i> </a>	
											</div>
										</div>
									</div>
								</div>
							...
							<li class="advertising branding card-container col-lg-3 col-md-4 col-sm-6 col-6">
								<div class="dez-box dez-gallery-box">
									...
									<a href="javascript:void(0);"> <img src="{{ asset('frontend/images/gallery/middle/pic1.jpg') }}"  alt=""> </a>
										<div class="overlay-bx">
											<div class="overlay-icon"> 
												<a class="mfp-link" title="Construct" href="{{ asset('frontend/images/gallery/middle/pic1.jpg') }}"> <i class="ti-fullscreen"></i> </a>	
											</div>
										</div>
									</div>
								</div>
							 ...
							 <li class="web design card-container col-lg-3 col-md-4 col-sm-6 col-6">
								<div class="dez-box dez-gallery-box">
									...
									<a href="javascript:void(0);"> <img src="{{ asset('frontend/images/gallery/middle/pic2.jpg') }}"  alt=""> </a>
										<div class="overlay-bx">
											<div class="overlay-icon"> 
												<a class="mfp-link" title="Finance" href="{{ asset('frontend/images/gallery/middle/pic2.jpg') }}"> <i class="ti-fullscreen"></i> </a>	
											</div>
										</div>
									</div>
								</div>
