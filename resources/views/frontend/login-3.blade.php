            ...
            <div class="container-fluid">
                <div class="row">
					<div class="col-lg-6 col-md-7 box-skew d-flex">
						<div class="login-2 p-a30 seth d-flex align-self-center m-auto wow fadeInRight" data-wow-delay="0.8s">
							<div class="tab-content nav">
								<form id="login" class="tab-pane active col-12 p-a0 ">
									...
									<div class="text-left">
										...
										<a data-bs-toggle="tab" href="#forgot-password" class="site-button-link forget-pass float-end m-t15"><i class="fa fa-unlock-alt"></i> Forgot Password</a> 
									</div>
								</form>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-12 text-center">
						<span class="float-start text-black-light"> © Copyright by <i class="fa fa-heart m-lr5 text-red heart"></i>
						<a href="javascript:void(0);" class="text-primary">DexignZone </a></span>
						<span class="float-end">All rights reserved.</span>
					</div>
				</div>
			</div>
		</footer>
