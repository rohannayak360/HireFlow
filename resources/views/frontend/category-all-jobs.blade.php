...
<div id="loading-area"></div>
    ...
    <div class="page-content">
        <!-- inner page banner -->
        <div class="dez-bnr-inr jobs-category overlay-black-middle" style="background-image:url({{ asset('frontend/images/banner/bnr1.jpg') }});">
            <div class="container">
                <div class="dez-bnr-inr-entry">
					...
					<div class="category-jobs-info">
						<div class="nav">
							<ul>
								<li class="active"><a href="{{ url('category-all-jobs') }}">All Jobs</a></li>
								<li><a href="{{ url('category-company-jobs') }}">Jobs by Company</a></li>
								<li><a href="{{ url('category-jobs') }}">Jobs by Category</a></li>
								<li><a href="{{ url('category-location-jobs') }}">Jobs by Location</a></li>
								<li><a href="{{ url('category-designations-jobs') }}">Jobs by Designation</a></li>
								<li><a href="{{ url('category-skill-jobs') }}">Jobs by Skill</a></li>
							</ul>
						</div>
					</div>
                </div>
				...
				<div class="container">
					<div class="row">
						<div class="col-lg-12 m-b30">
							<div class="job-bx">
								<div class="job-bx-title clearfix">
									...
									<a href="javascript:void(0);" class="float-end font-12 text-primary">View All</a></h6>
								</div>
								<div class="row">
						...
						<div class="col-lg-6 m-b30">
							<div class="job-bx">
								<div class="job-bx-title clearfix">
									<h6 class="text-uppercase">Browse Jobs by Industries
									<a href="javascript:void(0);" class="float-end font-12 text-primary">View All</a></h6>
								</div>
								<div class="row">
						...
						<div class="col-lg-6 m-b30">
							<div class="job-bx">
								<div class="job-bx-title clearfix">
									<h6 class="text-uppercase">Browse Jobs by Functional Areas
									<a href="javascript:void(0);" class="float-end font-12 text-primary">View All</a></h6>
								</div>
								<div class="row">
									<div class="col-lg-6 col-sm-6">
						...
						<div class="col-lg-12 m-b30">
							<div class="job-bx clearfix">
								<div class="job-bx-title clearfix">
									<h6 class="text-uppercase">Browse Jobs by Companies
									<a href="javascript:void(0);" class="float-end font-12 text-primary">View All</a></h6>
								</div>
								<ul class="company-logo-wg clearfix">
									<li class="brand-logo">
										<a href="javascript:void(0);">
											<img src="{{ asset('frontend/images/logo/logo1.jpg') }}" alt="">
										</a>
									</li>
									<li class="brand-logo">
										<a href="javascript:void(0);">
											<img src="{{ asset('frontend/images/logo/logo2.jpg') }}" alt="">
										</a>
									</li>
									<li class="brand-logo">
										<a href="javascript:void(0);">
											<img src="{{ asset('frontend/images/logo/logo3.jpg') }}" alt="">
										</a>
									</li>
									<li class="brand-logo">
										<a href="javascript:void(0);">
											<img src="{{ asset('frontend/images/logo/logo4.jpg') }}" alt="">
										</a>
									</li>
									<li class="brand-logo">
										<a href="javascript:void(0);">
											<img src="{{ asset('frontend/images/logo/logo5.jpg') }}" alt="">
										</a>
									</li>
									<li class="brand-logo">
										<a href="javascript:void(0);">
											<img src="{{ asset('frontend/images/logo/logo6.jpg') }}" alt="">
										</a>
									</li>
									<li class="brand-logo">
										<a href="javascript:void(0);">
											<img src="{{ asset('frontend/images/logo/logo7.jpg') }}" alt="">
										</a>
									</li>
									<li class="brand-logo">
										<a href="javascript:void(0);">
											<img src="{{ asset('frontend/images/logo/logo8.jpg') }}" alt="">
										</a>
									</li>
									<li class="brand-logo">
										<a href="javascript:void(0);">
											<img src="{{ asset('frontend/images/logo/logo9.jpg') }}" alt="">
										</a>
									</li>
									<li class="brand-logo">
										<a href="javascript:void(0);">
											<img src="{{ asset('frontend/images/logo/logo10.jpg') }}" alt="">
										</a>
									</li>
								</ul>
							</div>
						...
						<div class="col-lg-6 m-b30">
							<div class="job-bx">
								<div class="job-bx-title clearfix">
									<h6 class="text-uppercase">Browse Jobs by Designations
									<a href="javascript:void(0);" class="float-end font-12 text-primary">View All</a></h6>
								</div>
								<div class="row">
									<div class="col-lg-6 col-sm-6">
						...
						<div class="col-lg-6 m-b30">
							<div class="job-bx">
								<div class="job-bx-title clearfix">
									<h6 class="text-uppercase">Browse Jobs by Skills
									<a href="javascript:void(0);" class="float-end font-12 text-primary">View All</a></h6>
								</div>
								<div class="row">
									<div class="col-lg-6 col-sm-6">
									...
									<div class="col-lg-6 col-sm-6">
										<ul class="category-list">
											<li><a href="javascript:void(0);">Website Design Jobs</a></li>
											<li><a href="javascript:void(0);">Web Development Jobs</a></li>
											<li><a href="javascript:void(0);">Web Design Jobs</a></li>
											<li><a href="javascript:void(0);">Programming Jobs</a></li>
											<li><a href="javascript:void(0);">JavaScript Jobs</a></li>
											<li><a href="javascript:void(0);">Developer Jobs</a></li>
											<li><a href="javascript:void(0);">Software Jobs</a></li>
