						...
						<div class="col-xl-3 col-lg-4 m-b30">
							<div class="sticky-top">
								<div class="candidate-info company-info">
									...
									<ul>
										<li><a href="{{ url('company-profile') }}" class="active">
						...
						<div class="col-xl-9 col-lg-8 m-b30">
							<div class="job-bx submit-resume">
								<div class="job-bx-title clearfix">
									...
									<a href="{{ url('company-profile') }}" class="site-button right-arrow button-sm float-end">Back</a>
								</div>
								<form>
									<div class="row m-b30">
										...
										<div class="col-lg-6 col-md-6">
											<div class="form-group">
												...
												<input type="email" class="form-control" placeholder="17/12/2021">
											</div>
										</div>
										<div class="col-lg-6 col-md-6">
											<div class="form-group">
									...
									<!-- Social Link -->
									<div class="job-bx-title clearfix">
										<h5 class="font-weight-700 float-start text-uppercase">Social link</h5>
									</div>
									<div class="row">
										<div class="col-lg-6 col-md-6">
											<div class="form-group">
