							...
							<div class="sticky-top">
								<div class="candidate-info">
									...
									<ul>
										...
										<li><a href="{{ url('jobs-cv-manager') }}" class="active">
						...
						<div class="col-xl-9 col-lg-8 m-b30">
							<div class="job-bx clearfix">
								<div class="job-bx-title clearfix">
									<h5 class="font-weight-700 float-start text-uppercase">CV Manager</h5>
									<div class="float-end">
										...
										<div class="d-flex float-start">
											...
											<div class="job-post-info">
												...
												<ul>
													...
													<li><i class="far fa-clock"></i> 11 days ago</li>
												</ul>
											</div>
										</div>
										<div class="job-links action-bx">
											<a href="{{ asset('frontend/files/pdf-sample.pdf') }}" target="blank"><i class="fa fa-download"></i></a>
										...
										<div class="d-flex float-start">
											...
											<div class="job-post-info">
												...
												<ul>
													<li><i class="fas fa-map-marker-alt"></i> Sacramento, California</li>
													<li><i class="far fa-bookmark"></i> Full Time</li>
													<li><i class="far fa-clock"></i> 10 days ago</li>
												</ul>
											</div>
										</div>
										<div class="job-links action-bx">
										...
										<div class="d-flex float-start">
											...
											<div class="job-post-info">
												...
												<ul>
													<li><i class="fas fa-map-marker-alt"></i> Sacramento, California</li>
													<li><i class="far fa-bookmark"></i> Full Time</li>
													<li><i class="far fa-clock"></i> 09 days ago</li>
												</ul>
											</div>
										</div>
										<div class="job-links action-bx">
										...
										<div class="d-flex float-start">
											...
											<div class="job-post-info">
												...
												<ul>
													<li><i class="fas fa-map-marker-alt"></i> Sacramento, California</li>
													<li><i class="far fa-bookmark"></i> Full Time</li>
													<li><i class="far fa-clock"></i> 08 days ago</li>
												</ul>
											</div>
										</div>
										<div class="job-links action-bx">
										...
										<div class="d-flex float-start">
											...
											<div class="job-post-info">
												...
												<ul>
													<li><i class="fas fa-map-marker-alt"></i> Sacramento, California</li>
													<li><i class="far fa-bookmark"></i> Full Time</li>
													<li><i class="far fa-clock"></i> 07 days ago</li>
												</ul>
											</div>
										</div>
										<div class="job-links action-bx">
										...
										<div class="d-flex float-start">
											...
											<div class="job-post-info">
												...
												<ul>
													<li><i class="fas fa-map-marker-alt"></i> Sacramento, California</li>
													<li><i class="far fa-bookmark"></i> Full Time</li>
													<li><i class="far fa-clock"></i> 06 days ago</li>
												</ul>
											</div>
										</div>
										<div class="job-links action-bx">
