							...
							<div class="sticky-top">
								<div class="candidate-info">
									...
									<ul>
										...
										<li><a href="{{ url('jobs-applied-job') }}" class="active">
						...
						<div class="col-xl-9 col-lg-8 m-b30">
							...
							<ul class="post-job-bx browse-job">
								<li>
									<div class="post-bx">
										<div class="job-post-info m-a0">
											<h4><a href="{{ url('job-detail') }}">PHP Web Developer</a></h4>
											<ul>
												<li><a href="{{ url('company-profile') }}">@company-name</a></li>
											...
											<div class="posted-info clearfix">
												...
												<a href="{{ url('jobs-my-resume') }}" class="site-button button-sm float-end">Apply Job</a>
											</div>
										</div>
									</div>
								</li>
								<li>
									<div class="post-bx">
										<div class="job-post-info m-a0">
											<h4><a href="{{ url('job-detail') }}">Software Developer</a></h4>
											<ul>
												<li><a href="{{ url('company-profile') }}">@company-name</a></li>
												<li><i class="fas fa-map-marker-alt"></i> Sacramento, California</li>
												<li><i class="far fa-money-bill-alt"></i> 25,000</li>
								...
								<li>
									<div class="post-bx">
										<div class="job-post-info m-a0">
											<h4><a href="{{ url('job-detail') }}">Branch Credit Manager</a></h4>
											<ul>
												<li><a href="{{ url('company-profile') }}">@company-name</a></li>
												<li><i class="fas fa-map-marker-alt"></i> Sacramento, California</li>
												<li><i class="far fa-money-bill-alt"></i> 25,000</li>
