                ...
                <div class="row">
                            ...
                            <ul class="no-margin">
                                ...
                                <li class="icon-bx-wraper left  m-b30">
                                    ...
                                    <div class="icon-content">
                                        ...
                                        <p><a href="https://job-board.dexignzone.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="30595e565f705548515d405c551e535f5d">[email&#160;protected]</a></p>
                                    </div>
                                </li>
					...
					<div class="col-lg-4 col-md-6">
                        <div class="p-a30 m-b30 radius-sm bg-gray clearfix">
							...
							<form method="post" class="dzForm" action="https://job-board.dexignzone.com/xhtml/script/contact_smtp.php">
