										...
										<div class="d-flex m-b30">
											<div class="job-post-company">
												<a href="javascript:void(0);"><span>
													<img alt="" src="{{ asset('frontend/images/testimonials/pic1.jpg') }}"/>
												</span></a>
											</div>
											<div class="job-post-info">
												...
												<ul>
													...
													<li><i class="fas fa-dollar-sign"></i> Full Time</li>
								...
								<li>
									<div class="post-bx">
										<div class="d-flex m-b30">
											<div class="job-post-company">
												<a href="javascript:void(0);"><span>
													<img alt="" src="{{ asset('frontend/images/testimonials/pic2.jpg') }}"/>
												</span></a>
											</div>
											<div class="job-post-info">
												<h4><a href="{{ url('job-detail') }}">Digital Marketing Executive</a></h4>
								...
								<li>
									<div class="post-bx">
										<div class="d-flex m-b30">
											<div class="job-post-company">
												<a href="javascript:void(0);"><span>
													<img alt="" src="{{ asset('frontend/images/testimonials/pic3.jpg') }}"/>
												</span></a>
											</div>
											<div class="job-post-info">
												<h4><a href="{{ url('job-detail') }}">Digital Marketing Executive</a></h4>
									...
									<div class="row">
										<div class="col-lg-6 col-md-6 col-sm-6 col-6">
											<div class="product-brand">
												<div class="form-check m-b5">
													<input type="checkbox" class="form-check-input" id="check1" name="example1">
													<label class="form-check-label" for="check1">Freelance</label>
												</div>
												<div class="form-check m-b5">
												...
												<div class="form-check m-b5">
													...
													<label class="form-check-label" for="check3">Internship</label>
												</div>
												<div class="form-check m-b5">
													<input type="checkbox" class="form-check-input" id="check4" name="example1">
													<label class="form-check-label" for="check4">Part Time</label>
												</div>
												<div class="form-check m-b5">
													<input type="checkbox" class="form-check-input" id="check5" name="example1">
													<label class="form-check-label" for="check5">Temporary</label>
												</div>
											</div>
										</div>
										<div class="col-lg-6 col-md-6 col-sm-6 col-6">
											<div class="product-brand">
												<div class="form-check m-b5">
													...
													<label class="form-check-label" for="check8">Internship</label>
												</div>
												<div class="form-check m-b5">
													<input type="checkbox" class="form-check-input" id="check9" name="example1">
													<label class="form-check-label" for="check9">Part Time</label>
												</div>
												<div class="form-check m-b5">
													<input type="checkbox" class="form-check-input" id="check10" name="example1">
													<label class="form-check-label" for="check10">Temporary</label>
												</div>
												<div class="form-check m-b5">
													<input type="checkbox" class="form-check-input" id="check6" name="example1">
													<label class="form-check-label" for="check6">Freelance</label>
												</div>
												<div class="form-check m-b5">
													<input type="checkbox" class="form-check-input" id="check7" name="example1">
													<label class="form-check-label" for="check7">Full Time</label>
												</div>
											</div>
										</div>
									</div>
