		...
		<div id="rev_slider_152_1" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.4.1">
			<ul><!-- SLIDE  -->
				<li data-index="rs-414" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300"  data-rotate="0"  data-saveperformance="off"  data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
					<!-- MAIN IMAGE -->
					<img src="{{ asset('frontend/images/background/bg2.jpg') }}"  alt=""  data-bgposition="center center" data-kenburns="on" data-duration="20000" data-ease="Linear.easeNone" data-scalestart="130" data-scaleend="100" data-rotatestart="0" data-rotateend="0" data-offsetstart="0 0" data-offsetend="0 0" class="rev-slidebg" data-no-retina>
					<!-- LAYERS -->
					...
					<!-- LAYER NR. 12 -->
					<a class="tp-caption tp-resizeme" target="_blank" href="https://www.facebook.com/" id="slide-414-layer-16" 
						data-x="['left','left','left','left']" data-hoffset="['100','50','50','30']" 
						...
						style="z-index: 16; min-width: 60px; max-width: 60px; max-width: 60px; max-width: 60px; white-space: nowrap; font-size: 20px; line-height: 55px; font-weight: 400; color: rgba(255, 255, 255, 1.00);font-family:Open Sans;border-color:rgba(255, 255, 255, 1.00);border-style:solid;border-width:2px 2px 2px 2px;border-radius:50% 50% 50% 50%;cursor:pointer;"><i class="fab fa-facebook-f"></i> </a>
						
							
					<!-- LAYER NR. 13 -->
					<a class="tp-caption tp-resizeme" target="_blank" href="https://twitter.com/" id="slide-414-layer-17" 
						...
						style="z-index: 17; min-width: 60px; max-width: 60px; max-width: 60px; max-width: 60px; white-space: nowrap; font-size: 20px; line-height: 55px; font-weight: 400; color: rgba(255, 255, 255, 1.00);font-family:Open Sans;border-color:rgba(255, 255, 255, 1.00);border-style:solid;border-width:2px 2px 2px 2px;border-radius:50% 50% 50% 50%;cursor:pointer;"><i class="fab  fa-twitter"></i> </a>
							
					<!-- LAYER NR. 14 -->
					<a class="tp-caption tp-resizeme" target="_blank" href="https://www.google.com/" id="slide-414-layer-18" 
						...
						style="z-index: 18; font-size: 20px; line-height: 55px; font-weight: 400; width: 60px; height: 60px; color: rgba(255, 255, 255, 1.00); font-family:Open Sans; border: 2px solid rgba(255, 255, 255, 1.00); border-radius: 50%;"><i class="fab fa-google-plus-g"></i> </a>
				</li>
			</ul>
...
<script src="{{ asset('frontend/plugins/revolution/revolution-addons/typewriter/js/revolution.addon.typewriter.min.js') }}"></script>
<script src="{{ asset('frontend/plugins/revolution/revolution-addons/countdown/revolution.addon.countdown.min.js') }}"></script>
