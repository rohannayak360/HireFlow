										...
										<div class="d-flex m-b30">
											<div class="job-post-company">
												<a href="javascript:void(0);"><span>
													<img alt="" src="{{ asset('frontend/images/logo/svg/logo1.svg') }}"/>
												</span></a>
											</div>
								...
								<li>
									<div class="post-bx">
										<div class="d-flex m-b30">
											<div class="job-post-company">
												<a href="javascript:void(0);"><span>
													<img alt="" src="{{ asset('frontend/images/logo/svg/logo2.svg') }}"/>
												</span></a>
											</div>
											<div class="job-post-info">
								...
								<li>
									<div class="post-bx">
										<div class="d-flex m-b30">
											<div class="job-post-company">
												<a href="javascript:void(0);"><span>
													<img alt="" src="{{ asset('frontend/images/logo/svg/logo3.svg') }}"/>
												</span></a>
											</div>
											<div class="job-post-info">
								...
								<li>
									<div class="post-bx">
										<div class="d-flex m-b30">
											<div class="job-post-company">
												<a href="javascript:void(0);"><span>
													<img alt="" src="{{ asset('frontend/images/logo/svg/logo4.svg') }}"/>
												</span></a>
											</div>
											<div class="job-post-info">
								...
								<li>
									<div class="post-bx">
										<div class="d-flex m-b30">
											<div class="job-post-company">
												<a href="javascript:void(0);"><span>
													<img alt="" src="{{ asset('frontend/images/logo/svg/logo5.svg') }}"/>
												</span></a>
											</div>
											<div class="job-post-info">
												<h4><a href="{{ url('job-detail') }}">Digital Marketing Executive</a></h4>
								...
								<li>
									<div class="post-bx">
										<div class="d-flex m-b30">
											<div class="job-post-company">
												<a href="javascript:void(0);"><span>
													<img alt="" src="{{ asset('frontend/images/logo/icon1.png') }}"/>
												</span></a>
											</div>
											<div class="job-post-info">
