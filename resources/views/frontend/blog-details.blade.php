                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-md-7 m-b10">
                        ...
                        <div class="blog-post blog-single blog-style-1">
                            ...
                            <div class="dez-post-media dez-img-effect zoom-slow m-t20"><img src="{{ asset('frontend/images/blog/default/thum1.jpg') }}" alt=""></div>
                            <div class="dez-post-text">
                                ...
                                <img class="alignleft blog-side-img" src="{{ asset('frontend/images/blog/grid/pic4.jpg') }}" alt="">
                                ...
                                <img class="alignright blog-side-img" src="{{ asset('frontend/images/blog/grid/pic1.jpg') }}" alt="">
                                <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text 
                                    ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only                                 
                                    five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release
                                    of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like 
                                    ...
                                    <ol class="comment-list">
                                        <li class="comment">
                                            <div class="comment-body">
                                                <div class="comment-author vcard"> <img  class="avatar photo" src="{{ asset('frontend/images/testimonials/pic1.jpg') }}" alt=""> <cite class="fn">Stacy poe</cite> <span class="says">says:</span> </div>
                                            ...
                                            <ol class="children">
                                                <li class="comment odd parent">
                                                    <div class="comment-body">
                                                        <div class="comment-author vcard"> <img  class="avatar photo" src="{{ asset('frontend/images/testimonials/pic2.jpg') }}" alt=""> <cite class="fn">Stacy poe</cite> <span class="says">says:</span> </div>
                                                        <div class="comment-meta"> <a href="javascript:void(0);">October 6, 2021 at 7:15 am</a> </div>
                                                    ...
                                                    <ol class="children">
                                                        <li class="comment odd parent">
                                                            <div class="comment-body">
                                                                <div class="comment-author vcard"> <img  class="avatar photo" src="{{ asset('frontend/images/testimonials/pic3.jpg') }}" alt=""> <cite class="fn">Stacy poe</cite> <span class="says">says:</span> </div>
                                                                <div class="comment-meta"> <a href="javascript:void(0);">October 6, 2021 at 7:15 am</a> </div>
                                                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam vitae neque vitae sapien malesuada aliquet. 
                                                                    In viverra dictum justo in vehicula. Fusce et massa eu ante ornare molestie. Sed vestibulum sem felis, 
                                                                    ac elementum ligula blandit ac.</p>
