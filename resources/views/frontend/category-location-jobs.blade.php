    ...
    <div class="page-content">
					...
					<div class="category-jobs-info">
						<div class="nav">
							<ul>
								...
								<li class="active"><a href="{{ url('category-location-jobs') }}">Jobs by Location</a></li>
        ...
        <div class="content-block">
			...
			<div class="section-full content-inner jobs-category-bx bg-white">
				<div class="container">
					<div class="row">
						<div class="col-lg-12 m-b30 clearfix">
							<div class="job-bx">
								<div class="job-bx-title clearfix">
									<h6 class="font-weight-700 float-start text-uppercase">Browse Jobs by Top Locations</h6>
								</div>
								<div class="row">
					...
					<div id="masonry" class="row">
						<div class="card-container clearfix col-lg-3 col-sm-6 m-b30">
							<div class="job-bx">
								<div class="job-bx-title clearfix">
									<h6 class="font-weight-700 float-start m-b0 font-13 text-uppercase">Jobs In London</h6>
								</div>
								<ul class="category-list">
									<li><a href="javascript:void(0);">Email Marketing</a></li>
									<li><a href="javascript:void(0);">Lead Generation</a></li>
