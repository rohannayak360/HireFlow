							...
							<div class="sticky-top">
								<div class="candidate-info company-info">
									...
									<ul>
										...
										<li><a href="{{ url('company-manage-job') }}">
											<i class="fa fa-briefcase" aria-hidden="true"></i> 
											<span>Manage jobs</span></a></li>
										<li><a href="{{ url('company-resume') }}" class="active">
						...
						<div class="col-xl-9 col-lg-8 m-b30">
							<div class="job-bx clearfix">
								<div class="job-bx-title clearfix">
									...
									<a href="{{ url('company-manage-job') }}" class="site-button right-arrow button-sm float-end">Back</a>
								</div>
								<ul class="post-job-bx browse-job-grid post-resume row">
										...
										<div class="post-bx">
											<div class="d-flex m-b20">
												<div class="job-post-info">
													<h5 class="m-b0"><a href="{{ url('jobs-profile') }}">Ali Tufan</a></h5>
											...
											<a href="{{ asset('frontend/files/pdf-sample.pdf') }}" target="blank" class="job-links">
									...
									<li class="col-lg-6 col-md-6">
										<div class="post-bx">
											<div class="d-flex m-b20">
												<div class="job-post-info">
													<h5 class="m-b0"><a href="{{ url('jobs-profile') }}">Tammy Dixon</a></h5>
													<p class="m-b5 font-13">
														<a href="javascript:void(0);" class="text-primary">UX / UI Designer </a>
														at Atract Solutions</p>
													<ul>
									...
									<li class="col-lg-6 col-md-6">
										<div class="post-bx">
											<div class="d-flex m-b20">
												<div class="job-post-info">
													<h5 class="m-b0"><a href="{{ url('jobs-profile') }}">David kamal</a></h5>
													<p class="m-b5 font-13">
														<a href="javascript:void(0);" class="text-primary">UX / UI Designer </a>
														at Atract Solutions</p>
													<ul>
									...
									<li class="col-lg-6 col-md-6">
										<div class="post-bx">
											<div class="d-flex m-b20">
												<div class="job-post-info">
													<h5 class="m-b0"><a href="{{ url('jobs-profile') }}">John Doe</a></h5>
													<p class="m-b5 font-13">
														<a href="javascript:void(0);" class="text-primary">UX / UI Designer </a>
														at Atract Solutions</p>
													<ul>
