					...
					<div class="row">
							...
							<div class="sticky-top">
								<div class="row">
									<div class="col-lg-12 col-md-6">
										<div class="m-b30">
											<img src="{{ asset('frontend/images/blog/grid/pic1.jpg') }}" alt="">
										</div>
									</div>
									<div class="col-lg-12 col-md-6">
						...
						<div class="col-lg-8">
							<div class="job-info-box">
								...
								<a href="{{ url('jobs-applied-job') }}" class="site-button">Apply This Job</a>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="row">
						<div class="col-xl-3 col-lg-6 col-md-6">
							<div class="m-b30 blog-grid">
                                <div class="dez-post-media dez-img-effect "> <a href="{{ url('blog-details') }}"><img src="{{ asset('frontend/images/blog/grid/pic1.jpg') }}" alt=""></a> </div>
                                <div class="dez-info p-a20 border-1">
                                    <div class="dez-post-title ">
                                        <h5 class="post-title"><a href="{{ url('blog-details') }}">Title of blog post</a></h5>
                                    </div>
						...
						<div class="col-xl-3 col-lg-6 col-md-6">
							<div class="m-b30 blog-grid">
                                <div class="dez-post-media dez-img-effect "> <a href="{{ url('blog-details') }}"><img src="{{ asset('frontend/images/blog/grid/pic2.jpg') }}" alt=""></a> </div>
                                <div class="dez-info p-a20 border-1">
                                    <div class="dez-post-title ">
                                        <h5 class="post-title"><a href="{{ url('blog-details') }}">Title of blog post</a></h5>
                                    </div>
						...
						<div class="col-xl-3 col-lg-6 col-md-6">
							<div class="m-b30 blog-grid">
                                <div class="dez-post-media dez-img-effect "> <a href="{{ url('blog-details') }}"><img src="{{ asset('frontend/images/blog/grid/pic3.jpg') }}" alt=""></a> </div>
                                <div class="dez-info p-a20 border-1">
                                    <div class="dez-post-title ">
                                        <h5 class="post-title"><a href="{{ url('blog-details') }}">Title of blog post</a></h5>
                                    </div>
						...
						<div class="col-xl-3 col-lg-6 col-md-6">
							<div class="m-b30 blog-grid">
                                <div class="dez-post-media dez-img-effect "> <a href="{{ url('blog-details') }}"><img src="{{ asset('frontend/images/blog/grid/pic4.jpg') }}" alt=""></a> </div>
                                <div class="dez-info p-a20 border-1">
                                    <div class="dez-post-title ">
                                        <h5 class="post-title"><a href="{{ url('blog-details') }}">Title of blog post</a></h5>
                                    </div>
