            ...
            <div class="container">
                <div class="dez-bnr-inr-entry">
					...
					<div class="category-jobs-info">
						<div class="nav">
							<ul>
								<li><a href="{{ url('category-all-jobs') }}">All Jobs</a></li>
								<li><a href="{{ url('category-company-jobs') }}">Jobs by Company</a></li>
								<li class="active"><a href="{{ url('category-jobs') }}">Jobs by Category</a></li>
				...
				<div class="container">
					<div class="row">
						<div class="col-lg-12 m-b30">
							<div class="job-bx">
								<div class="job-bx-title clearfix">
									<h6 class="text-uppercase">Browse Jobs by Functional Area / Department
								...
								<div class="row">
									<div class="col-lg-4 col-sm-12">
										<ul class="category-list category-bx">
											<li><a href="javascript:void(0);">
												<div class="logo"><img src="{{ asset('frontend/images/logo/logo18.png') }}" alt=""></div>
												<span>Directi Jobs</span>
											</a></li>
											<li><a href="javascript:void(0);">
												<div class="logo"><img src="{{ asset('frontend/images/logo/logo17.png') }}" alt=""></div>
												<span>Data Entry Jobs</span>
											</a></li>
											<li><a href="javascript:void(0);">
												<div class="logo"><img src="{{ asset('frontend/images/logo/logo19.png') }}" alt=""></div>
												<span>Philips Software Centre Jobs</span>
											</a></li>
											<li><a href="javascript:void(0);">
												<div class="logo"><img src="{{ asset('frontend/images/logo/logo21.png') }}" alt=""></div>
												<span>Philips Software Centre Jobs</span>
											</a></li>
											<li><a href="javascript:void(0);">
												<div class="logo"><img src="{{ asset('frontend/images/logo/logo20.png') }}" alt=""></div>
												<span>Bank Jobs </span>
											</a></li>
										</ul>
									</div>
									<div class="col-lg-4 col-sm-12">
										<ul class="category-list category-bx">
											<li><a href="javascript:void(0);">
												<div class="logo"><img src="{{ asset('frontend/images/logo/logo19.png') }}" alt=""></div>
												<span>Samsung Software Jobs</span>
											</a></li>
											<li><a href="javascript:void(0);">
												<div class="logo"><img src="{{ asset('frontend/images/logo/logo20.png') }}" alt=""></div>
												<span>Samsung Software Jobs</span>
											...
											<li><a href="javascript:void(0);">
												<div class="logo"><img src="{{ asset('frontend/images/logo/logo18.png') }}" alt=""></div>
												<span>24/7 Customer Jobs</span>
											</a></li>
											<li><a href="javascript:void(0);">
												<div class="logo"><img src="{{ asset('frontend/images/logo/logo17.png') }}" alt=""></div>
												<span>African Commodities DMCC Jobs</span>
											</a></li>
											<li><a href="javascript:void(0);">
												<div class="logo"><img src="{{ asset('frontend/images/logo/logo17.png') }}" alt=""></div>
												<span>Foton Motors Jobs</span>
											</a></li>
										</ul>
									</div>
									<div class="col-lg-4 col-sm-12">
						...
						<div class="col-lg-12 m-b30">
							<div class="job-bx">
								<div class="job-bx-title clearfix">
									<h6 class="text-uppercase">Browse Jobs by Industry / Sector
									<a href="javascript:void(0);" class="float-end font-12 text-primary">View All</a></h6>
								</div>
								<div class="row">
