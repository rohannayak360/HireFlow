					...
					<div class="category-jobs-info">
						<div class="nav">
							<ul>
								...
								<li class="active"><a href="{{ url('category-company-jobs') }}">Jobs by Company</a></li>
						...
						<div class="col-lg-12 m-b30">
							<div class="job-bx">
								<div class="job-bx-title clearfix">
									<h6 class="font-weight-700 float-start text-uppercase">Browse Jobs by Companies</h6>
								</div>
									...
									<div class="col-lg-4 col-sm-12">
										<ul class="category-list category-bx">
											...
											<li><a href="javascript:void(0);">
												...
												<span>Religare Technologies Jobs</span>
											</a></li>
											<li><a href="javascript:void(0);">
												<div class="logo"><img src="{{ asset('frontend/images/logo/logo17.png') }}" alt=""></div>
