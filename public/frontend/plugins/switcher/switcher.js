...
function addSwitcher()
{
	...
	var dzSwitcher = '<div id="dzSwitcher-right" class="styleswitcher"><div class="overlay-switch"></div><div class="switcher-btn-bx"><a href="javascript:void(0);" class="switch-btn closed"><span class="fas fa-cog"></span></a></div><div class="styleswitcher-inner"><a target="_blank" href="https://1.envato.market/g56Wg" class="site-button m-b30 btn-block">Buy Jobboard Now!</a><div class="sw-main-title">Theme Setting<a href="javascript:void(0);" class="dez-page btn btn-primary btn-sm" onclick="deleteAllCookie()">Delete All Cookie</a></div><div class="theme-design theme-option row" opt="themeFullColor"><div class="theme-box col-md-12"><h5 class="switcher-title"><span>Theme Color</span></h5><ul val="themeFullColor" class="color-skins theme-panel-save"><li class="active"><a class="theme-skin skin-1 theme-color" href="javascript:void(0);" data-color-theme="skin-1" data-logo-selector=".logo-dark img, .logo-white img, .layout-dark .header .logo-dark img" data-logo-image="/RozgarRadar/frontend/images/logo.png, /RozgarRadar/frontend/images/logo-white.png, /RozgarRadar/frontend/images/logo-white.png"></a></li><li><a class="theme-skin skin-2 theme-color" href="javascript:void(0);" data-color-theme="skin-2" data-logo-selector=".logo-dark img, .logo-white img, .layout-dark .header .logo-dark img" data-logo-image="/RozgarRadar/frontend/images/logo2.png, /RozgarRadar/frontend/images/logo2-white.png, /RozgarRadar/frontend/images/logo2-white.png"></a></li><li><a class="theme-skin skin-3 theme-color" href="javascript:void(0);" data-color-theme="skin-3" data-logo-selector=".logo-dark img, .logo-white img, .layout-dark .header .logo-dark img" data-logo-image="/RozgarRadar/frontend/images/logo3.png, /RozgarRadar/frontend/images/logo3-white.png, /RozgarRadar/frontend/images/logo3-white.png"></a></li><li><a class="theme-skin skin-4 theme-color" href="javascript:void(0);" data-color-theme="skin-4" data-logo-selector=".logo-dark img, .logo-white img, .layout-dark .header .logo-dark img" data-logo-image="/RozgarRadar/frontend/images/logo4.png, /RozgarRadar/frontend/images/logo4-white.png, /RozgarRadar/frontend/images/logo4-white.png"></a></li><li><a class="theme-skin skin-5 theme-color" href="javascript:void(0);" data-color-theme="skin-5" data-logo-selector=".logo-dark img, .logo-white img, .layout-dark .header .logo-dark img" data-logo-image="/RozgarRadar/frontend/images/logo5.png, /RozgarRadar/frontend/images/logo5-white.png, /RozgarRadar/frontend/images/logo5-white.png"></a></li><li><a class="theme-skin skin-6 theme-color" href="javascript:void(0);" data-color-theme="skin-6" data-logo-selector=".logo-dark img, .logo-white img, .layout-dark .header .logo-dark img" data-logo-image="/RozgarRadar/frontend/images/logo6.png, /RozgarRadar/frontend/images/logo6-white.png, /RozgarRadar/frontend/images/logo6-white.png"></a></li><li><a class="theme-skin skin-7 theme-color" href="javascript:void(0);" data-color-theme="skin-7" data-logo-selector=".logo-dark img, .logo-white img, .layout-dark .header .logo-dark img" data-logo-image="/RozgarRadar/frontend/images/logo7.png, /RozgarRadar/frontend/images/logo7-white.png, /RozgarRadar/frontend/images/logo7-white.png"></a></li><li><a class="theme-skin skin-8 theme-color" href="javascript:void(0);" data-color-theme="skin-8" data-logo-selector=".logo-dark img, .logo-white img, .layout-dark .header .logo-dark img" data-logo-image="/RozgarRadar/frontend/images/logo8.png, /RozgarRadar/frontend/images/logo8-white.png, /RozgarRadar/frontend/images/logo8-white.png"></a></li><li><a class="theme-skin skin-9 theme-color" href="javascript:void(0);" data-color-theme="skin-9" data-logo-selector=".logo-dark img, .logo-white img, .layout-dark .header .logo-dark img" data-logo-image="/RozgarRadar/frontend/images/logo9.png, /RozgarRadar/frontend/images/logo9-white.png, /RozgarRadar/frontend/images/logo9-white.png"></a></li><li><a class="theme-skin skin-10 theme-color" href="javascript:void(0);" data-color-theme="skin-10" data-logo-selector=".logo-dark img, .logo-white img, .layout-dark .header .logo-dark img" data-logo-image="/RozgarRadar/frontend/images/logo10.png, /RozgarRadar/frontend/images/logo10-white.png, /RozgarRadar/frontend/images/logo10-white.png"></a></li></ul></div></div><div class="row theme-design theme-option theme-view-wrapper"><div class="col-md-10 theme-box"><h5 class="switcher-title"><span>Template View</span></h5><ul class="tab-checkbx theme-panel-save mb-0"><li class="active"><a href="'+urlLTR+'">LTR</a></li><li><a href="'+urlRTL+'">RTL</a></li></ul></div></div><h5 class="switcher-title text-center m-b15">Home Page</h5><ul class="demos clearfix mb-0"><li><a href="index.html?data-color=skin-1&version=light"><img src="/RozgarRadar/frontend/images/switcher/index.jpg"></a></li><li><a href="index-2.html?data-color=skin-5&version=light"><img src="/RozgarRadar/frontend/images/switcher/index-2.jpg"></a></li><li><a href="index-3.html?data-color=skin-10&version=light"><img src="/RozgarRadar/frontend/images/switcher/index-3.jpg"></a></li></ul></div></div>';
...
themeOption['themeFullColor'] = ['/RozgarRadar/frontend/css/skin/skin-1','/RozgarRadar/frontend/css/skin/skin-2','/RozgarRadar/frontend/css/skin/skin-3','/RozgarRadar/frontend/css/skin/skin-4','/RozgarRadar/frontend/css/skin/skin-5','/RozgarRadar/frontend/css/skin/skin-6','/RozgarRadar/frontend/css/skin/skin-7','/RozgarRadar/frontend/css/skin/skin-8','/RozgarRadar/frontend/css/skin/skin-9','/RozgarRadar/frontend/css/skin/skin-10','themeFullColor_value','themeFullColor_logo'];
...
themeOption['backgroundImage'] =['bg1.jpg','error-404.html','error-404.html','error-404.html','backgroundImage_value'];
themeOption['backgroundPattern'] =['pt1.jpg','error-404.html','error-404.html','error-404.html','error-404.html','error-404.html','error-404.html','error-404.html','error-404.html','error-404.html','error-404.html','error-404.html','backgroundPattern_value'];
...
var SwigoSwitcher = function(){		
	...
	var handleThemeFullColor = function(){
		jQuery(document).on('click', '.color-skins li a', function(){
			...
			jQuery(".skin").attr("href", '/RozgarRadar/frontend/css/skin/'+jQuery(this).data('color-theme')+'.css');
	...
	var handleThemeStandardColor = function(){
		jQuery(document).on('click', '.color-skins-db li a', function(){
			...
			jQuery(this).parent('li').addClass('active');
			jQuery(".skin").attr("href", '/RozgarRadar/frontend/css/skin/color/'+jQuery(this).data('color-theme')+'.css');
			var logoSelectorArr = jQuery(this).data('logo-selector').split(',');
			var logoSrcArr		= jQuery(this).data('logo-image').split(',');
			var arrCount = logoSelectorArr.length;
			for(var i=0; i<arrCount; i++){
	...
	var handleThemeVersion = function(){
		...
		/* if(currentURL.indexOf('dark') > -1){
			...
			jQuery('.layout-dark .logo-dark img').attr('src','/RozgarRadar/frontend/images/logo-white.png');
	...
	jQuery.each(themeOption, function(index, themeOptionItem) {
		...
		if(themeOptionItemValue != '' && themeOptionItemValue != '1'){
			...
			if(themeOptionItem == 'themeStandardColor'){
				...
				jQuery(".skin").attr("href", '/RozgarRadar/frontend/css/skin/'+themeOptionItemValue+'.css');
